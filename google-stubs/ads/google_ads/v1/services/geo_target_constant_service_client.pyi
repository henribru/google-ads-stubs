...
from google.ads.google_ads.v1.services.transports.geo_target_constant_service_grpc_transport import GeoTargetConstantServiceGrpcTransport
from google.auth.credentials import Credentials  # type: ignore
from google.api_core.gapic_v1.client_info import ClientInfo  # type: ignore
from google.api_core.retry import Retry  # type: ignore
from typing import Optional, Dict, Any, List, Sequence, Tuple, Union, Callable, ClassVar, Text
from google.ads.google_ads.v1.proto.resources.geo_target_constant_pb2 import GeoTargetConstant
...
class GeoTargetConstantServiceClient:
    ...
    def suggest_geo_target_constants(self, locale: Union[StringValueDict, StringValue], country_code: Union[StringValueDict, StringValue], location_names: Optional[Union[Dict[str, Any], SuggestGeoTargetConstantsRequest.LocationNames]] = ..., geo_targets: Optional[Union[Dict[str, Any], SuggestGeoTargetConstantsRequest.GeoTargets]] = ..., retry: Optional[Retry] = ..., timeout: Optional[float] = ..., metadata: Optional[Sequence[Tuple[str, str]]] = ...) -> SuggestGeoTargetConstantsResponse: ...
