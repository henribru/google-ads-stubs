...
from google.ads.google_ads.v1.services.transports.keyword_plan_idea_service_grpc_transport import KeywordPlanIdeaServiceGrpcTransport
...
from google.ads.google_ads.v1.services.enums import KeywordPlanNetworkEnum
...
class KeywordPlanIdeaServiceClient:
    ...
    def generate_keyword_ideas(self, customer_id: str, language: Union[StringValueDict, StringValue], geo_target_constants: List[Union[StringValueDict, StringValue]], keyword_plan_network: KeywordPlanNetworkEnum.KeywordPlanNetwork, keyword_and_url_seed: Optional[Union[Dict[str, Any], KeywordAndUrlSeed]] = ..., keyword_seed: Optional[Any] = ..., url_seed: Optional[Union[Dict[str, Any], KeywordSeed]] = ..., retry: Optional[Retry] = ..., timeout: Optional[float] = ..., metadata: Optional[Sequence[Tuple[str, str]]] = ...) -> GenerateKeywordIdeaResponse: ...
