...
from google.ads.google_ads.v1.proto.services.google_ads_service_pb2 import MutateOperation

from google.ads.google_ads.v1.proto.services.mutate_job_service_pb2 import AddMutateJobOperationsResponse, \
    MutateJobResult, CreateMutateJobResponse
...
class MutateJobServiceClient:
    ...
    def __init__(self, transport: Optional[Union[MutateJobServiceGrpcTransport, Callable[[Credentials, type], MutateJobServiceGrpcTransport]]] = ..., channel: Optional[grpc.Channel] = ..., credentials: Optional[Credentials] = ..., client_config: Optional[Dict[str, Any]] = ..., client_info: Optional[ClientInfo] = ...) -> None: ...
    ...
    def add_mutate_job_operations(self, resource_name: str, sequence_token: str, mutate_operations: List[Union[Dict[str, Any], MutateOperation]], retry: Optional[Retry] = ..., timeout: Optional[float] = ..., metadata: Optional[Sequence[Tuple[str, str]]] = ...) -> AddMutateJobOperationsResponse: ...
