...
from google.ads.google_ads.v1.services.transports.change_status_service_grpc_transport import ChangeStatusServiceGrpcTransport
...
class ChangeStatusServiceClient:
    ...
    def __init__(self, transport: Optional[Union[ChangeStatusServiceGrpcTransport, Callable[[Credentials, type], ChangeStatusServiceGrpcTransport]]] = ..., channel: Optional[grpc.Channel] = ..., credentials: Optional[Credentials] = ..., client_config: Optional[Dict[Any, Any]] = ..., client_info: Optional[ClientInfo] = ...) -> None: ...
