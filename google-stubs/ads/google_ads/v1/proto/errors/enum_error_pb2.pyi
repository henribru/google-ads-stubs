...
class EnumErrorEnum(google___protobuf___message___Message):
    class EnumError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ENUM_VALUE_NOT_PERMITTED']]
        ...
        ENUM_VALUE_NOT_PERMITTED: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ENUM_VALUE_NOT_PERMITTED: typing_extensions___Literal[3]
