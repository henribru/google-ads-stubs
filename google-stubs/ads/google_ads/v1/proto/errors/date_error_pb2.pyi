...
class DateErrorEnum(google___protobuf___message___Message):
    ...
    class DateError(builtin___int):
        ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'DateErrorEnum.DateError']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> DateErrorEnum: ...
