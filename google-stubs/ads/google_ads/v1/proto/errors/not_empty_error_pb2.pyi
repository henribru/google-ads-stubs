...
class NotEmptyErrorEnum(google___protobuf___message___Message):
    class NotEmptyError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['EMPTY_LIST']]
        ...
        EMPTY_LIST: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    EMPTY_LIST: typing_extensions___Literal[2]
