...
class SharedCriterionErrorEnum(google___protobuf___message___Message):
    class SharedCriterionError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CRITERION_TYPE_NOT_ALLOWED_FOR_SHARED_SET_TYPE']]
        ...
        CRITERION_TYPE_NOT_ALLOWED_FOR_SHARED_SET_TYPE: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CRITERION_TYPE_NOT_ALLOWED_FOR_SHARED_SET_TYPE: typing_extensions___Literal[2]
