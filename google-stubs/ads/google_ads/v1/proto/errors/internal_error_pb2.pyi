...
class InternalErrorEnum(google___protobuf___message___Message):
    class InternalError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['INTERNAL_ERROR'],typing_extensions___Literal['ERROR_CODE_NOT_PUBLISHED'],typing_extensions___Literal['TRANSIENT_ERROR']]
        ...
        INTERNAL_ERROR: typing_extensions___Literal[2]
        ERROR_CODE_NOT_PUBLISHED: typing_extensions___Literal[3]
        TRANSIENT_ERROR: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    INTERNAL_ERROR: typing_extensions___Literal[2]
    ERROR_CODE_NOT_PUBLISHED: typing_extensions___Literal[3]
