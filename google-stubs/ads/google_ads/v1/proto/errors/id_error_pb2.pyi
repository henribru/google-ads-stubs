...
class IdErrorEnum(google___protobuf___message___Message):
    class IdError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['NOT_FOUND']]
        ...
        NOT_FOUND: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    NOT_FOUND: typing_extensions___Literal[2]
