...
class NullErrorEnum(google___protobuf___message___Message):
    class NullError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['NULL_CONTENT']]
        ...
        NULL_CONTENT: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    NULL_CONTENT: typing_extensions___Literal[2]
