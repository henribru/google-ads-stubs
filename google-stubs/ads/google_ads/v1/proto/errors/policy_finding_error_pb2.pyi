...
class PolicyFindingErrorEnum(google___protobuf___message___Message):
    class PolicyFindingError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['POLICY_FINDING'],typing_extensions___Literal['POLICY_TOPIC_NOT_FOUND']]
        ...
        POLICY_FINDING: typing_extensions___Literal[2]
        POLICY_TOPIC_NOT_FOUND: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    POLICY_FINDING: typing_extensions___Literal[2]
    POLICY_TOPIC_NOT_FOUND: typing_extensions___Literal[3]
