...
class OperatorErrorEnum(google___protobuf___message___Message):
    class OperatorError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['OPERATOR_NOT_SUPPORTED']]
        ...
        OPERATOR_NOT_SUPPORTED: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    OPERATOR_NOT_SUPPORTED: typing_extensions___Literal[2]
