...
class AdParameterErrorEnum(google___protobuf___message___Message):
    class AdParameterError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['AD_GROUP_CRITERION_MUST_BE_KEYWORD'],typing_extensions___Literal['INVALID_INSERTION_TEXT_FORMAT']]
        ...
        AD_GROUP_CRITERION_MUST_BE_KEYWORD: typing_extensions___Literal[2]
        INVALID_INSERTION_TEXT_FORMAT: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    AD_GROUP_CRITERION_MUST_BE_KEYWORD: typing_extensions___Literal[2]
    INVALID_INSERTION_TEXT_FORMAT: typing_extensions___Literal[3]
