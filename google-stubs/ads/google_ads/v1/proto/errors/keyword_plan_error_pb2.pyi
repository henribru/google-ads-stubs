...
class KeywordPlanErrorEnum(google___protobuf___message___Message):
    ...
    class KeywordPlanError(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'KeywordPlanErrorEnum.KeywordPlanError': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['KeywordPlanErrorEnum.KeywordPlanError']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'KeywordPlanErrorEnum.KeywordPlanError']]: ...
        ...
        BID_MULTIPLIER_OUT_OF_RANGE = typing___cast('KeywordPlanErrorEnum.KeywordPlanError', 2)
        ...
        BID_TOO_MANY_FRACTIONAL_DIGITS = typing___cast('KeywordPlanErrorEnum.KeywordPlanError', 5)
        DAILY_BUDGET_TOO_LOW = typing___cast('KeywordPlanErrorEnum.KeywordPlanError', 6)
        DAILY_BUDGET_TOO_MANY_FRACTIONAL_DIGITS = typing___cast('KeywordPlanErrorEnum.KeywordPlanError', 7)
        INVALID_VALUE = typing___cast('KeywordPlanErrorEnum.KeywordPlanError', 8)
        KEYWORD_PLAN_HAS_NO_KEYWORDS = typing___cast('KeywordPlanErrorEnum.KeywordPlanError', 9)
        KEYWORD_PLAN_NOT_ENABLED = typing___cast('KeywordPlanErrorEnum.KeywordPlanError', 10)
        ...
        INVALID_FORECAST_DATE_RANGE = typing___cast('KeywordPlanErrorEnum.KeywordPlanError', 15)
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> KeywordPlanErrorEnum: ...
