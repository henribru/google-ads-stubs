...
class ContextErrorEnum(google___protobuf___message___Message):
    class ContextError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['OPERATION_NOT_PERMITTED_FOR_CONTEXT'],typing_extensions___Literal['OPERATION_NOT_PERMITTED_FOR_REMOVED_RESOURCE']]
        ...
        OPERATION_NOT_PERMITTED_FOR_CONTEXT: typing_extensions___Literal[2]
        OPERATION_NOT_PERMITTED_FOR_REMOVED_RESOURCE: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    OPERATION_NOT_PERMITTED_FOR_CONTEXT: typing_extensions___Literal[2]
    OPERATION_NOT_PERMITTED_FOR_REMOVED_RESOURCE: typing_extensions___Literal[3]
