...
class CountryCodeErrorEnum(google___protobuf___message___Message):
    class CountryCodeError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['INVALID_COUNTRY_CODE']]
        ...
        INVALID_COUNTRY_CODE: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    INVALID_COUNTRY_CODE: typing_extensions___Literal[2]
