...
class StringLengthErrorEnum(google___protobuf___message___Message):
    class StringLengthError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['TOO_SHORT'],typing_extensions___Literal['TOO_LONG']]
        ...
        TOO_SHORT: typing_extensions___Literal[2]
        TOO_LONG: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    TOO_SHORT: typing_extensions___Literal[2]
    TOO_LONG: typing_extensions___Literal[3]
