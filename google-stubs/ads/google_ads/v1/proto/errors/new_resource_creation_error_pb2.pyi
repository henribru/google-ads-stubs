...
class NewResourceCreationErrorEnum(google___protobuf___message___Message):
    class NewResourceCreationError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CANNOT_SET_ID_FOR_CREATE'],typing_extensions___Literal['DUPLICATE_TEMP_IDS'],typing_extensions___Literal['TEMP_ID_RESOURCE_HAD_ERRORS']]
        ...
        CANNOT_SET_ID_FOR_CREATE: typing_extensions___Literal[2]
        DUPLICATE_TEMP_IDS: typing_extensions___Literal[3]
        TEMP_ID_RESOURCE_HAD_ERRORS: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CANNOT_SET_ID_FOR_CREATE: typing_extensions___Literal[2]
    DUPLICATE_TEMP_IDS: typing_extensions___Literal[3]
