...
class AdxErrorEnum(google___protobuf___message___Message):
    class AdxError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['UNSUPPORTED_FEATURE']]
        ...
        UNSUPPORTED_FEATURE: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    UNSUPPORTED_FEATURE: typing_extensions___Literal[2]
