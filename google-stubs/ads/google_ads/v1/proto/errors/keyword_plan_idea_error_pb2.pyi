...
class KeywordPlanIdeaErrorEnum(google___protobuf___message___Message):
    class KeywordPlanIdeaError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['URL_CRAWL_ERROR'],typing_extensions___Literal['INVALID_VALUE']]
        ...
        URL_CRAWL_ERROR: typing_extensions___Literal[2]
        INVALID_VALUE: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    URL_CRAWL_ERROR: typing_extensions___Literal[2]
    INVALID_VALUE: typing_extensions___Literal[3]
