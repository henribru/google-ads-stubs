...
class RangeErrorEnum(google___protobuf___message___Message):
    class RangeError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['TOO_LOW'],typing_extensions___Literal['TOO_HIGH']]
        ...
        TOO_LOW: typing_extensions___Literal[2]
        TOO_HIGH: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    TOO_LOW: typing_extensions___Literal[2]
    TOO_HIGH: typing_extensions___Literal[3]
