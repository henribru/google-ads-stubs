...
class DatabaseErrorEnum(google___protobuf___message___Message):
    class DatabaseError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CONCURRENT_MODIFICATION']]
