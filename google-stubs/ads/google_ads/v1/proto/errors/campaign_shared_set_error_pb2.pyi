...
class CampaignSharedSetErrorEnum(google___protobuf___message___Message):
    ...
    class CampaignSharedSetError(int):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
        @classmethod
        def Name(cls, number: int) -> str: ...
        @classmethod
        def Value(cls, name: str) -> CampaignSharedSetErrorEnum.CampaignSharedSetError: ...
        @classmethod
        def keys(cls) -> typing___List[str]: ...
        @classmethod
        def values(cls) -> typing___List[CampaignSharedSetErrorEnum.CampaignSharedSetError]: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[str, CampaignSharedSetErrorEnum.CampaignSharedSetError]]: ...
