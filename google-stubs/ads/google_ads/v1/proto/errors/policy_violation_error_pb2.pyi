...
class PolicyViolationErrorEnum(google___protobuf___message___Message):
    class PolicyViolationError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['POLICY_ERROR']]
        ...
        POLICY_ERROR: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    POLICY_ERROR: typing_extensions___Literal[2]
