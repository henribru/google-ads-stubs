...
class CollectionSizeErrorEnum(google___protobuf___message___Message):
    class CollectionSizeError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['TOO_FEW'],typing_extensions___Literal['TOO_MANY']]
        ...
        TOO_FEW: typing_extensions___Literal[2]
        TOO_MANY: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    TOO_FEW: typing_extensions___Literal[2]
    TOO_MANY: typing_extensions___Literal[3]
