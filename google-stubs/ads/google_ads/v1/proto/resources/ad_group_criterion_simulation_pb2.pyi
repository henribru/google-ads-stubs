...
class AdGroupCriterionSimulation(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> AdGroupCriterionSimulation: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"ad_group_id",b"ad_group_id",u"cpc_bid_point_list",b"cpc_bid_point_list",u"criterion_id",b"criterion_id",u"end_date",b"end_date",u"point_list",b"point_list",u"start_date",b"start_date"]) -> builtin___bool: ...
