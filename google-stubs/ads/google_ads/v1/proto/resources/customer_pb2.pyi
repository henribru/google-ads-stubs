...
class Customer(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        ...
        conversion_tracking_setting : typing___Optional[global___ConversionTrackingSetting] = None,
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> Customer: ...
...
class CallReportingSetting(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> CallReportingSetting: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"call_conversion_action",b"call_conversion_action",u"call_conversion_reporting_enabled",b"call_conversion_reporting_enabled",u"call_reporting_enabled",b"call_reporting_enabled"]) -> builtin___bool: ...
...
class ConversionTrackingSetting(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> ConversionTrackingSetting: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"conversion_tracking_id",b"conversion_tracking_id",u"cross_account_conversion_tracking_id",b"cross_account_conversion_tracking_id"]) -> builtin___bool: ...
...
class RemarketingSetting(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> RemarketingSetting: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"google_global_site_tag",b"google_global_site_tag"]) -> builtin___bool: ...
