...
class MutateJob(google___protobuf___message___Message):
    ...
    class MutateJobMetadata(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            ...
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> MutateJob.MutateJobMetadata: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def HasField(self, field_name: typing_extensions___Literal[u"completion_date_time",b"completion_date_time",u"creation_date_time",b"creation_date_time",u"estimated_completion_ratio",b"estimated_completion_ratio",u"executed_operation_count",b"executed_operation_count",u"operation_count",b"operation_count"]) -> builtin___bool: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> MutateJob: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"id",b"id",u"long_running_operation",b"long_running_operation",u"metadata",b"metadata",u"next_add_sequence_token",b"next_add_sequence_token"]) -> builtin___bool: ...
