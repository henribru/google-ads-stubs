...
class GeographicView(google___protobuf___message___Message):
    ...
    location_type = ... # type: google___ads___googleads___v1___enums___geo_targeting_type_pb2___GeoTargetingTypeEnum.GeoTargetingType.ClosedValueType

    @property
    def country_geo_target_constant(self) -> google___protobuf___wrappers_pb2___StringValue: ...

    def __init__(self,
        *,
        resource_name : typing___Optional[typing___Text] = None,
        country_geo_target_constant : typing___Optional[google___protobuf___wrappers_pb2___StringValue] = None,
        location_type : typing___Optional[google___ads___googleads___v1___enums___geo_targeting_type_pb2___GeoTargetingTypeEnum.GeoTargetingType.ClosedValueType] = None,
        ) -> None: ...
    @classmethod
