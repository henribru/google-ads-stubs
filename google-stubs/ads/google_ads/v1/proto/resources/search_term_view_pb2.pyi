...
class SearchTermView(google___protobuf___message___Message):
    ...
    status = (
        ...
    )  # type: google___ads___googleads___v1___enums___search_term_targeting_status_pb2___SearchTermTargetingStatusEnum.SearchTermTargetingStatus
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v1___enums___search_term_targeting_status_pb2___SearchTermTargetingStatusEnum.SearchTermTargetingStatus
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
