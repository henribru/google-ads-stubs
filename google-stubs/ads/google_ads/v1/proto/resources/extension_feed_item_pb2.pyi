...
class ExtensionFeedItem(google___protobuf___message___Message):
    ...
    extension_type = (
        ...
    )  # type: google___ads___googleads___v1___enums___extension_type_pb2___ExtensionTypeEnum.ExtensionType
    device = (
        ...
    )  # type: google___ads___googleads___v1___enums___feed_item_target_device_pb2___FeedItemTargetDeviceEnum.FeedItemTargetDevice
    status = (
        ...
    ...
    def structured_snippet_feed_item(
        self,
    ) -> google___ads___googleads___v1___common___extensions_pb2___StructuredSnippetFeedItem: ...
    @property
    def app_feed_item(
        self,
    ) -> google___ads___googleads___v1___common___extensions_pb2___AppFeedItem: ...
    @property
    def call_feed_item(
        self,
    ...
    def text_message_feed_item(
        self,
    ) -> google___ads___googleads___v1___common___extensions_pb2___TextMessageFeedItem: ...
    @property
    def price_feed_item(
        self,
    ) -> google___ads___googleads___v1___common___extensions_pb2___PriceFeedItem: ...
    @property
    def promotion_feed_item(
        self,
    ) -> google___ads___googleads___v1___common___extensions_pb2___PromotionFeedItem: ...
    @property
    def location_feed_item(
        self,
    ) -> google___ads___googleads___v1___common___extensions_pb2___LocationFeedItem: ...
    @property
    def affiliate_location_feed_item(
        self,
    ) -> google___ads___googleads___v1___common___extensions_pb2___AffiliateLocationFeedItem: ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        extension_type: typing___Optional[
            google___ads___googleads___v1___enums___extension_type_pb2___ExtensionTypeEnum.ExtensionType
        ] = None,
        ...
        device: typing___Optional[
            google___ads___googleads___v1___enums___feed_item_target_device_pb2___FeedItemTargetDeviceEnum.FeedItemTargetDevice
        ] = None,
