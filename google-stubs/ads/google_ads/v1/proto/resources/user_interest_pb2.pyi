...
class UserInterest(google___protobuf___message___Message):
    ...
    taxonomy_type = (
        ...
    )  # type: google___ads___googleads___v1___enums___user_interest_taxonomy_type_pb2___UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType
    @property
    ...
    def availabilities(
        ...
        google___ads___googleads___v1___common___criterion_category_availability_pb2___CriterionCategoryAvailability
    ]: ...
    def __init__(
        self,
        *,
        ...
        taxonomy_type: typing___Optional[
            google___ads___googleads___v1___enums___user_interest_taxonomy_type_pb2___UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType
        ] = None,
