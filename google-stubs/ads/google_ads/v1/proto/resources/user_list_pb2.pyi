...
class UserList(google___protobuf___message___Message):
    ...
    membership_status = (
        ...
    )  # type: google___ads___googleads___v1___enums___user_list_membership_status_pb2___UserListMembershipStatusEnum.UserListMembershipStatus
    size_range_for_display = (
        ...
    )  # type: google___ads___googleads___v1___enums___user_list_size_range_pb2___UserListSizeRangeEnum.UserListSizeRange
    size_range_for_search = (
        ...
    )  # type: google___ads___googleads___v1___enums___user_list_size_range_pb2___UserListSizeRangeEnum.UserListSizeRange
    type = (
        ...
    )  # type: google___ads___googleads___v1___enums___user_list_type_pb2___UserListTypeEnum.UserListType
    closing_reason = (
        ...
    )  # type: google___ads___googleads___v1___enums___user_list_closing_reason_pb2___UserListClosingReasonEnum.UserListClosingReason
    access_reason = (
        ...
    )  # type: google___ads___googleads___v1___enums___access_reason_pb2___AccessReasonEnum.AccessReason
    account_user_list_status = (
        ...
    )  # type: google___ads___googleads___v1___enums___user_list_access_status_pb2___UserListAccessStatusEnum.UserListAccessStatus
    @property
    ...
    def __init__(
        ...
        *,
        ...
        membership_status: typing___Optional[
            google___ads___googleads___v1___enums___user_list_membership_status_pb2___UserListMembershipStatusEnum.UserListMembershipStatus
        ] = None,
        ...
        size_range_for_display: typing___Optional[
            google___ads___googleads___v1___enums___user_list_size_range_pb2___UserListSizeRangeEnum.UserListSizeRange
        ] = None,
        ...
        type: typing___Optional[
            google___ads___googleads___v1___enums___user_list_type_pb2___UserListTypeEnum.UserListType
        ] = None,
        closing_reason: typing___Optional[
            google___ads___googleads___v1___enums___user_list_closing_reason_pb2___UserListClosingReasonEnum.UserListClosingReason
        ] = None,
        access_reason: typing___Optional[
            google___ads___googleads___v1___enums___access_reason_pb2___AccessReasonEnum.AccessReason
        ] = None,
        account_user_list_status: typing___Optional[
            google___ads___googleads___v1___enums___user_list_access_status_pb2___UserListAccessStatusEnum.UserListAccessStatus
        ] = None,
