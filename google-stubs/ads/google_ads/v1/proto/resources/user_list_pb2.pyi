...
class UserList(google___protobuf___message___Message):
    ...
    membership_status = ... # type: google___ads___googleads___v1___enums___user_list_membership_status_pb2___UserListMembershipStatusEnum.UserListMembershipStatus.ClosedValueType
    size_range_for_display = ... # type: google___ads___googleads___v1___enums___user_list_size_range_pb2___UserListSizeRangeEnum.UserListSizeRange.ClosedValueType
    size_range_for_search = ... # type: google___ads___googleads___v1___enums___user_list_size_range_pb2___UserListSizeRangeEnum.UserListSizeRange.ClosedValueType
    type = ... # type: google___ads___googleads___v1___enums___user_list_type_pb2___UserListTypeEnum.UserListType.ClosedValueType
    closing_reason = ... # type: google___ads___googleads___v1___enums___user_list_closing_reason_pb2___UserListClosingReasonEnum.UserListClosingReason.ClosedValueType
    access_reason = ... # type: google___ads___googleads___v1___enums___access_reason_pb2___AccessReasonEnum.AccessReason.ClosedValueType
    account_user_list_status = ... # type: google___ads___googleads___v1___enums___user_list_access_status_pb2___UserListAccessStatusEnum.UserListAccessStatus.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        membership_status : typing___Optional[google___ads___googleads___v1___enums___user_list_membership_status_pb2___UserListMembershipStatusEnum.UserListMembershipStatus.ClosedValueType] = None,
        ...
        size_range_for_display : typing___Optional[google___ads___googleads___v1___enums___user_list_size_range_pb2___UserListSizeRangeEnum.UserListSizeRange.ClosedValueType] = None,
        size_for_search : typing___Optional[google___protobuf___wrappers_pb2___Int64Value] = None,
        size_range_for_search : typing___Optional[google___ads___googleads___v1___enums___user_list_size_range_pb2___UserListSizeRangeEnum.UserListSizeRange.ClosedValueType] = None,
        type : typing___Optional[google___ads___googleads___v1___enums___user_list_type_pb2___UserListTypeEnum.UserListType.ClosedValueType] = None,
        closing_reason : typing___Optional[google___ads___googleads___v1___enums___user_list_closing_reason_pb2___UserListClosingReasonEnum.UserListClosingReason.ClosedValueType] = None,
        access_reason : typing___Optional[google___ads___googleads___v1___enums___access_reason_pb2___AccessReasonEnum.AccessReason.ClosedValueType] = None,
        account_user_list_status : typing___Optional[google___ads___googleads___v1___enums___user_list_access_status_pb2___UserListAccessStatusEnum.UserListAccessStatus.ClosedValueType] = None,
