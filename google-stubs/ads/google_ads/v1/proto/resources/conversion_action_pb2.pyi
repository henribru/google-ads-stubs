...
class ConversionAction(google___protobuf___message___Message):
    ...
    class AttributionModelSettings(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> ConversionAction.AttributionModelSettings: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> ConversionAction.AttributionModelSettings: ...
    ...
    class ValueSettings(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> ConversionAction.ValueSettings: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> ConversionAction.ValueSettings: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def HasField(self, field_name: typing_extensions___Literal[u"always_use_default_value",b"always_use_default_value",u"default_currency_code",b"default_currency_code",u"default_value",b"default_value"]) -> builtin___bool: ...
    ...
    @property
    def tag_snippets(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[google___ads___googleads___v1___common___tag_snippet_pb2___TagSnippet]: ...
    ...
    def __init__(self,
        *,
        ...
        value_settings : typing___Optional[global___ConversionAction.ValueSettings] = None,
        ...
        attribution_model_settings : typing___Optional[global___ConversionAction.AttributionModelSettings] = None,
