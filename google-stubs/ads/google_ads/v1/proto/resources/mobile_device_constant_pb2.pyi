...
class MobileDeviceConstant(google___protobuf___message___Message):
    ...
    type = (
        ...
    )  # type: google___ads___googleads___v1___enums___mobile_device_type_pb2___MobileDeviceTypeEnum.MobileDeviceType
    @property
    ...
    def __init__(
        ...
        *,
        ...
        type: typing___Optional[
            google___ads___googleads___v1___enums___mobile_device_type_pb2___MobileDeviceTypeEnum.MobileDeviceType
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
