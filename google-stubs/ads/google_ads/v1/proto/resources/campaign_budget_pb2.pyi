...
class CampaignBudget(google___protobuf___message___Message):
    ...
    status = (
        ...
    )  # type: google___ads___googleads___v1___enums___budget_status_pb2___BudgetStatusEnum.BudgetStatus
    delivery_method = (
        ...
    )  # type: google___ads___googleads___v1___enums___budget_delivery_method_pb2___BudgetDeliveryMethodEnum.BudgetDeliveryMethod
    period = (
        ...
    )  # type: google___ads___googleads___v1___enums___budget_period_pb2___BudgetPeriodEnum.BudgetPeriod
    type = (
        ...
    )  # type: google___ads___googleads___v1___enums___budget_type_pb2___BudgetTypeEnum.BudgetType
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v1___enums___budget_status_pb2___BudgetStatusEnum.BudgetStatus
        ] = None,
        delivery_method: typing___Optional[
            google___ads___googleads___v1___enums___budget_delivery_method_pb2___BudgetDeliveryMethodEnum.BudgetDeliveryMethod
        ] = None,
        ...
        period: typing___Optional[
            google___ads___googleads___v1___enums___budget_period_pb2___BudgetPeriodEnum.BudgetPeriod
        ] = None,
        ...
        type: typing___Optional[
            google___ads___googleads___v1___enums___budget_type_pb2___BudgetTypeEnum.BudgetType
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
