...
class MatchingFunction(google___protobuf___message___Message):
    ...
    operator = (
        ...
    )  # type: google___ads___googleads___v1___enums___matching_function_operator_pb2___MatchingFunctionOperatorEnum.MatchingFunctionOperator
    @property
    ...
    def __init__(
        ...
        *,
        ...
        operator: typing___Optional[
            google___ads___googleads___v1___enums___matching_function_operator_pb2___MatchingFunctionOperatorEnum.MatchingFunctionOperator
        ] = None,
...
class Operand(google___protobuf___message___Message):
    ...
    class RequestContextOperand(google___protobuf___message___Message):
        ...
        context_type = (
            ...
        )  # type: google___ads___googleads___v1___enums___matching_function_context_type_pb2___MatchingFunctionContextTypeEnum.MatchingFunctionContextType
        def __init__(
            self,
            *,
            context_type: typing___Optional[
                google___ads___googleads___v1___enums___matching_function_context_type_pb2___MatchingFunctionContextTypeEnum.MatchingFunctionContextType
            ] = None,
        ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
