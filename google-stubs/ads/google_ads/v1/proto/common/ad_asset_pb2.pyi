...
class AdTextAsset(google___protobuf___message___Message):
    ...
    pinned_field = (
        ...
    )  # type: google___ads___googleads___v1___enums___served_asset_field_type_pb2___ServedAssetFieldTypeEnum.ServedAssetFieldType
    @property
    ...
    def __init__(
        ...
        *,
        ...
        pinned_field: typing___Optional[
            google___ads___googleads___v1___enums___served_asset_field_type_pb2___ServedAssetFieldTypeEnum.ServedAssetFieldType
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
