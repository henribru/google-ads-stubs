...
class MerchantCenterLinkStatusEnum(google___protobuf___message___Message):
    class MerchantCenterLinkStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ENABLED'],typing_extensions___Literal['PENDING']]
        ...
        PENDING: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ENABLED: typing_extensions___Literal[2]
    PENDING: typing_extensions___Literal[3]
