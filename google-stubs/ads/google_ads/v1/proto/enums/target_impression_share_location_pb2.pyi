...
class TargetImpressionShareLocationEnum(google___protobuf___message___Message):
    class TargetImpressionShareLocation(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ANYWHERE_ON_PAGE'],typing_extensions___Literal['TOP_OF_PAGE'],typing_extensions___Literal['ABSOLUTE_TOP_OF_PAGE']]
        ...
        ANYWHERE_ON_PAGE: typing_extensions___Literal[2]
        TOP_OF_PAGE: typing_extensions___Literal[3]
        ABSOLUTE_TOP_OF_PAGE: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ANYWHERE_ON_PAGE: typing_extensions___Literal[2]
    TOP_OF_PAGE: typing_extensions___Literal[3]
