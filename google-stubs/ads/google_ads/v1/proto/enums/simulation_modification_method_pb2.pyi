...
class SimulationModificationMethodEnum(google___protobuf___message___Message):
    class SimulationModificationMethod(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['UNIFORM'],typing_extensions___Literal['DEFAULT']]
        ...
        UNIFORM: typing_extensions___Literal[2]
        DEFAULT: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    UNIFORM: typing_extensions___Literal[2]
    DEFAULT: typing_extensions___Literal[3]
