...
class CallConversionReportingStateEnum(google___protobuf___message___Message):
    class CallConversionReportingState(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['DISABLED'],typing_extensions___Literal['USE_ACCOUNT_LEVEL_CALL_CONVERSION_ACTION'],typing_extensions___Literal['USE_RESOURCE_LEVEL_CALL_CONVERSION_ACTION']]
        ...
        DISABLED: typing_extensions___Literal[2]
        USE_ACCOUNT_LEVEL_CALL_CONVERSION_ACTION: typing_extensions___Literal[3]
        USE_RESOURCE_LEVEL_CALL_CONVERSION_ACTION: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    DISABLED: typing_extensions___Literal[2]
    USE_ACCOUNT_LEVEL_CALL_CONVERSION_ACTION: typing_extensions___Literal[3]
