...
class ExtensionSettingDeviceEnum(google___protobuf___message___Message):
    class ExtensionSettingDevice(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['MOBILE'],typing_extensions___Literal['DESKTOP']]
        ...
        DESKTOP: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    MOBILE: typing_extensions___Literal[2]
    DESKTOP: typing_extensions___Literal[3]
    ...
    @classmethod
    def FromString(cls, s: bytes) -> ExtensionSettingDeviceEnum: ...
