...
class FrequencyCapTimeUnitEnum(google___protobuf___message___Message):
    class FrequencyCapTimeUnit(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['DAY'],typing_extensions___Literal['WEEK'],typing_extensions___Literal['MONTH']]
        ...
        DAY: typing_extensions___Literal[2]
        WEEK: typing_extensions___Literal[3]
        MONTH: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    DAY: typing_extensions___Literal[2]
    WEEK: typing_extensions___Literal[3]
