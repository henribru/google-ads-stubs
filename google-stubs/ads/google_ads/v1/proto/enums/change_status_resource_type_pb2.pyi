...
class ChangeStatusResourceTypeEnum(google___protobuf___message___Message):
    ...
    class ChangeStatusResourceType(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'ChangeStatusResourceTypeEnum.ChangeStatusResourceType': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['ChangeStatusResourceTypeEnum.ChangeStatusResourceType']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'ChangeStatusResourceTypeEnum.ChangeStatusResourceType']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> ChangeStatusResourceTypeEnum: ...
