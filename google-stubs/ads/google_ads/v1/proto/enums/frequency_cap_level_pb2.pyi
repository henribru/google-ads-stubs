...
class FrequencyCapLevelEnum(google___protobuf___message___Message):
    class FrequencyCapLevel(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['AD_GROUP_AD'],typing_extensions___Literal['AD_GROUP'],typing_extensions___Literal['CAMPAIGN']]
        ...
        AD_GROUP_AD: typing_extensions___Literal[2]
        AD_GROUP: typing_extensions___Literal[3]
        CAMPAIGN: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    AD_GROUP_AD: typing_extensions___Literal[2]
    AD_GROUP: typing_extensions___Literal[3]
