...
class InteractionEventTypeEnum(google___protobuf___message___Message):
    class InteractionEventType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CLICK'],typing_extensions___Literal['ENGAGEMENT'],typing_extensions___Literal['VIDEO_VIEW'],typing_extensions___Literal['NONE']]
        ...
        CLICK: typing_extensions___Literal[2]
        ENGAGEMENT: typing_extensions___Literal[3]
        VIDEO_VIEW: typing_extensions___Literal[4]
