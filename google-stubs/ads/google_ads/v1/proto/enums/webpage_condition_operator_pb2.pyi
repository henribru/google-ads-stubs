...
class WebpageConditionOperatorEnum(google___protobuf___message___Message):
    class WebpageConditionOperator(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['EQUALS'],typing_extensions___Literal['CONTAINS']]
        ...
        CONTAINS: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    EQUALS: typing_extensions___Literal[2]
    CONTAINS: typing_extensions___Literal[3]
