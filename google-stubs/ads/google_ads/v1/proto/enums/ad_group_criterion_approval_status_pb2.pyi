...
class AdGroupCriterionApprovalStatusEnum(google___protobuf___message___Message):
    class AdGroupCriterionApprovalStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['APPROVED'],typing_extensions___Literal['DISAPPROVED'],typing_extensions___Literal['PENDING_REVIEW'],typing_extensions___Literal['UNDER_REVIEW']]
        ...
        APPROVED: typing_extensions___Literal[2]
        DISAPPROVED: typing_extensions___Literal[3]
        PENDING_REVIEW: typing_extensions___Literal[4]
        UNDER_REVIEW: typing_extensions___Literal[5]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    APPROVED: typing_extensions___Literal[2]
    DISAPPROVED: typing_extensions___Literal[3]
