...
class SharedSetTypeEnum(google___protobuf___message___Message):
    class SharedSetType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['NEGATIVE_KEYWORDS'],typing_extensions___Literal['NEGATIVE_PLACEMENTS']]
        ...
        NEGATIVE_KEYWORDS: typing_extensions___Literal[2]
        NEGATIVE_PLACEMENTS: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    NEGATIVE_KEYWORDS: typing_extensions___Literal[2]
    NEGATIVE_PLACEMENTS: typing_extensions___Literal[3]
