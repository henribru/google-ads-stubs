...
class ConversionAdjustmentTypeEnum(google___protobuf___message___Message):
    class ConversionAdjustmentType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['RETRACTION'],typing_extensions___Literal['RESTATEMENT']]
        ...
        RETRACTION: typing_extensions___Literal[2]
        RESTATEMENT: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    RETRACTION: typing_extensions___Literal[2]
    RESTATEMENT: typing_extensions___Literal[3]
