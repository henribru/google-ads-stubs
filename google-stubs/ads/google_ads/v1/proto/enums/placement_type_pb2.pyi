...
class PlacementTypeEnum(google___protobuf___message___Message):
    class PlacementType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['WEBSITE'],typing_extensions___Literal['MOBILE_APP_CATEGORY'],typing_extensions___Literal['MOBILE_APPLICATION'],typing_extensions___Literal['YOUTUBE_VIDEO'],typing_extensions___Literal['YOUTUBE_CHANNEL']]
        ...
        WEBSITE: typing_extensions___Literal[2]
        MOBILE_APP_CATEGORY: typing_extensions___Literal[3]
        MOBILE_APPLICATION: typing_extensions___Literal[4]
        YOUTUBE_VIDEO: typing_extensions___Literal[5]
        YOUTUBE_CHANNEL: typing_extensions___Literal[6]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    WEBSITE: typing_extensions___Literal[2]
    MOBILE_APP_CATEGORY: typing_extensions___Literal[3]
