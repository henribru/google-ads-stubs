...
class AccountBudgetStatusEnum(google___protobuf___message___Message):
    class AccountBudgetStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['PENDING'],typing_extensions___Literal['APPROVED'],typing_extensions___Literal['CANCELLED']]
        ...
        APPROVED: typing_extensions___Literal[3]
        CANCELLED: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    PENDING: typing_extensions___Literal[2]
    APPROVED: typing_extensions___Literal[3]
