...
class PriceExtensionPriceUnitEnum(google___protobuf___message___Message):
    class PriceExtensionPriceUnit(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['PER_HOUR'],typing_extensions___Literal['PER_DAY'],typing_extensions___Literal['PER_WEEK'],typing_extensions___Literal['PER_MONTH'],typing_extensions___Literal['PER_YEAR'],typing_extensions___Literal['PER_NIGHT']]
        ...
        PER_HOUR: typing_extensions___Literal[2]
        PER_DAY: typing_extensions___Literal[3]
        PER_WEEK: typing_extensions___Literal[4]
        PER_MONTH: typing_extensions___Literal[5]
        PER_YEAR: typing_extensions___Literal[6]
        PER_NIGHT: typing_extensions___Literal[7]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    PER_HOUR: typing_extensions___Literal[2]
    PER_DAY: typing_extensions___Literal[3]
