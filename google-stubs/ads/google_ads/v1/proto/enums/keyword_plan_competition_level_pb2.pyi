...
class KeywordPlanCompetitionLevelEnum(google___protobuf___message___Message):
    class KeywordPlanCompetitionLevel(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['LOW'],typing_extensions___Literal['MEDIUM'],typing_extensions___Literal['HIGH']]
        ...
        LOW: typing_extensions___Literal[2]
        MEDIUM: typing_extensions___Literal[3]
        HIGH: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    LOW: typing_extensions___Literal[2]
    MEDIUM: typing_extensions___Literal[3]
