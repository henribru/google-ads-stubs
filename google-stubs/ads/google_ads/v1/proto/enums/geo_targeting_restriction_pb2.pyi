...
class GeoTargetingRestrictionEnum(google___protobuf___message___Message):
    class GeoTargetingRestriction(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['LOCATION_OF_PRESENCE']]
        ...
        LOCATION_OF_PRESENCE: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    LOCATION_OF_PRESENCE: typing_extensions___Literal[2]
