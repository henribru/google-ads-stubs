...
class CampaignSharedSetStatusEnum(google___protobuf___message___Message):
    ...
    class CampaignSharedSetStatus(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'CampaignSharedSetStatusEnum.CampaignSharedSetStatus': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['CampaignSharedSetStatusEnum.CampaignSharedSetStatus']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'CampaignSharedSetStatusEnum.CampaignSharedSetStatus']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> CampaignSharedSetStatusEnum: ...
