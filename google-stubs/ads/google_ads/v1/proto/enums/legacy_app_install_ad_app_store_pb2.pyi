...
class LegacyAppInstallAdAppStoreEnum(google___protobuf___message___Message):
    ...
    class LegacyAppInstallAdAppStore(int):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
        @classmethod
        def Name(cls, number: int) -> str: ...
        @classmethod
        def Value(cls, name: str) -> LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore: ...
        @classmethod
        def keys(cls) -> typing___List[str]: ...
        @classmethod
        def values(cls) -> typing___List[LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore]: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[str, LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore]]: ...
