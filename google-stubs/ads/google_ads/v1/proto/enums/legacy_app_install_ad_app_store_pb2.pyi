...
class LegacyAppInstallAdAppStoreEnum(google___protobuf___message___Message):
    class LegacyAppInstallAdAppStore(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['APPLE_APP_STORE'],typing_extensions___Literal['GOOGLE_PLAY'],typing_extensions___Literal['WINDOWS_STORE'],typing_extensions___Literal['WINDOWS_PHONE_STORE'],typing_extensions___Literal['CN_APP_STORE']]
        ...
        APPLE_APP_STORE: typing_extensions___Literal[2]
        GOOGLE_PLAY: typing_extensions___Literal[3]
        WINDOWS_STORE: typing_extensions___Literal[4]
        WINDOWS_PHONE_STORE: typing_extensions___Literal[5]
        CN_APP_STORE: typing_extensions___Literal[6]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    APPLE_APP_STORE: typing_extensions___Literal[2]
    GOOGLE_PLAY: typing_extensions___Literal[3]
    ...
    @classmethod
    def FromString(cls, s: bytes) -> LegacyAppInstallAdAppStoreEnum: ...
