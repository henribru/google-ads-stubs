...
class DayOfWeekEnum(google___protobuf___message___Message):
    class DayOfWeek(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['MONDAY'],typing_extensions___Literal['TUESDAY'],typing_extensions___Literal['WEDNESDAY'],typing_extensions___Literal['THURSDAY'],typing_extensions___Literal['FRIDAY'],typing_extensions___Literal['SATURDAY'],typing_extensions___Literal['SUNDAY']]
        ...
        MONDAY: typing_extensions___Literal[2]
        TUESDAY: typing_extensions___Literal[3]
        WEDNESDAY: typing_extensions___Literal[4]
        THURSDAY: typing_extensions___Literal[5]
        FRIDAY: typing_extensions___Literal[6]
        SATURDAY: typing_extensions___Literal[7]
        SUNDAY: typing_extensions___Literal[8]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    MONDAY: typing_extensions___Literal[2]
    TUESDAY: typing_extensions___Literal[3]
