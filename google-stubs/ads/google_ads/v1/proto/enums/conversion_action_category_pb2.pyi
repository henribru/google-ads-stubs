...
class ConversionActionCategoryEnum(google___protobuf___message___Message):
    class ConversionActionCategory(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['DEFAULT'],typing_extensions___Literal['PAGE_VIEW'],typing_extensions___Literal['PURCHASE'],typing_extensions___Literal['SIGNUP'],typing_extensions___Literal['LEAD'],typing_extensions___Literal['DOWNLOAD']]
        ...
        DEFAULT: typing_extensions___Literal[2]
        PAGE_VIEW: typing_extensions___Literal[3]
        PURCHASE: typing_extensions___Literal[4]
        SIGNUP: typing_extensions___Literal[5]
        LEAD: typing_extensions___Literal[6]
        DOWNLOAD: typing_extensions___Literal[7]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    DEFAULT: typing_extensions___Literal[2]
    PAGE_VIEW: typing_extensions___Literal[3]
