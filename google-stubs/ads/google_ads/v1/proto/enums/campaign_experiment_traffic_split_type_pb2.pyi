...
class CampaignExperimentTrafficSplitTypeEnum(google___protobuf___message___Message):
    class CampaignExperimentTrafficSplitType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['RANDOM_QUERY'],typing_extensions___Literal['COOKIE']]
        ...
        RANDOM_QUERY: typing_extensions___Literal[2]
        COOKIE: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    RANDOM_QUERY: typing_extensions___Literal[2]
    COOKIE: typing_extensions___Literal[3]
