...
class HotelRateTypeEnum(google___protobuf___message___Message):
    class HotelRateType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['UNAVAILABLE'],typing_extensions___Literal['PUBLIC_RATE'],typing_extensions___Literal['QUALIFIED_RATE'],typing_extensions___Literal['PRIVATE_RATE']]
        ...
        UNAVAILABLE: typing_extensions___Literal[2]
        PUBLIC_RATE: typing_extensions___Literal[3]
        QUALIFIED_RATE: typing_extensions___Literal[4]
        PRIVATE_RATE: typing_extensions___Literal[5]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    UNAVAILABLE: typing_extensions___Literal[2]
    PUBLIC_RATE: typing_extensions___Literal[3]
