...
class ManagerLinkStatusEnum(google___protobuf___message___Message):
    class ManagerLinkStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ACTIVE'],typing_extensions___Literal['INACTIVE'],typing_extensions___Literal['PENDING'],typing_extensions___Literal['REFUSED'],typing_extensions___Literal['CANCELED']]
        ...
        ACTIVE: typing_extensions___Literal[2]
        INACTIVE: typing_extensions___Literal[3]
        PENDING: typing_extensions___Literal[4]
        REFUSED: typing_extensions___Literal[5]
        CANCELED: typing_extensions___Literal[6]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ACTIVE: typing_extensions___Literal[2]
    INACTIVE: typing_extensions___Literal[3]
