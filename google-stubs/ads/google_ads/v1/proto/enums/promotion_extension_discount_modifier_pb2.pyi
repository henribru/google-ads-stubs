...
class PromotionExtensionDiscountModifierEnum(google___protobuf___message___Message):
    class PromotionExtensionDiscountModifier(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['UP_TO']]
        ...
        UP_TO: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    UP_TO: typing_extensions___Literal[2]
