...
class HotelPlaceholderFieldEnum(google___protobuf___message___Message):
    ...
    class HotelPlaceholderField(int):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
        @classmethod
        def Name(cls, number: int) -> str: ...
        @classmethod
        def Value(cls, name: str) -> HotelPlaceholderFieldEnum.HotelPlaceholderField: ...
        @classmethod
        def keys(cls) -> typing___List[str]: ...
        @classmethod
        def values(cls) -> typing___List[HotelPlaceholderFieldEnum.HotelPlaceholderField]: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[str, HotelPlaceholderFieldEnum.HotelPlaceholderField]]: ...
