...
class HotelPlaceholderFieldEnum(google___protobuf___message___Message):
    ...
    class HotelPlaceholderField(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'HotelPlaceholderFieldEnum.HotelPlaceholderField': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['HotelPlaceholderFieldEnum.HotelPlaceholderField']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'HotelPlaceholderFieldEnum.HotelPlaceholderField']]: ...
        ...
        DESTINATION_NAME = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 4)
        ...
        FORMATTED_PRICE = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 8)
        SALE_PRICE = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 9)
        FORMATTED_SALE_PRICE = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 10)
        ...
        CONTEXTUAL_KEYWORDS = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 14)
        FINAL_URLS = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 15)
        FINAL_MOBILE_URLS = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 16)
        TRACKING_URL = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 17)
        ANDROID_APP_LINK = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 18)
        SIMILAR_PROPERTY_IDS = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 19)
        IOS_APP_LINK = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 20)
        IOS_APP_STORE_ID = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 21)
    UNSPECIFIED = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 0)
    UNKNOWN = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 1)
    PROPERTY_ID = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 2)
    PROPERTY_NAME = typing___cast('HotelPlaceholderFieldEnum.HotelPlaceholderField', 3)
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> HotelPlaceholderFieldEnum: ...
