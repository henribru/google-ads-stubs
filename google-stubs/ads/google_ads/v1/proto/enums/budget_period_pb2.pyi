...
class BudgetPeriodEnum(google___protobuf___message___Message):
    class BudgetPeriod(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['DAILY'],typing_extensions___Literal['CUSTOM'],typing_extensions___Literal['FIXED_DAILY']]
        ...
        DAILY: typing_extensions___Literal[2]
        CUSTOM: typing_extensions___Literal[3]
        FIXED_DAILY: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    DAILY: typing_extensions___Literal[2]
    CUSTOM: typing_extensions___Literal[3]
