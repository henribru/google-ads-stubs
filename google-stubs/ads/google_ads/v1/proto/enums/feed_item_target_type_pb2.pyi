...
class FeedItemTargetTypeEnum(google___protobuf___message___Message):
    class FeedItemTargetType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CAMPAIGN'],typing_extensions___Literal['AD_GROUP'],typing_extensions___Literal['CRITERION']]
        ...
        CRITERION: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CAMPAIGN: typing_extensions___Literal[2]
    AD_GROUP: typing_extensions___Literal[3]
