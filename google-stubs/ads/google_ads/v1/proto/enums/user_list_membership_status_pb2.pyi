...
class UserListMembershipStatusEnum(google___protobuf___message___Message):
    class UserListMembershipStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['OPEN'],typing_extensions___Literal['CLOSED']]
        ...
        OPEN: typing_extensions___Literal[2]
        CLOSED: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    OPEN: typing_extensions___Literal[2]
    CLOSED: typing_extensions___Literal[3]
