...
class GoogleAdsFieldDataTypeEnum(google___protobuf___message___Message):
    ...
    class GoogleAdsFieldDataType(int):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
        @classmethod
        def Name(cls, number: int) -> str: ...
        @classmethod
        def Value(cls, name: str) -> GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType: ...
        @classmethod
        def keys(cls) -> typing___List[str]: ...
        @classmethod
        def values(cls) -> typing___List[GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType]: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[str, GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType]]: ...
