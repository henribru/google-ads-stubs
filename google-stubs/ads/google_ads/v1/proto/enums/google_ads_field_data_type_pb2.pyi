...
class GoogleAdsFieldDataTypeEnum(google___protobuf___message___Message):
    ...
    class GoogleAdsFieldDataType(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType']]: ...
        ...
        RESOURCE_NAME = typing___cast('GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType', 10)
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> GoogleAdsFieldDataTypeEnum: ...
