...
class CampaignExperimentTypeEnum(google___protobuf___message___Message):
    class CampaignExperimentType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['BASE'],typing_extensions___Literal['DRAFT'],typing_extensions___Literal['EXPERIMENT']]
        ...
        BASE: typing_extensions___Literal[2]
        DRAFT: typing_extensions___Literal[3]
        EXPERIMENT: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    BASE: typing_extensions___Literal[2]
    DRAFT: typing_extensions___Literal[3]
