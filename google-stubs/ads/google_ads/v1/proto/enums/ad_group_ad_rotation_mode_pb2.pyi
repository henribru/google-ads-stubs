...
class AdGroupAdRotationModeEnum(google___protobuf___message___Message):
    class AdGroupAdRotationMode(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['OPTIMIZE'],typing_extensions___Literal['ROTATE_FOREVER']]
        ...
        ROTATE_FOREVER: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    OPTIMIZE: typing_extensions___Literal[2]
    ROTATE_FOREVER: typing_extensions___Literal[3]
