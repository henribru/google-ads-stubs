...
class UserListRuleTypeEnum(google___protobuf___message___Message):
    class UserListRuleType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['AND_OF_ORS'],typing_extensions___Literal['OR_OF_ANDS']]
        ...
        AND_OF_ORS: typing_extensions___Literal[2]
        OR_OF_ANDS: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    AND_OF_ORS: typing_extensions___Literal[2]
    OR_OF_ANDS: typing_extensions___Literal[3]
