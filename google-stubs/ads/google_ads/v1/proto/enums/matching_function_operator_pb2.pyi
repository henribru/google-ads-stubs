...
class MatchingFunctionOperatorEnum(google___protobuf___message___Message):
    class MatchingFunctionOperator(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['IN'],typing_extensions___Literal['IDENTITY'],typing_extensions___Literal['EQUALS'],typing_extensions___Literal['AND'],typing_extensions___Literal['CONTAINS_ANY']]
        ...
        IN: typing_extensions___Literal[2]
        IDENTITY: typing_extensions___Literal[3]
        EQUALS: typing_extensions___Literal[4]
        AND: typing_extensions___Literal[5]
        CONTAINS_ANY: typing_extensions___Literal[6]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    IN: typing_extensions___Literal[2]
    IDENTITY: typing_extensions___Literal[3]
    ...
    @classmethod
    def FromString(cls, s: bytes) -> MatchingFunctionOperatorEnum: ...
