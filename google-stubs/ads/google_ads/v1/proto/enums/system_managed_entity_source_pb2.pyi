...
class SystemManagedResourceSourceEnum(google___protobuf___message___Message):
    class SystemManagedResourceSource(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['AD_VARIATIONS']]
        ...
        AD_VARIATIONS: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    AD_VARIATIONS: typing_extensions___Literal[2]
