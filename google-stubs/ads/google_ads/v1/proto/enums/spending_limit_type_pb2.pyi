...
class SpendingLimitTypeEnum(google___protobuf___message___Message):
    class SpendingLimitType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['INFINITE']]
        ...
        INFINITE: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    INFINITE: typing_extensions___Literal[2]
