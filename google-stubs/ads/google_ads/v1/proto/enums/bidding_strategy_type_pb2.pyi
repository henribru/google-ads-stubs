...
class BiddingStrategyTypeEnum(google___protobuf___message___Message):
    ...
    class BiddingStrategyType(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'BiddingStrategyTypeEnum.BiddingStrategyType': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['BiddingStrategyTypeEnum.BiddingStrategyType']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'BiddingStrategyTypeEnum.BiddingStrategyType']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> BiddingStrategyTypeEnum: ...
