...
class ConversionActionCountingTypeEnum(google___protobuf___message___Message):
    class ConversionActionCountingType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ONE_PER_CLICK'],typing_extensions___Literal['MANY_PER_CLICK']]
        ...
        ONE_PER_CLICK: typing_extensions___Literal[2]
        MANY_PER_CLICK: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ONE_PER_CLICK: typing_extensions___Literal[2]
    MANY_PER_CLICK: typing_extensions___Literal[3]
