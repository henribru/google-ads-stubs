...
class AdCustomizerPlaceholderFieldEnum(google___protobuf___message___Message):
    class AdCustomizerPlaceholderField(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['INTEGER'],typing_extensions___Literal['PRICE'],typing_extensions___Literal['DATE'],typing_extensions___Literal['STRING']]
        ...
        INTEGER: typing_extensions___Literal[2]
        PRICE: typing_extensions___Literal[3]
        DATE: typing_extensions___Literal[4]
        STRING: typing_extensions___Literal[5]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    INTEGER: typing_extensions___Literal[2]
    PRICE: typing_extensions___Literal[3]
