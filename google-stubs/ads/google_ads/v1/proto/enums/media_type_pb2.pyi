...
class MediaTypeEnum(google___protobuf___message___Message):
    class MediaType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['IMAGE'],typing_extensions___Literal['ICON'],typing_extensions___Literal['MEDIA_BUNDLE'],typing_extensions___Literal['AUDIO'],typing_extensions___Literal['VIDEO'],typing_extensions___Literal['DYNAMIC_IMAGE']]
        ...
        IMAGE: typing_extensions___Literal[2]
        ICON: typing_extensions___Literal[3]
        MEDIA_BUNDLE: typing_extensions___Literal[4]
        AUDIO: typing_extensions___Literal[5]
        VIDEO: typing_extensions___Literal[6]
        DYNAMIC_IMAGE: typing_extensions___Literal[7]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    IMAGE: typing_extensions___Literal[2]
    ICON: typing_extensions___Literal[3]
