...
class TrackingCodePageFormatEnum(google___protobuf___message___Message):
    class TrackingCodePageFormat(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['HTML'],typing_extensions___Literal['AMP']]
        ...
        HTML: typing_extensions___Literal[2]
        AMP: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    HTML: typing_extensions___Literal[2]
    AMP: typing_extensions___Literal[3]
