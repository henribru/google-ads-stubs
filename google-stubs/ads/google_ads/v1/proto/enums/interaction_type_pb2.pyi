...
class InteractionTypeEnum(google___protobuf___message___Message):
    class InteractionType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CALLS']]
        ClosedValueType = typing___Union[typing_extensions___Literal[0],typing_extensions___Literal[1],typing_extensions___Literal[8000]]
        ...
        CALLS: typing_extensions___Literal[8000]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CALLS: typing_extensions___Literal[8000]
