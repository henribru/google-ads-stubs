...
class ProductBiddingCategoryStatusEnum(google___protobuf___message___Message):
    class ProductBiddingCategoryStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ACTIVE'],typing_extensions___Literal['OBSOLETE']]
        ...
        OBSOLETE: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ACTIVE: typing_extensions___Literal[2]
    OBSOLETE: typing_extensions___Literal[3]
