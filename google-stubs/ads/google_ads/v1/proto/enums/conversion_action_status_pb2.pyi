...
class ConversionActionStatusEnum(google___protobuf___message___Message):
    class ConversionActionStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ENABLED'],typing_extensions___Literal['REMOVED'],typing_extensions___Literal['HIDDEN']]
        ...
        HIDDEN: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ENABLED: typing_extensions___Literal[2]
    REMOVED: typing_extensions___Literal[3]
    ...
    @classmethod
    def FromString(cls, s: bytes) -> ConversionActionStatusEnum: ...
