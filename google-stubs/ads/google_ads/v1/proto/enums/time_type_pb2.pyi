...
class TimeTypeEnum(google___protobuf___message___Message):
    class TimeType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['NOW'],typing_extensions___Literal['FOREVER']]
        ...
        NOW: typing_extensions___Literal[2]
        FOREVER: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    NOW: typing_extensions___Literal[2]
    FOREVER: typing_extensions___Literal[3]
