...
class CalloutPlaceholderFieldEnum(google___protobuf___message___Message):
    class CalloutPlaceholderField(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CALLOUT_TEXT']]
        ...
        CALLOUT_TEXT: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CALLOUT_TEXT: typing_extensions___Literal[2]
