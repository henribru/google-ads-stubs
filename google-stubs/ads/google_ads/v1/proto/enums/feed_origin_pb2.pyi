...
class FeedOriginEnum(google___protobuf___message___Message):
    class FeedOrigin(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['USER'],typing_extensions___Literal['GOOGLE']]
        ...
        USER: typing_extensions___Literal[2]
        GOOGLE: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    USER: typing_extensions___Literal[2]
    GOOGLE: typing_extensions___Literal[3]
