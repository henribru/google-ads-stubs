...
class BudgetDeliveryMethodEnum(google___protobuf___message___Message):
    class BudgetDeliveryMethod(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['STANDARD'],typing_extensions___Literal['ACCELERATED']]
        ...
        STANDARD: typing_extensions___Literal[2]
        ACCELERATED: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    STANDARD: typing_extensions___Literal[2]
    ACCELERATED: typing_extensions___Literal[3]
