...
class AccessReasonEnum(google___protobuf___message___Message):
    ...
    class AccessReason(builtin___int):
        ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'AccessReasonEnum.AccessReason']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> AccessReasonEnum: ...
