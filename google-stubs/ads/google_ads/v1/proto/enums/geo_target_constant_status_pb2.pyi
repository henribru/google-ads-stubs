...
class GeoTargetConstantStatusEnum(google___protobuf___message___Message):
    class GeoTargetConstantStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ENABLED'],typing_extensions___Literal['REMOVAL_PLANNED']]
        ...
        REMOVAL_PLANNED: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ENABLED: typing_extensions___Literal[2]
    REMOVAL_PLANNED: typing_extensions___Literal[3]
