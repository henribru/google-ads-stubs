...
class SimulationTypeEnum(google___protobuf___message___Message):
    class SimulationType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CPC_BID'],typing_extensions___Literal['CPV_BID'],typing_extensions___Literal['TARGET_CPA'],typing_extensions___Literal['BID_MODIFIER']]
        ...
        CPC_BID: typing_extensions___Literal[2]
        CPV_BID: typing_extensions___Literal[3]
        TARGET_CPA: typing_extensions___Literal[4]
        BID_MODIFIER: typing_extensions___Literal[5]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CPC_BID: typing_extensions___Literal[2]
    CPV_BID: typing_extensions___Literal[3]
