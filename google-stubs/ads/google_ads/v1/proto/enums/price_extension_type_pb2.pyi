...
class PriceExtensionTypeEnum(google___protobuf___message___Message):
    ...
    class PriceExtensionType(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'PriceExtensionTypeEnum.PriceExtensionType': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['PriceExtensionTypeEnum.PriceExtensionType']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'PriceExtensionTypeEnum.PriceExtensionType']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> PriceExtensionTypeEnum: ...
