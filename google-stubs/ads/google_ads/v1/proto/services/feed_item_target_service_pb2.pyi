...
class GetFeedItemTargetRequest(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> GetFeedItemTargetRequest: ...
...
class MutateFeedItemTargetsRequest(google___protobuf___message___Message):
    ...
    @property
    def operations(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[global___FeedItemTargetOperation]: ...

    def __init__(self,
        *,
        customer_id : typing___Optional[typing___Text] = None,
        operations : typing___Optional[typing___Iterable[global___FeedItemTargetOperation]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> MutateFeedItemTargetsRequest: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
...
class FeedItemTargetOperation(google___protobuf___message___Message):
    ...
    @property
    def create(self) -> google___ads___googleads___v1___resources___feed_item_target_pb2___FeedItemTarget: ...

    def __init__(self,
        *,
        create : typing___Optional[google___ads___googleads___v1___resources___feed_item_target_pb2___FeedItemTarget] = None,
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> FeedItemTargetOperation: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
...
class MutateFeedItemTargetsResponse(google___protobuf___message___Message):
    ...
    @property
    def results(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[global___MutateFeedItemTargetResult]: ...

    def __init__(self,
        *,
        results : typing___Optional[typing___Iterable[global___MutateFeedItemTargetResult]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> MutateFeedItemTargetsResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
...
class MutateFeedItemTargetResult(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> MutateFeedItemTargetResult: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def ClearField(self, field_name: typing_extensions___Literal[u"resource_name",b"resource_name"]) -> None: ...
