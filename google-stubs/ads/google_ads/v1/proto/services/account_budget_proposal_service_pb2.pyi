...
class AccountBudgetProposalOperation(google___protobuf___message___Message):
    ...
    @property
    def create(self) -> google___ads___googleads___v1___resources___account_budget_proposal_pb2___AccountBudgetProposal: ...

    def __init__(self,
        *,
        update_mask : typing___Optional[google___protobuf___field_mask_pb2___FieldMask] = None,
        create : typing___Optional[google___ads___googleads___v1___resources___account_budget_proposal_pb2___AccountBudgetProposal] = None,
