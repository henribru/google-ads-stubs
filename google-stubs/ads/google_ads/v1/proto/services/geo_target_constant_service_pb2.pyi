...
class GetGeoTargetConstantRequest(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> GetGeoTargetConstantRequest: ...
...
class SuggestGeoTargetConstantsRequest(google___protobuf___message___Message):
    ...
    class LocationNames(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> SuggestGeoTargetConstantsRequest.LocationNames: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SuggestGeoTargetConstantsRequest.LocationNames: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    ...
    class GeoTargets(google___protobuf___message___Message):
        ...
        if sys.version_info >= (3,):
            @classmethod
            def FromString(cls, s: builtin___bytes) -> SuggestGeoTargetConstantsRequest.GeoTargets: ...
        else:
            @classmethod
            def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SuggestGeoTargetConstantsRequest.GeoTargets: ...
        def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
        def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    ...
    def __init__(self,
        *,
        ...
        location_names : typing___Optional[global___SuggestGeoTargetConstantsRequest.LocationNames] = None,
        geo_targets : typing___Optional[global___SuggestGeoTargetConstantsRequest.GeoTargets] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SuggestGeoTargetConstantsRequest: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"country_code",b"country_code",u"geo_targets",b"geo_targets",u"locale",b"locale",u"location_names",b"location_names",u"query",b"query"]) -> builtin___bool: ...
...
class SuggestGeoTargetConstantsResponse(google___protobuf___message___Message):
    ...
    @property
    def geo_target_constant_suggestions(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[global___GeoTargetConstantSuggestion]: ...

    def __init__(self,
        *,
        geo_target_constant_suggestions : typing___Optional[typing___Iterable[global___GeoTargetConstantSuggestion]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> SuggestGeoTargetConstantsResponse: ...
    else:
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> SuggestGeoTargetConstantsResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
...
class GeoTargetConstantSuggestion(google___protobuf___message___Message):
    ...
    @property
    def geo_target_constant_parents(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[google___ads___googleads___v1___resources___geo_target_constant_pb2___GeoTargetConstant]: ...
    ...
    def __init__(self,
        *,
        ...
        geo_target_constant_parents : typing___Optional[typing___Iterable[google___ads___googleads___v1___resources___geo_target_constant_pb2___GeoTargetConstant]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> GeoTargetConstantSuggestion: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def HasField(self, field_name: typing_extensions___Literal[u"geo_target_constant",b"geo_target_constant",u"locale",b"locale",u"reach",b"reach",u"search_term",b"search_term"]) -> builtin___bool: ...
