...
class SharedCriterionOperation(google___protobuf___message___Message):
    ...
    @property
    def create(self) -> google___ads___googleads___v1___resources___shared_criterion_pb2___SharedCriterion: ...

    def __init__(self,
        *,
        create : typing___Optional[google___ads___googleads___v1___resources___shared_criterion_pb2___SharedCriterion] = None,
