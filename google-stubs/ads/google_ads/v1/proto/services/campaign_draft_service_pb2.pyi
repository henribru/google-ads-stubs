...
class CampaignDraftOperation(google___protobuf___message___Message):
    ...
    @property
    def create(self) -> google___ads___googleads___v1___resources___campaign_draft_pb2___CampaignDraft: ...

    @property
    def update(self) -> google___ads___googleads___v1___resources___campaign_draft_pb2___CampaignDraft: ...

    def __init__(self,
        *,
        update_mask : typing___Optional[google___protobuf___field_mask_pb2___FieldMask] = None,
        create : typing___Optional[google___ads___googleads___v1___resources___campaign_draft_pb2___CampaignDraft] = None,
        update : typing___Optional[google___ads___googleads___v1___resources___campaign_draft_pb2___CampaignDraft] = None,
