...
class CustomerExtensionSettingOperation(google___protobuf___message___Message):
    ...
    @property
    def create(self) -> google___ads___googleads___v1___resources___customer_extension_setting_pb2___CustomerExtensionSetting: ...

    @property
    def update(self) -> google___ads___googleads___v1___resources___customer_extension_setting_pb2___CustomerExtensionSetting: ...

    def __init__(self,
        *,
        update_mask : typing___Optional[google___protobuf___field_mask_pb2___FieldMask] = None,
        create : typing___Optional[google___ads___googleads___v1___resources___customer_extension_setting_pb2___CustomerExtensionSetting] = None,
        update : typing___Optional[google___ads___googleads___v1___resources___customer_extension_setting_pb2___CustomerExtensionSetting] = None,
