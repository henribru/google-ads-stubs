...
from google.ads.google_ads.v5.proto.resources.invoice_pb2 import (
    Invoice as google___ads___googleads___v5___resources___invoice_pb2___Invoice,
)
...
class ListInvoicesRequest(google___protobuf___message___Message):
    ...
    issue_month: google___ads___googleads___v5___enums___month_of_year_pb2___MonthOfYearEnum.MonthOfYearValue = ...
    def __init__(
        self,
        *,
...
class ListInvoicesResponse(google___protobuf___message___Message):
    ...
    def invoices(
        ...
        google___ads___googleads___v5___resources___invoice_pb2___Invoice
    ]: ...
    def __init__(
        self,
        *,
