...
"""
import builtins
import google.ads.google_ads.v5.proto.common.text_label_pb2
import google.ads.google_ads.v5.proto.enums.label_status_pb2
...
class Label(google.protobuf.message.Message):
    ...
    status: google.ads.google_ads.v5.proto.enums.label_status_pb2.LabelStatusEnum.LabelStatus.V = (
        ...
    )
    @property
    ...
    def text_label(
        self,
    ) -> google.ads.google_ads.v5.proto.common.text_label_pb2.TextLabel: ...
    def __init__(
        self,
        *,
        resource_name: typing.Text = ...,
