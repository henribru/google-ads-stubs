...
type___GetKeywordPlanKeywordRequest = GetKeywordPlanKeywordRequest
...
class MutateKeywordPlanKeywordsRequest(google___protobuf___message___Message):
    ...
    def operations(
        ...
        type___KeywordPlanKeywordOperation
    ]: ...
    def __init__(
        self,
        *,
        ...
        operations: typing___Optional[
            typing___Iterable[type___KeywordPlanKeywordOperation]
        ] = None,
...
type___MutateKeywordPlanKeywordsRequest = MutateKeywordPlanKeywordsRequest
...
type___KeywordPlanKeywordOperation = KeywordPlanKeywordOperation
...
class MutateKeywordPlanKeywordsResponse(google___protobuf___message___Message):
    ...
    def results(
        ...
        type___MutateKeywordPlanKeywordResult
    ]: ...
    def __init__(
        self,
        *,
        ...
        results: typing___Optional[
            typing___Iterable[type___MutateKeywordPlanKeywordResult]
        ] = None,
    ) -> None: ...
    def HasField(
        self,
...
type___MutateKeywordPlanKeywordsResponse = MutateKeywordPlanKeywordsResponse
...
type___MutateKeywordPlanKeywordResult = MutateKeywordPlanKeywordResult
