...
class MutateKeywordPlanKeywordsRequest(google___protobuf___message___Message):
    ...
    def operations(
        ...
        global___KeywordPlanKeywordOperation
    ]: ...
    def __init__(
        self,
        *,
        ...
        operations: typing___Optional[
            typing___Iterable[global___KeywordPlanKeywordOperation]
        ] = None,
...
class MutateKeywordPlanKeywordsResponse(google___protobuf___message___Message):
    ...
    def results(
        ...
        global___MutateKeywordPlanKeywordResult
    ]: ...
    def __init__(
        self,
        *,
        ...
        results: typing___Optional[
            typing___Iterable[global___MutateKeywordPlanKeywordResult]
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
