...
class CreateCustomerClientRequest(google___protobuf___message___Message):
    ...
    access_role = (
        ...
    )  # type: google___ads___googleads___v3___enums___access_role_pb2___AccessRoleEnum.AccessRole
    @property
    def customer_client(
        self,
    ...
    def __init__(
        ...
        *,
        ...
        access_role: typing___Optional[
            google___ads___googleads___v3___enums___access_role_pb2___AccessRoleEnum.AccessRole
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
