    ...
    def __init__(
        ...
        *,
        ...
        operations: typing___Optional[
            typing___Iterable[global___KeywordPlanNegativeKeywordOperation]
        ] = None,
...
global___MutateKeywordPlanNegativeKeywordsRequest = (
    MutateKeywordPlanNegativeKeywordsRequest
)
    ...
    def __init__(
        ...
        *,
        ...
        results: typing___Optional[
            typing___Iterable[global___MutateKeywordPlanNegativeKeywordResult]
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
...
global___MutateKeywordPlanNegativeKeywordsResponse = (
    MutateKeywordPlanNegativeKeywordsResponse
)
