...
class FeedMapping(google___protobuf___message___Message):
    ...
    status = (
        ...
    )  # type: google___ads___googleads___v3___enums___feed_mapping_status_pb2___FeedMappingStatusEnum.FeedMappingStatus
    placeholder_type = (
        ...
    )  # type: google___ads___googleads___v3___enums___placeholder_type_pb2___PlaceholderTypeEnum.PlaceholderType
    criterion_type = (
        ...
    )  # type: google___ads___googleads___v3___enums___feed_mapping_criterion_type_pb2___FeedMappingCriterionTypeEnum.FeedMappingCriterionType
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v3___enums___feed_mapping_status_pb2___FeedMappingStatusEnum.FeedMappingStatus
        ] = None,
        ...
        criterion_type: typing___Optional[
            google___ads___googleads___v3___enums___feed_mapping_criterion_type_pb2___FeedMappingCriterionTypeEnum.FeedMappingCriterionType
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
...
class AttributeFieldMapping(google___protobuf___message___Message):
    ...
    sitelink_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___sitelink_placeholder_field_pb2___SitelinkPlaceholderFieldEnum.SitelinkPlaceholderField
    call_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___call_placeholder_field_pb2___CallPlaceholderFieldEnum.CallPlaceholderField
    app_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___app_placeholder_field_pb2___AppPlaceholderFieldEnum.AppPlaceholderField
    location_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___location_placeholder_field_pb2___LocationPlaceholderFieldEnum.LocationPlaceholderField
    affiliate_location_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___affiliate_location_placeholder_field_pb2___AffiliateLocationPlaceholderFieldEnum.AffiliateLocationPlaceholderField
    callout_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___callout_placeholder_field_pb2___CalloutPlaceholderFieldEnum.CalloutPlaceholderField
    structured_snippet_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___structured_snippet_placeholder_field_pb2___StructuredSnippetPlaceholderFieldEnum.StructuredSnippetPlaceholderField
    message_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___message_placeholder_field_pb2___MessagePlaceholderFieldEnum.MessagePlaceholderField
    price_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___price_placeholder_field_pb2___PricePlaceholderFieldEnum.PricePlaceholderField
    promotion_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___promotion_placeholder_field_pb2___PromotionPlaceholderFieldEnum.PromotionPlaceholderField
    ad_customizer_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___ad_customizer_placeholder_field_pb2___AdCustomizerPlaceholderFieldEnum.AdCustomizerPlaceholderField
    dsa_page_feed_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___dsa_page_feed_criterion_field_pb2___DsaPageFeedCriterionFieldEnum.DsaPageFeedCriterionField
    location_extension_targeting_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___location_extension_targeting_criterion_field_pb2___LocationExtensionTargetingCriterionFieldEnum.LocationExtensionTargetingCriterionField
    education_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___education_placeholder_field_pb2___EducationPlaceholderFieldEnum.EducationPlaceholderField
    flight_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___flight_placeholder_field_pb2___FlightPlaceholderFieldEnum.FlightPlaceholderField
    custom_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___custom_placeholder_field_pb2___CustomPlaceholderFieldEnum.CustomPlaceholderField
    hotel_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___hotel_placeholder_field_pb2___HotelPlaceholderFieldEnum.HotelPlaceholderField
    real_estate_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___real_estate_placeholder_field_pb2___RealEstatePlaceholderFieldEnum.RealEstatePlaceholderField
    travel_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___travel_placeholder_field_pb2___TravelPlaceholderFieldEnum.TravelPlaceholderField
    local_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___local_placeholder_field_pb2___LocalPlaceholderFieldEnum.LocalPlaceholderField
    job_field = (
        ...
    )  # type: google___ads___googleads___v3___enums___job_placeholder_field_pb2___JobPlaceholderFieldEnum.JobPlaceholderField
    @property
    ...
    def __init__(
        ...
        *,
        ...
        sitelink_field: typing___Optional[
            google___ads___googleads___v3___enums___sitelink_placeholder_field_pb2___SitelinkPlaceholderFieldEnum.SitelinkPlaceholderField
        ] = None,
        call_field: typing___Optional[
            google___ads___googleads___v3___enums___call_placeholder_field_pb2___CallPlaceholderFieldEnum.CallPlaceholderField
        ] = None,
        app_field: typing___Optional[
            google___ads___googleads___v3___enums___app_placeholder_field_pb2___AppPlaceholderFieldEnum.AppPlaceholderField
        ] = None,
        location_field: typing___Optional[
            google___ads___googleads___v3___enums___location_placeholder_field_pb2___LocationPlaceholderFieldEnum.LocationPlaceholderField
        ] = None,
        affiliate_location_field: typing___Optional[
            google___ads___googleads___v3___enums___affiliate_location_placeholder_field_pb2___AffiliateLocationPlaceholderFieldEnum.AffiliateLocationPlaceholderField
        ] = None,
        callout_field: typing___Optional[
            google___ads___googleads___v3___enums___callout_placeholder_field_pb2___CalloutPlaceholderFieldEnum.CalloutPlaceholderField
        ] = None,
        structured_snippet_field: typing___Optional[
            google___ads___googleads___v3___enums___structured_snippet_placeholder_field_pb2___StructuredSnippetPlaceholderFieldEnum.StructuredSnippetPlaceholderField
        ] = None,
        message_field: typing___Optional[
            google___ads___googleads___v3___enums___message_placeholder_field_pb2___MessagePlaceholderFieldEnum.MessagePlaceholderField
        ] = None,
        price_field: typing___Optional[
            google___ads___googleads___v3___enums___price_placeholder_field_pb2___PricePlaceholderFieldEnum.PricePlaceholderField
        ] = None,
        promotion_field: typing___Optional[
            google___ads___googleads___v3___enums___promotion_placeholder_field_pb2___PromotionPlaceholderFieldEnum.PromotionPlaceholderField
        ] = None,
        ad_customizer_field: typing___Optional[
            google___ads___googleads___v3___enums___ad_customizer_placeholder_field_pb2___AdCustomizerPlaceholderFieldEnum.AdCustomizerPlaceholderField
        ] = None,
        dsa_page_feed_field: typing___Optional[
            google___ads___googleads___v3___enums___dsa_page_feed_criterion_field_pb2___DsaPageFeedCriterionFieldEnum.DsaPageFeedCriterionField
        ] = None,
        location_extension_targeting_field: typing___Optional[
            google___ads___googleads___v3___enums___location_extension_targeting_criterion_field_pb2___LocationExtensionTargetingCriterionFieldEnum.LocationExtensionTargetingCriterionField
        ] = None,
        education_field: typing___Optional[
            google___ads___googleads___v3___enums___education_placeholder_field_pb2___EducationPlaceholderFieldEnum.EducationPlaceholderField
        ] = None,
        flight_field: typing___Optional[
            google___ads___googleads___v3___enums___flight_placeholder_field_pb2___FlightPlaceholderFieldEnum.FlightPlaceholderField
        ] = None,
        custom_field: typing___Optional[
            google___ads___googleads___v3___enums___custom_placeholder_field_pb2___CustomPlaceholderFieldEnum.CustomPlaceholderField
        ] = None,
        hotel_field: typing___Optional[
            google___ads___googleads___v3___enums___hotel_placeholder_field_pb2___HotelPlaceholderFieldEnum.HotelPlaceholderField
        ] = None,
        real_estate_field: typing___Optional[
            google___ads___googleads___v3___enums___real_estate_placeholder_field_pb2___RealEstatePlaceholderFieldEnum.RealEstatePlaceholderField
        ] = None,
        travel_field: typing___Optional[
            google___ads___googleads___v3___enums___travel_placeholder_field_pb2___TravelPlaceholderFieldEnum.TravelPlaceholderField
        ] = None,
        local_field: typing___Optional[
            google___ads___googleads___v3___enums___local_placeholder_field_pb2___LocalPlaceholderFieldEnum.LocalPlaceholderField
        ] = None,
        job_field: typing___Optional[
            google___ads___googleads___v3___enums___job_placeholder_field_pb2___JobPlaceholderFieldEnum.JobPlaceholderField
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
