...
class AccountBudgetProposal(google___protobuf___message___Message):
    ...
    proposal_type = (
        ...
    )  # type: google___ads___googleads___v3___enums___account_budget_proposal_type_pb2___AccountBudgetProposalTypeEnum.AccountBudgetProposalType
    status = (
        ...
    )  # type: google___ads___googleads___v3___enums___account_budget_proposal_status_pb2___AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus
    proposed_start_time_type = (
        ...
    )  # type: google___ads___googleads___v3___enums___time_type_pb2___TimeTypeEnum.TimeType
    ...
    proposed_spending_limit_type = (
        ...
    )  # type: google___ads___googleads___v3___enums___spending_limit_type_pb2___SpendingLimitTypeEnum.SpendingLimitType
    ...
    def __init__(
        ...
        *,
        ...
        proposal_type: typing___Optional[
            google___ads___googleads___v3___enums___account_budget_proposal_type_pb2___AccountBudgetProposalTypeEnum.AccountBudgetProposalType
        ] = None,
        status: typing___Optional[
            google___ads___googleads___v3___enums___account_budget_proposal_status_pb2___AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus
        ] = None,
        ...
        proposed_start_time_type: typing___Optional[
            google___ads___googleads___v3___enums___time_type_pb2___TimeTypeEnum.TimeType
        ] = None,
        ...
        proposed_spending_limit_type: typing___Optional[
            google___ads___googleads___v3___enums___spending_limit_type_pb2___SpendingLimitTypeEnum.SpendingLimitType
        ] = None,
