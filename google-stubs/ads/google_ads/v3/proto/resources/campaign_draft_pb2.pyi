...
class CampaignDraft(google___protobuf___message___Message):
    ...
    status = (
        ...
    )  # type: google___ads___googleads___v3___enums___campaign_draft_status_pb2___CampaignDraftStatusEnum.CampaignDraftStatus
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v3___enums___campaign_draft_status_pb2___CampaignDraftStatusEnum.CampaignDraftStatus
        ] = None,
