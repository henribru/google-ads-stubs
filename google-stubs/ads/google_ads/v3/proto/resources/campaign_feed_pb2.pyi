...
class CampaignFeed(google___protobuf___message___Message):
    ...
    status: google___ads___googleads___v3___enums___feed_link_status_pb2___FeedLinkStatusEnum.FeedLinkStatusValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v3___enums___feed_link_status_pb2___FeedLinkStatusEnum.FeedLinkStatusValue
        ] = None,
    ) -> None: ...
    def HasField(
        self,
