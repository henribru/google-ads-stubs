...
class GeoTargetConstant(google___protobuf___message___Message):
    ...
    status = (
        ...
    )  # type: google___ads___googleads___v3___enums___geo_target_constant_status_pb2___GeoTargetConstantStatusEnum.GeoTargetConstantStatus
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v3___enums___geo_target_constant_status_pb2___GeoTargetConstantStatusEnum.GeoTargetConstantStatus
        ] = None,
