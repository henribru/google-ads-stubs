...
class CustomInterest(google___protobuf___message___Message):
    ...
    status = (
        ...
    )  # type: google___ads___googleads___v3___enums___custom_interest_status_pb2___CustomInterestStatusEnum.CustomInterestStatus
    type = (
        ...
    )  # type: google___ads___googleads___v3___enums___custom_interest_type_pb2___CustomInterestTypeEnum.CustomInterestType
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v3___enums___custom_interest_status_pb2___CustomInterestStatusEnum.CustomInterestStatus
        ] = None,
        name: typing___Optional[google___protobuf___wrappers_pb2___StringValue] = None,
        type: typing___Optional[
            google___ads___googleads___v3___enums___custom_interest_type_pb2___CustomInterestTypeEnum.CustomInterestType
        ] = None,
...
class CustomInterestMember(google___protobuf___message___Message):
    ...
    member_type = (
        ...
    )  # type: google___ads___googleads___v3___enums___custom_interest_member_type_pb2___CustomInterestMemberTypeEnum.CustomInterestMemberType
    @property
    ...
    def __init__(
        ...
        *,
        member_type: typing___Optional[
            google___ads___googleads___v3___enums___custom_interest_member_type_pb2___CustomInterestMemberTypeEnum.CustomInterestMemberType
        ] = None,
