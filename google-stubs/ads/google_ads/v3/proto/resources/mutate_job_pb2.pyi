...
class MutateJob(google___protobuf___message___Message):
    ...
    status = (
        ...
    )  # type: google___ads___googleads___v3___enums___mutate_job_status_pb2___MutateJobStatusEnum.MutateJobStatus
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v3___enums___mutate_job_status_pb2___MutateJobStatusEnum.MutateJobStatus
        ] = None,
