...
class BillingSetup(google___protobuf___message___Message):
    ...
    status = (
        ...
    )  # type: google___ads___googleads___v3___enums___billing_setup_status_pb2___BillingSetupStatusEnum.BillingSetupStatus
    start_time_type = (
        ...
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v3___enums___billing_setup_status_pb2___BillingSetupStatusEnum.BillingSetupStatus
        ] = None,
