...
class CampaignServingStatusEnum(google___protobuf___message___Message):
    ...
    class CampaignServingStatus(builtin___int):
        ...
        def values(
            cls,
        ) -> typing___List["CampaignServingStatusEnum.CampaignServingStatus"]: ...
        @classmethod
        def items(
            cls,
        ) -> typing___List[
            typing___Tuple[
                builtin___str, "CampaignServingStatusEnum.CampaignServingStatus"
            ]
        ]: ...
        UNSPECIFIED = typing___cast(
            "CampaignServingStatusEnum.CampaignServingStatus", 0
        )
