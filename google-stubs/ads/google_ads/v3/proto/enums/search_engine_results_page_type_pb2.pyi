...
class SearchEngineResultsPageTypeEnum(google___protobuf___message___Message):
    ...
    class SearchEngineResultsPageType(builtin___int):
        ...
        UNSPECIFIED = typing___cast(
            "SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType", 0
        )
        UNKNOWN = typing___cast(
            "SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType", 1
        )
        ADS_ONLY = typing___cast(
            "SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType", 2
        )
        ORGANIC_ONLY = typing___cast(
            "SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType", 3
        )
        ADS_AND_ORGANIC = typing___cast(
            "SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType", 4
        )
    UNSPECIFIED = typing___cast(
        "SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType", 0
    )
