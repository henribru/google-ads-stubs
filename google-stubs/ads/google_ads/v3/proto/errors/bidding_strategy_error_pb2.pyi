...
class BiddingStrategyErrorEnum(google___protobuf___message___Message):
    ...
    class BiddingStrategyError(builtin___int):
        ...
        ) -> "BiddingStrategyErrorEnum.BiddingStrategyError": ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(
            cls,
        ) -> typing___List["BiddingStrategyErrorEnum.BiddingStrategyError"]: ...
        @classmethod
        def items(
            cls,
        ) -> typing___List[
            typing___Tuple[
                builtin___str, "BiddingStrategyErrorEnum.BiddingStrategyError"
            ]
        ]: ...
        ...
        DUPLICATE_NAME = typing___cast(
            "BiddingStrategyErrorEnum.BiddingStrategyError", 2
        )
        CANNOT_CHANGE_BIDDING_STRATEGY_TYPE = typing___cast(
            "BiddingStrategyErrorEnum.BiddingStrategyError", 3
        )
        CANNOT_REMOVE_ASSOCIATED_STRATEGY = typing___cast(
            "BiddingStrategyErrorEnum.BiddingStrategyError", 4
        )
        BIDDING_STRATEGY_NOT_SUPPORTED = typing___cast(
            "BiddingStrategyErrorEnum.BiddingStrategyError", 5
        )
        INCOMPATIBLE_BIDDING_STRATEGY_AND_BIDDING_STRATEGY_GOAL_TYPE = typing___cast(
            "BiddingStrategyErrorEnum.BiddingStrategyError", 6
        )
    UNSPECIFIED = typing___cast("BiddingStrategyErrorEnum.BiddingStrategyError", 0)
    UNKNOWN = typing___cast("BiddingStrategyErrorEnum.BiddingStrategyError", 1)
    ...
    global___BiddingStrategyError = BiddingStrategyError
    def __init__(self,) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
        def FromString(cls, s: builtin___bytes) -> BiddingStrategyErrorEnum: ...
    else:
        @classmethod
        def FromString(
