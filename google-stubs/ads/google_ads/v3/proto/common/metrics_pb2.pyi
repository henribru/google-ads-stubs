...
class Metrics(google___protobuf___message___Message):
    ...
    interaction_event_types = (
        ...
    )  # type: google___protobuf___internal___containers___RepeatedScalarFieldContainer[google___ads___googleads___v3___enums___interaction_event_type_pb2___InteractionEventTypeEnum.InteractionEventType]
    @property
    ...
    def __init__(
        ...
        *,
        ...
        interaction_event_types: typing___Optional[
            typing___Iterable[
                google___ads___googleads___v3___enums___interaction_event_type_pb2___InteractionEventTypeEnum.InteractionEventType
            ]
        ] = None,
