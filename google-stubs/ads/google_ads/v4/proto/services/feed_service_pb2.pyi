...
class FeedOperation(google___protobuf___message___Message):
    ...
    @property
    def create(self) -> google___ads___googleads___v4___resources___feed_pb2___Feed: ...
    @property
    def update(self) -> google___ads___googleads___v4___resources___feed_pb2___Feed: ...
    def __init__(
        self,
        *,
