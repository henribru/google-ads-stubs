...
class MutateKeywordPlanAdGroupKeywordsRequest(google.protobuf.message.Message):
    ...
    def operations(
        ...
        global___KeywordPlanAdGroupKeywordOperation
    ]: ...
    def __init__(
        self,
        *,
        ...
        operations: typing.Optional[
            typing.Iterable[global___KeywordPlanAdGroupKeywordOperation]
        ] = ...,
        partial_failure: builtins.bool = ...,
        validate_only: builtins.bool = ...,
    ) -> None: ...
...
global___MutateKeywordPlanAdGroupKeywordsRequest = (
...
class MutateKeywordPlanAdGroupKeywordsResponse(google.protobuf.message.Message):
    ...
    def results(
        ...
        global___MutateKeywordPlanAdGroupKeywordResult
    ]: ...
    def __init__(
        self,
        *,
        ...
        results: typing.Optional[
            typing.Iterable[global___MutateKeywordPlanAdGroupKeywordResult]
        ] = ...,
    ) -> None: ...
    def HasField(
        self,
