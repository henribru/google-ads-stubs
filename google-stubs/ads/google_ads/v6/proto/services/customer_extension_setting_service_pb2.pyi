...
type___GetCustomerExtensionSettingRequest = GetCustomerExtensionSettingRequest
...
class MutateCustomerExtensionSettingsRequest(google___protobuf___message___Message):
    ...
    def operations(
        ...
        type___CustomerExtensionSettingOperation
    ]: ...
    def __init__(
        self,
        *,
        ...
        operations: typing___Optional[
            typing___Iterable[type___CustomerExtensionSettingOperation]
        ] = None,
...
type___MutateCustomerExtensionSettingsRequest = MutateCustomerExtensionSettingsRequest
...
type___CustomerExtensionSettingOperation = CustomerExtensionSettingOperation
...
class MutateCustomerExtensionSettingsResponse(google___protobuf___message___Message):
    ...
    def results(
        ...
        type___MutateCustomerExtensionSettingResult
    ]: ...
    def __init__(
        self,
        *,
        ...
        results: typing___Optional[
            typing___Iterable[type___MutateCustomerExtensionSettingResult]
        ] = None,
    ) -> None: ...
    def HasField(
        self,
...
type___MutateCustomerExtensionSettingsResponse = MutateCustomerExtensionSettingsResponse
...
type___MutateCustomerExtensionSettingResult = MutateCustomerExtensionSettingResult
