...
type___GetSharedSetRequest = GetSharedSetRequest
    ...
    def __init__(
        ...
        *,
        ...
        operations: typing___Optional[
            typing___Iterable[type___SharedSetOperation]
        ] = None,
...
type___MutateSharedSetsRequest = MutateSharedSetsRequest
...
type___SharedSetOperation = SharedSetOperation
    ...
    def __init__(
        ...
        *,
        ...
        results: typing___Optional[
            typing___Iterable[type___MutateSharedSetResult]
        ] = None,
    ) -> None: ...
    def HasField(
        self,
...
type___MutateSharedSetsResponse = MutateSharedSetsResponse
...
class MutateSharedSetResult(google___protobuf___message___Message):
    ...
    def HasField(
        self, field_name: typing_extensions___Literal["shared_set", b"shared_set"]
    ) -> builtin___bool: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
            "resource_name", b"resource_name", "shared_set", b"shared_set"
        ],
    ) -> None: ...

type___MutateSharedSetResult = MutateSharedSetResult
