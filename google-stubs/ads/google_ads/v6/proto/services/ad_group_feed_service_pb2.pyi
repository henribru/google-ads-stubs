...
type___GetAdGroupFeedRequest = GetAdGroupFeedRequest
    ...
    def __init__(
        ...
        *,
        ...
        operations: typing___Optional[
            typing___Iterable[type___AdGroupFeedOperation]
        ] = None,
...
type___MutateAdGroupFeedsRequest = MutateAdGroupFeedsRequest
...
type___AdGroupFeedOperation = AdGroupFeedOperation
...
class MutateAdGroupFeedsResponse(google___protobuf___message___Message):
    ...
    def results(
        ...
        type___MutateAdGroupFeedResult
    ]: ...
    def __init__(
        self,
        *,
        ...
        results: typing___Optional[
            typing___Iterable[type___MutateAdGroupFeedResult]
        ] = None,
    ) -> None: ...
    def HasField(
        self,
...
type___MutateAdGroupFeedsResponse = MutateAdGroupFeedsResponse
...
class MutateAdGroupFeedResult(google___protobuf___message___Message):
    ...
    def HasField(
        self, field_name: typing_extensions___Literal["ad_group_feed", b"ad_group_feed"]
    ) -> builtin___bool: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
            "ad_group_feed", b"ad_group_feed", "resource_name", b"resource_name"
        ],
    ) -> None: ...

type___MutateAdGroupFeedResult = MutateAdGroupFeedResult
