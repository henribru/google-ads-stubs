...
type___GetCampaignBudgetRequest = GetCampaignBudgetRequest
...
class MutateCampaignBudgetsRequest(google___protobuf___message___Message):
    ...
    def operations(
        ...
        type___CampaignBudgetOperation
    ]: ...
    def __init__(
        self,
        *,
        ...
        operations: typing___Optional[
            typing___Iterable[type___CampaignBudgetOperation]
        ] = None,
...
type___MutateCampaignBudgetsRequest = MutateCampaignBudgetsRequest
...
type___CampaignBudgetOperation = CampaignBudgetOperation
...
class MutateCampaignBudgetsResponse(google___protobuf___message___Message):
    ...
    def results(
        ...
        type___MutateCampaignBudgetResult
    ]: ...
    def __init__(
        self,
        *,
        ...
        results: typing___Optional[
            typing___Iterable[type___MutateCampaignBudgetResult]
        ] = None,
    ) -> None: ...
    def HasField(
        self,
...
type___MutateCampaignBudgetsResponse = MutateCampaignBudgetsResponse
...
class MutateCampaignBudgetResult(google___protobuf___message___Message):
    ...
    def HasField(
        self,
        field_name: typing_extensions___Literal["campaign_budget", b"campaign_budget"],
    ) -> builtin___bool: ...
    def ClearField(
        self,
        field_name: typing_extensions___Literal[
            "campaign_budget", b"campaign_budget", "resource_name", b"resource_name"
        ],
    ) -> None: ...

type___MutateCampaignBudgetResult = MutateCampaignBudgetResult
