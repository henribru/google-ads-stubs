...
class FeedItemValidationErrorEnum(google.protobuf.message.Message):
    ...
    class _FeedItemValidationError(
        ...
        INVALID_ASSET_ID = FeedItemValidationErrorEnum.FeedItemValidationError.V(100)
        INCOMPATIBLE_ASSET_TYPE = FeedItemValidationErrorEnum.FeedItemValidationError.V(
            101
        )
        IMAGE_ERROR_UNEXPECTED_SIZE = (
            FeedItemValidationErrorEnum.FeedItemValidationError.V(102)
        )
        IMAGE_ERROR_ASPECT_RATIO_NOT_ALLOWED = (
            FeedItemValidationErrorEnum.FeedItemValidationError.V(103)
        )
        IMAGE_ERROR_FILE_TOO_LARGE = (
            FeedItemValidationErrorEnum.FeedItemValidationError.V(104)
        )
        IMAGE_ERROR_FORMAT_NOT_ALLOWED = (
            FeedItemValidationErrorEnum.FeedItemValidationError.V(105)
        )
        IMAGE_ERROR_CONSTRAINTS_VIOLATED = (
            FeedItemValidationErrorEnum.FeedItemValidationError.V(106)
        )
        IMAGE_ERROR_SERVER_ERROR = (
            FeedItemValidationErrorEnum.FeedItemValidationError.V(107)
        )
    ...
    INVALID_ASSET_ID = FeedItemValidationErrorEnum.FeedItemValidationError.V(100)
    INCOMPATIBLE_ASSET_TYPE = FeedItemValidationErrorEnum.FeedItemValidationError.V(101)
    IMAGE_ERROR_UNEXPECTED_SIZE = FeedItemValidationErrorEnum.FeedItemValidationError.V(
        102
    )
    IMAGE_ERROR_ASPECT_RATIO_NOT_ALLOWED = (
        FeedItemValidationErrorEnum.FeedItemValidationError.V(103)
    )
    IMAGE_ERROR_FILE_TOO_LARGE = FeedItemValidationErrorEnum.FeedItemValidationError.V(
        104
    )
    IMAGE_ERROR_FORMAT_NOT_ALLOWED = (
        FeedItemValidationErrorEnum.FeedItemValidationError.V(105)
    ...
    IMAGE_ERROR_SERVER_ERROR = FeedItemValidationErrorEnum.FeedItemValidationError.V(
        107
    )
    def __init__(
        self,
