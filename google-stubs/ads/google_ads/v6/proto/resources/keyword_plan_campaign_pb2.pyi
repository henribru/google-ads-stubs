...
class KeywordPlanCampaign(google.protobuf.message.Message):
    ...
    id: builtins.int = ...
    name: typing.Text = ...
    language_constants: google.protobuf.internal.containers.RepeatedScalarFieldContainer[
        typing.Text
    ] = ...
    ...
    @typing.overload
    def WhichOneof(
        self, oneof_group: typing_extensions.Literal["_keyword_plan", b"_keyword_plan"]
    ) -> typing_extensions.Literal["keyword_plan"]: ...
    @typing.overload
    def WhichOneof(
