...
from google.ads.google_ads.v6.proto.common.simulation_pb2 import (
    CpcBidSimulationPointList as google___ads___googleads___v6___common___simulation_pb2___CpcBidSimulationPointList,
    CpvBidSimulationPointList as google___ads___googleads___v6___common___simulation_pb2___CpvBidSimulationPointList,
    TargetCpaSimulationPointList as google___ads___googleads___v6___common___simulation_pb2___TargetCpaSimulationPointList,
    TargetRoasSimulationPointList as google___ads___googleads___v6___common___simulation_pb2___TargetRoasSimulationPointList,
)
...
class AdGroupSimulation(google___protobuf___message___Message):
    ...
    def cpc_bid_point_list(
        self,
    ) -> google___ads___googleads___v6___common___simulation_pb2___CpcBidSimulationPointList: ...
    @property
    def cpv_bid_point_list(
        self,
    ) -> google___ads___googleads___v6___common___simulation_pb2___CpvBidSimulationPointList: ...
    @property
    def target_cpa_point_list(
        self,
    ) -> google___ads___googleads___v6___common___simulation_pb2___TargetCpaSimulationPointList: ...
    @property
    def target_roas_point_list(
        self,
    ) -> google___ads___googleads___v6___common___simulation_pb2___TargetRoasSimulationPointList: ...
    def __init__(
        self,
        *,
