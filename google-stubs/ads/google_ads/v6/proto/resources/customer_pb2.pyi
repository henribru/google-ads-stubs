...
from google.ads.google_ads.v6.proto.enums.customer_pay_per_conversion_eligibility_failure_reason_pb2 import (
    CustomerPayPerConversionEligibilityFailureReasonEnum as google___ads___googleads___v6___enums___customer_pay_per_conversion_eligibility_failure_reason_pb2___CustomerPayPerConversionEligibilityFailureReasonEnum,
)
...
class Customer(google___protobuf___message___Message):
    ...
    pay_per_conversion_eligibility_failure_reasons: google___protobuf___internal___containers___RepeatedScalarFieldContainer[
        google___ads___googleads___v6___enums___customer_pay_per_conversion_eligibility_failure_reason_pb2___CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReasonValue
    ] = ...
    optimization_score: builtin___float = ...
    optimization_score_weight: builtin___float = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        optimization_score_weight: typing___Optional[builtin___float] = None,
    ) -> None: ...
    def HasField(
        self,
