...
"""
import builtins
import google.ads.google_ads.v6.proto.enums.customer_match_upload_key_type_pb2
import google.ads.google_ads.v6.proto.enums.user_list_combined_rule_operator_pb2
import google.ads.google_ads.v6.proto.enums.user_list_crm_data_source_type_pb2
import google.ads.google_ads.v6.proto.enums.user_list_date_rule_item_operator_pb2
import google.ads.google_ads.v6.proto.enums.user_list_logical_rule_operator_pb2
import google.ads.google_ads.v6.proto.enums.user_list_number_rule_item_operator_pb2
import google.ads.google_ads.v6.proto.enums.user_list_prepopulation_status_pb2
import google.ads.google_ads.v6.proto.enums.user_list_rule_type_pb2
import google.ads.google_ads.v6.proto.enums.user_list_string_rule_item_operator_pb2
...
class SimilarUserListInfo(google.protobuf.message.Message):
    ...
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal["_seed_user_list", b"_seed_user_list"],
    ) -> typing_extensions.Literal["seed_user_list"]: ...
...
class CrmBasedUserListInfo(google.protobuf.message.Message):
    ...
    app_id: typing.Text = ...
    upload_key_type: google.ads.google_ads.v6.proto.enums.customer_match_upload_key_type_pb2.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType.V = (
        ...
    )
    data_source_type: google.ads.google_ads.v6.proto.enums.user_list_crm_data_source_type_pb2.UserListCrmDataSourceTypeEnum.UserListCrmDataSourceType.V = (
        ...
    )
    def __init__(
        self,
...
class UserListRuleInfo(google.protobuf.message.Message):
    ...
    rule_type: google.ads.google_ads.v6.proto.enums.user_list_rule_type_pb2.UserListRuleTypeEnum.UserListRuleType.V = (
        ...
    )
    @property
...
class UserListDateRuleItemInfo(google.protobuf.message.Message):
    ...
    operator: google.ads.google_ads.v6.proto.enums.user_list_date_rule_item_operator_pb2.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator.V = (
        ...
    )
    value: typing.Text = ...
    ...
    def WhichOneof(
        self,
        oneof_group: typing_extensions.Literal["_offset_in_days", b"_offset_in_days"],
    ) -> typing_extensions.Literal["offset_in_days"]: ...
    @typing.overload
    def WhichOneof(
...
class UserListNumberRuleItemInfo(google.protobuf.message.Message):
    ...
    OPERATOR_FIELD_NUMBER: builtins.int
    VALUE_FIELD_NUMBER: builtins.int
    operator: google.ads.google_ads.v6.proto.enums.user_list_number_rule_item_operator_pb2.UserListNumberRuleItemOperatorEnum.UserListNumberRuleItemOperator.V = (
        ...
    )
...
class UserListStringRuleItemInfo(google.protobuf.message.Message):
    ...
    OPERATOR_FIELD_NUMBER: builtins.int
    VALUE_FIELD_NUMBER: builtins.int
    operator: google.ads.google_ads.v6.proto.enums.user_list_string_rule_item_operator_pb2.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator.V = (
        ...
    )
    value: typing.Text = ...
    def __init__(
...
class CombinedRuleUserListInfo(google.protobuf.message.Message):
    ...
    rule_operator: google.ads.google_ads.v6.proto.enums.user_list_combined_rule_operator_pb2.UserListCombinedRuleOperatorEnum.UserListCombinedRuleOperator.V = (
        ...
    )
    @property
...
class RuleBasedUserListInfo(google.protobuf.message.Message):
    ...
    prepopulation_status: google.ads.google_ads.v6.proto.enums.user_list_prepopulation_status_pb2.UserListPrepopulationStatusEnum.UserListPrepopulationStatus.V = (
        ...
    )
    @property
...
class UserListLogicalRuleInfo(google.protobuf.message.Message):
    ...
    operator: google.ads.google_ads.v6.proto.enums.user_list_logical_rule_operator_pb2.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator.V = (
        ...
    )
    @property
    def rule_operands(
