...
from google.ads.google_ads.v6.types import CampaignBudget, ResponseContentTypeEnum
...
class CampaignBudgetServiceClient:
    ...
    @classmethod
    def campaign_budget_path(cls, customer_id: Any, campaign_budget_id: Any) -> str: ...
    transport: Union[
