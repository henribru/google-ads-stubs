...
from google.ads.google_ads.v6.types import AdGroupLabel
...
class AdGroupLabelServiceClient:
    ...
    def ad_group_label_path(
        cls, customer_id: Any, ad_group_id: Any, label_id: Any
    ) -> str: ...
    transport: Union[
    ...
    def mutate_ad_group_labels(
        ...
        customer_id: str,
        operations: List[
            Union[Dict[str, Any], ad_group_label_service_pb2.AdGroupLabelOperation]
        ],
        ...
        timeout: Optional[float] = ...,
        metadata: Optional[Sequence[Tuple[str, str]]] = ...,
    ) -> ad_group_label_service_pb2.MutateAdGroupLabelsResponse: ...
