...
class MediaFileOperation(google___protobuf___message___Message):
    ...
    @property
    def create(self) -> google___ads___googleads___v2___resources___media_file_pb2___MediaFile: ...

    def __init__(self,
        *,
        create : typing___Optional[google___ads___googleads___v2___resources___media_file_pb2___MediaFile] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
