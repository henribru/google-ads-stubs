...
class MutateRemarketingActionsRequest(google___protobuf___message___Message):
    ...
    def operations(
        ...
        global___RemarketingActionOperation
    ]: ...
    def __init__(
        self,
        *,
        ...
        operations: typing___Optional[
            typing___Iterable[global___RemarketingActionOperation]
        ] = None,
...
class MutateRemarketingActionsResponse(google___protobuf___message___Message):
    ...
    def results(
        ...
        global___MutateRemarketingActionResult
    ]: ...
    def __init__(
        self,
        *,
        ...
        results: typing___Optional[
            typing___Iterable[global___MutateRemarketingActionResult]
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
