...
class CustomerFeedOperation(google___protobuf___message___Message):
    ...
    @property
    def create(self) -> google___ads___googleads___v2___resources___customer_feed_pb2___CustomerFeed: ...

    @property
    def update(self) -> google___ads___googleads___v2___resources___customer_feed_pb2___CustomerFeed: ...

    def __init__(self,
        *,
        update_mask : typing___Optional[google___protobuf___field_mask_pb2___FieldMask] = None,
        create : typing___Optional[google___ads___googleads___v2___resources___customer_feed_pb2___CustomerFeed] = None,
        update : typing___Optional[google___ads___googleads___v2___resources___customer_feed_pb2___CustomerFeed] = None,
