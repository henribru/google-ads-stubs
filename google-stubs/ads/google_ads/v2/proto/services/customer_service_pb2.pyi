...
class CreateCustomerClientRequest(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    customer_id: typing___Text = ...
    access_role: google___ads___googleads___v2___enums___access_role_pb2___AccessRoleEnum.AccessRoleValue = ...
    @property
    def customer_client(
        self,
    ...
    def __init__(
        ...
        *,
        ...
        access_role: typing___Optional[
            google___ads___googleads___v2___enums___access_role_pb2___AccessRoleEnum.AccessRoleValue
        ] = None,
    ) -> None: ...
    def HasField(
        self,
