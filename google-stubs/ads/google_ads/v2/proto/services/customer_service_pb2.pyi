...
import sys
from google.ads.google_ads.v2.proto.enums.access_role_pb2 import (
    AccessRoleEnum as google___ads___googleads___v2___enums___access_role_pb2___AccessRoleEnum,
)
...
class CreateCustomerClientRequest(google___protobuf___message___Message):
    ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def HasField(self, field_name: typing_extensions___Literal[u"customer_client",u"email_address"]) -> bool: ...
        def ClearField(self, field_name: typing_extensions___Literal[u"access_role",u"customer_client",u"customer_id",u"email_address"]) -> None: ...
    else:
        def HasField(self, field_name: typing_extensions___Literal[u"customer_client",b"customer_client",u"email_address",b"email_address"]) -> bool: ...
...
class CustomerOperation(google___protobuf___message___Message):
    ...
    def __init__(self,
        *,
        update : typing___Optional[google___ads___googleads___v2___resources___customer_pb2___Customer] = None,
