...
class CampaignBudgetOperation(google___protobuf___message___Message):
    ...
    @property
    def create(self) -> google___ads___googleads___v2___resources___campaign_budget_pb2___CampaignBudget: ...

    @property
    def update(self) -> google___ads___googleads___v2___resources___campaign_budget_pb2___CampaignBudget: ...

    def __init__(self,
        *,
        update_mask : typing___Optional[google___protobuf___field_mask_pb2___FieldMask] = None,
        create : typing___Optional[google___ads___googleads___v2___resources___campaign_budget_pb2___CampaignBudget] = None,
        update : typing___Optional[google___ads___googleads___v2___resources___campaign_budget_pb2___CampaignBudget] = None,
