...
class AdGroupFeedOperation(google___protobuf___message___Message):
    ...
    @property
    def create(self) -> google___ads___googleads___v2___resources___ad_group_feed_pb2___AdGroupFeed: ...

    @property
    def update(self) -> google___ads___googleads___v2___resources___ad_group_feed_pb2___AdGroupFeed: ...

    def __init__(self,
        *,
        update_mask : typing___Optional[google___protobuf___field_mask_pb2___FieldMask] = None,
        create : typing___Optional[google___ads___googleads___v2___resources___ad_group_feed_pb2___AdGroupFeed] = None,
        update : typing___Optional[google___ads___googleads___v2___resources___ad_group_feed_pb2___AdGroupFeed] = None,
