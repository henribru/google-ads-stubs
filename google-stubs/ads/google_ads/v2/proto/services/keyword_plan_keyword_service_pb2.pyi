...
class GetKeywordPlanKeywordRequest(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> GetKeywordPlanKeywordRequest: ...
...
class MutateKeywordPlanKeywordsRequest(google___protobuf___message___Message):
    ...
    @property
    def operations(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[KeywordPlanKeywordOperation]: ...

    def __init__(self,
        *,
        customer_id : typing___Optional[typing___Text] = None,
        operations : typing___Optional[typing___Iterable[KeywordPlanKeywordOperation]] = None,
        partial_failure : typing___Optional[bool] = None,
        validate_only : typing___Optional[bool] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> MutateKeywordPlanKeywordsRequest: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
...
class KeywordPlanKeywordOperation(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> KeywordPlanKeywordOperation: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
...
class MutateKeywordPlanKeywordsResponse(google___protobuf___message___Message):
    ...
    @property
    def results(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[MutateKeywordPlanKeywordResult]: ...

    def __init__(self,
        *,
        partial_failure_error : typing___Optional[google___rpc___status_pb2___Status] = None,
        results : typing___Optional[typing___Iterable[MutateKeywordPlanKeywordResult]] = None,
        ) -> None: ...
    @classmethod
    def FromString(cls, s: bytes) -> MutateKeywordPlanKeywordsResponse: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
...
class MutateKeywordPlanKeywordResult(google___protobuf___message___Message):
    ...
    @classmethod
    def FromString(cls, s: bytes) -> MutateKeywordPlanKeywordResult: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    if sys.version_info >= (3,):
        def ClearField(self, field_name: typing_extensions___Literal[u"resource_name"]) -> None: ...
