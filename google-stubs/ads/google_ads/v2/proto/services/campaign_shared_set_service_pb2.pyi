...
class MutateCampaignSharedSetsRequest(google___protobuf___message___Message):
    ...
    def operations(
        ...
        global___CampaignSharedSetOperation
    ]: ...
    def __init__(
        self,
        *,
        ...
        operations: typing___Optional[
            typing___Iterable[global___CampaignSharedSetOperation]
        ] = None,
...
class MutateCampaignSharedSetsResponse(google___protobuf___message___Message):
    ...
    def results(
        ...
        global___MutateCampaignSharedSetResult
    ]: ...
    def __init__(
        self,
        *,
        ...
        results: typing___Optional[
            typing___Iterable[global___MutateCampaignSharedSetResult]
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
