...
class ConversionAction(google___protobuf___message___Message):
    ...
    class AttributionModelSettings(google___protobuf___message___Message):
        DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
        attribution_model: google___ads___googleads___v2___enums___attribution_model_pb2___AttributionModelEnum.AttributionModelValue = ...
        data_driven_model_status: google___ads___googleads___v2___enums___data_driven_model_status_pb2___DataDrivenModelStatusEnum.DataDrivenModelStatusValue = ...
        def __init__(
            self,
            *,
            attribution_model: typing___Optional[
                google___ads___googleads___v2___enums___attribution_model_pb2___AttributionModelEnum.AttributionModelValue
            ] = None,
            data_driven_model_status: typing___Optional[
                google___ads___googleads___v2___enums___data_driven_model_status_pb2___DataDrivenModelStatusEnum.DataDrivenModelStatusValue
            ] = None,
        ) -> None: ...
        def ClearField(
            self,
    ...
    status: google___ads___googleads___v2___enums___conversion_action_status_pb2___ConversionActionStatusEnum.ConversionActionStatusValue = ...
    type: google___ads___googleads___v2___enums___conversion_action_type_pb2___ConversionActionTypeEnum.ConversionActionTypeValue = ...
    category: google___ads___googleads___v2___enums___conversion_action_category_pb2___ConversionActionCategoryEnum.ConversionActionCategoryValue = ...
    counting_type: google___ads___googleads___v2___enums___conversion_action_counting_type_pb2___ConversionActionCountingTypeEnum.ConversionActionCountingTypeValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v2___enums___conversion_action_status_pb2___ConversionActionStatusEnum.ConversionActionStatusValue
        ] = None,
        type: typing___Optional[
            google___ads___googleads___v2___enums___conversion_action_type_pb2___ConversionActionTypeEnum.ConversionActionTypeValue
        ] = None,
        ...
        counting_type: typing___Optional[
            google___ads___googleads___v2___enums___conversion_action_counting_type_pb2___ConversionActionCountingTypeEnum.ConversionActionCountingTypeValue
        ] = None,
