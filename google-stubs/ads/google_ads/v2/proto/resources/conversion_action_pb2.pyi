...
class ConversionAction(google___protobuf___message___Message):
    ...
    class AttributionModelSettings(google___protobuf___message___Message):
        ...
        attribution_model = (
            ...
        )  # type: google___ads___googleads___v2___enums___attribution_model_pb2___AttributionModelEnum.AttributionModel
        data_driven_model_status = (
            ...
        )  # type: google___ads___googleads___v2___enums___data_driven_model_status_pb2___DataDrivenModelStatusEnum.DataDrivenModelStatus
        def __init__(
            self,
            *,
            attribution_model: typing___Optional[
                google___ads___googleads___v2___enums___attribution_model_pb2___AttributionModelEnum.AttributionModel
            ] = None,
            data_driven_model_status: typing___Optional[
                google___ads___googleads___v2___enums___data_driven_model_status_pb2___DataDrivenModelStatusEnum.DataDrivenModelStatus
            ] = None,
        ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
    ...
    status = (
        ...
    )  # type: google___ads___googleads___v2___enums___conversion_action_status_pb2___ConversionActionStatusEnum.ConversionActionStatus
    type = (
        ...
    )  # type: google___ads___googleads___v2___enums___conversion_action_type_pb2___ConversionActionTypeEnum.ConversionActionType
    category = (
        ...
    ...
    counting_type = (
        ...
    )  # type: google___ads___googleads___v2___enums___conversion_action_counting_type_pb2___ConversionActionCountingTypeEnum.ConversionActionCountingType
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v2___enums___conversion_action_status_pb2___ConversionActionStatusEnum.ConversionActionStatus
        ] = None,
        type: typing___Optional[
            google___ads___googleads___v2___enums___conversion_action_type_pb2___ConversionActionTypeEnum.ConversionActionType
        ] = None,
        ...
        counting_type: typing___Optional[
            google___ads___googleads___v2___enums___conversion_action_counting_type_pb2___ConversionActionCountingTypeEnum.ConversionActionCountingType
        ] = None,
