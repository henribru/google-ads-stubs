...
class ConversionAction(google___protobuf___message___Message):
    class AttributionModelSettings(google___protobuf___message___Message):
        attribution_model = ... # type: google___ads___googleads___v2___enums___attribution_model_pb2___AttributionModelEnum.AttributionModel.ClosedValueType
        data_driven_model_status = ... # type: google___ads___googleads___v2___enums___data_driven_model_status_pb2___DataDrivenModelStatusEnum.DataDrivenModelStatus.ClosedValueType

        def __init__(self,
            *,
            attribution_model : typing___Optional[google___ads___googleads___v2___enums___attribution_model_pb2___AttributionModelEnum.AttributionModel.ClosedValueType] = None,
            data_driven_model_status : typing___Optional[google___ads___googleads___v2___enums___data_driven_model_status_pb2___DataDrivenModelStatusEnum.DataDrivenModelStatus.ClosedValueType] = None,
            ) -> None: ...
        @classmethod
    ...
    status = ... # type: google___ads___googleads___v2___enums___conversion_action_status_pb2___ConversionActionStatusEnum.ConversionActionStatus.ClosedValueType
    type = ... # type: google___ads___googleads___v2___enums___conversion_action_type_pb2___ConversionActionTypeEnum.ConversionActionType.ClosedValueType
    category = ... # type: google___ads___googleads___v2___enums___conversion_action_category_pb2___ConversionActionCategoryEnum.ConversionActionCategory.ClosedValueType
    counting_type = ... # type: google___ads___googleads___v2___enums___conversion_action_counting_type_pb2___ConversionActionCountingTypeEnum.ConversionActionCountingType.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[google___ads___googleads___v2___enums___conversion_action_status_pb2___ConversionActionStatusEnum.ConversionActionStatus.ClosedValueType] = None,
        type : typing___Optional[google___ads___googleads___v2___enums___conversion_action_type_pb2___ConversionActionTypeEnum.ConversionActionType.ClosedValueType] = None,
        category : typing___Optional[google___ads___googleads___v2___enums___conversion_action_category_pb2___ConversionActionCategoryEnum.ConversionActionCategory.ClosedValueType] = None,
        ...
        counting_type : typing___Optional[google___ads___googleads___v2___enums___conversion_action_counting_type_pb2___ConversionActionCountingTypeEnum.ConversionActionCountingType.ClosedValueType] = None,
