...
class OperatingSystemVersionConstant(google___protobuf___message___Message):
    ...
    operator_type = (
        ...
    )  # type: google___ads___googleads___v2___enums___operating_system_version_operator_type_pb2___OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType
    @property
    ...
    def __init__(
        ...
        *,
        ...
        operator_type: typing___Optional[
            google___ads___googleads___v2___enums___operating_system_version_operator_type_pb2___OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
