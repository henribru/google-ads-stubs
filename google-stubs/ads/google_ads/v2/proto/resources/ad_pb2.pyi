...
class Ad(google___protobuf___message___Message):
    ...
    @property
    def final_app_urls(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[google___ads___googleads___v2___common___final_app_url_pb2___FinalAppUrl]: ...
    ...
    @property
    def url_collections(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[google___ads___googleads___v2___common___url_collection_pb2___UrlCollection]: ...

    @property
    def name(self) -> google___protobuf___wrappers_pb2___StringValue: ...

    @property
    def text_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___TextAdInfo: ...

    @property
    def expanded_text_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___ExpandedTextAdInfo: ...

    @property
    def call_only_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___CallOnlyAdInfo: ...

    @property
    def expanded_dynamic_search_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___ExpandedDynamicSearchAdInfo: ...

    @property
    def hotel_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___HotelAdInfo: ...

    @property
    def shopping_smart_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___ShoppingSmartAdInfo: ...

    @property
    def shopping_product_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___ShoppingProductAdInfo: ...

    @property
    def gmail_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___GmailAdInfo: ...

    @property
    def image_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___ImageAdInfo: ...

    @property
    def video_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___VideoAdInfo: ...

    @property
    def responsive_search_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___ResponsiveSearchAdInfo: ...

    @property
    def legacy_responsive_display_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___LegacyResponsiveDisplayAdInfo: ...

    @property
    def app_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___AppAdInfo: ...

    @property
    def legacy_app_install_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___LegacyAppInstallAdInfo: ...

    @property
    def responsive_display_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___ResponsiveDisplayAdInfo: ...

    @property
    def display_upload_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___DisplayUploadAdInfo: ...

    @property
    def app_engagement_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___AppEngagementAdInfo: ...

    @property
    def shopping_comparison_listing_ad(self) -> google___ads___googleads___v2___common___ad_type_infos_pb2___ShoppingComparisonListingAdInfo: ...
    ...
    def __init__(self,
        *,
        ...
        expanded_dynamic_search_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___ExpandedDynamicSearchAdInfo] = None,
        hotel_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___HotelAdInfo] = None,
        shopping_smart_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___ShoppingSmartAdInfo] = None,
        shopping_product_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___ShoppingProductAdInfo] = None,
        gmail_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___GmailAdInfo] = None,
        image_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___ImageAdInfo] = None,
        video_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___VideoAdInfo] = None,
        responsive_search_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___ResponsiveSearchAdInfo] = None,
        legacy_responsive_display_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___LegacyResponsiveDisplayAdInfo] = None,
        app_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___AppAdInfo] = None,
        legacy_app_install_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___LegacyAppInstallAdInfo] = None,
        responsive_display_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___ResponsiveDisplayAdInfo] = None,
        display_upload_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___DisplayUploadAdInfo] = None,
        app_engagement_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___AppEngagementAdInfo] = None,
        shopping_comparison_listing_ad : typing___Optional[google___ads___googleads___v2___common___ad_type_infos_pb2___ShoppingComparisonListingAdInfo] = None,
        ) -> None: ...
    @classmethod
