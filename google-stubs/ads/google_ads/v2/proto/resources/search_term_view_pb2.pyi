...
class SearchTermView(google___protobuf___message___Message):
    ...
    status = ... # type: google___ads___googleads___v2___enums___search_term_targeting_status_pb2___SearchTermTargetingStatusEnum.SearchTermTargetingStatus.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[google___ads___googleads___v2___enums___search_term_targeting_status_pb2___SearchTermTargetingStatusEnum.SearchTermTargetingStatus.ClosedValueType] = None,
        ) -> None: ...
    @classmethod
