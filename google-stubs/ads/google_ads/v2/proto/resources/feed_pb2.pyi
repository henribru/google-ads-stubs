...
class Feed(google___protobuf___message___Message):
    ...
    class AffiliateLocationFeedData(google___protobuf___message___Message):
        ...
        relationship_type = (
            ...
        )  # type: google___ads___googleads___v2___enums___affiliate_location_feed_relationship_type_pb2___AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType
        @property
        def chain_ids(
            self,
        ) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[
        ...
        def __init__(
            ...
            *,
            ...
            relationship_type: typing___Optional[
                google___ads___googleads___v2___enums___affiliate_location_feed_relationship_type_pb2___AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType
            ] = None,
        ) -> None: ...
        if sys.version_info >= (3,):
            @classmethod
    ...
    origin = (
        ...
    )  # type: google___ads___googleads___v2___enums___feed_origin_pb2___FeedOriginEnum.FeedOrigin
    status = (
        ...
    )  # type: google___ads___googleads___v2___enums___feed_status_pb2___FeedStatusEnum.FeedStatus
    @property
    ...
    def __init__(
        ...
        *,
        ...
        origin: typing___Optional[
            google___ads___googleads___v2___enums___feed_origin_pb2___FeedOriginEnum.FeedOrigin
        ] = None,
        status: typing___Optional[
            google___ads___googleads___v2___enums___feed_status_pb2___FeedStatusEnum.FeedStatus
        ] = None,
...
class FeedAttribute(google___protobuf___message___Message):
    ...
    type = (
        ...
    )  # type: google___ads___googleads___v2___enums___feed_attribute_type_pb2___FeedAttributeTypeEnum.FeedAttributeType
    @property
    def id(self) -> google___protobuf___wrappers_pb2___Int64Value: ...
    @property
    def name(self) -> google___protobuf___wrappers_pb2___StringValue: ...
    ...
    def __init__(
        ...
        *,
        ...
        type: typing___Optional[
            google___ads___googleads___v2___enums___feed_attribute_type_pb2___FeedAttributeTypeEnum.FeedAttributeType
        ] = None,
