...
class AdGroupAd(google___protobuf___message___Message):
    ...
    status = (
        ...
    )  # type: google___ads___googleads___v2___enums___ad_group_ad_status_pb2___AdGroupAdStatusEnum.AdGroupAdStatus
    ad_strength = (
        ...
    )  # type: google___ads___googleads___v2___enums___ad_strength_pb2___AdStrengthEnum.AdStrength
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v2___enums___ad_group_ad_status_pb2___AdGroupAdStatusEnum.AdGroupAdStatus
        ] = None,
        ...
        ad_strength: typing___Optional[
            google___ads___googleads___v2___enums___ad_strength_pb2___AdStrengthEnum.AdStrength
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
