...
class KeywordPlanForecastPeriod(google___protobuf___message___Message):
    ...
    date_interval = (
        ...
    )  # type: google___ads___googleads___v2___enums___keyword_plan_forecast_interval_pb2___KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval
    @property
    def date_range(
        self,
    ...
    def __init__(
        ...
        *,
        date_interval: typing___Optional[
            google___ads___googleads___v2___enums___keyword_plan_forecast_interval_pb2___KeywordPlanForecastIntervalEnum.KeywordPlanForecastInterval
        ] = None,
