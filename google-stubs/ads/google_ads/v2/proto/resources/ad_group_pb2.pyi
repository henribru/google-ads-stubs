...
class AdGroup(google___protobuf___message___Message):
    ...
    status = ... # type: google___ads___googleads___v2___enums___ad_group_status_pb2___AdGroupStatusEnum.AdGroupStatus.ClosedValueType
    type = ... # type: google___ads___googleads___v2___enums___ad_group_type_pb2___AdGroupTypeEnum.AdGroupType.ClosedValueType
    ad_rotation_mode = ... # type: google___ads___googleads___v2___enums___ad_group_ad_rotation_mode_pb2___AdGroupAdRotationModeEnum.AdGroupAdRotationMode.ClosedValueType
    display_custom_bid_dimension = ... # type: google___ads___googleads___v2___enums___targeting_dimension_pb2___TargetingDimensionEnum.TargetingDimension.ClosedValueType
    effective_target_cpa_source = ... # type: google___ads___googleads___v2___enums___bidding_source_pb2___BiddingSourceEnum.BiddingSource.ClosedValueType
    effective_target_roas_source = ... # type: google___ads___googleads___v2___enums___bidding_source_pb2___BiddingSourceEnum.BiddingSource.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[google___ads___googleads___v2___enums___ad_group_status_pb2___AdGroupStatusEnum.AdGroupStatus.ClosedValueType] = None,
        type : typing___Optional[google___ads___googleads___v2___enums___ad_group_type_pb2___AdGroupTypeEnum.AdGroupType.ClosedValueType] = None,
        ad_rotation_mode : typing___Optional[google___ads___googleads___v2___enums___ad_group_ad_rotation_mode_pb2___AdGroupAdRotationModeEnum.AdGroupAdRotationMode.ClosedValueType] = None,
        ...
        display_custom_bid_dimension : typing___Optional[google___ads___googleads___v2___enums___targeting_dimension_pb2___TargetingDimensionEnum.TargetingDimension.ClosedValueType] = None,
        ...
        effective_target_cpa_source : typing___Optional[google___ads___googleads___v2___enums___bidding_source_pb2___BiddingSourceEnum.BiddingSource.ClosedValueType] = None,
        effective_target_roas : typing___Optional[google___protobuf___wrappers_pb2___DoubleValue] = None,
        effective_target_roas_source : typing___Optional[google___ads___googleads___v2___enums___bidding_source_pb2___BiddingSourceEnum.BiddingSource.ClosedValueType] = None,
