...
class AdGroup(google___protobuf___message___Message):
    ...
    status = (
        ...
    )  # type: google___ads___googleads___v2___enums___ad_group_status_pb2___AdGroupStatusEnum.AdGroupStatus
    type = (
        ...
    )  # type: google___ads___googleads___v2___enums___ad_group_type_pb2___AdGroupTypeEnum.AdGroupType
    ad_rotation_mode = (
        ...
    )  # type: google___ads___googleads___v2___enums___ad_group_ad_rotation_mode_pb2___AdGroupAdRotationModeEnum.AdGroupAdRotationMode
    display_custom_bid_dimension = (
        ...
    )  # type: google___ads___googleads___v2___enums___targeting_dimension_pb2___TargetingDimensionEnum.TargetingDimension
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v2___enums___ad_group_status_pb2___AdGroupStatusEnum.AdGroupStatus
        ] = None,
        type: typing___Optional[
            google___ads___googleads___v2___enums___ad_group_type_pb2___AdGroupTypeEnum.AdGroupType
        ] = None,
        ad_rotation_mode: typing___Optional[
            google___ads___googleads___v2___enums___ad_group_ad_rotation_mode_pb2___AdGroupAdRotationModeEnum.AdGroupAdRotationMode
        ] = None,
        ...
        display_custom_bid_dimension: typing___Optional[
            google___ads___googleads___v2___enums___targeting_dimension_pb2___TargetingDimensionEnum.TargetingDimension
        ] = None,
