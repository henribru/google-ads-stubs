...
class ProductBiddingCategoryConstant(google___protobuf___message___Message):
    ...
    status = ... # type: google___ads___googleads___v2___enums___product_bidding_category_status_pb2___ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatus.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[google___ads___googleads___v2___enums___product_bidding_category_status_pb2___ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatus.ClosedValueType] = None,
