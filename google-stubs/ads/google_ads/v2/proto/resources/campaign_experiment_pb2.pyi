...
class CampaignExperiment(google___protobuf___message___Message):
    ...
    traffic_split_type = (
        ...
    )  # type: google___ads___googleads___v2___enums___campaign_experiment_traffic_split_type_pb2___CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType
    status = (
        ...
    )  # type: google___ads___googleads___v2___enums___campaign_experiment_status_pb2___CampaignExperimentStatusEnum.CampaignExperimentStatus
    @property
    ...
    def __init__(
        ...
        *,
        ...
        traffic_split_type: typing___Optional[
            google___ads___googleads___v2___enums___campaign_experiment_traffic_split_type_pb2___CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType
        ] = None,
        experiment_campaign: typing___Optional[
            google___protobuf___wrappers_pb2___StringValue
        ] = None,
        status: typing___Optional[
            google___ads___googleads___v2___enums___campaign_experiment_status_pb2___CampaignExperimentStatusEnum.CampaignExperimentStatus
        ] = None,
