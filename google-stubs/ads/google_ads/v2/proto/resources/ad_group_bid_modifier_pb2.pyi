...
class AdGroupBidModifier(google___protobuf___message___Message):
    ...
    bid_modifier_source: google___ads___googleads___v2___enums___bid_modifier_source_pb2___BidModifierSourceEnum.BidModifierSourceValue = ...
    @property
    ...
    def hotel_date_selection_type(
        self,
    ) -> google___ads___googleads___v2___common___criteria_pb2___HotelDateSelectionTypeInfo: ...
    @property
    def hotel_advance_booking_window(
        self,
    ) -> google___ads___googleads___v2___common___criteria_pb2___HotelAdvanceBookingWindowInfo: ...
    @property
    def hotel_length_of_stay(
        self,
    ) -> google___ads___googleads___v2___common___criteria_pb2___HotelLengthOfStayInfo: ...
    @property
    def hotel_check_in_day(
        self,
    ) -> google___ads___googleads___v2___common___criteria_pb2___HotelCheckInDayInfo: ...
    @property
    def device(
        self,
    ...
    def preferred_content(
        self,
    ) -> google___ads___googleads___v2___common___criteria_pb2___PreferredContentInfo: ...
    def __init__(
        self,
        *,
        ...
        bid_modifier_source: typing___Optional[
            google___ads___googleads___v2___enums___bid_modifier_source_pb2___BidModifierSourceEnum.BidModifierSourceValue
        ] = None,
