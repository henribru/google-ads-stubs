...
from google.ads.google_ads.v2.proto.common.criteria_pb2 import (
    ...
    HotelAdvanceBookingWindowInfo as google___ads___googleads___v2___common___criteria_pb2___HotelAdvanceBookingWindowInfo,
    HotelCheckInDayInfo as google___ads___googleads___v2___common___criteria_pb2___HotelCheckInDayInfo,
    HotelDateSelectionTypeInfo as google___ads___googleads___v2___common___criteria_pb2___HotelDateSelectionTypeInfo,
    HotelLengthOfStayInfo as google___ads___googleads___v2___common___criteria_pb2___HotelLengthOfStayInfo,
    PreferredContentInfo as google___ads___googleads___v2___common___criteria_pb2___PreferredContentInfo,
)

from google.ads.google_ads.v2.proto.enums.bid_modifier_source_pb2 import (
...
class AdGroupBidModifier(google___protobuf___message___Message):
    ...
    @property
    def hotel_date_selection_type(self) -> google___ads___googleads___v2___common___criteria_pb2___HotelDateSelectionTypeInfo: ...

    @property
    def hotel_advance_booking_window(self) -> google___ads___googleads___v2___common___criteria_pb2___HotelAdvanceBookingWindowInfo: ...

    @property
    def hotel_length_of_stay(self) -> google___ads___googleads___v2___common___criteria_pb2___HotelLengthOfStayInfo: ...

    @property
    def hotel_check_in_day(self) -> google___ads___googleads___v2___common___criteria_pb2___HotelCheckInDayInfo: ...

    @property
    def device(self) -> google___ads___googleads___v2___common___criteria_pb2___DeviceInfo: ...

    @property
    def preferred_content(self) -> google___ads___googleads___v2___common___criteria_pb2___PreferredContentInfo: ...
    ...
    def __init__(self,
        *,
        ...
        hotel_check_in_day : typing___Optional[google___ads___googleads___v2___common___criteria_pb2___HotelCheckInDayInfo] = None,
        device : typing___Optional[google___ads___googleads___v2___common___criteria_pb2___DeviceInfo] = None,
        preferred_content : typing___Optional[google___ads___googleads___v2___common___criteria_pb2___PreferredContentInfo] = None,
        ) -> None: ...
    @classmethod
