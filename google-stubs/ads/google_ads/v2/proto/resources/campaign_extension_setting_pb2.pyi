...
class CampaignExtensionSetting(google___protobuf___message___Message):
    ...
    device = ... # type: google___ads___googleads___v2___enums___extension_setting_device_pb2___ExtensionSettingDeviceEnum.ExtensionSettingDevice.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        device : typing___Optional[google___ads___googleads___v2___enums___extension_setting_device_pb2___ExtensionSettingDeviceEnum.ExtensionSettingDevice.ClosedValueType] = None,
        ) -> None: ...
    @classmethod
