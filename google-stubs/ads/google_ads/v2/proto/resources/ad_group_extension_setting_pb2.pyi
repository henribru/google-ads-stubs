...
class AdGroupExtensionSetting(google___protobuf___message___Message):
    ...
    device: google___ads___googleads___v2___enums___extension_setting_device_pb2___ExtensionSettingDeviceEnum.ExtensionSettingDeviceValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        device: typing___Optional[
            google___ads___googleads___v2___enums___extension_setting_device_pb2___ExtensionSettingDeviceEnum.ExtensionSettingDeviceValue
        ] = None,
    ) -> None: ...
    def HasField(
