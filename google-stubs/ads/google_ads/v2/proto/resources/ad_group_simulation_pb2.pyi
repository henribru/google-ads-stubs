...
class AdGroupSimulation(google___protobuf___message___Message):
    ...
    def cpv_bid_point_list(
        self,
    ) -> google___ads___googleads___v2___common___simulation_pb2___CpvBidSimulationPointList: ...
    @property
    def target_cpa_point_list(
        self,
    ) -> google___ads___googleads___v2___common___simulation_pb2___TargetCpaSimulationPointList: ...
    def __init__(
        self,
        *,
