...
class FeedItem(google___protobuf___message___Message):
    ...
    geo_targeting_restriction = (
        ...
    )  # type: google___ads___googleads___v2___enums___geo_targeting_restriction_pb2___GeoTargetingRestrictionEnum.GeoTargetingRestriction
    status = (
        ...
    )  # type: google___ads___googleads___v2___enums___feed_item_status_pb2___FeedItemStatusEnum.FeedItemStatus
    @property
    ...
    def __init__(
        ...
        *,
        ...
        geo_targeting_restriction: typing___Optional[
            google___ads___googleads___v2___enums___geo_targeting_restriction_pb2___GeoTargetingRestrictionEnum.GeoTargetingRestriction
        ] = None,
        ...
        status: typing___Optional[
            google___ads___googleads___v2___enums___feed_item_status_pb2___FeedItemStatusEnum.FeedItemStatus
        ] = None,
...
class FeedItemPlaceholderPolicyInfo(google___protobuf___message___Message):
    ...
    validation_status = (
        ...
    )  # type: google___ads___googleads___v2___enums___feed_item_validation_status_pb2___FeedItemValidationStatusEnum.FeedItemValidationStatus
    quality_approval_status = (
        ...
    )  # type: google___ads___googleads___v2___enums___feed_item_quality_approval_status_pb2___FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus
    ...
    def __init__(
        ...
        *,
        ...
        validation_status: typing___Optional[
            google___ads___googleads___v2___enums___feed_item_validation_status_pb2___FeedItemValidationStatusEnum.FeedItemValidationStatus
        ] = None,
        ...
        quality_approval_status: typing___Optional[
            google___ads___googleads___v2___enums___feed_item_quality_approval_status_pb2___FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus
        ] = None,
        quality_disapproval_reasons: typing___Optional[
            typing___Iterable[
                google___ads___googleads___v2___enums___feed_item_quality_disapproval_reason_pb2___FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason
            ]
        ] = None,
    ) -> None: ...
    if sys.version_info >= (3,):
