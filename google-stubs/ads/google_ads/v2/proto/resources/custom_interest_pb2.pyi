...
class CustomInterest(google___protobuf___message___Message):
    ...
    @property
    def members(self) -> google___protobuf___internal___containers___RepeatedCompositeFieldContainer[global___CustomInterestMember]: ...
    ...
    def __init__(self,
        *,
        ...
        members : typing___Optional[typing___Iterable[global___CustomInterestMember]] = None,
        ) -> None: ...
    if sys.version_info >= (3,):
        @classmethod
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> CustomInterest: ...
...
class CustomInterestMember(google___protobuf___message___Message):
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> CustomInterestMember: ...
    def MergeFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
    def CopyFrom(self, other_msg: google___protobuf___message___Message) -> None: ...
