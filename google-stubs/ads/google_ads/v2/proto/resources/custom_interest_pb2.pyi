...
class CustomInterest(google___protobuf___message___Message):
    ...
    status: google___ads___googleads___v2___enums___custom_interest_status_pb2___CustomInterestStatusEnum.CustomInterestStatusValue = ...
    type: google___ads___googleads___v2___enums___custom_interest_type_pb2___CustomInterestTypeEnum.CustomInterestTypeValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v2___enums___custom_interest_status_pb2___CustomInterestStatusEnum.CustomInterestStatusValue
        ] = None,
        name: typing___Optional[google___protobuf___wrappers_pb2___StringValue] = None,
        type: typing___Optional[
            google___ads___googleads___v2___enums___custom_interest_type_pb2___CustomInterestTypeEnum.CustomInterestTypeValue
        ] = None,
...
class CustomInterestMember(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    member_type: google___ads___googleads___v2___enums___custom_interest_member_type_pb2___CustomInterestMemberTypeEnum.CustomInterestMemberTypeValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        member_type: typing___Optional[
            google___ads___googleads___v2___enums___custom_interest_member_type_pb2___CustomInterestMemberTypeEnum.CustomInterestMemberTypeValue
        ] = None,
