...
class CustomInterest(google___protobuf___message___Message):
    ...
    status = ... # type: google___ads___googleads___v2___enums___custom_interest_status_pb2___CustomInterestStatusEnum.CustomInterestStatus.ClosedValueType
    type = ... # type: google___ads___googleads___v2___enums___custom_interest_type_pb2___CustomInterestTypeEnum.CustomInterestType.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        status : typing___Optional[google___ads___googleads___v2___enums___custom_interest_status_pb2___CustomInterestStatusEnum.CustomInterestStatus.ClosedValueType] = None,
        name : typing___Optional[google___protobuf___wrappers_pb2___StringValue] = None,
        type : typing___Optional[google___ads___googleads___v2___enums___custom_interest_type_pb2___CustomInterestTypeEnum.CustomInterestType.ClosedValueType] = None,
...
class CustomInterestMember(google___protobuf___message___Message):
    member_type = ... # type: google___ads___googleads___v2___enums___custom_interest_member_type_pb2___CustomInterestMemberTypeEnum.CustomInterestMemberType.ClosedValueType
    ...
    def __init__(self,
        *,
        member_type : typing___Optional[google___ads___googleads___v2___enums___custom_interest_member_type_pb2___CustomInterestMemberTypeEnum.CustomInterestMemberType.ClosedValueType] = None,
