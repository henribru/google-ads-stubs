...
class CampaignBudget(google___protobuf___message___Message):
    ...
    status: google___ads___googleads___v2___enums___budget_status_pb2___BudgetStatusEnum.BudgetStatusValue = ...
    delivery_method: google___ads___googleads___v2___enums___budget_delivery_method_pb2___BudgetDeliveryMethodEnum.BudgetDeliveryMethodValue = ...
    period: google___ads___googleads___v2___enums___budget_period_pb2___BudgetPeriodEnum.BudgetPeriodValue = ...
    type: google___ads___googleads___v2___enums___budget_type_pb2___BudgetTypeEnum.BudgetTypeValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        status: typing___Optional[
            google___ads___googleads___v2___enums___budget_status_pb2___BudgetStatusEnum.BudgetStatusValue
        ] = None,
        delivery_method: typing___Optional[
            google___ads___googleads___v2___enums___budget_delivery_method_pb2___BudgetDeliveryMethodEnum.BudgetDeliveryMethodValue
        ] = None,
        ...
        period: typing___Optional[
            google___ads___googleads___v2___enums___budget_period_pb2___BudgetPeriodEnum.BudgetPeriodValue
        ] = None,
        ...
        type: typing___Optional[
            google___ads___googleads___v2___enums___budget_type_pb2___BudgetTypeEnum.BudgetTypeValue
        ] = None,
    ) -> None: ...
    def HasField(
        self,
