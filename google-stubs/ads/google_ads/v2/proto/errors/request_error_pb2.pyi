...
class RequestErrorEnum(google___protobuf___message___Message):
    ...
    class RequestError(builtin___int):
        ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'RequestErrorEnum.RequestError']]: ...
        ...
        CANNOT_RETURN_SUMMARY_ROW_FOR_REQUEST_WITHOUT_METRICS = typing___cast('RequestErrorEnum.RequestError', 29)
        CANNOT_RETURN_SUMMARY_ROW_FOR_VALIDATE_ONLY_REQUESTS = typing___cast('RequestErrorEnum.RequestError', 30)
        INCONSISTENT_RETURN_SUMMARY_ROW_VALUE = typing___cast('RequestErrorEnum.RequestError', 31)
    UNSPECIFIED = typing___cast('RequestErrorEnum.RequestError', 0)
    UNKNOWN = typing___cast('RequestErrorEnum.RequestError', 1)
    RESOURCE_NAME_MISSING = typing___cast('RequestErrorEnum.RequestError', 3)
    RESOURCE_NAME_MALFORMED = typing___cast('RequestErrorEnum.RequestError', 4)
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> RequestErrorEnum: ...
