...
class AdGroupErrorEnum(google___protobuf___message___Message):
    ...
    class AdGroupError(builtin___int):
        ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'AdGroupErrorEnum.AdGroupError']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> AdGroupErrorEnum: ...
