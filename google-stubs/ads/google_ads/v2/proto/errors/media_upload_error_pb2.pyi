...
class MediaUploadErrorEnum(google___protobuf___message___Message):
    class MediaUploadError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['FILE_TOO_BIG'],typing_extensions___Literal['UNPARSEABLE_IMAGE'],typing_extensions___Literal['ANIMATED_IMAGE_NOT_ALLOWED'],typing_extensions___Literal['FORMAT_NOT_ALLOWED']]
        ...
        FILE_TOO_BIG: typing_extensions___Literal[2]
        UNPARSEABLE_IMAGE: typing_extensions___Literal[3]
        ANIMATED_IMAGE_NOT_ALLOWED: typing_extensions___Literal[4]
        FORMAT_NOT_ALLOWED: typing_extensions___Literal[5]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    FILE_TOO_BIG: typing_extensions___Literal[2]
    UNPARSEABLE_IMAGE: typing_extensions___Literal[3]
