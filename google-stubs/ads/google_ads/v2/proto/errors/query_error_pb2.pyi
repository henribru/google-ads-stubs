...
class QueryErrorEnum(google___protobuf___message___Message):
    ...
    class QueryError(builtin___int):
        ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'QueryErrorEnum.QueryError']]: ...
        ...
        DATE_RANGE_TOO_NARROW = typing___cast('QueryErrorEnum.QueryError', 60)
        EXPECTED_AND = typing___cast('QueryErrorEnum.QueryError', 30)
        EXPECTED_BY = typing___cast('QueryErrorEnum.QueryError', 14)
        EXPECTED_DIMENSION_FIELD_IN_SELECT_CLAUSE = typing___cast('QueryErrorEnum.QueryError', 37)
        ...
        EXPECTED_REFERENCED_FIELD_IN_SELECT_CLAUSE = typing___cast('QueryErrorEnum.QueryError', 16)
        ...
        EXPECTED_VALUE_WITH_BETWEEN_OPERATOR = typing___cast('QueryErrorEnum.QueryError', 29)
        ...
        PROHIBITED_FIELD_COMBINATION_IN_SELECT_CLAUSE = typing___cast('QueryErrorEnum.QueryError', 31)
        ...
        PROHIBITED_RESOURCE_TYPE_IN_FROM_CLAUSE = typing___cast('QueryErrorEnum.QueryError', 43)
        PROHIBITED_RESOURCE_TYPE_IN_SELECT_CLAUSE = typing___cast('QueryErrorEnum.QueryError', 48)
        PROHIBITED_RESOURCE_TYPE_IN_WHERE_CLAUSE = typing___cast('QueryErrorEnum.QueryError', 58)
        PROHIBITED_METRIC_IN_SELECT_OR_WHERE_CLAUSE = typing___cast('QueryErrorEnum.QueryError', 49)
        PROHIBITED_SEGMENT_IN_SELECT_OR_WHERE_CLAUSE = typing___cast('QueryErrorEnum.QueryError', 51)
        PROHIBITED_SEGMENT_WITH_METRIC_IN_SELECT_OR_WHERE_CLAUSE = typing___cast('QueryErrorEnum.QueryError', 53)
        ...
        PROHIBITED_VALUE_COMBINATION_IN_LIST = typing___cast('QueryErrorEnum.QueryError', 10)
        PROHIBITED_VALUE_COMBINATION_WITH_BETWEEN_OPERATOR = typing___cast('QueryErrorEnum.QueryError', 21)
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> QueryErrorEnum: ...
