...
class AccessInvitationErrorEnum(google___protobuf___message___Message):
    class AccessInvitationError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['INVALID_EMAIL_ADDRESS'],typing_extensions___Literal['EMAIL_ADDRESS_ALREADY_HAS_ACCESS']]
        ...
        INVALID_EMAIL_ADDRESS: typing_extensions___Literal[2]
        EMAIL_ADDRESS_ALREADY_HAS_ACCESS: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    INVALID_EMAIL_ADDRESS: typing_extensions___Literal[2]
    EMAIL_ADDRESS_ALREADY_HAS_ACCESS: typing_extensions___Literal[3]
