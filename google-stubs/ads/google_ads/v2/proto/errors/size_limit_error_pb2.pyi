...
class SizeLimitErrorEnum(google___protobuf___message___Message):
    class SizeLimitError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['REQUEST_SIZE_LIMIT_EXCEEDED'],typing_extensions___Literal['RESPONSE_SIZE_LIMIT_EXCEEDED']]
        ...
        REQUEST_SIZE_LIMIT_EXCEEDED: typing_extensions___Literal[2]
        RESPONSE_SIZE_LIMIT_EXCEEDED: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    REQUEST_SIZE_LIMIT_EXCEEDED: typing_extensions___Literal[2]
    RESPONSE_SIZE_LIMIT_EXCEEDED: typing_extensions___Literal[3]
