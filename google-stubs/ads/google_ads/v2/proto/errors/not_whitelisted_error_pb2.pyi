...
class NotWhitelistedErrorEnum(google___protobuf___message___Message):
    class NotWhitelistedError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CUSTOMER_NOT_WHITELISTED_FOR_THIS_FEATURE']]
        ...
        CUSTOMER_NOT_WHITELISTED_FOR_THIS_FEATURE: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CUSTOMER_NOT_WHITELISTED_FOR_THIS_FEATURE: typing_extensions___Literal[2]
