...
class AuthorizationErrorEnum(google___protobuf___message___Message):
    class AuthorizationError(object):
        ...
        DEVELOPER_TOKEN_NOT_WHITELISTED: typing_extensions___Literal[3]
        DEVELOPER_TOKEN_PROHIBITED: typing_extensions___Literal[4]
        PROJECT_DISABLED: typing_extensions___Literal[5]
        AUTHORIZATION_ERROR: typing_extensions___Literal[6]
        ACTION_NOT_PERMITTED: typing_extensions___Literal[7]
        INCOMPLETE_SIGNUP: typing_extensions___Literal[8]
