...
class QuotaErrorEnum(google___protobuf___message___Message):
    class QuotaError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['RESOURCE_EXHAUSTED'],typing_extensions___Literal['ACCESS_PROHIBITED'],typing_extensions___Literal['RESOURCE_TEMPORARILY_EXHAUSTED']]
        ...
        RESOURCE_EXHAUSTED: typing_extensions___Literal[2]
        ACCESS_PROHIBITED: typing_extensions___Literal[3]
        RESOURCE_TEMPORARILY_EXHAUSTED: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    RESOURCE_EXHAUSTED: typing_extensions___Literal[2]
    ACCESS_PROHIBITED: typing_extensions___Literal[3]
