...
class AdGroupBidModifierErrorEnum(google___protobuf___message___Message):
    class AdGroupBidModifierError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CRITERION_ID_NOT_SUPPORTED'],typing_extensions___Literal['CANNOT_OVERRIDE_OPTED_OUT_CAMPAIGN_CRITERION_BID_MODIFIER']]
        ...
        CRITERION_ID_NOT_SUPPORTED: typing_extensions___Literal[2]
        CANNOT_OVERRIDE_OPTED_OUT_CAMPAIGN_CRITERION_BID_MODIFIER: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CRITERION_ID_NOT_SUPPORTED: typing_extensions___Literal[2]
    CANNOT_OVERRIDE_OPTED_OUT_CAMPAIGN_CRITERION_BID_MODIFIER: typing_extensions___Literal[3]
