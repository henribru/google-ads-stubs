...
class PartialFailureErrorEnum(google___protobuf___message___Message):
    class PartialFailureError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['PARTIAL_FAILURE_MODE_REQUIRED']]
        ...
        PARTIAL_FAILURE_MODE_REQUIRED: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    PARTIAL_FAILURE_MODE_REQUIRED: typing_extensions___Literal[2]
