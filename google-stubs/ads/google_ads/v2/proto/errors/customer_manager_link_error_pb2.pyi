...
class CustomerManagerLinkErrorEnum(google___protobuf___message___Message):
    ...
    class CustomerManagerLinkError(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'CustomerManagerLinkErrorEnum.CustomerManagerLinkError': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['CustomerManagerLinkErrorEnum.CustomerManagerLinkError']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'CustomerManagerLinkErrorEnum.CustomerManagerLinkError']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> CustomerManagerLinkErrorEnum: ...
