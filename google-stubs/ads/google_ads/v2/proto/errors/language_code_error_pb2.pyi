...
class LanguageCodeErrorEnum(google___protobuf___message___Message):
    class LanguageCodeError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['LANGUAGE_CODE_NOT_FOUND'],typing_extensions___Literal['INVALID_LANGUAGE_CODE']]
        ...
        LANGUAGE_CODE_NOT_FOUND: typing_extensions___Literal[2]
        INVALID_LANGUAGE_CODE: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    LANGUAGE_CODE_NOT_FOUND: typing_extensions___Literal[2]
    INVALID_LANGUAGE_CODE: typing_extensions___Literal[3]
