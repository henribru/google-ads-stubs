...
class DistinctErrorEnum(google___protobuf___message___Message):
    class DistinctError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['DUPLICATE_ELEMENT'],typing_extensions___Literal['DUPLICATE_TYPE']]
        ...
        DUPLICATE_ELEMENT: typing_extensions___Literal[2]
        DUPLICATE_TYPE: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    DUPLICATE_ELEMENT: typing_extensions___Literal[2]
    DUPLICATE_TYPE: typing_extensions___Literal[3]
