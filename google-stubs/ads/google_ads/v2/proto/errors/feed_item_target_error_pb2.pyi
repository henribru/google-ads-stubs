...
class FeedItemTargetErrorEnum(google___protobuf___message___Message):
    ...
    class FeedItemTargetError(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'FeedItemTargetErrorEnum.FeedItemTargetError': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['FeedItemTargetErrorEnum.FeedItemTargetError']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'FeedItemTargetErrorEnum.FeedItemTargetError']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> FeedItemTargetErrorEnum: ...
