...
class CustomerErrorEnum(google___protobuf___message___Message):
    class CustomerError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['STATUS_CHANGE_DISALLOWED'],typing_extensions___Literal['ACCOUNT_NOT_SET_UP']]
        ...
        STATUS_CHANGE_DISALLOWED: typing_extensions___Literal[2]
        ACCOUNT_NOT_SET_UP: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    STATUS_CHANGE_DISALLOWED: typing_extensions___Literal[2]
    ACCOUNT_NOT_SET_UP: typing_extensions___Literal[3]
