...
class SharedSetErrorEnum(google___protobuf___message___Message):
    class SharedSetError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CUSTOMER_CANNOT_CREATE_SHARED_SET_OF_THIS_TYPE'],typing_extensions___Literal['DUPLICATE_NAME'],typing_extensions___Literal['SHARED_SET_REMOVED'],typing_extensions___Literal['SHARED_SET_IN_USE']]
        ...
        CUSTOMER_CANNOT_CREATE_SHARED_SET_OF_THIS_TYPE: typing_extensions___Literal[2]
        DUPLICATE_NAME: typing_extensions___Literal[3]
        SHARED_SET_REMOVED: typing_extensions___Literal[4]
        SHARED_SET_IN_USE: typing_extensions___Literal[5]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CUSTOMER_CANNOT_CREATE_SHARED_SET_OF_THIS_TYPE: typing_extensions___Literal[2]
    DUPLICATE_NAME: typing_extensions___Literal[3]
