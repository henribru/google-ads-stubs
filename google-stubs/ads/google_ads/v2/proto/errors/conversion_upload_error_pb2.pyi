...
class ConversionUploadErrorEnum(google___protobuf___message___Message):
    ...
    class ConversionUploadError(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'ConversionUploadErrorEnum.ConversionUploadError': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['ConversionUploadErrorEnum.ConversionUploadError']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'ConversionUploadErrorEnum.ConversionUploadError']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> ConversionUploadErrorEnum: ...
