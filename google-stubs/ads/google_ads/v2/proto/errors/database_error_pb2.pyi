...
class DatabaseErrorEnum(google___protobuf___message___Message):
    class DatabaseError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CONCURRENT_MODIFICATION'],typing_extensions___Literal['DATA_CONSTRAINT_VIOLATION']]
        ...
        CONCURRENT_MODIFICATION: typing_extensions___Literal[2]
        DATA_CONSTRAINT_VIOLATION: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CONCURRENT_MODIFICATION: typing_extensions___Literal[2]
    DATA_CONSTRAINT_VIOLATION: typing_extensions___Literal[3]
