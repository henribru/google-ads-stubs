...
class CampaignSharedSetErrorEnum(google___protobuf___message___Message):
    class CampaignSharedSetError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['SHARED_SET_ACCESS_DENIED']]
        ...
        SHARED_SET_ACCESS_DENIED: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    SHARED_SET_ACCESS_DENIED: typing_extensions___Literal[2]
    ...
    @classmethod
    def FromString(cls, s: bytes) -> CampaignSharedSetErrorEnum: ...
