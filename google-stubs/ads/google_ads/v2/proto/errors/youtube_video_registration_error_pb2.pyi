...
class YoutubeVideoRegistrationErrorEnum(google___protobuf___message___Message):
    class YoutubeVideoRegistrationError(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['VIDEO_NOT_FOUND'],typing_extensions___Literal['VIDEO_NOT_ACCESSIBLE']]
        ...
        VIDEO_NOT_FOUND: typing_extensions___Literal[2]
        VIDEO_NOT_ACCESSIBLE: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    VIDEO_NOT_FOUND: typing_extensions___Literal[2]
    VIDEO_NOT_ACCESSIBLE: typing_extensions___Literal[3]
