...
class UserListErrorEnum(google___protobuf___message___Message):
    ...
    class UserListError(builtin___int):
        ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'UserListErrorEnum.UserListError']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> UserListErrorEnum: ...
