...
class FunctionErrorEnum(google___protobuf___message___Message):
    ...
    class FunctionError(builtin___int):
        ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'FunctionErrorEnum.FunctionError']]: ...
        ...
        INVALID_FUNCTION_FOR_CALL_PLACEHOLDER = typing___cast('FunctionErrorEnum.FunctionError', 9)
        INVALID_FUNCTION_FOR_PLACEHOLDER = typing___cast('FunctionErrorEnum.FunctionError', 10)
        INVALID_OPERAND = typing___cast('FunctionErrorEnum.FunctionError', 11)
        MISSING_CONSTANT_OPERAND_VALUE = typing___cast('FunctionErrorEnum.FunctionError', 12)
        INVALID_CONSTANT_OPERAND_VALUE = typing___cast('FunctionErrorEnum.FunctionError', 13)
        INVALID_NESTING = typing___cast('FunctionErrorEnum.FunctionError', 14)
        MULTIPLE_FEED_IDS_NOT_SUPPORTED = typing___cast('FunctionErrorEnum.FunctionError', 15)
        INVALID_FUNCTION_FOR_FEED_WITH_FIXED_SCHEMA = typing___cast('FunctionErrorEnum.FunctionError', 16)
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> FunctionErrorEnum: ...
