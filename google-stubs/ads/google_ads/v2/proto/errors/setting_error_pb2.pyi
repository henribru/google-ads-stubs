...
class SettingErrorEnum(google___protobuf___message___Message):
    ...
    TOO_MANY_EXCLAMATION_MARKS = typing___cast(SettingErrorEnum.SettingErrorValue, 19)
