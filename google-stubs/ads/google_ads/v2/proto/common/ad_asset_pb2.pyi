...
class AdTextAsset(google___protobuf___message___Message):
    ...
    pinned_field: google___ads___googleads___v2___enums___served_asset_field_type_pb2___ServedAssetFieldTypeEnum.ServedAssetFieldTypeValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        pinned_field: typing___Optional[
            google___ads___googleads___v2___enums___served_asset_field_type_pb2___ServedAssetFieldTypeEnum.ServedAssetFieldTypeValue
        ] = None,
    ) -> None: ...
    def HasField(
