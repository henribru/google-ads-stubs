...
class KeywordPlanHistoricalMetrics(google___protobuf___message___Message):
    competition = ... # type: google___ads___googleads___v2___enums___keyword_plan_competition_level_pb2___KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        competition : typing___Optional[google___ads___googleads___v2___enums___keyword_plan_competition_level_pb2___KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel.ClosedValueType] = None,
        ) -> None: ...
    @classmethod
