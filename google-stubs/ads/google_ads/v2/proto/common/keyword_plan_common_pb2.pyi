...
class KeywordPlanHistoricalMetrics(google___protobuf___message___Message):
    ...
    competition: google___ads___googleads___v2___enums___keyword_plan_competition_level_pb2___KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevelValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        competition: typing___Optional[
            google___ads___googleads___v2___enums___keyword_plan_competition_level_pb2___KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevelValue
        ] = None,
    ) -> None: ...
    def HasField(
        self,
