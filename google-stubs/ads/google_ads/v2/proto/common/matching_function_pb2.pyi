...
class MatchingFunction(google___protobuf___message___Message):
    ...
    operator: google___ads___googleads___v2___enums___matching_function_operator_pb2___MatchingFunctionOperatorEnum.MatchingFunctionOperatorValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        operator: typing___Optional[
            google___ads___googleads___v2___enums___matching_function_operator_pb2___MatchingFunctionOperatorEnum.MatchingFunctionOperatorValue
        ] = None,
...
class Operand(google___protobuf___message___Message):
    ...
    class RequestContextOperand(google___protobuf___message___Message):
        DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
        context_type: google___ads___googleads___v2___enums___matching_function_context_type_pb2___MatchingFunctionContextTypeEnum.MatchingFunctionContextTypeValue = ...
        def __init__(
            self,
            *,
            context_type: typing___Optional[
                google___ads___googleads___v2___enums___matching_function_context_type_pb2___MatchingFunctionContextTypeEnum.MatchingFunctionContextTypeValue
            ] = None,
        ) -> None: ...
        def ClearField(
            self,
