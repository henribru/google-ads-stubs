...
class TagSnippet(google___protobuf___message___Message):
    type = ... # type: google___ads___googleads___v2___enums___tracking_code_type_pb2___TrackingCodeTypeEnum.TrackingCodeType.ClosedValueType
    page_format = ... # type: google___ads___googleads___v2___enums___tracking_code_page_format_pb2___TrackingCodePageFormatEnum.TrackingCodePageFormat.ClosedValueType
    ...
    def __init__(self,
        *,
        type : typing___Optional[google___ads___googleads___v2___enums___tracking_code_type_pb2___TrackingCodeTypeEnum.TrackingCodeType.ClosedValueType] = None,
        page_format : typing___Optional[google___ads___googleads___v2___enums___tracking_code_page_format_pb2___TrackingCodePageFormatEnum.TrackingCodePageFormat.ClosedValueType] = None,
