...
class AppFeedItem(google___protobuf___message___Message):
    app_store = ... # type: google___ads___googleads___v2___enums___app_store_pb2___AppStoreEnum.AppStore.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        app_store : typing___Optional[google___ads___googleads___v2___enums___app_store_pb2___AppStoreEnum.AppStore.ClosedValueType] = None,
...
class CallFeedItem(google___protobuf___message___Message):
    call_conversion_reporting_state = ... # type: google___ads___googleads___v2___enums___call_conversion_reporting_state_pb2___CallConversionReportingStateEnum.CallConversionReportingState.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        call_conversion_reporting_state : typing___Optional[google___ads___googleads___v2___enums___call_conversion_reporting_state_pb2___CallConversionReportingStateEnum.CallConversionReportingState.ClosedValueType] = None,
        ) -> None: ...
    @classmethod
...
class PriceFeedItem(google___protobuf___message___Message):
    type = ... # type: google___ads___googleads___v2___enums___price_extension_type_pb2___PriceExtensionTypeEnum.PriceExtensionType.ClosedValueType
    price_qualifier = ... # type: google___ads___googleads___v2___enums___price_extension_price_qualifier_pb2___PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier.ClosedValueType
    ...
    def __init__(self,
        *,
        type : typing___Optional[google___ads___googleads___v2___enums___price_extension_type_pb2___PriceExtensionTypeEnum.PriceExtensionType.ClosedValueType] = None,
        price_qualifier : typing___Optional[google___ads___googleads___v2___enums___price_extension_price_qualifier_pb2___PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier.ClosedValueType] = None,
        tracking_url_template : typing___Optional[google___protobuf___wrappers_pb2___StringValue] = None,
...
class PriceOffer(google___protobuf___message___Message):
    unit = ... # type: google___ads___googleads___v2___enums___price_extension_price_unit_pb2___PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        unit : typing___Optional[google___ads___googleads___v2___enums___price_extension_price_unit_pb2___PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit.ClosedValueType] = None,
        final_urls : typing___Optional[typing___Iterable[google___protobuf___wrappers_pb2___StringValue]] = None,
        final_mobile_urls : typing___Optional[typing___Iterable[google___protobuf___wrappers_pb2___StringValue]] = None,
        ) -> None: ...
    @classmethod
...
class PromotionFeedItem(google___protobuf___message___Message):
    discount_modifier = ... # type: google___ads___googleads___v2___enums___promotion_extension_discount_modifier_pb2___PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier.ClosedValueType
    occasion = ... # type: google___ads___googleads___v2___enums___promotion_extension_occasion_pb2___PromotionExtensionOccasionEnum.PromotionExtensionOccasion.ClosedValueType
    ...
    def __init__(self,
        *,
        ...
        discount_modifier : typing___Optional[google___ads___googleads___v2___enums___promotion_extension_discount_modifier_pb2___PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier.ClosedValueType] = None,
        ...
        occasion : typing___Optional[google___ads___googleads___v2___enums___promotion_extension_occasion_pb2___PromotionExtensionOccasionEnum.PromotionExtensionOccasion.ClosedValueType] = None,
        final_urls : typing___Optional[typing___Iterable[google___protobuf___wrappers_pb2___StringValue]] = None,
        final_mobile_urls : typing___Optional[typing___Iterable[google___protobuf___wrappers_pb2___StringValue]] = None,
        tracking_url_template : typing___Optional[google___protobuf___wrappers_pb2___StringValue] = None,
        url_custom_parameters : typing___Optional[typing___Iterable[google___ads___googleads___v2___common___custom_parameter_pb2___CustomParameter]] = None,
