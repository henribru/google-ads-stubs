...
class AppFeedItem(google___protobuf___message___Message):
    ...
    app_store: google___ads___googleads___v2___enums___app_store_pb2___AppStoreEnum.AppStoreValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        app_store: typing___Optional[
            google___ads___googleads___v2___enums___app_store_pb2___AppStoreEnum.AppStoreValue
        ] = None,
...
class CallFeedItem(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    call_conversion_reporting_state: google___ads___googleads___v2___enums___call_conversion_reporting_state_pb2___CallConversionReportingStateEnum.CallConversionReportingStateValue = ...
    @property
...
class PriceFeedItem(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    type: google___ads___googleads___v2___enums___price_extension_type_pb2___PriceExtensionTypeEnum.PriceExtensionTypeValue = ...
    price_qualifier: google___ads___googleads___v2___enums___price_extension_price_qualifier_pb2___PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifierValue = ...
    @property
    def tracking_url_template(
        self,
    ) -> google___protobuf___wrappers_pb2___StringValue: ...
    ...
    def __init__(
        ...
        *,
        type: typing___Optional[
            google___ads___googleads___v2___enums___price_extension_type_pb2___PriceExtensionTypeEnum.PriceExtensionTypeValue
        ] = None,
        price_qualifier: typing___Optional[
            google___ads___googleads___v2___enums___price_extension_price_qualifier_pb2___PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifierValue
        ] = None,
        tracking_url_template: typing___Optional[
            google___protobuf___wrappers_pb2___StringValue
        ] = None,
...
class PriceOffer(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    unit: google___ads___googleads___v2___enums___price_extension_price_unit_pb2___PriceExtensionPriceUnitEnum.PriceExtensionPriceUnitValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        unit: typing___Optional[
            google___ads___googleads___v2___enums___price_extension_price_unit_pb2___PriceExtensionPriceUnitEnum.PriceExtensionPriceUnitValue
        ] = None,
        final_urls: typing___Optional[
            typing___Iterable[google___protobuf___wrappers_pb2___StringValue]
        ] = None,
...
class PromotionFeedItem(google___protobuf___message___Message):
    DESCRIPTOR: google___protobuf___descriptor___Descriptor = ...
    discount_modifier: google___ads___googleads___v2___enums___promotion_extension_discount_modifier_pb2___PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifierValue = ...
    occasion: google___ads___googleads___v2___enums___promotion_extension_occasion_pb2___PromotionExtensionOccasionEnum.PromotionExtensionOccasionValue = ...
    @property
    ...
    def __init__(
        ...
        *,
        ...
        discount_modifier: typing___Optional[
            google___ads___googleads___v2___enums___promotion_extension_discount_modifier_pb2___PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifierValue
        ] = None,
        ...
        occasion: typing___Optional[
            google___ads___googleads___v2___enums___promotion_extension_occasion_pb2___PromotionExtensionOccasionEnum.PromotionExtensionOccasionValue
        ] = None,
        final_urls: typing___Optional[
            typing___Iterable[google___protobuf___wrappers_pb2___StringValue]
        ] = None,
