...
class FrequencyCapKey(google___protobuf___message___Message):
    ...
    level = (
        ...
    )  # type: google___ads___googleads___v2___enums___frequency_cap_level_pb2___FrequencyCapLevelEnum.FrequencyCapLevel
    event_type = (
        ...
    )  # type: google___ads___googleads___v2___enums___frequency_cap_event_type_pb2___FrequencyCapEventTypeEnum.FrequencyCapEventType
    time_unit = (
        ...
    )  # type: google___ads___googleads___v2___enums___frequency_cap_time_unit_pb2___FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit
    @property
    ...
    def __init__(
        ...
        *,
        level: typing___Optional[
            google___ads___googleads___v2___enums___frequency_cap_level_pb2___FrequencyCapLevelEnum.FrequencyCapLevel
        ] = None,
        event_type: typing___Optional[
            google___ads___googleads___v2___enums___frequency_cap_event_type_pb2___FrequencyCapEventTypeEnum.FrequencyCapEventType
        ] = None,
        time_unit: typing___Optional[
            google___ads___googleads___v2___enums___frequency_cap_time_unit_pb2___FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit
        ] = None,
