...
class MatchingFunctionContextTypeEnum(google___protobuf___message___Message):
    class MatchingFunctionContextType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['FEED_ITEM_ID'],typing_extensions___Literal['DEVICE_NAME']]
        ...
        FEED_ITEM_ID: typing_extensions___Literal[2]
        DEVICE_NAME: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    FEED_ITEM_ID: typing_extensions___Literal[2]
    DEVICE_NAME: typing_extensions___Literal[3]
