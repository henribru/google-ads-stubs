...
class ListingGroupTypeEnum(google___protobuf___message___Message):
    class ListingGroupType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['SUBDIVISION'],typing_extensions___Literal['UNIT']]
        ...
        SUBDIVISION: typing_extensions___Literal[2]
        UNIT: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    SUBDIVISION: typing_extensions___Literal[2]
    UNIT: typing_extensions___Literal[3]
