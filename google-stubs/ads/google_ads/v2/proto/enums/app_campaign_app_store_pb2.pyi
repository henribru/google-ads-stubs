...
class AppCampaignAppStoreEnum(google___protobuf___message___Message):
    class AppCampaignAppStore(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['APPLE_APP_STORE'],typing_extensions___Literal['GOOGLE_APP_STORE']]
        ...
        GOOGLE_APP_STORE: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    APPLE_APP_STORE: typing_extensions___Literal[2]
    GOOGLE_APP_STORE: typing_extensions___Literal[3]
