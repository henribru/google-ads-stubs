...
class PolicyReviewStatusEnum(google___protobuf___message___Message):
    ...
    class PolicyReviewStatus(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'PolicyReviewStatusEnum.PolicyReviewStatus': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['PolicyReviewStatusEnum.PolicyReviewStatus']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'PolicyReviewStatusEnum.PolicyReviewStatus']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> PolicyReviewStatusEnum: ...
