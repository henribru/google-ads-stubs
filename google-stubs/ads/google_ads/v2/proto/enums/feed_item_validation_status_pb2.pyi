...
class FeedItemValidationStatusEnum(google___protobuf___message___Message):
    class FeedItemValidationStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['PENDING'],typing_extensions___Literal['INVALID'],typing_extensions___Literal['VALID']]
        ...
        INVALID: typing_extensions___Literal[3]
        VALID: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    PENDING: typing_extensions___Literal[2]
    INVALID: typing_extensions___Literal[3]
