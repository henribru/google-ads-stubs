...
class FeedItemValidationStatusEnum(google___protobuf___message___Message):
    ...
    class FeedItemValidationStatus(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'FeedItemValidationStatusEnum.FeedItemValidationStatus': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['FeedItemValidationStatusEnum.FeedItemValidationStatus']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'FeedItemValidationStatusEnum.FeedItemValidationStatus']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> FeedItemValidationStatusEnum: ...
