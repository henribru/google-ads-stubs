...
class ChangeStatusOperationEnum(google___protobuf___message___Message):
    class ChangeStatusOperation(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ADDED'],typing_extensions___Literal['CHANGED'],typing_extensions___Literal['REMOVED']]
        ...
        CHANGED: typing_extensions___Literal[3]
