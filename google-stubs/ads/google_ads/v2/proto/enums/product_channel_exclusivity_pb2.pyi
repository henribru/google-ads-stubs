...
class ProductChannelExclusivityEnum(google___protobuf___message___Message):
    class ProductChannelExclusivity(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['SINGLE_CHANNEL'],typing_extensions___Literal['MULTI_CHANNEL']]
        ...
        SINGLE_CHANNEL: typing_extensions___Literal[2]
        MULTI_CHANNEL: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    SINGLE_CHANNEL: typing_extensions___Literal[2]
    MULTI_CHANNEL: typing_extensions___Literal[3]
