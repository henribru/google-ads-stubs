...
class ProductChannelExclusivityEnum(google___protobuf___message___Message):
    ...
    class ProductChannelExclusivity(builtin___int):
        ...
        ) -> "ProductChannelExclusivityEnum.ProductChannelExclusivity": ...
        @classmethod
        ...
        def items(
            ...
            typing___Tuple[
                builtin___str, "ProductChannelExclusivityEnum.ProductChannelExclusivity"
            ]
        ]: ...
        UNSPECIFIED = typing___cast(
            "ProductChannelExclusivityEnum.ProductChannelExclusivity", 0
        )
        UNKNOWN = typing___cast(
            "ProductChannelExclusivityEnum.ProductChannelExclusivity", 1
        )
        SINGLE_CHANNEL = typing___cast(
            "ProductChannelExclusivityEnum.ProductChannelExclusivity", 2
        )
        MULTI_CHANNEL = typing___cast(
            "ProductChannelExclusivityEnum.ProductChannelExclusivity", 3
        )
    UNSPECIFIED = typing___cast(
        "ProductChannelExclusivityEnum.ProductChannelExclusivity", 0
    )
