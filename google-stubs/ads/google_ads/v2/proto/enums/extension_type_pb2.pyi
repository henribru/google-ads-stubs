...
class ExtensionTypeEnum(google___protobuf___message___Message):
    ...
    class ExtensionType(int):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
        @classmethod
        def Name(cls, number: int) -> str: ...
        @classmethod
        def Value(cls, name: str) -> ExtensionTypeEnum.ExtensionType: ...
        @classmethod
        def keys(cls) -> typing___List[str]: ...
        @classmethod
        def values(cls) -> typing___List[ExtensionTypeEnum.ExtensionType]: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[str, ExtensionTypeEnum.ExtensionType]]: ...
