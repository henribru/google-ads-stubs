...
class AssetPerformanceLabelEnum(google___protobuf___message___Message):
    class AssetPerformanceLabel(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['PENDING'],typing_extensions___Literal['LEARNING'],typing_extensions___Literal['LOW'],typing_extensions___Literal['GOOD'],typing_extensions___Literal['BEST']]
        ...
        LEARNING: typing_extensions___Literal[3]
        LOW: typing_extensions___Literal[4]
        GOOD: typing_extensions___Literal[5]
        BEST: typing_extensions___Literal[6]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    PENDING: typing_extensions___Literal[2]
    LEARNING: typing_extensions___Literal[3]
