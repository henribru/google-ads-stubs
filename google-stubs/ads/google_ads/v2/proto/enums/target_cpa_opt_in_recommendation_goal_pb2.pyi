...
class TargetCpaOptInRecommendationGoalEnum(google___protobuf___message___Message):
    class TargetCpaOptInRecommendationGoal(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['SAME_COST'],typing_extensions___Literal['SAME_CONVERSIONS'],typing_extensions___Literal['SAME_CPA'],typing_extensions___Literal['CLOSEST_CPA']]
        ...
        SAME_COST: typing_extensions___Literal[2]
        SAME_CONVERSIONS: typing_extensions___Literal[3]
        SAME_CPA: typing_extensions___Literal[4]
        CLOSEST_CPA: typing_extensions___Literal[5]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    SAME_COST: typing_extensions___Literal[2]
    SAME_CONVERSIONS: typing_extensions___Literal[3]
