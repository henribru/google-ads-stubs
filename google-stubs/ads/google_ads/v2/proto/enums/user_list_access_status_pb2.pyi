...
class UserListAccessStatusEnum(google___protobuf___message___Message):
    ...
    class UserListAccessStatus(int):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
        @classmethod
        def Name(cls, number: int) -> str: ...
        @classmethod
        def Value(cls, name: str) -> UserListAccessStatusEnum.UserListAccessStatus: ...
        @classmethod
        def keys(cls) -> typing___List[str]: ...
        @classmethod
        def values(cls) -> typing___List[UserListAccessStatusEnum.UserListAccessStatus]: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[str, UserListAccessStatusEnum.UserListAccessStatus]]: ...
