...
class UserListAccessStatusEnum(google___protobuf___message___Message):
    class UserListAccessStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ENABLED'],typing_extensions___Literal['DISABLED']]
        ...
        DISABLED: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ENABLED: typing_extensions___Literal[2]
    DISABLED: typing_extensions___Literal[3]
    ...
    @classmethod
    def FromString(cls, s: bytes) -> UserListAccessStatusEnum: ...
