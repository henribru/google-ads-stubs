...
class UserListDateRuleItemOperatorEnum(google___protobuf___message___Message):
    class UserListDateRuleItemOperator(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['EQUALS'],typing_extensions___Literal['NOT_EQUALS'],typing_extensions___Literal['BEFORE'],typing_extensions___Literal['AFTER']]
        ...
        EQUALS: typing_extensions___Literal[2]
        NOT_EQUALS: typing_extensions___Literal[3]
        BEFORE: typing_extensions___Literal[4]
        AFTER: typing_extensions___Literal[5]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    EQUALS: typing_extensions___Literal[2]
    NOT_EQUALS: typing_extensions___Literal[3]
