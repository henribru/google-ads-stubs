...
class VanityPharmaDisplayUrlModeEnum(google___protobuf___message___Message):
    class VanityPharmaDisplayUrlMode(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['MANUFACTURER_WEBSITE_URL'],typing_extensions___Literal['WEBSITE_DESCRIPTION']]
        ...
        MANUFACTURER_WEBSITE_URL: typing_extensions___Literal[2]
        WEBSITE_DESCRIPTION: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    MANUFACTURER_WEBSITE_URL: typing_extensions___Literal[2]
    WEBSITE_DESCRIPTION: typing_extensions___Literal[3]
