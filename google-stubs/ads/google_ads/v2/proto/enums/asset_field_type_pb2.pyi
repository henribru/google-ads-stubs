...
class AssetFieldTypeEnum(google___protobuf___message___Message):
    class AssetFieldType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['HEADLINE'],typing_extensions___Literal['DESCRIPTION'],typing_extensions___Literal['MANDATORY_AD_TEXT'],typing_extensions___Literal['MARKETING_IMAGE'],typing_extensions___Literal['MEDIA_BUNDLE'],typing_extensions___Literal['YOUTUBE_VIDEO']]
        ...
        HEADLINE: typing_extensions___Literal[2]
        DESCRIPTION: typing_extensions___Literal[3]
        MANDATORY_AD_TEXT: typing_extensions___Literal[4]
        MARKETING_IMAGE: typing_extensions___Literal[5]
        MEDIA_BUNDLE: typing_extensions___Literal[6]
        YOUTUBE_VIDEO: typing_extensions___Literal[7]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    HEADLINE: typing_extensions___Literal[2]
    DESCRIPTION: typing_extensions___Literal[3]
