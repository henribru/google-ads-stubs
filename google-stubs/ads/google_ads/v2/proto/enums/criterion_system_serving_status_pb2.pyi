...
class CriterionSystemServingStatusEnum(google___protobuf___message___Message):
    class CriterionSystemServingStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ELIGIBLE'],typing_extensions___Literal['RARELY_SERVED']]
        ...
        ELIGIBLE: typing_extensions___Literal[2]
        RARELY_SERVED: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ELIGIBLE: typing_extensions___Literal[2]
    RARELY_SERVED: typing_extensions___Literal[3]
