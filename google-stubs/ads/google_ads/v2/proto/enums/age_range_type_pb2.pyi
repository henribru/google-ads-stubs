...
class AgeRangeTypeEnum(google___protobuf___message___Message):
    ...
    class AgeRangeType(builtin___int):
        ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'AgeRangeTypeEnum.AgeRangeType']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> AgeRangeTypeEnum: ...
