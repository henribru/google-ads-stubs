...
class BillingSetupStatusEnum(google___protobuf___message___Message):
    class BillingSetupStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['PENDING'],typing_extensions___Literal['APPROVED_HELD'],typing_extensions___Literal['APPROVED'],typing_extensions___Literal['CANCELLED']]
