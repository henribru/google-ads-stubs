...
class SearchEngineResultsPageTypeEnum(google___protobuf___message___Message):
    class SearchEngineResultsPageType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ADS_ONLY'],typing_extensions___Literal['ORGANIC_ONLY'],typing_extensions___Literal['ADS_AND_ORGANIC']]
        ...
        ADS_ONLY: typing_extensions___Literal[2]
        ORGANIC_ONLY: typing_extensions___Literal[3]
        ADS_AND_ORGANIC: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ADS_ONLY: typing_extensions___Literal[2]
    ORGANIC_ONLY: typing_extensions___Literal[3]
