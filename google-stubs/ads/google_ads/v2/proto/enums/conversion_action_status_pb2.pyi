...
class ConversionActionStatusEnum(google___protobuf___message___Message):
    ...
    class ConversionActionStatus(int):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
        @classmethod
        def Name(cls, number: int) -> str: ...
        @classmethod
        def Value(cls, name: str) -> ConversionActionStatusEnum.ConversionActionStatus: ...
        @classmethod
        def keys(cls) -> typing___List[str]: ...
        @classmethod
        def values(cls) -> typing___List[ConversionActionStatusEnum.ConversionActionStatus]: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[str, ConversionActionStatusEnum.ConversionActionStatus]]: ...
