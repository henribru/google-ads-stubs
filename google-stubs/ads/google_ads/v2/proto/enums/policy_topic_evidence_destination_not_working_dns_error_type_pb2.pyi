...
class PolicyTopicEvidenceDestinationNotWorkingDnsErrorTypeEnum(google___protobuf___message___Message):
    class PolicyTopicEvidenceDestinationNotWorkingDnsErrorType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['HOSTNAME_NOT_FOUND'],typing_extensions___Literal['GOOGLE_CRAWLER_DNS_ISSUE']]
        ...
        HOSTNAME_NOT_FOUND: typing_extensions___Literal[2]
        GOOGLE_CRAWLER_DNS_ISSUE: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    HOSTNAME_NOT_FOUND: typing_extensions___Literal[2]
    GOOGLE_CRAWLER_DNS_ISSUE: typing_extensions___Literal[3]
