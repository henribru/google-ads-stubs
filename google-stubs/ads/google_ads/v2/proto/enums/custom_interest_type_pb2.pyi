...
class CustomInterestTypeEnum(google___protobuf___message___Message):
    class CustomInterestType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CUSTOM_AFFINITY'],typing_extensions___Literal['CUSTOM_INTENT']]
        ...
        CUSTOM_AFFINITY: typing_extensions___Literal[2]
        CUSTOM_INTENT: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CUSTOM_AFFINITY: typing_extensions___Literal[2]
    CUSTOM_INTENT: typing_extensions___Literal[3]
