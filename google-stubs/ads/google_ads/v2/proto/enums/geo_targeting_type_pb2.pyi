...
class GeoTargetingTypeEnum(google___protobuf___message___Message):
    class GeoTargetingType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['AREA_OF_INTEREST'],typing_extensions___Literal['LOCATION_OF_PRESENCE']]
        ...
        AREA_OF_INTEREST: typing_extensions___Literal[2]
        LOCATION_OF_PRESENCE: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    AREA_OF_INTEREST: typing_extensions___Literal[2]
    LOCATION_OF_PRESENCE: typing_extensions___Literal[3]
