...
class CustomInterestMemberTypeEnum(google___protobuf___message___Message):
    class CustomInterestMemberType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['KEYWORD'],typing_extensions___Literal['URL']]
        ...
        URL: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    KEYWORD: typing_extensions___Literal[2]
    URL: typing_extensions___Literal[3]
