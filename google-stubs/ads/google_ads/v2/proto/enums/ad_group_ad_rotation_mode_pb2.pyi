...
class AdGroupAdRotationModeEnum(google___protobuf___message___Message):
    ...
    class AdGroupAdRotationMode(builtin___int):
        ...
        def values(
            cls,
        ) -> typing___List["AdGroupAdRotationModeEnum.AdGroupAdRotationMode"]: ...
        @classmethod
        def items(
            cls,
        ) -> typing___List[
            typing___Tuple[
                builtin___str, "AdGroupAdRotationModeEnum.AdGroupAdRotationMode"
            ]
        ]: ...
        UNSPECIFIED = typing___cast(
            "AdGroupAdRotationModeEnum.AdGroupAdRotationMode", 0
        )
        ...
        ROTATE_FOREVER = typing___cast(
            "AdGroupAdRotationModeEnum.AdGroupAdRotationMode", 3
        )
