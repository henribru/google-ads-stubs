...
class PriceExtensionPriceQualifierEnum(google___protobuf___message___Message):
    class PriceExtensionPriceQualifier(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['FROM'],typing_extensions___Literal['UP_TO'],typing_extensions___Literal['AVERAGE']]
        ...
        FROM: typing_extensions___Literal[2]
        UP_TO: typing_extensions___Literal[3]
        AVERAGE: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    FROM: typing_extensions___Literal[2]
    UP_TO: typing_extensions___Literal[3]
