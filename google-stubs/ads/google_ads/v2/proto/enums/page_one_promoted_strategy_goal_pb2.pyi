...
class PageOnePromotedStrategyGoalEnum(google___protobuf___message___Message):
    class PageOnePromotedStrategyGoal(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['FIRST_PAGE'],typing_extensions___Literal['FIRST_PAGE_PROMOTED']]
        ...
        FIRST_PAGE: typing_extensions___Literal[2]
        FIRST_PAGE_PROMOTED: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    FIRST_PAGE: typing_extensions___Literal[2]
    FIRST_PAGE_PROMOTED: typing_extensions___Literal[3]
