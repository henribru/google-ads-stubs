...
class ProximityRadiusUnitsEnum(google___protobuf___message___Message):
    class ProximityRadiusUnits(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['MILES'],typing_extensions___Literal['KILOMETERS']]
        ...
        MILES: typing_extensions___Literal[2]
        KILOMETERS: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    MILES: typing_extensions___Literal[2]
    KILOMETERS: typing_extensions___Literal[3]
