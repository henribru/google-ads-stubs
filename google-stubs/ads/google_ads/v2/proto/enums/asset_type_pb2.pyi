...
class AssetTypeEnum(google___protobuf___message___Message):
    class AssetType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['YOUTUBE_VIDEO'],typing_extensions___Literal['MEDIA_BUNDLE'],typing_extensions___Literal['IMAGE'],typing_extensions___Literal['TEXT']]
        ...
        YOUTUBE_VIDEO: typing_extensions___Literal[2]
        MEDIA_BUNDLE: typing_extensions___Literal[3]
        IMAGE: typing_extensions___Literal[4]
        TEXT: typing_extensions___Literal[5]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    YOUTUBE_VIDEO: typing_extensions___Literal[2]
    MEDIA_BUNDLE: typing_extensions___Literal[3]
