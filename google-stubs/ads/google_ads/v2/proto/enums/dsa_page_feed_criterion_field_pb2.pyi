...
class DsaPageFeedCriterionFieldEnum(google___protobuf___message___Message):
    class DsaPageFeedCriterionField(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['PAGE_URL'],typing_extensions___Literal['LABEL']]
        ...
        PAGE_URL: typing_extensions___Literal[2]
        LABEL: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    PAGE_URL: typing_extensions___Literal[2]
    LABEL: typing_extensions___Literal[3]
