...
class FrequencyCapEventTypeEnum(google___protobuf___message___Message):
    class FrequencyCapEventType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['IMPRESSION'],typing_extensions___Literal['VIDEO_VIEW']]
        ...
        VIDEO_VIEW: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    IMPRESSION: typing_extensions___Literal[2]
    VIDEO_VIEW: typing_extensions___Literal[3]
