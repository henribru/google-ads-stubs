...
class MutateJobStatusEnum(google___protobuf___message___Message):
    class MutateJobStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['PENDING'],typing_extensions___Literal['RUNNING'],typing_extensions___Literal['DONE']]
        ...
        RUNNING: typing_extensions___Literal[3]
        DONE: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    PENDING: typing_extensions___Literal[2]
    RUNNING: typing_extensions___Literal[3]
