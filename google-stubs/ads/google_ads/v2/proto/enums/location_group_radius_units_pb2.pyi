...
class LocationGroupRadiusUnitsEnum(google___protobuf___message___Message):
    class LocationGroupRadiusUnits(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['METERS'],typing_extensions___Literal['MILES']]
        ...
        METERS: typing_extensions___Literal[2]
        MILES: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    METERS: typing_extensions___Literal[2]
    MILES: typing_extensions___Literal[3]
