...
class AffiliateLocationFeedRelationshipTypeEnum(google___protobuf___message___Message):
    class AffiliateLocationFeedRelationshipType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['GENERAL_RETAILER']]
        ...
        GENERAL_RETAILER: typing_extensions___Literal[2]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    GENERAL_RETAILER: typing_extensions___Literal[2]
