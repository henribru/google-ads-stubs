...
class UserListPrepopulationStatusEnum(google___protobuf___message___Message):
    class UserListPrepopulationStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['REQUESTED'],typing_extensions___Literal['FINISHED'],typing_extensions___Literal['FAILED']]
        ...
        REQUESTED: typing_extensions___Literal[2]
        FINISHED: typing_extensions___Literal[3]
        FAILED: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    REQUESTED: typing_extensions___Literal[2]
    FINISHED: typing_extensions___Literal[3]
