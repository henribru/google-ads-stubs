...
class StructuredSnippetPlaceholderFieldEnum(google___protobuf___message___Message):
    class StructuredSnippetPlaceholderField(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['HEADER'],typing_extensions___Literal['SNIPPETS']]
        ...
        HEADER: typing_extensions___Literal[2]
        SNIPPETS: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    HEADER: typing_extensions___Literal[2]
    SNIPPETS: typing_extensions___Literal[3]
