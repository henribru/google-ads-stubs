...
class ContentLabelTypeEnum(google___protobuf___message___Message):
    ...
    class ContentLabelType(builtin___int):
        ...
        @classmethod
        def Value(cls, name: builtin___str) -> 'ContentLabelTypeEnum.ContentLabelType': ...
        @classmethod
        def keys(cls) -> typing___List[builtin___str]: ...
        @classmethod
        def values(cls) -> typing___List['ContentLabelTypeEnum.ContentLabelType']: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'ContentLabelTypeEnum.ContentLabelType']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> ContentLabelTypeEnum: ...
