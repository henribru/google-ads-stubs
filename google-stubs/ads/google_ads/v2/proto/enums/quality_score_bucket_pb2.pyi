...
class QualityScoreBucketEnum(google___protobuf___message___Message):
    class QualityScoreBucket(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['BELOW_AVERAGE'],typing_extensions___Literal['AVERAGE'],typing_extensions___Literal['ABOVE_AVERAGE']]
        ...
        BELOW_AVERAGE: typing_extensions___Literal[2]
        AVERAGE: typing_extensions___Literal[3]
        ABOVE_AVERAGE: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    BELOW_AVERAGE: typing_extensions___Literal[2]
    AVERAGE: typing_extensions___Literal[3]
    ...
    @classmethod
    def FromString(cls, s: bytes) -> QualityScoreBucketEnum: ...
