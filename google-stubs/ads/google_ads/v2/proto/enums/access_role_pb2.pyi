...
class AccessRoleEnum(google___protobuf___message___Message):
    class AccessRole(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ADMIN'],typing_extensions___Literal['STANDARD'],typing_extensions___Literal['READ_ONLY']]
        ...
        ADMIN: typing_extensions___Literal[2]
        STANDARD: typing_extensions___Literal[3]
        READ_ONLY: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ADMIN: typing_extensions___Literal[2]
    STANDARD: typing_extensions___Literal[3]
