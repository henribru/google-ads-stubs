...
class UserListLogicalRuleOperatorEnum(google___protobuf___message___Message):
    class UserListLogicalRuleOperator(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ALL'],typing_extensions___Literal['ANY'],typing_extensions___Literal['NONE']]
        ...
        ALL: typing_extensions___Literal[2]
        ANY: typing_extensions___Literal[3]
        NONE: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ALL: typing_extensions___Literal[2]
    ANY: typing_extensions___Literal[3]
