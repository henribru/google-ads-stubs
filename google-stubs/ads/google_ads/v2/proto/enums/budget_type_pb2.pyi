...
class BudgetTypeEnum(google___protobuf___message___Message):
    class BudgetType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['STANDARD'],typing_extensions___Literal['HOTEL_ADS_COMMISSION'],typing_extensions___Literal['FIXED_CPA']]
        ...
        HOTEL_ADS_COMMISSION: typing_extensions___Literal[3]
        FIXED_CPA: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    STANDARD: typing_extensions___Literal[2]
    HOTEL_ADS_COMMISSION: typing_extensions___Literal[3]
