...
class TrackingCodeTypeEnum(google___protobuf___message___Message):
    class TrackingCodeType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['WEBPAGE'],typing_extensions___Literal['WEBPAGE_ONCLICK'],typing_extensions___Literal['CLICK_TO_CALL'],typing_extensions___Literal['WEBSITE_CALL']]
        ...
        WEBSITE_CALL: typing_extensions___Literal[5]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    WEBPAGE: typing_extensions___Literal[2]
    WEBPAGE_ONCLICK: typing_extensions___Literal[3]
