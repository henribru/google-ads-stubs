...
class ExtensionSettingDeviceEnum(google___protobuf___message___Message):
    ...
    class ExtensionSettingDevice(int):
        DESCRIPTOR: google___protobuf___descriptor___EnumDescriptor = ...
        @classmethod
        def Name(cls, number: int) -> str: ...
        @classmethod
        def Value(cls, name: str) -> ExtensionSettingDeviceEnum.ExtensionSettingDevice: ...
        @classmethod
        def keys(cls) -> typing___List[str]: ...
        @classmethod
        def values(cls) -> typing___List[ExtensionSettingDeviceEnum.ExtensionSettingDevice]: ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[str, ExtensionSettingDeviceEnum.ExtensionSettingDevice]]: ...
