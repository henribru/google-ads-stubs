...
class UserListCombinedRuleOperatorEnum(google___protobuf___message___Message):
    class UserListCombinedRuleOperator(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['AND'],typing_extensions___Literal['AND_NOT']]
        ...
        AND: typing_extensions___Literal[2]
        AND_NOT: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    AND: typing_extensions___Literal[2]
    AND_NOT: typing_extensions___Literal[3]
