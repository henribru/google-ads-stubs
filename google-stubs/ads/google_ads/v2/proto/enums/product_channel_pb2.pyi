...
class ProductChannelEnum(google___protobuf___message___Message):
    class ProductChannel(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ONLINE'],typing_extensions___Literal['LOCAL']]
        ...
        ONLINE: typing_extensions___Literal[2]
        LOCAL: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ONLINE: typing_extensions___Literal[2]
    LOCAL: typing_extensions___Literal[3]
