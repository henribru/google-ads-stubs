...
class DisplayAdFormatSettingEnum(google___protobuf___message___Message):
    class DisplayAdFormatSetting(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ALL_FORMATS'],typing_extensions___Literal['NON_NATIVE'],typing_extensions___Literal['NATIVE']]
        ...
        ALL_FORMATS: typing_extensions___Literal[2]
        NON_NATIVE: typing_extensions___Literal[3]
        NATIVE: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ALL_FORMATS: typing_extensions___Literal[2]
    NON_NATIVE: typing_extensions___Literal[3]
