...
class CampaignServingStatusEnum(google___protobuf___message___Message):
    class CampaignServingStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['SERVING'],typing_extensions___Literal['NONE'],typing_extensions___Literal['ENDED'],typing_extensions___Literal['PENDING'],typing_extensions___Literal['SUSPENDED']]
        ...
        SERVING: typing_extensions___Literal[2]
        NONE: typing_extensions___Literal[3]
        ENDED: typing_extensions___Literal[4]
        PENDING: typing_extensions___Literal[5]
        SUSPENDED: typing_extensions___Literal[6]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    SERVING: typing_extensions___Literal[2]
    NONE: typing_extensions___Literal[3]
