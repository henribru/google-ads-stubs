...
class AccountBudgetProposalStatusEnum(google___protobuf___message___Message):
    class AccountBudgetProposalStatus(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['PENDING'],typing_extensions___Literal['APPROVED_HELD'],typing_extensions___Literal['APPROVED'],typing_extensions___Literal['CANCELLED'],typing_extensions___Literal['REJECTED']]
        ...
        APPROVED_HELD: typing_extensions___Literal[3]
        APPROVED: typing_extensions___Literal[4]
        CANCELLED: typing_extensions___Literal[5]
        REJECTED: typing_extensions___Literal[6]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    PENDING: typing_extensions___Literal[2]
    APPROVED_HELD: typing_extensions___Literal[3]
