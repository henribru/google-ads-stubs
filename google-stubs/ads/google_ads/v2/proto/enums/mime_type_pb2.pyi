...
class MimeTypeEnum(google___protobuf___message___Message):
    ...
    class MimeType(builtin___int):
        ...
        @classmethod
        def items(cls) -> typing___List[typing___Tuple[builtin___str, 'MimeTypeEnum.MimeType']]: ...
    ...
    if sys.version_info >= (3,):
        ...
        @classmethod
        def FromString(cls, s: typing___Union[builtin___bytes, builtin___buffer, builtin___unicode]) -> MimeTypeEnum: ...
