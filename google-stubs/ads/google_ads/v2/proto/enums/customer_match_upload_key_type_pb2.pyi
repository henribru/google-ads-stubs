...
class CustomerMatchUploadKeyTypeEnum(google___protobuf___message___Message):
    class CustomerMatchUploadKeyType(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['CONTACT_INFO'],typing_extensions___Literal['CRM_ID'],typing_extensions___Literal['MOBILE_ADVERTISING_ID']]
        ...
        CONTACT_INFO: typing_extensions___Literal[2]
        CRM_ID: typing_extensions___Literal[3]
        MOBILE_ADVERTISING_ID: typing_extensions___Literal[4]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    CONTACT_INFO: typing_extensions___Literal[2]
    CRM_ID: typing_extensions___Literal[3]
