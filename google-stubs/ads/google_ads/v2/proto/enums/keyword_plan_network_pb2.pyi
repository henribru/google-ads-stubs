...
class KeywordPlanNetworkEnum(google___protobuf___message___Message):
    class KeywordPlanNetwork(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['GOOGLE_SEARCH'],typing_extensions___Literal['GOOGLE_SEARCH_AND_PARTNERS']]
        ...
        GOOGLE_SEARCH: typing_extensions___Literal[2]
        GOOGLE_SEARCH_AND_PARTNERS: typing_extensions___Literal[3]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    GOOGLE_SEARCH: typing_extensions___Literal[2]
    GOOGLE_SEARCH_AND_PARTNERS: typing_extensions___Literal[3]
