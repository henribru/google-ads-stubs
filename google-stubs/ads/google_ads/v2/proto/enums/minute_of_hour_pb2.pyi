...
class MinuteOfHourEnum(google___protobuf___message___Message):
    class MinuteOfHour(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['ZERO'],typing_extensions___Literal['FIFTEEN'],typing_extensions___Literal['THIRTY'],typing_extensions___Literal['FORTY_FIVE']]
        ...
        ZERO: typing_extensions___Literal[2]
        FIFTEEN: typing_extensions___Literal[3]
        THIRTY: typing_extensions___Literal[4]
        FORTY_FIVE: typing_extensions___Literal[5]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    ZERO: typing_extensions___Literal[2]
    FIFTEEN: typing_extensions___Literal[3]
