...
class AccessReasonEnum(google___protobuf___message___Message):
    class AccessReason(object):
        ClosedKeyType = typing___Union[typing_extensions___Literal['UNSPECIFIED'],typing_extensions___Literal['UNKNOWN'],typing_extensions___Literal['OWNED'],typing_extensions___Literal['SHARED'],typing_extensions___Literal['LICENSED'],typing_extensions___Literal['SUBSCRIBED'],typing_extensions___Literal['AFFILIATED']]
        ...
        OWNED: typing_extensions___Literal[2]
        SHARED: typing_extensions___Literal[3]
        LICENSED: typing_extensions___Literal[4]
        SUBSCRIBED: typing_extensions___Literal[5]
        AFFILIATED: typing_extensions___Literal[6]
    UNSPECIFIED: typing_extensions___Literal[0]
    UNKNOWN: typing_extensions___Literal[1]
    OWNED: typing_extensions___Literal[2]
    SHARED: typing_extensions___Literal[3]
