...
from google.ads.google_ads.v2.services.transports.hotel_group_view_service_grpc_transport import HotelGroupViewServiceGrpcTransport
...
class HotelGroupViewServiceClient:
    ...
    def __init__(self, transport: Optional[Union[HotelGroupViewServiceGrpcTransport, Callable[[Credentials, type], HotelGroupViewServiceGrpcTransport]]] = ..., channel: Optional[grpc.Channel] = ..., credentials: Optional[Credentials] = ..., client_config: Optional[Dict[Any, Any]] = ..., client_info: Optional[ClientInfo] = ...) -> None: ...
