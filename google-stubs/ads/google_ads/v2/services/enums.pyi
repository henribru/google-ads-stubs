...
class AccessInvitationErrorEnumEnum:
...
class AdCustomizerFeedErrorEnum:
...
class CustomerNegativeCriterionErrorEnum:
    class CustomerNegativeCriterionError(enum.IntEnum):
        UNSPECIFIED: int = ...
        UNKNOWN: int = ...
        SHARED_SET_IS_REMOVED: int = ...
        INVALID_SHARED_SET_TYPE: int = ...
        MANAGER_CUSTOMER_CANNOT_CREATE: int = ...
...
class ListOperationErrorEnum:
    class ListOperationError(enum.IntEnum):
        UNSPECIFIED: int = ...
        UNKNOWN: int = ...
        OPERATOR_MISSING: int = ...
        ADD_OPERATOR_EXPECTED_IN_CREATE: int = ...
        CLEAR_WITH_VALUE_SPECIFIED: int = ...
        CLEAR_AFTER_OTHER_OPERATIONS: int = ...
        VALUE_IS_MISSING: int = ...
        REQUIRED_FIELD_MISSING: int = ...
        DUPLICATE_VALUES: int = ...
        LIST_AND_LIST_OPERATIONS_USED_TOGETHER: int = ...
        REMOVE_WITH_VALUE_SPECIFIED: int = ...
...
class MerchantCenterLinkErrorEnum:
    class MerchantCenterLinkError(enum.IntEnum):
        UNSPECIFIED: int = ...
        UNKNOWN: int = ...
        CANNOT_DOWNGRADE_LINK_TO_PENDING: int = ...
...
class OfflineUserDataJobErrorEnum:
    class OfflineUserDataJobError(enum.IntEnum):
        UNSPECIFIED: int = ...
        UNKNOWN: int = ...
        ID_AND_EXTERNAL_ID_NOT_ALLOWED: int = ...
        ...
        MULTIPLE_UPLOADS_NOT_ALLOWED_PER_USER_LIST: int = ...
...
class SettingErrorEnum:
    class SettingError(enum.IntEnum):
        ...
        UNIVERSAL_APP_CAMPAIGN_SETTING_DUPLICATE_DESCRIPTION: int = ...
        UNIVERSAL_APP_CAMPAIGN_SETTING_DESCRIPTION_LINE_WIDTH_TOO_LONG: int = ...
        UNIVERSAL_APP_CAMPAIGN_SETTING_APP_ID_CANNOT_BE_MODIFIED: int = ...
        TOO_MANY_YOUTUBE_MEDIA_IDS_IN_UNIVERSAL_APP_CAMPAIGN: int = ...
        TOO_MANY_IMAGE_MEDIA_IDS_IN_UNIVERSAL_APP_CAMPAIGN: int = ...
        MEDIA_INCOMPATIBLE_FOR_UNIVERSAL_APP_CAMPAIGN: int = ...
        TOO_MANY_EXCLAMATION_MARKS: int = ...
