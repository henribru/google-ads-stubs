...
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from google.ads.googleads.v19.enums.types.ad_group_ad_primary_status_reason import AdGroupAdPrimaryStatusReasonEnum
from google.ads.googleads.v19.enums.types.ad_group_ad_primary_status import AdGroupAdPrimaryStatusEnum
from collections.abc import MutableSequence
from collections.abc import MutableSequence
...
class AdGroupAd(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., resource_name: str = ..., status: AdGroupAdStatusEnum.AdGroupAdStatus = ..., ad_group: str = ..., ad: Ad = ..., policy_summary: AdGroupAdPolicySummary = ..., ad_strength: AdStrengthEnum.AdStrength = ..., action_items: MutableSequence[str] = ..., labels: MutableSequence[str] = ..., primary_status: AdGroupAdPrimaryStatusEnum.AdGroupAdPrimaryStatus = ..., primary_status_reasons: MutableSequence[AdGroupAdPrimaryStatusReasonEnum.AdGroupAdPrimaryStatusReason] = ..., ad_group_ad_asset_automation_settings: MutableSequence[AdGroupAdAssetAutomationSetting] = ...) -> None: ...
