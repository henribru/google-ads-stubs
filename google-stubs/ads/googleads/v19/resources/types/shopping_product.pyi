...
from google.ads.googleads.v19.enums.types.product_status import ProductStatusEnum
from collections.abc import MutableSequence
from google.ads.googleads.v19.enums.types.product_availability import ProductAvailabilityEnum
...
from collections.abc import MutableSequence
from google.ads.googleads.v19.enums.types.product_issue_severity import ProductIssueSeverityEnum
import proto
...
class ShoppingProduct(proto.Message):
    class ProductIssue(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., error_code: str = ..., ads_severity: ProductIssueSeverityEnum.ProductIssueSeverity = ..., attribute_name: str = ..., description: str = ..., detail: str = ..., documentation: str = ..., affected_regions: MutableSequence[str] = ...) -> None: ...
