...
from google.ads.googleads.v19.enums.types.ad_group_primary_status_reason import AdGroupPrimaryStatusReasonEnum
from google.ads.googleads.v19.enums.types.ad_group_primary_status import AdGroupPrimaryStatusEnum
from collections.abc import MutableSequence
...
from google.ads.googleads.v19.enums.types.targeting_dimension import TargetingDimensionEnum
from collections.abc import MutableSequence
from google.ads.googleads.v19.common.types.custom_parameter import CustomParameter
from google.ads.googleads.v19.enums.types.ad_group_ad_rotation_mode import AdGroupAdRotationModeEnum
...
from google.ads.googleads.v19.enums.types.demand_gen_channel_strategy import DemandGenChannelStrategyEnum
from google.ads.googleads.v19.enums.types.demand_gen_channel_config import DemandGenChannelConfigEnum
import proto
    ...
    class DemandGenAdGroupSettings(proto.Message):
        class DemandGenChannelControls(proto.Message):
            class DemandGenSelectedChannels(proto.Message):
                ...
                gmail: bool
                display: bool
                def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., youtube_in_stream: bool = ..., youtube_in_feed: bool = ..., youtube_shorts: bool = ..., discover: bool = ..., gmail: bool = ..., display: bool = ...) -> None: ...
                def __contains__(  # type: ignore[override]
            ...
            def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., channel_config: DemandGenChannelConfigEnum.DemandGenChannelConfig = ..., channel_strategy: DemandGenChannelStrategyEnum.DemandGenChannelStrategy = ..., selected_channels: AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls.DemandGenSelectedChannels = ...) -> None: ...
            def __contains__(  # type: ignore[override]
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., channel_controls: AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls = ...) -> None: ...
        def __contains__(  # type: ignore[override]
