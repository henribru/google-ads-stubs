...
from google.ads.googleads.v19.enums.types import interaction_event_type, quality_score_bucket
...
class Metrics(proto.Message):
    ...
    historical_creative_quality_score: quality_score_bucket.QualityScoreBucketEnum.QualityScoreBucket
    historical_landing_page_quality_score: quality_score_bucket.QualityScoreBucketEnum.QualityScoreBucket
    historical_quality_score: int
    historical_search_predicted_ctr: quality_score_bucket.QualityScoreBucketEnum.QualityScoreBucket
    gmail_forwards: int
    gmail_saves: int
    ...
    interactions: int
    interaction_event_types: MutableSequence[interaction_event_type.InteractionEventTypeEnum.InteractionEventType]
