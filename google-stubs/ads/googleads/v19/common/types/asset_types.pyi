...
from google.ads.googleads.v19.common.types.feed_common import Money
from google.ads.googleads.v19.common.types.feed_common import Money
from collections.abc import MutableSequence
from google.ads.googleads.v19.common.types.criteria import AdScheduleInfo
from google.ads.googleads.v19.enums.types.promotion_extension_occasion import PromotionExtensionOccasionEnum
from google.ads.googleads.v19.enums.types.promotion_extension_discount_modifier import PromotionExtensionDiscountModifierEnum
...
from collections.abc import MutableSequence
from google.ads.googleads.v19.enums.types.mobile_app_vendor import MobileAppVendorEnum
from google.ads.googleads.v19.enums.types.location_ownership_type import LocationOwnershipTypeEnum
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from google.ads.googleads.v19.enums.types.lead_form_field_user_input_type import LeadFormFieldUserInputTypeEnum
from google.ads.googleads.v19.enums.types.lead_form_desired_intent import LeadFormDesiredIntentEnum
...
from collections.abc import MutableSequence
from google.ads.googleads.v19.common.types.criteria import AdScheduleInfo
from google.ads.googleads.v19.enums.types.call_to_action_type import CallToActionTypeEnum
from collections.abc import MutableSequence
from google.ads.googleads.v19.common.types.criteria import AdScheduleInfo
from google.ads.googleads.v19.enums.types.call_conversion_reporting_state import CallConversionReportingStateEnum
from collections.abc import MutableSequence
from google.ads.googleads.v19.enums.types.business_message_call_to_action_type import BusinessMessageCallToActionTypeEnum
from google.ads.googleads.v19.enums.types.business_message_provider import BusinessMessageProviderEnum
import proto
...
class AppDeepLinkAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., app_deep_link_uri: str = ...) -> None: ...
...
class BusinessMessageAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., message_provider: BusinessMessageProviderEnum.BusinessMessageProvider = ..., starter_message: str = ..., call_to_action: BusinessMessageCallToActionInfo = ..., whatsapp_info: WhatsappBusinessMessageInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["message_provider", "starter_message", "call_to_action", "whatsapp_info"]) -> bool: ...
class BusinessMessageCallToActionInfo(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., call_to_action_selection: BusinessMessageCallToActionTypeEnum.BusinessMessageCallToActionType = ..., call_to_action_description: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class BusinessProfileLocation(proto.Message):
    ...
    store_code: str
    listing_id: int
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., labels: MutableSequence[str] = ..., store_code: str = ..., listing_id: int = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class CallAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., country_code: str = ..., phone_number: str = ..., call_conversion_reporting_state: CallConversionReportingStateEnum.CallConversionReportingState = ..., call_conversion_action: str = ..., ad_schedule_targets: MutableSequence[AdScheduleInfo] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class CallToActionAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., call_to_action: CallToActionTypeEnum.CallToActionType = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class CalloutAsset(proto.Message):
    ...
    end_date: str
    ad_schedule_targets: MutableSequence[AdScheduleInfo]
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., callout_text: str = ..., start_date: str = ..., end_date: str = ..., ad_schedule_targets: MutableSequence[AdScheduleInfo] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class DemandGenCarouselCardAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., marketing_image_asset: str = ..., square_marketing_image_asset: str = ..., portrait_marketing_image_asset: str = ..., headline: str = ..., call_to_action_text: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class DynamicCustomAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., id: str = ..., id2: str = ..., item_title: str = ..., item_subtitle: str = ..., item_description: str = ..., item_address: str = ..., item_category: str = ..., price: str = ..., sale_price: str = ..., formatted_price: str = ..., formatted_sale_price: str = ..., image_url: str = ..., contextual_keywords: MutableSequence[str] = ..., android_app_link: str = ..., ios_app_link: str = ..., ios_app_store_id: int = ..., similar_ids: MutableSequence[str] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class DynamicFlightsAsset(proto.Message):
    ...
    custom_mapping: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., destination_id: str = ..., origin_id: str = ..., flight_description: str = ..., image_url: str = ..., destination_name: str = ..., origin_name: str = ..., flight_price: str = ..., flight_sale_price: str = ..., formatted_price: str = ..., formatted_sale_price: str = ..., android_app_link: str = ..., ios_app_link: str = ..., ios_app_store_id: int = ..., similar_destination_ids: MutableSequence[str] = ..., custom_mapping: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class DynamicHotelsAndRentalsAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., property_id: str = ..., property_name: str = ..., image_url: str = ..., destination_name: str = ..., description: str = ..., price: str = ..., sale_price: str = ..., star_rating: int = ..., category: str = ..., contextual_keywords: MutableSequence[str] = ..., address: str = ..., android_app_link: str = ..., ios_app_link: str = ..., ios_app_store_id: int = ..., formatted_price: str = ..., formatted_sale_price: str = ..., similar_property_ids: MutableSequence[str] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class DynamicJobsAsset(proto.Message):
    ...
    ios_app_link: str
    ios_app_store_id: int
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., job_id: str = ..., location_id: str = ..., job_title: str = ..., job_subtitle: str = ..., description: str = ..., image_url: str = ..., job_category: str = ..., contextual_keywords: MutableSequence[str] = ..., address: str = ..., salary: str = ..., android_app_link: str = ..., similar_job_ids: MutableSequence[str] = ..., ios_app_link: str = ..., ios_app_store_id: int = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class DynamicLocalAsset(proto.Message):
    ...
    ios_app_link: str
    ios_app_store_id: int
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., deal_id: str = ..., deal_name: str = ..., subtitle: str = ..., description: str = ..., price: str = ..., sale_price: str = ..., image_url: str = ..., address: str = ..., category: str = ..., contextual_keywords: MutableSequence[str] = ..., formatted_price: str = ..., formatted_sale_price: str = ..., android_app_link: str = ..., similar_deal_ids: MutableSequence[str] = ..., ios_app_link: str = ..., ios_app_store_id: int = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class DynamicRealEstateAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., listing_id: str = ..., listing_name: str = ..., city_name: str = ..., description: str = ..., address: str = ..., price: str = ..., image_url: str = ..., property_type: str = ..., listing_type: str = ..., contextual_keywords: MutableSequence[str] = ..., formatted_price: str = ..., android_app_link: str = ..., ios_app_link: str = ..., ios_app_store_id: int = ..., similar_listing_ids: MutableSequence[str] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class DynamicTravelAsset(proto.Message):
    ...
    ios_app_link: str
    ios_app_store_id: int
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., destination_id: str = ..., origin_id: str = ..., title: str = ..., destination_name: str = ..., destination_address: str = ..., origin_name: str = ..., price: str = ..., sale_price: str = ..., formatted_price: str = ..., formatted_sale_price: str = ..., category: str = ..., contextual_keywords: MutableSequence[str] = ..., similar_destination_ids: MutableSequence[str] = ..., image_url: str = ..., android_app_link: str = ..., ios_app_link: str = ..., ios_app_store_id: int = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class HotelCalloutAsset(proto.Message):
    text: str
    language_code: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., text: str = ..., language_code: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class HotelPropertyAsset(proto.Message):
    ...
    hotel_address: str
    hotel_name: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., place_id: str = ..., hotel_address: str = ..., hotel_name: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ImageAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., data: bytes = ..., file_size: int = ..., mime_type: MimeTypeEnum.MimeType = ..., full_size: ImageDimension = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ImageDimension(proto.Message):
    ...
    width_pixels: int
    url: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., height_pixels: int = ..., width_pixels: int = ..., url: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class LeadFormCustomQuestionField(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., custom_question_text: str = ..., single_choice_answers: LeadFormSingleChoiceAnswers = ..., has_location_answer: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class LeadFormDeliveryMethod(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., webhook: WebhookDelivery = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class LeadFormField(proto.Message):
    ...
    single_choice_answers: LeadFormSingleChoiceAnswers
    has_location_answer: bool
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., input_type: LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType = ..., single_choice_answers: LeadFormSingleChoiceAnswers = ..., has_location_answer: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class LeadFormSingleChoiceAnswers(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., answers: MutableSequence[str] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class LocationAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., place_id: str = ..., business_profile_locations: MutableSequence[BusinessProfileLocation] = ..., location_ownership_type: LocationOwnershipTypeEnum.LocationOwnershipType = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["place_id", "business_profile_locations", "location_ownership_type"]) -> bool: ...
class MediaBundleAsset(proto.Message):
    data: bytes
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., data: bytes = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class MobileAppAsset(proto.Message):
    ...
    start_date: str
    end_date: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., app_id: str = ..., app_store: MobileAppVendorEnum.MobileAppVendor = ..., link_text: str = ..., start_date: str = ..., end_date: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["app_id", "app_store", "link_text", "start_date", "end_date"]) -> bool: ...
class PageFeedAsset(proto.Message):
    page_url: str
    labels: MutableSequence[str]
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., page_url: str = ..., labels: MutableSequence[str] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class PriceAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., type_: PriceExtensionTypeEnum.PriceExtensionType = ..., price_qualifier: PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier = ..., language_code: str = ..., price_offerings: MutableSequence[PriceOffering] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class PriceOffering(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., header: str = ..., description: str = ..., price: Money = ..., unit: PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit = ..., final_url: str = ..., final_mobile_url: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class PromotionAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., promotion_target: str = ..., discount_modifier: PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier = ..., redemption_start_date: str = ..., redemption_end_date: str = ..., occasion: PromotionExtensionOccasionEnum.PromotionExtensionOccasion = ..., language_code: str = ..., start_date: str = ..., end_date: str = ..., ad_schedule_targets: MutableSequence[AdScheduleInfo] = ..., percent_off: int = ..., money_amount_off: Money = ..., promotion_code: str = ..., orders_over_amount: Money = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["promotion_target", "discount_modifier", "redemption_start_date", "redemption_end_date", "occasion", "language_code", "start_date", "end_date", "ad_schedule_targets", "percent_off", "money_amount_off", "promotion_code", "orders_over_amount"]) -> bool: ...
class SitelinkAsset(proto.Message):
    ...
    end_date: str
    ad_schedule_targets: MutableSequence[AdScheduleInfo]
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., link_text: str = ..., description1: str = ..., description2: str = ..., start_date: str = ..., end_date: str = ..., ad_schedule_targets: MutableSequence[AdScheduleInfo] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class StructuredSnippetAsset(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., header: str = ..., values: MutableSequence[str] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["header", "values"]) -> bool: ...
class TextAsset(proto.Message):
    text: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., text: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class WebhookDelivery(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., advertiser_webhook_url: str = ..., google_secret: str = ..., payload_schema_version: int = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class WhatsappBusinessMessageInfo(proto.Message):
    country_code: str
    phone_number: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., country_code: str = ..., phone_number: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["country_code", "phone_number"]) -> bool: ...
class YoutubeVideoAsset(proto.Message):
    youtube_video_id: str
    youtube_video_title: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., youtube_video_id: str = ..., youtube_video_title: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
