...
class KeywordPlanCampaignServiceGrpcAsyncIOTransport(KeywordPlanCampaignServiceTransport):
    @classmethod
    ...
    @property
    def mutate_keyword_plan_campaigns(self) -> Callable[[keyword_plan_campaign_service.MutateKeywordPlanCampaignsRequest], Awaitable[keyword_plan_campaign_service.MutateKeywordPlanCampaignsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
