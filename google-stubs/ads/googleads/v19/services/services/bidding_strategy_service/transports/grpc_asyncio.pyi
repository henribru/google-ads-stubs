...
class BiddingStrategyServiceGrpcAsyncIOTransport(BiddingStrategyServiceTransport):
    @classmethod
    ...
    @property
    def mutate_bidding_strategies(self) -> Callable[[bidding_strategy_service.MutateBiddingStrategiesRequest], Awaitable[bidding_strategy_service.MutateBiddingStrategiesResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
