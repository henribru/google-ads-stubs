...
class BiddingStrategyServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_bidding_strategies(self) -> Callable[[bidding_strategy_service.MutateBiddingStrategiesRequest], bidding_strategy_service.MutateBiddingStrategiesResponse | Awaitable[bidding_strategy_service.MutateBiddingStrategiesResponse]]: ...
    @property
    def kind(self) -> str: ...
