...
class AssetGroupServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_asset_groups(self) -> Callable[[asset_group_service.MutateAssetGroupsRequest], asset_group_service.MutateAssetGroupsResponse | Awaitable[asset_group_service.MutateAssetGroupsResponse]]: ...
    @property
    def kind(self) -> str: ...
