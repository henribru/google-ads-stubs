...
from google.ads.googleads.v19.services.types import identity_verification_service
...
class IdentityVerificationServiceGrpcAsyncIOTransport(IdentityVerificationServiceTransport):
    @classmethod
    ...
    @property
    def start_identity_verification(self) -> Callable[[identity_verification_service.StartIdentityVerificationRequest], Awaitable[empty_pb2.Empty]]: ...
    @property
    def get_identity_verification(self) -> Callable[[identity_verification_service.GetIdentityVerificationRequest], Awaitable[identity_verification_service.GetIdentityVerificationResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
