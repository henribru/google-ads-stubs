...
class IdentityVerificationServiceGrpcTransport(IdentityVerificationServiceTransport):
    ...
    @property
    def start_identity_verification(self) -> Callable[[identity_verification_service.StartIdentityVerificationRequest], empty_pb2.Empty]: ...
    @property
    def get_identity_verification(self) -> Callable[[identity_verification_service.GetIdentityVerificationRequest], identity_verification_service.GetIdentityVerificationResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
