...
class CustomerCustomizerServiceAsyncClient:
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CustomerCustomizerServiceTransport | Callable[..., CustomerCustomizerServiceTransport] | None = 'grpc_asyncio', client_options: ClientOptions | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    async def mutate_customer_customizers(self, request: customer_customizer_service.MutateCustomerCustomizersRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[customer_customizer_service.CustomerCustomizerOperation] | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> customer_customizer_service.MutateCustomerCustomizersResponse: ...
