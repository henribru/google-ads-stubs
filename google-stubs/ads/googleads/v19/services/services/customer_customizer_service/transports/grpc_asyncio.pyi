...
class CustomerCustomizerServiceGrpcAsyncIOTransport(CustomerCustomizerServiceTransport):
    @classmethod
    ...
    @property
    def mutate_customer_customizers(self) -> Callable[[customer_customizer_service.MutateCustomerCustomizersRequest], Awaitable[customer_customizer_service.MutateCustomerCustomizersResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
