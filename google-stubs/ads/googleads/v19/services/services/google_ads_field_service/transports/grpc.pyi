...
class GoogleAdsFieldServiceGrpcTransport(GoogleAdsFieldServiceTransport):
    ...
    @property
    def get_google_ads_field(self) -> Callable[[google_ads_field_service.GetGoogleAdsFieldRequest], google_ads_field.GoogleAdsField]: ...
    @property
    def search_google_ads_fields(self) -> Callable[[google_ads_field_service.SearchGoogleAdsFieldsRequest], google_ads_field_service.SearchGoogleAdsFieldsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
