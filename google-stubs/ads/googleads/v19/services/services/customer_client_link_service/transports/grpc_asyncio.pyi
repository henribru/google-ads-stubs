...
class CustomerClientLinkServiceGrpcAsyncIOTransport(CustomerClientLinkServiceTransport):
    @classmethod
    ...
    @property
    def mutate_customer_client_link(self) -> Callable[[customer_client_link_service.MutateCustomerClientLinkRequest], Awaitable[customer_client_link_service.MutateCustomerClientLinkResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
