...
class ThirdPartyAppAnalyticsLinkServiceGrpcTransport(ThirdPartyAppAnalyticsLinkServiceTransport):
    ...
    @property
    def regenerate_shareable_link_id(self) -> Callable[[third_party_app_analytics_link_service.RegenerateShareableLinkIdRequest], third_party_app_analytics_link_service.RegenerateShareableLinkIdResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
