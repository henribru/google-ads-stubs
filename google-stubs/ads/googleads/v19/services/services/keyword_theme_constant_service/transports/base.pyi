...
class KeywordThemeConstantServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def suggest_keyword_theme_constants(self) -> Callable[[keyword_theme_constant_service.SuggestKeywordThemeConstantsRequest], keyword_theme_constant_service.SuggestKeywordThemeConstantsResponse | Awaitable[keyword_theme_constant_service.SuggestKeywordThemeConstantsResponse]]: ...
    @property
    def kind(self) -> str: ...
