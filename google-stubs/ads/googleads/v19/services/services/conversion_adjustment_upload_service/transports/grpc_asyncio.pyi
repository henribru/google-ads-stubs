...
class ConversionAdjustmentUploadServiceGrpcAsyncIOTransport(ConversionAdjustmentUploadServiceTransport):
    @classmethod
    ...
    @property
    def upload_conversion_adjustments(self) -> Callable[[conversion_adjustment_upload_service.UploadConversionAdjustmentsRequest], Awaitable[conversion_adjustment_upload_service.UploadConversionAdjustmentsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
