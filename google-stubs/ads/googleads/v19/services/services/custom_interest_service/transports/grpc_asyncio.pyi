...
class CustomInterestServiceGrpcAsyncIOTransport(CustomInterestServiceTransport):
    ...
    @property
    def mutate_custom_interests(self) -> Callable[[custom_interest_service.MutateCustomInterestsRequest], Awaitable[custom_interest_service.MutateCustomInterestsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
