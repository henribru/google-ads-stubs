...
class DataLinkServiceGrpcTransport(DataLinkServiceTransport):
    ...
    @property
    def create_data_link(self) -> Callable[[data_link_service.CreateDataLinkRequest], data_link_service.CreateDataLinkResponse]: ...
    @property
    def remove_data_link(self) -> Callable[[data_link_service.RemoveDataLinkRequest], data_link_service.RemoveDataLinkResponse]: ...
    @property
    def update_data_link(self) -> Callable[[data_link_service.UpdateDataLinkRequest], data_link_service.UpdateDataLinkResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
