...
class CampaignServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[CampaignServiceTransport]: ...
...
class CampaignServiceClient(metaclass=CampaignServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CampaignServiceTransport | Callable[..., CampaignServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_campaigns(self, request: campaign_service.MutateCampaignsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[campaign_service.CampaignOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> campaign_service.MutateCampaignsResponse: ...
    def enable_p_max_brand_guidelines(self, request: campaign_service.EnablePMaxBrandGuidelinesRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[campaign_service.EnableOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> campaign_service.EnablePMaxBrandGuidelinesResponse: ...
