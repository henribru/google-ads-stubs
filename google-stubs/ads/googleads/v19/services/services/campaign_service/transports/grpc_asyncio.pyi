...
class CampaignServiceGrpcAsyncIOTransport(CampaignServiceTransport):
    ...
    @property
    def enable_p_max_brand_guidelines(self) -> Callable[[campaign_service.EnablePMaxBrandGuidelinesRequest], Awaitable[campaign_service.EnablePMaxBrandGuidelinesResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
