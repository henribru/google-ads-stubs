...
class CampaignCriterionServiceGrpcAsyncIOTransport(CampaignCriterionServiceTransport):
    @classmethod
    ...
    @property
    def mutate_campaign_criteria(self) -> Callable[[campaign_criterion_service.MutateCampaignCriteriaRequest], Awaitable[campaign_criterion_service.MutateCampaignCriteriaResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
