...
class CampaignCriterionServiceAsyncClient:
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CampaignCriterionServiceTransport | Callable[..., CampaignCriterionServiceTransport] | None = 'grpc_asyncio', client_options: ClientOptions | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    async def mutate_campaign_criteria(self, request: campaign_criterion_service.MutateCampaignCriteriaRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[campaign_criterion_service.CampaignCriterionOperation] | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> campaign_criterion_service.MutateCampaignCriteriaResponse: ...
