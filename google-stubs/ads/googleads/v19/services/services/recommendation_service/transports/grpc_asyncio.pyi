...
class RecommendationServiceGrpcAsyncIOTransport(RecommendationServiceTransport):
    ...
    @property
    def apply_recommendation(self) -> Callable[[recommendation_service.ApplyRecommendationRequest], Awaitable[recommendation_service.ApplyRecommendationResponse]]: ...
    @property
    def dismiss_recommendation(self) -> Callable[[recommendation_service.DismissRecommendationRequest], Awaitable[recommendation_service.DismissRecommendationResponse]]: ...
    @property
    def generate_recommendations(self) -> Callable[[recommendation_service.GenerateRecommendationsRequest], Awaitable[recommendation_service.GenerateRecommendationsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
