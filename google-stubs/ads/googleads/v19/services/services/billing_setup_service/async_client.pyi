...
class BillingSetupServiceAsyncClient:
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | BillingSetupServiceTransport | Callable[..., BillingSetupServiceTransport] | None = 'grpc_asyncio', client_options: ClientOptions | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    async def mutate_billing_setup(self, request: billing_setup_service.MutateBillingSetupRequest | dict | None = None, *, customer_id: str | None = None, operation: billing_setup_service.BillingSetupOperation | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> billing_setup_service.MutateBillingSetupResponse: ...
