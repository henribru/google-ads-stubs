...
class KeywordPlanAdGroupServiceGrpcAsyncIOTransport(KeywordPlanAdGroupServiceTransport):
    @classmethod
    ...
    @property
    def mutate_keyword_plan_ad_groups(self) -> Callable[[keyword_plan_ad_group_service.MutateKeywordPlanAdGroupsRequest], Awaitable[keyword_plan_ad_group_service.MutateKeywordPlanAdGroupsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
