...
class ConversionGoalCampaignConfigServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_conversion_goal_campaign_configs(self) -> Callable[[conversion_goal_campaign_config_service.MutateConversionGoalCampaignConfigsRequest], conversion_goal_campaign_config_service.MutateConversionGoalCampaignConfigsResponse | Awaitable[conversion_goal_campaign_config_service.MutateConversionGoalCampaignConfigsResponse]]: ...
    @property
    def kind(self) -> str: ...
