...
class GoogleAdsServiceGrpcTransport(GoogleAdsServiceTransport):
    ...
    @property
    def search(self) -> Callable[[google_ads_service.SearchGoogleAdsRequest], google_ads_service.SearchGoogleAdsResponse]: ...
    @property
    def search_stream(self) -> Callable[[google_ads_service.SearchGoogleAdsStreamRequest], google_ads_service.SearchGoogleAdsStreamResponse]: ...
    @property
    def mutate(self) -> Callable[[google_ads_service.MutateGoogleAdsRequest], google_ads_service.MutateGoogleAdsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
