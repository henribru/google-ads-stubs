...
class CustomerServiceGrpcAsyncIOTransport(CustomerServiceTransport):
    ...
    @property
    def mutate_customer(self) -> Callable[[customer_service.MutateCustomerRequest], Awaitable[customer_service.MutateCustomerResponse]]: ...
    @property
    def list_accessible_customers(self) -> Callable[[customer_service.ListAccessibleCustomersRequest], Awaitable[customer_service.ListAccessibleCustomersResponse]]: ...
    @property
    def create_customer_client(self) -> Callable[[customer_service.CreateCustomerClientRequest], Awaitable[customer_service.CreateCustomerClientResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
