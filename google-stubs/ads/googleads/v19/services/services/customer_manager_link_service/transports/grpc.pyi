...
class CustomerManagerLinkServiceGrpcTransport(CustomerManagerLinkServiceTransport):
    ...
    @property
    def mutate_customer_manager_link(self) -> Callable[[customer_manager_link_service.MutateCustomerManagerLinkRequest], customer_manager_link_service.MutateCustomerManagerLinkResponse]: ...
    @property
    def move_manager_link(self) -> Callable[[customer_manager_link_service.MoveManagerLinkRequest], customer_manager_link_service.MoveManagerLinkResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
