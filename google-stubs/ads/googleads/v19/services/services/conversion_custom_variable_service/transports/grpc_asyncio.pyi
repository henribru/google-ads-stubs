...
class ConversionCustomVariableServiceGrpcAsyncIOTransport(ConversionCustomVariableServiceTransport):
    @classmethod
    ...
    @property
    def mutate_conversion_custom_variables(self) -> Callable[[conversion_custom_variable_service.MutateConversionCustomVariablesRequest], Awaitable[conversion_custom_variable_service.MutateConversionCustomVariablesResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
