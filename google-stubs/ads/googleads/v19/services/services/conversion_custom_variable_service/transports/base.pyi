...
class ConversionCustomVariableServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_conversion_custom_variables(self) -> Callable[[conversion_custom_variable_service.MutateConversionCustomVariablesRequest], conversion_custom_variable_service.MutateConversionCustomVariablesResponse | Awaitable[conversion_custom_variable_service.MutateConversionCustomVariablesResponse]]: ...
    @property
    def kind(self) -> str: ...
