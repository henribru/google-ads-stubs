...
class ConversionCustomVariableServiceGrpcTransport(ConversionCustomVariableServiceTransport):
    ...
    @property
    def mutate_conversion_custom_variables(self) -> Callable[[conversion_custom_variable_service.MutateConversionCustomVariablesRequest], conversion_custom_variable_service.MutateConversionCustomVariablesResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
