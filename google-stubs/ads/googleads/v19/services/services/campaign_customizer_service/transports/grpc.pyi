...
class CampaignCustomizerServiceGrpcTransport(CampaignCustomizerServiceTransport):
    ...
    @property
    def mutate_campaign_customizers(self) -> Callable[[campaign_customizer_service.MutateCampaignCustomizersRequest], campaign_customizer_service.MutateCampaignCustomizersResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
