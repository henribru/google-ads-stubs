...
class KeywordPlanIdeaServiceGrpcTransport(KeywordPlanIdeaServiceTransport):
    ...
    @property
    def generate_keyword_ideas(self) -> Callable[[keyword_plan_idea_service.GenerateKeywordIdeasRequest], keyword_plan_idea_service.GenerateKeywordIdeaResponse]: ...
    @property
    def generate_keyword_historical_metrics(self) -> Callable[[keyword_plan_idea_service.GenerateKeywordHistoricalMetricsRequest], keyword_plan_idea_service.GenerateKeywordHistoricalMetricsResponse]: ...
    @property
    def generate_ad_group_themes(self) -> Callable[[keyword_plan_idea_service.GenerateAdGroupThemesRequest], keyword_plan_idea_service.GenerateAdGroupThemesResponse]: ...
    @property
    def generate_keyword_forecast_metrics(self) -> Callable[[keyword_plan_idea_service.GenerateKeywordForecastMetricsRequest], keyword_plan_idea_service.GenerateKeywordForecastMetricsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
