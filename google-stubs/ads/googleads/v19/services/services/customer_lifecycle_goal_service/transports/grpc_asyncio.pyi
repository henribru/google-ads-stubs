...
class CustomerLifecycleGoalServiceGrpcAsyncIOTransport(CustomerLifecycleGoalServiceTransport):
    @classmethod
    ...
    @property
    def configure_customer_lifecycle_goals(self) -> Callable[[customer_lifecycle_goal_service.ConfigureCustomerLifecycleGoalsRequest], Awaitable[customer_lifecycle_goal_service.ConfigureCustomerLifecycleGoalsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
