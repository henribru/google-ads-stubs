...
class CustomizerAttributeServiceGrpcAsyncIOTransport(CustomizerAttributeServiceTransport):
    @classmethod
    ...
    @property
    def mutate_customizer_attributes(self) -> Callable[[customizer_attribute_service.MutateCustomizerAttributesRequest], Awaitable[customizer_attribute_service.MutateCustomizerAttributesResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
