...
class RemarketingActionServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[RemarketingActionServiceTransport]: ...
...
class RemarketingActionServiceClient(metaclass=RemarketingActionServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | RemarketingActionServiceTransport | Callable[..., RemarketingActionServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_remarketing_actions(self, request: remarketing_action_service.MutateRemarketingActionsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[remarketing_action_service.RemarketingActionOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> remarketing_action_service.MutateRemarketingActionsResponse: ...
