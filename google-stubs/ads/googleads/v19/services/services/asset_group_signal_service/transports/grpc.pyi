...
class AssetGroupSignalServiceGrpcTransport(AssetGroupSignalServiceTransport):
    ...
    @property
    def mutate_asset_group_signals(self) -> Callable[[asset_group_signal_service.MutateAssetGroupSignalsRequest], asset_group_signal_service.MutateAssetGroupSignalsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
