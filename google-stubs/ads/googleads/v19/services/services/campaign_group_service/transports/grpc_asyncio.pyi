...
class CampaignGroupServiceGrpcAsyncIOTransport(CampaignGroupServiceTransport):
    ...
    @property
    def mutate_campaign_groups(self) -> Callable[[campaign_group_service.MutateCampaignGroupsRequest], Awaitable[campaign_group_service.MutateCampaignGroupsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
