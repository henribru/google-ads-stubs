...
class CampaignSharedSetServiceGrpcAsyncIOTransport(CampaignSharedSetServiceTransport):
    @classmethod
    ...
    @property
    def mutate_campaign_shared_sets(self) -> Callable[[campaign_shared_set_service.MutateCampaignSharedSetsRequest], Awaitable[campaign_shared_set_service.MutateCampaignSharedSetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
