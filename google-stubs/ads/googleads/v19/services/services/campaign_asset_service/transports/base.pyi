...
class CampaignAssetServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_campaign_assets(self) -> Callable[[campaign_asset_service.MutateCampaignAssetsRequest], campaign_asset_service.MutateCampaignAssetsResponse | Awaitable[campaign_asset_service.MutateCampaignAssetsResponse]]: ...
    @property
    def kind(self) -> str: ...
