...
class ConversionUploadServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[ConversionUploadServiceTransport]: ...
...
class ConversionUploadServiceClient(metaclass=ConversionUploadServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | ConversionUploadServiceTransport | Callable[..., ConversionUploadServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def upload_click_conversions(self, request: conversion_upload_service.UploadClickConversionsRequest | dict | None = None, *, customer_id: str | None = None, conversions: MutableSequence[conversion_upload_service.ClickConversion] | None = None, partial_failure: bool | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> conversion_upload_service.UploadClickConversionsResponse: ...
    def upload_call_conversions(self, request: conversion_upload_service.UploadCallConversionsRequest | dict | None = None, *, customer_id: str | None = None, conversions: MutableSequence[conversion_upload_service.CallConversion] | None = None, partial_failure: bool | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> conversion_upload_service.UploadCallConversionsResponse: ...
