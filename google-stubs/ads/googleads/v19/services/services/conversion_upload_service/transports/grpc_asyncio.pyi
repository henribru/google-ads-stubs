...
class ConversionUploadServiceGrpcAsyncIOTransport(ConversionUploadServiceTransport):
    ...
    @property
    def upload_click_conversions(self) -> Callable[[conversion_upload_service.UploadClickConversionsRequest], Awaitable[conversion_upload_service.UploadClickConversionsResponse]]: ...
    @property
    def upload_call_conversions(self) -> Callable[[conversion_upload_service.UploadCallConversionsRequest], Awaitable[conversion_upload_service.UploadCallConversionsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
