...
class CampaignConversionGoalServiceGrpcTransport(CampaignConversionGoalServiceTransport):
    ...
    @property
    def mutate_campaign_conversion_goals(self) -> Callable[[campaign_conversion_goal_service.MutateCampaignConversionGoalsRequest], campaign_conversion_goal_service.MutateCampaignConversionGoalsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
