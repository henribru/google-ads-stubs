...
class BrandSuggestionServiceGrpcAsyncIOTransport(BrandSuggestionServiceTransport):
    @classmethod
    ...
    @property
    def suggest_brands(self) -> Callable[[brand_suggestion_service.SuggestBrandsRequest], Awaitable[brand_suggestion_service.SuggestBrandsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
