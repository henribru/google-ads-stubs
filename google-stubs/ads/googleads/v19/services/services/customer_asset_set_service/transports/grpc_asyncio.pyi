...
class CustomerAssetSetServiceGrpcAsyncIOTransport(CustomerAssetSetServiceTransport):
    @classmethod
    ...
    @property
    def mutate_customer_asset_sets(self) -> Callable[[customer_asset_set_service.MutateCustomerAssetSetsRequest], Awaitable[customer_asset_set_service.MutateCustomerAssetSetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
