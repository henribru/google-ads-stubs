...
class AdGroupCustomizerServiceGrpcTransport(AdGroupCustomizerServiceTransport):
    ...
    @property
    def mutate_ad_group_customizers(self) -> Callable[[ad_group_customizer_service.MutateAdGroupCustomizersRequest], ad_group_customizer_service.MutateAdGroupCustomizersResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
