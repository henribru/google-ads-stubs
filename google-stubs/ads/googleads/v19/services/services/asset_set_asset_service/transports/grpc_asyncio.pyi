...
class AssetSetAssetServiceGrpcAsyncIOTransport(AssetSetAssetServiceTransport):
    ...
    @property
    def mutate_asset_set_assets(self) -> Callable[[asset_set_asset_service.MutateAssetSetAssetsRequest], Awaitable[asset_set_asset_service.MutateAssetSetAssetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
