...
class AssetGroupAssetServiceGrpcTransport(AssetGroupAssetServiceTransport):
    ...
    @property
    def mutate_asset_group_assets(self) -> Callable[[asset_group_asset_service.MutateAssetGroupAssetsRequest], asset_group_asset_service.MutateAssetGroupAssetsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
