from google.ads.googleads.v19.enums.types.local_services_lead_survey_satisfied_reason import LocalServicesLeadSurveySatisfiedReasonEnum
from google.ads.googleads.v19.enums.types.local_services_lead_survey_dissatisfied_reason import LocalServicesLeadSurveyDissatisfiedReasonEnum
from google.ads.googleads.v19.enums.types.local_services_lead_credit_issuance_decision import LocalServicesLeadCreditIssuanceDecisionEnum
from google.ads.googleads.v19.enums.types.local_services_lead_survey_answer import LocalServicesLeadSurveyAnswerEnum
...
class ProvideLeadFeedbackRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., resource_name: str = ..., survey_answer: LocalServicesLeadSurveyAnswerEnum.SurveyAnswer = ..., survey_satisfied: SurveySatisfied = ..., survey_dissatisfied: SurveyDissatisfied = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ProvideLeadFeedbackResponse(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., credit_issuance_decision: LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class SurveyDissatisfied(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., survey_dissatisfied_reason: LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason = ..., other_reason_comment: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class SurveySatisfied(proto.Message):
    ...
    other_reason_comment: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., survey_satisfied_reason: LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason = ..., other_reason_comment: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
