...
class UpdateDataLinkRequest(proto.Message):
    ...
    resource_name: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., data_link_status: DataLinkStatusEnum.DataLinkStatus = ..., resource_name: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
