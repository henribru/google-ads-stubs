...
class AdGroupCriterionLabelOperation(proto.Message):
    ...
    remove: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., create: AdGroupCriterionLabel = ..., remove: str = ...) -> None: ...
...
class MutateAdGroupCriterionLabelsRequest(proto.Message):
    ...
    validate_only: bool
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., operations: MutableSequence[AdGroupCriterionLabelOperation] = ..., partial_failure: bool = ..., validate_only: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class MutateAdGroupCriterionLabelsResponse(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., partial_failure_error: Status = ..., results: MutableSequence[MutateAdGroupCriterionLabelResult] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
