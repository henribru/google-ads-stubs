...
from collections.abc import MutableSequence
from google.ads.googleads.v19.common.types.audience_insights_attribute import AudienceInsightsAttributeMetadata
from collections.abc import MutableSequence
from google.ads.googleads.v19.common.types.audience_insights_attribute import AudienceInsightsAttributeMetadata
from collections.abc import MutableSequence
from google.ads.googleads.v19.common.types.audience_insights_attribute import AudienceInsightsAttributeMetadata
...
from google.ads.googleads.v19.common.types.audience_insights_attribute import AudienceInsightsAttributeMetadata
from collections.abc import MutableSequence
from google.ads.googleads.v19.common.types.audience_insights_attribute import AudienceInsightsEntity
from collections.abc import MutableSequence
from google.ads.googleads.v19.common.types.audience_insights_attribute import AudienceInsightsAttribute
from collections.abc import MutableSequence
...
class GenerateTrendingInsightsRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., customer_insights_group: str = ..., country_location: LocationInfo = ..., search_audience: SearchAudience = ..., search_topics: SearchTopics = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["customer_id", "customer_insights_group", "country_location", "search_audience", "search_topics"]) -> bool: ...
...
class TrendInsightMetrics(proto.Message):
    views_count: int
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, views_count: int = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class YouTubeChannelInsights(proto.Message):
    ...
    channel_type: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, display_name: str = ..., youtube_channel: YouTubeChannelInfo = ..., channel_url: str = ..., channel_description: str = ..., channel_metrics: YouTubeMetrics = ..., channel_audience_attributes: MutableSequence[AudienceInsightsAttributeMetadata] = ..., channel_attributes: MutableSequence[AudienceInsightsAttributeMetadata] = ..., top_videos: MutableSequence[AudienceInsightsAttributeMetadata] = ..., channel_type: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class YouTubeMetrics(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, subscriber_count: int = ..., views_count: int = ..., video_count: int = ..., is_active_shorts_creator: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["subscriber_count", "views_count", "video_count", "is_active_shorts_creator"]) -> bool: ...
