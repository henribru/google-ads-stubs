...
class GenerateTrendingInsightsRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., customer_insights_group: str = ..., country_location: LocationInfo = ..., search_audience: SearchAudience = ..., search_topics: SearchTopics = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class YouTubeMetrics(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., subscriber_count: int = ..., views_count: int = ..., video_count: int = ..., is_active_shorts_creator: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
