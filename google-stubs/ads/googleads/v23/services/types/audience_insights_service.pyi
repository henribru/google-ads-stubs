...
from google.ads.googleads.v23.common.types.audience_insights_attribute import AudienceInsightsAttributeMetadataGroup
...
from google.ads.googleads.v23.common.types.additional_application_info import AdditionalApplicationInfo
from collections.abc import MutableSequence
from google.ads.googleads.v23.enums.types.audience_insights_dimension import AudienceInsightsDimensionEnum
from google.ads.googleads.v23.enums.types.audience_insights_marketing_objective import AudienceInsightsMarketingObjectiveEnum
from collections.abc import MutableSequence
from google.ads.googleads.v23.common.types.criteria import LocationInfo
from collections.abc import MutableSequence
...
from collections.abc import MutableSequence
from google.ads.googleads.v23.common.types.audience_insights_attribute import AudienceInsightsLineup
from collections.abc import MutableSequence
...
class AudienceInsightsDimensions(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, dimensions: MutableSequence[AudienceInsightsDimensionEnum.AudienceInsightsDimension] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class GenerateAudienceDefinitionRequest(proto.Message):
    ...
    customer_insights_group: str
    insights_application_info: AdditionalApplicationInfo
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., audience_description: InsightsAudienceDescription = ..., customer_insights_group: str = ..., insights_application_info: AdditionalApplicationInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["customer_id", "audience_description", "customer_insights_group", "insights_application_info"]) -> bool: ...
class GenerateAudienceDefinitionResponse(proto.Message):
    high_relevance_attributes: MutableSequence[AudienceInsightsAttributeMetadata]
    medium_relevance_attributes: MutableSequence[AudienceInsightsAttributeMetadata]
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, high_relevance_attributes: MutableSequence[AudienceInsightsAttributeMetadata] = ..., medium_relevance_attributes: MutableSequence[AudienceInsightsAttributeMetadata] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["high_relevance_attributes", "medium_relevance_attributes"]) -> bool: ...
...
class InsightsAudienceDescription(proto.Message):
    ...
    audience_dimensions: AudienceInsightsDimensions
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, country_locations: MutableSequence[LocationInfo] = ..., audience_description: str = ..., marketing_objective: AudienceInsightsMarketingObjectiveEnum.AudienceInsightsMarketingObjective = ..., audience_dimensions: AudienceInsightsDimensions = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["country_locations", "audience_description", "marketing_objective", "audience_dimensions"]) -> bool: ...
