...
class AutomaticallyCreatedAssetRemovalServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def remove_campaign_automatically_created_asset(self) -> Callable[[automatically_created_asset_removal_service.RemoveCampaignAutomaticallyCreatedAssetRequest], automatically_created_asset_removal_service.RemoveCampaignAutomaticallyCreatedAssetResponse | Awaitable[automatically_created_asset_removal_service.RemoveCampaignAutomaticallyCreatedAssetResponse]]: ...
    @property
    def kind(self) -> str: ...
