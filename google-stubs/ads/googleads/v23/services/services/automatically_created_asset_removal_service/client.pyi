...
class AutomaticallyCreatedAssetRemovalServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> type[AutomaticallyCreatedAssetRemovalServiceTransport]: ...

class AutomaticallyCreatedAssetRemovalServiceClient(metaclass=AutomaticallyCreatedAssetRemovalServiceClientMeta):
