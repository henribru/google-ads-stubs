...
class RemarketingActionServiceGrpcAsyncIOTransport(RemarketingActionServiceTransport):
    ...
    @property
    def mutate_remarketing_actions(self) -> Callable[[remarketing_action_service.MutateRemarketingActionsRequest], Awaitable[remarketing_action_service.MutateRemarketingActionsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
