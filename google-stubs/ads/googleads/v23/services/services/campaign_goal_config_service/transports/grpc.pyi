...
class CampaignGoalConfigServiceGrpcTransport(CampaignGoalConfigServiceTransport):
    ...
    @property
    def mutate_campaign_goal_configs(self) -> Callable[[campaign_goal_config_service.MutateCampaignGoalConfigsRequest], campaign_goal_config_service.MutateCampaignGoalConfigsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
