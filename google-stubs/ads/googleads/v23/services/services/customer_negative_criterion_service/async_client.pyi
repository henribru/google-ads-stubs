...
from google.ads.googleads.v23.services.types import customer_negative_criterion_service
...
class CustomerNegativeCriterionServiceAsyncClient:
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CustomerNegativeCriterionServiceTransport | Callable[..., CustomerNegativeCriterionServiceTransport] | None = 'grpc_asyncio', client_options: ClientOptions | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    async def mutate_customer_negative_criteria(self, request: customer_negative_criterion_service.MutateCustomerNegativeCriteriaRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[customer_negative_criterion_service.CustomerNegativeCriterionOperation] | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> customer_negative_criterion_service.MutateCustomerNegativeCriteriaResponse: ...
