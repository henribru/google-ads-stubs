...
class KeywordThemeConstantServiceGrpcTransport(KeywordThemeConstantServiceTransport):
    ...
    @property
    def suggest_keyword_theme_constants(self) -> Callable[[keyword_theme_constant_service.SuggestKeywordThemeConstantsRequest], keyword_theme_constant_service.SuggestKeywordThemeConstantsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
