...
class AccountLinkServiceGrpcTransport(AccountLinkServiceTransport):
    ...
    @property
    def create_account_link(self) -> Callable[[account_link_service.CreateAccountLinkRequest], account_link_service.CreateAccountLinkResponse]: ...
    @property
    def mutate_account_link(self) -> Callable[[account_link_service.MutateAccountLinkRequest], account_link_service.MutateAccountLinkResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
