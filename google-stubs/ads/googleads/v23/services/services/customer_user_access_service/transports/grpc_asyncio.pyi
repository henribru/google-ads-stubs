...
class CustomerUserAccessServiceGrpcAsyncIOTransport(CustomerUserAccessServiceTransport):
    @classmethod
    ...
    @property
    def mutate_customer_user_access(self) -> Callable[[customer_user_access_service.MutateCustomerUserAccessRequest], Awaitable[customer_user_access_service.MutateCustomerUserAccessResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
