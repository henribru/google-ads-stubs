...
class CustomerUserAccessServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_customer_user_access(self) -> Callable[[customer_user_access_service.MutateCustomerUserAccessRequest], customer_user_access_service.MutateCustomerUserAccessResponse | Awaitable[customer_user_access_service.MutateCustomerUserAccessResponse]]: ...
    @property
    def kind(self) -> str: ...
