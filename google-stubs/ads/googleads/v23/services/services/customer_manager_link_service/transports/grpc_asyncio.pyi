...
class CustomerManagerLinkServiceGrpcAsyncIOTransport(CustomerManagerLinkServiceTransport):
    @classmethod
    ...
    @property
    def mutate_customer_manager_link(self) -> Callable[[customer_manager_link_service.MutateCustomerManagerLinkRequest], Awaitable[customer_manager_link_service.MutateCustomerManagerLinkResponse]]: ...
    @property
    def move_manager_link(self) -> Callable[[customer_manager_link_service.MoveManagerLinkRequest], Awaitable[customer_manager_link_service.MoveManagerLinkResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
