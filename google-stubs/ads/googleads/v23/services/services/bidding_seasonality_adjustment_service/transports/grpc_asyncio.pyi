...
from google.ads.googleads.v23.services.types import bidding_seasonality_adjustment_service
...
class BiddingSeasonalityAdjustmentServiceGrpcAsyncIOTransport(BiddingSeasonalityAdjustmentServiceTransport):
    @classmethod
    ...
    @property
    def mutate_bidding_seasonality_adjustments(self) -> Callable[[bidding_seasonality_adjustment_service.MutateBiddingSeasonalityAdjustmentsRequest], Awaitable[bidding_seasonality_adjustment_service.MutateBiddingSeasonalityAdjustmentsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
