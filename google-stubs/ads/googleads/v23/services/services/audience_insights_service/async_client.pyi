...
class AudienceInsightsServiceAsyncClient:
    ...
    async def generate_insights_finder_report(self, request: audience_insights_service.GenerateInsightsFinderReportRequest | dict | None = None, *, customer_id: str | None = None, baseline_audience: audience_insights_service.InsightsAudience | None = None, specific_audience: audience_insights_service.InsightsAudience | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> audience_insights_service.GenerateInsightsFinderReportResponse: ...
    ...
    async def generate_audience_definition(self, request: audience_insights_service.GenerateAudienceDefinitionRequest | dict | None = None, *, customer_id: str | None = None, audience_description: audience_insights_service.InsightsAudienceDescription | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> audience_insights_service.GenerateAudienceDefinitionResponse: ...
