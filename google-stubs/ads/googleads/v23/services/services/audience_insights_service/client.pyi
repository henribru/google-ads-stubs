...
from google.ads.googleads.v23.common.types import audience_insights_attribute, criteria
...
class AudienceInsightsServiceClient(metaclass=AudienceInsightsServiceClientMeta):
    ...
    def generate_audience_definition(
        ...
        *,
        customer_id: str | None = None,
        audience_description: audience_insights_service.InsightsAudienceDescription
        | None = None,
        retry: retries.Retry | gapic_v1.method._MethodDefault = ...,
        timeout: float | object = ...,
        metadata: Sequence[tuple[str, str | bytes]] = (),
