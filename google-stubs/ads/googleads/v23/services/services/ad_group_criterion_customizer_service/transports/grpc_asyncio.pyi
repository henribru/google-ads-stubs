...
class AdGroupCriterionCustomizerServiceGrpcAsyncIOTransport(AdGroupCriterionCustomizerServiceTransport):
    @classmethod
    ...
    @property
    def mutate_ad_group_criterion_customizers(self) -> Callable[[ad_group_criterion_customizer_service.MutateAdGroupCriterionCustomizersRequest], Awaitable[ad_group_criterion_customizer_service.MutateAdGroupCriterionCustomizersResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
