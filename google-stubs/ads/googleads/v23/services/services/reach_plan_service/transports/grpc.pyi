...
class ReachPlanServiceGrpcTransport(ReachPlanServiceTransport):
    ...
    @property
    def generate_conversion_rates(self) -> Callable[[reach_plan_service.GenerateConversionRatesRequest], reach_plan_service.GenerateConversionRatesResponse]: ...
    @property
    def list_plannable_locations(self) -> Callable[[reach_plan_service.ListPlannableLocationsRequest], reach_plan_service.ListPlannableLocationsResponse]: ...
    @property
    def list_plannable_products(self) -> Callable[[reach_plan_service.ListPlannableProductsRequest], reach_plan_service.ListPlannableProductsResponse]: ...
    @property
    def generate_reach_forecast(self) -> Callable[[reach_plan_service.GenerateReachForecastRequest], reach_plan_service.GenerateReachForecastResponse]: ...
    @property
    def list_plannable_user_lists(self) -> Callable[[reach_plan_service.ListPlannableUserListsRequest], reach_plan_service.ListPlannableUserListsResponse]: ...
    @property
    def list_plannable_user_interests(self) -> Callable[[reach_plan_service.ListPlannableUserInterestsRequest], reach_plan_service.ListPlannableUserInterestsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
