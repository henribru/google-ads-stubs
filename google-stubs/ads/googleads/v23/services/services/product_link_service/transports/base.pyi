...
class ProductLinkServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def create_product_link(self) -> Callable[[product_link_service.CreateProductLinkRequest], product_link_service.CreateProductLinkResponse | Awaitable[product_link_service.CreateProductLinkResponse]]: ...
    @property
    def remove_product_link(self) -> Callable[[product_link_service.RemoveProductLinkRequest], product_link_service.RemoveProductLinkResponse | Awaitable[product_link_service.RemoveProductLinkResponse]]: ...
    @property
    def kind(self) -> str: ...
