...
class CampaignLifecycleGoalServiceGrpcAsyncIOTransport(CampaignLifecycleGoalServiceTransport):
    @classmethod
    ...
    @property
    def configure_campaign_lifecycle_goals(self) -> Callable[[campaign_lifecycle_goal_service.ConfigureCampaignLifecycleGoalsRequest], Awaitable[campaign_lifecycle_goal_service.ConfigureCampaignLifecycleGoalsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
