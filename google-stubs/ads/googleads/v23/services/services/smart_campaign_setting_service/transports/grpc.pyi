...
class SmartCampaignSettingServiceGrpcTransport(SmartCampaignSettingServiceTransport):
    ...
    @property
    def get_smart_campaign_status(self) -> Callable[[smart_campaign_setting_service.GetSmartCampaignStatusRequest], smart_campaign_setting_service.GetSmartCampaignStatusResponse]: ...
    @property
    def mutate_smart_campaign_settings(self) -> Callable[[smart_campaign_setting_service.MutateSmartCampaignSettingsRequest], smart_campaign_setting_service.MutateSmartCampaignSettingsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
