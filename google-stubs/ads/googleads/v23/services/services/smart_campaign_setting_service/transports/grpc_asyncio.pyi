...
class SmartCampaignSettingServiceGrpcAsyncIOTransport(SmartCampaignSettingServiceTransport):
    @classmethod
    ...
    @property
    def get_smart_campaign_status(self) -> Callable[[smart_campaign_setting_service.GetSmartCampaignStatusRequest], Awaitable[smart_campaign_setting_service.GetSmartCampaignStatusResponse]]: ...
    @property
    def mutate_smart_campaign_settings(self) -> Callable[[smart_campaign_setting_service.MutateSmartCampaignSettingsRequest], Awaitable[smart_campaign_setting_service.MutateSmartCampaignSettingsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
