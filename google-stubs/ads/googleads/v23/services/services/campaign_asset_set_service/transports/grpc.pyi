...
class CampaignAssetSetServiceGrpcTransport(CampaignAssetSetServiceTransport):
    ...
    @property
    def mutate_campaign_asset_sets(self) -> Callable[[campaign_asset_set_service.MutateCampaignAssetSetsRequest], campaign_asset_set_service.MutateCampaignAssetSetsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
