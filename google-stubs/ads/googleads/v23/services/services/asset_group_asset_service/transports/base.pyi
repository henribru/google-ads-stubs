...
class AssetGroupAssetServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_asset_group_assets(self) -> Callable[[asset_group_asset_service.MutateAssetGroupAssetsRequest], asset_group_asset_service.MutateAssetGroupAssetsResponse | Awaitable[asset_group_asset_service.MutateAssetGroupAssetsResponse]]: ...
    @property
    def kind(self) -> str: ...
