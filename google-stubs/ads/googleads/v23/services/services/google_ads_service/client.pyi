...
class GoogleAdsServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> type[GoogleAdsServiceTransport]: ...
...
class GoogleAdsServiceClient(metaclass=GoogleAdsServiceClientMeta):
    ...
    @staticmethod
    def ad_group_ad_asset_combination_view_path(customer_id: str, ad_group_id: str, ad_id: str, asset_combination_id_low: str, asset_combination_id_high: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def ai_max_search_term_ad_combination_view_path(customer_id: str, ad_group_id: str, search_term: str, landing_page: str, headline: str) -> str: ...
    @staticmethod
    def parse_ai_max_search_term_ad_combination_view_path(path: str) -> dict[str, str]: ...
    @staticmethod
    def android_privacy_shared_key_google_ad_group_path(customer_id: str, campaign_id: str, ad_group_id: str, android_privacy_interaction_type: str, android_privacy_network_type: str, android_privacy_interaction_date: str) -> str: ...
    @staticmethod
    def parse_android_privacy_shared_key_google_ad_group_path(path: str) -> dict[str, str]: ...
    @staticmethod
    def android_privacy_shared_key_google_campaign_path(customer_id: str, campaign_id: str, android_privacy_interaction_type: str, android_privacy_interaction_date: str) -> str: ...
    @staticmethod
    def parse_android_privacy_shared_key_google_campaign_path(path: str) -> dict[str, str]: ...
    @staticmethod
    def android_privacy_shared_key_google_network_type_path(customer_id: str, campaign_id: str, android_privacy_interaction_type: str, android_privacy_network_type: str, android_privacy_interaction_date: str) -> str: ...
    @staticmethod
    def parse_android_privacy_shared_key_google_network_type_path(path: str) -> dict[str, str]: ...
    @staticmethod
    def applied_incentive_path(customer_id: str, coupon_code: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def campaign_aggregate_asset_view_path(customer_id: str, campaign_id: str, asset_id: str, asset_link_source: str, field_type: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def campaign_goal_config_path(customer_id: str, campaign_id: str, unified_goal_id: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def campaign_search_term_insight_path(customer_id: str, campaign_id: str, cluster_id: str) -> str: ...
    @staticmethod
    def parse_campaign_search_term_insight_path(path: str) -> dict[str, str]: ...
    @staticmethod
    def campaign_search_term_view_path(customer_id: str, campaign_id: str, query: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def channel_aggregate_asset_view_path(customer_id: str, advertising_channel_type: str, asset_id: str, asset_source: str, field_type: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def content_criterion_view_path(customer_id: str, ad_group_id: str, criterion_id: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def customer_search_term_insight_path(customer_id: str, cluster_id: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def data_link_path(customer_id: str, product_link_id: str, data_link_id: str) -> str: ...
    @staticmethod
    def parse_data_link_path(path: str) -> dict[str, str]: ...
    @staticmethod
    def detail_content_suitability_placement_view_path(customer_id: str, placement_fingerprint: str) -> str: ...
    @staticmethod
    def parse_detail_content_suitability_placement_view_path(path: str) -> dict[str, str]: ...
    @staticmethod
    ...
    @staticmethod
    def final_url_expansion_asset_view_path(customer_id: str, campaign_id: str, asset_id: str, field_type: str, url_fp: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def group_content_suitability_placement_view_path(customer_id: str, placement_fingerprint: str) -> str: ...
    @staticmethod
    def parse_group_content_suitability_placement_view_path(path: str) -> dict[str, str]: ...
    @staticmethod
    ...
    @staticmethod
    def lead_form_submission_data_path(customer_id: str, lead_form_user_submission_id: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def local_services_employee_path(customer_id: str, gls_employee_id: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def local_services_lead_conversation_path(customer_id: str, local_services_lead_conversation_id: str) -> str: ...
    @staticmethod
    def parse_local_services_lead_conversation_path(path: str) -> dict[str, str]: ...
    @staticmethod
    def local_services_verification_artifact_path(customer_id: str, gls_verification_artifact_id: str) -> str: ...
    @staticmethod
    def parse_local_services_verification_artifact_path(path: str) -> dict[str, str]: ...
    @staticmethod
    def location_interest_view_path(customer_id: str, campaign_id: str, ad_group_id: str, criterion_id: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def matched_location_interest_view_path(customer_id: str, country_criterion_id: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def offline_conversion_upload_client_summary_path(customer_id: str, client: str) -> str: ...
    @staticmethod
    def parse_offline_conversion_upload_client_summary_path(path: str) -> dict[str, str]: ...
    @staticmethod
    def offline_conversion_upload_conversion_action_summary_path(customer_id: str, conversion_type_id: str, client: str) -> str: ...
    @staticmethod
    def parse_offline_conversion_upload_conversion_action_summary_path(path: str) -> dict[str, str]: ...
    @staticmethod
    ...
    @staticmethod
    def performance_max_placement_view_path(customer_id: str, base_64_placement: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def product_link_invitation_path(customer_id: str, customer_invitation_id: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def recommendation_subscription_path(customer_id: str, recommendation_type: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def shopping_product_path(customer_id: str, merchant_center_id: str, channel: str, language_code: str, feed_label: str, item_id: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def targeting_expansion_view_path(customer_id: str, campaign_id: str, targeting_expansion_type: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def travel_activity_group_view_path(customer_id: str, ad_group_id: str, criterion_id: str) -> str: ...
    @staticmethod
    ...
    @staticmethod
    def user_list_customer_type_path(customer_id: str, user_list_id: str, semantic_label: str) -> str: ...
    @staticmethod
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | GoogleAdsServiceTransport | Callable[..., GoogleAdsServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def search(self, request: google_ads_service.SearchGoogleAdsRequest | dict | None = None, *, customer_id: str | None = None, query: str | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> pagers.SearchPager: ...
    def search_stream(self, request: google_ads_service.SearchGoogleAdsStreamRequest | dict | None = None, *, customer_id: str | None = None, query: str | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> Iterable[google_ads_service.SearchGoogleAdsStreamResponse]: ...
    def mutate(self, request: google_ads_service.MutateGoogleAdsRequest | dict | None = None, *, customer_id: str | None = None, mutate_operations: MutableSequence[google_ads_service.MutateOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> google_ads_service.MutateGoogleAdsResponse: ...
