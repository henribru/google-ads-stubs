...
class GeoTargetConstantServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def suggest_geo_target_constants(self) -> Callable[[geo_target_constant_service.SuggestGeoTargetConstantsRequest], geo_target_constant_service.SuggestGeoTargetConstantsResponse | Awaitable[geo_target_constant_service.SuggestGeoTargetConstantsResponse]]: ...
    @property
    def kind(self) -> str: ...
