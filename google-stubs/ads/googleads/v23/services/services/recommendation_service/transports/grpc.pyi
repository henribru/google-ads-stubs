...
class RecommendationServiceGrpcTransport(RecommendationServiceTransport):
    ...
    @property
    def apply_recommendation(self) -> Callable[[recommendation_service.ApplyRecommendationRequest], recommendation_service.ApplyRecommendationResponse]: ...
    @property
    def dismiss_recommendation(self) -> Callable[[recommendation_service.DismissRecommendationRequest], recommendation_service.DismissRecommendationResponse]: ...
    @property
    def generate_recommendations(self) -> Callable[[recommendation_service.GenerateRecommendationsRequest], recommendation_service.GenerateRecommendationsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
