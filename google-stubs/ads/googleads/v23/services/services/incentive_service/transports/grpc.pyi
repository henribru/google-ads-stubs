...
class IncentiveServiceGrpcTransport(IncentiveServiceTransport):
    ...
    @property
    def fetch_incentive(self) -> Callable[[incentive_service.FetchIncentiveRequest], incentive_service.FetchIncentiveResponse]: ...
    @property
    def apply_incentive(self) -> Callable[[incentive_service.ApplyIncentiveRequest], incentive_service.ApplyIncentiveResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
