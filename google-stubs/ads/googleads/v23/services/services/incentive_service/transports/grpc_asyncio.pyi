...
class IncentiveServiceGrpcAsyncIOTransport(IncentiveServiceTransport):
    ...
    @property
    def fetch_incentive(self) -> Callable[[incentive_service.FetchIncentiveRequest], Awaitable[incentive_service.FetchIncentiveResponse]]: ...
    @property
    def apply_incentive(self) -> Callable[[incentive_service.ApplyIncentiveRequest], Awaitable[incentive_service.ApplyIncentiveResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
