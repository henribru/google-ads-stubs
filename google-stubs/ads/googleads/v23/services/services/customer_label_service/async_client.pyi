...
class CustomerLabelServiceAsyncClient:
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CustomerLabelServiceTransport | Callable[..., CustomerLabelServiceTransport] | None = 'grpc_asyncio', client_options: ClientOptions | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    async def mutate_customer_labels(self, request: customer_label_service.MutateCustomerLabelsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[customer_label_service.CustomerLabelOperation] | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> customer_label_service.MutateCustomerLabelsResponse: ...
