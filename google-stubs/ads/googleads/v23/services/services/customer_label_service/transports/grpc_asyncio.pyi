...
class CustomerLabelServiceGrpcAsyncIOTransport(CustomerLabelServiceTransport):
    ...
    @property
    def mutate_customer_labels(self) -> Callable[[customer_label_service.MutateCustomerLabelsRequest], Awaitable[customer_label_service.MutateCustomerLabelsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
