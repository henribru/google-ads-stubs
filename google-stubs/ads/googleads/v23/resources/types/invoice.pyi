...
from google.ads.googleads.v23.enums.types.invoice_type import InvoiceTypeEnum
from google.ads.googleads.v23.enums.types.regulatory_fee_type import RegulatoryFeeTypeEnum
from google.ads.googleads.v23.enums.types.month_of_year import MonthOfYearEnum
from google.ads.googleads.v23.enums.types.unit_of_measure import UnitOfMeasureEnum
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from collections.abc import MutableSequence
...
class Invoice(proto.Message):
    class AccountBudgetSummary(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer: str = ..., customer_descriptive_name: str = ..., account_budget: str = ..., account_budget_name: str = ..., purchase_order_number: str = ..., subtotal_amount_micros: int = ..., tax_amount_micros: int = ..., total_amount_micros: int = ..., billable_activity_date_range: DateRange = ..., served_amount_micros: int = ..., billed_amount_micros: int = ..., overdelivery_amount_micros: int = ..., invalid_activity_amount_micros: int = ..., invalid_activity_summaries: MutableSequence[Invoice.InvalidActivitySummary] = ..., campaign_summaries: MutableSequence[Invoice.CampaignSummary] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["customer", "customer_descriptive_name", "account_budget", "account_budget_name", "purchase_order_number", "subtotal_amount_micros", "tax_amount_micros", "total_amount_micros", "billable_activity_date_range", "served_amount_micros", "billed_amount_micros", "overdelivery_amount_micros", "invalid_activity_amount_micros", "invalid_activity_summaries", "campaign_summaries"]) -> bool: ...
    ...
    class InvalidActivitySummary(proto.Message):
        ...
        amount_micros: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, original_month_of_service: MonthOfYearEnum.MonthOfYear = ..., original_year_of_service: str = ..., original_invoice_id: str = ..., original_account_budget_name: str = ..., original_purchase_order_number: str = ..., amount_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class RegulatoryCostSummary(proto.Message):
        regulatory_fee_type: RegulatoryFeeTypeEnum.RegulatoryFeeType
        amount_micros: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, regulatory_fee_type: RegulatoryFeeTypeEnum.RegulatoryFeeType = ..., amount_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["regulatory_fee_type", "amount_micros"]) -> bool: ...
    resource_name: str
    id: str
