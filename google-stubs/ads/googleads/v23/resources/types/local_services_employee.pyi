...
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from google.ads.googleads.v23.enums.types.local_services_employee_type import LocalServicesEmployeeTypeEnum
from google.ads.googleads.v23.enums.types.local_services_employee_status import LocalServicesEmployeeStatusEnum
import proto
...
class Fellowship(proto.Message):
    ...
    completion_year: int
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, institution_name: str = ..., completion_year: int = ...) -> None: ...
...
class UniversityDegree(proto.Message):
    ...
    degree: str
    graduation_year: int
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, institution_name: str = ..., degree: str = ..., graduation_year: int = ...) -> None: ...
    def __contains__(  # type: ignore[override]
