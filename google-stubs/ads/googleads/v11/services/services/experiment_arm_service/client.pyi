...
class ExperimentArmServiceClient(metaclass=ExperimentArmServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, ExperimentArmServiceTransport, None] = ...,
        client_options: Optional[client_options_lib.ClientOptions] = ...,
        client_info: gapic_v1.client_info.ClientInfo = ...
    ) -> None: ...
    def mutate_experiment_arms(
        self,
        request: Union[experiment_arm_service.MutateExperimentArmsRequest, dict] = ...,
        *,
        customer_id: str = ...,
        operations: Sequence[experiment_arm_service.ExperimentArmOperation] = ...,
