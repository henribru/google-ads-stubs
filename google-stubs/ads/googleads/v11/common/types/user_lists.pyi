...
from google.ads.googleads.v11.enums.types import (
    ...
    user_list_flexible_rule_operator as user_list_flexible_rule_operator,
...
class FlexibleRuleOperandInfo(proto.Message):
    rule: Incomplete
    lookback_window_days: Incomplete

class FlexibleRuleUserListInfo(proto.Message):
    inclusive_rule_operator: Incomplete
    inclusive_operands: Incomplete
    exclusive_operands: Incomplete

class RuleBasedUserListInfo(proto.Message):
    prepopulation_status: Incomplete
    flexible_rule_user_list: Incomplete
