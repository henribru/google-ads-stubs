...
class AdGroupAdLabelServiceGrpcAsyncIOTransport(AdGroupAdLabelServiceTransport):
    ...
    @property
    def mutate_ad_group_ad_labels(self) -> Callable[[ad_group_ad_label_service.MutateAdGroupAdLabelsRequest], Awaitable[ad_group_ad_label_service.MutateAdGroupAdLabelsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
