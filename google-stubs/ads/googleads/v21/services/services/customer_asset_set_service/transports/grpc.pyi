...
class CustomerAssetSetServiceGrpcTransport(CustomerAssetSetServiceTransport):
    ...
    @property
    def mutate_customer_asset_sets(self) -> Callable[[customer_asset_set_service.MutateCustomerAssetSetsRequest], customer_asset_set_service.MutateCustomerAssetSetsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
