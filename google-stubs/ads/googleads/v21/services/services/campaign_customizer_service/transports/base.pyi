...
class CampaignCustomizerServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_campaign_customizers(self) -> Callable[[campaign_customizer_service.MutateCampaignCustomizersRequest], campaign_customizer_service.MutateCampaignCustomizersResponse | Awaitable[campaign_customizer_service.MutateCampaignCustomizersResponse]]: ...
    @property
    def kind(self) -> str: ...
