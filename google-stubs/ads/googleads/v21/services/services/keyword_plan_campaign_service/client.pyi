...
class KeywordPlanCampaignServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> type[KeywordPlanCampaignServiceTransport]: ...
...
class KeywordPlanCampaignServiceClient(metaclass=KeywordPlanCampaignServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | KeywordPlanCampaignServiceTransport | Callable[..., KeywordPlanCampaignServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_keyword_plan_campaigns(self, request: keyword_plan_campaign_service.MutateKeywordPlanCampaignsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[keyword_plan_campaign_service.KeywordPlanCampaignOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> keyword_plan_campaign_service.MutateKeywordPlanCampaignsResponse: ...
