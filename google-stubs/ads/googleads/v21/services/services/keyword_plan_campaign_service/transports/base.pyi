...
class KeywordPlanCampaignServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_keyword_plan_campaigns(self) -> Callable[[keyword_plan_campaign_service.MutateKeywordPlanCampaignsRequest], keyword_plan_campaign_service.MutateKeywordPlanCampaignsResponse | Awaitable[keyword_plan_campaign_service.MutateKeywordPlanCampaignsResponse]]: ...
    @property
    def kind(self) -> str: ...
