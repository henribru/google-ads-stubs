...
class KeywordPlanCampaignServiceGrpcTransport(KeywordPlanCampaignServiceTransport):
    ...
    @property
    def mutate_keyword_plan_campaigns(self) -> Callable[[keyword_plan_campaign_service.MutateKeywordPlanCampaignsRequest], keyword_plan_campaign_service.MutateKeywordPlanCampaignsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
