...
class AssetGroupAssetServiceGrpcAsyncIOTransport(AssetGroupAssetServiceTransport):
    @classmethod
    ...
    @property
    def mutate_asset_group_assets(self) -> Callable[[asset_group_asset_service.MutateAssetGroupAssetsRequest], Awaitable[asset_group_asset_service.MutateAssetGroupAssetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
