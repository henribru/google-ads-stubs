...
from google.ads.googleads.v21.services.types import ad_group_criterion_label_service
...
class AdGroupCriterionLabelServiceGrpcAsyncIOTransport(AdGroupCriterionLabelServiceTransport):
    @classmethod
    ...
    @property
    def mutate_ad_group_criterion_labels(self) -> Callable[[ad_group_criterion_label_service.MutateAdGroupCriterionLabelsRequest], Awaitable[ad_group_criterion_label_service.MutateAdGroupCriterionLabelsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
