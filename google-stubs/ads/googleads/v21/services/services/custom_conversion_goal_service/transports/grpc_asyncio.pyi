...
from google.ads.googleads.v21.services.types import custom_conversion_goal_service
...
class CustomConversionGoalServiceGrpcAsyncIOTransport(CustomConversionGoalServiceTransport):
    @classmethod
    ...
    @property
    def mutate_custom_conversion_goals(self) -> Callable[[custom_conversion_goal_service.MutateCustomConversionGoalsRequest], Awaitable[custom_conversion_goal_service.MutateCustomConversionGoalsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
