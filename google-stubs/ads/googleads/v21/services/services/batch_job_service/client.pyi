...
class BatchJobServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> type[BatchJobServiceTransport]: ...
...
class BatchJobServiceClient(metaclass=BatchJobServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | BatchJobServiceTransport | Callable[..., BatchJobServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    ...
    def list_batch_job_results(self, request: batch_job_service.ListBatchJobResultsRequest | dict | None = None, *, resource_name: str | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> pagers.ListBatchJobResultsPager: ...
    def run_batch_job(self, request: batch_job_service.RunBatchJobRequest | dict | None = None, *, resource_name: str | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> operation.Operation: ...
    def add_batch_job_operations(self, request: batch_job_service.AddBatchJobOperationsRequest | dict | None = None, *, resource_name: str | None = None, sequence_token: str | None = None, mutate_operations: MutableSequence[google_ads_service.MutateOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> batch_job_service.AddBatchJobOperationsResponse: ...
