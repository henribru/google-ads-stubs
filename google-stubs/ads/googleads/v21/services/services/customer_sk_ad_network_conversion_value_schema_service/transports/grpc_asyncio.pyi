...
__all__ = ['CustomerSkAdNetworkConversionValueSchemaServiceGrpcAsyncIOTransport']

class _LoggingClientAIOInterceptor(grpc.aio.UnaryUnaryClientInterceptor):
    async def intercept_unary_unary(self, continuation, client_call_details, request): ...

class CustomerSkAdNetworkConversionValueSchemaServiceGrpcAsyncIOTransport(CustomerSkAdNetworkConversionValueSchemaServiceTransport):
    @classmethod
    ...
    @property
    def mutate_customer_sk_ad_network_conversion_value_schema(self) -> Callable[[customer_sk_ad_network_conversion_value_schema_service.MutateCustomerSkAdNetworkConversionValueSchemaRequest], Awaitable[customer_sk_ad_network_conversion_value_schema_service.MutateCustomerSkAdNetworkConversionValueSchemaResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
