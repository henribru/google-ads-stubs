...
class ProductLinkServiceGrpcAsyncIOTransport(ProductLinkServiceTransport):
    ...
    @property
    def create_product_link(self) -> Callable[[product_link_service.CreateProductLinkRequest], Awaitable[product_link_service.CreateProductLinkResponse]]: ...
    @property
    def remove_product_link(self) -> Callable[[product_link_service.RemoveProductLinkRequest], Awaitable[product_link_service.RemoveProductLinkResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
