...
class BillingSetupServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> type[BillingSetupServiceTransport]: ...
...
class BillingSetupServiceClient(metaclass=BillingSetupServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | BillingSetupServiceTransport | Callable[..., BillingSetupServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
