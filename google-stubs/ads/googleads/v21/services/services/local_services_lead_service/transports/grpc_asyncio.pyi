...
class LocalServicesLeadServiceGrpcAsyncIOTransport(LocalServicesLeadServiceTransport):
    ...
    @property
    def provide_lead_feedback(self) -> Callable[[local_services_lead_service.ProvideLeadFeedbackRequest], Awaitable[local_services_lead_service.ProvideLeadFeedbackResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
