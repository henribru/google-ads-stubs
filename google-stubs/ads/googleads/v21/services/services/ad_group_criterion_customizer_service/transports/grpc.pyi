...
class AdGroupCriterionCustomizerServiceGrpcTransport(AdGroupCriterionCustomizerServiceTransport):
    ...
    @property
    def mutate_ad_group_criterion_customizers(self) -> Callable[[ad_group_criterion_customizer_service.MutateAdGroupCriterionCustomizersRequest], ad_group_criterion_customizer_service.MutateAdGroupCriterionCustomizersResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
