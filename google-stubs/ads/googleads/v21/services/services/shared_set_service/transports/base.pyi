...
class SharedSetServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_shared_sets(self) -> Callable[[shared_set_service.MutateSharedSetsRequest], shared_set_service.MutateSharedSetsResponse | Awaitable[shared_set_service.MutateSharedSetsResponse]]: ...
    @property
    def kind(self) -> str: ...
