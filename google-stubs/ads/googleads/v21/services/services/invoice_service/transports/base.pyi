...
class InvoiceServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def list_invoices(self) -> Callable[[invoice_service.ListInvoicesRequest], invoice_service.ListInvoicesResponse | Awaitable[invoice_service.ListInvoicesResponse]]: ...
    @property
    def kind(self) -> str: ...
