...
class CampaignLifecycleGoalServiceGrpcTransport(CampaignLifecycleGoalServiceTransport):
    ...
    @property
    def configure_campaign_lifecycle_goals(self) -> Callable[[campaign_lifecycle_goal_service.ConfigureCampaignLifecycleGoalsRequest], campaign_lifecycle_goal_service.ConfigureCampaignLifecycleGoalsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
