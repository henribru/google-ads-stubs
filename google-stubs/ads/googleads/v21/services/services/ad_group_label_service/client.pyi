...
class AdGroupLabelServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> type[AdGroupLabelServiceTransport]: ...
...
class AdGroupLabelServiceClient(metaclass=AdGroupLabelServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | AdGroupLabelServiceTransport | Callable[..., AdGroupLabelServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_ad_group_labels(self, request: ad_group_label_service.MutateAdGroupLabelsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[ad_group_label_service.AdGroupLabelOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> ad_group_label_service.MutateAdGroupLabelsResponse: ...
