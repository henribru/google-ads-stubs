...
class CampaignDraftServiceGrpcTransport(CampaignDraftServiceTransport):
    ...
    @property
    def mutate_campaign_drafts(self) -> Callable[[campaign_draft_service.MutateCampaignDraftsRequest], campaign_draft_service.MutateCampaignDraftsResponse]: ...
    @property
    def promote_campaign_draft(self) -> Callable[[campaign_draft_service.PromoteCampaignDraftRequest], operations_pb2.Operation]: ...
    @property
    def list_campaign_draft_async_errors(self) -> Callable[[campaign_draft_service.ListCampaignDraftAsyncErrorsRequest], campaign_draft_service.ListCampaignDraftAsyncErrorsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
