...
class AdGroupAssetServiceGrpcAsyncIOTransport(AdGroupAssetServiceTransport):
    ...
    @property
    def mutate_ad_group_assets(self) -> Callable[[ad_group_asset_service.MutateAdGroupAssetsRequest], Awaitable[ad_group_asset_service.MutateAdGroupAssetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
