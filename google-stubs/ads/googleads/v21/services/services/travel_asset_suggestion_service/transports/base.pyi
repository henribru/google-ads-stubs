...
class TravelAssetSuggestionServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def suggest_travel_assets(self) -> Callable[[travel_asset_suggestion_service.SuggestTravelAssetsRequest], travel_asset_suggestion_service.SuggestTravelAssetsResponse | Awaitable[travel_asset_suggestion_service.SuggestTravelAssetsResponse]]: ...
    @property
    def kind(self) -> str: ...
