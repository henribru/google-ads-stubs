...
class AssetGroupSignalServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> type[AssetGroupSignalServiceTransport]: ...
...
class AssetGroupSignalServiceClient(metaclass=AssetGroupSignalServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | AssetGroupSignalServiceTransport | Callable[..., AssetGroupSignalServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_asset_group_signals(self, request: asset_group_signal_service.MutateAssetGroupSignalsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[asset_group_signal_service.AssetGroupSignalOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> asset_group_signal_service.MutateAssetGroupSignalsResponse: ...
