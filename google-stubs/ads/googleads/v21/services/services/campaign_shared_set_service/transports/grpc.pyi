...
class CampaignSharedSetServiceGrpcTransport(CampaignSharedSetServiceTransport):
    ...
    @property
    def mutate_campaign_shared_sets(self) -> Callable[[campaign_shared_set_service.MutateCampaignSharedSetsRequest], campaign_shared_set_service.MutateCampaignSharedSetsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
