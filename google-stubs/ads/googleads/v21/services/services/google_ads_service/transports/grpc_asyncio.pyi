...
class GoogleAdsServiceGrpcAsyncIOTransport(GoogleAdsServiceTransport):
    ...
    @property
    def search(self) -> Callable[[google_ads_service.SearchGoogleAdsRequest], Awaitable[google_ads_service.SearchGoogleAdsResponse]]: ...
    @property
    def search_stream(self) -> Callable[[google_ads_service.SearchGoogleAdsStreamRequest], Awaitable[google_ads_service.SearchGoogleAdsStreamResponse]]: ...
    @property
    def mutate(self) -> Callable[[google_ads_service.MutateGoogleAdsRequest], Awaitable[google_ads_service.MutateGoogleAdsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
