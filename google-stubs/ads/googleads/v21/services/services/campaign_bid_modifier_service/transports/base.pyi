...
class CampaignBidModifierServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_campaign_bid_modifiers(self) -> Callable[[campaign_bid_modifier_service.MutateCampaignBidModifiersRequest], campaign_bid_modifier_service.MutateCampaignBidModifiersResponse | Awaitable[campaign_bid_modifier_service.MutateCampaignBidModifiersResponse]]: ...
    @property
    def kind(self) -> str: ...
