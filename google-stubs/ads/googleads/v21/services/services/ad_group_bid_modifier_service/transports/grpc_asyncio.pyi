...
class AdGroupBidModifierServiceGrpcAsyncIOTransport(AdGroupBidModifierServiceTransport):
    @classmethod
    ...
    @property
    def mutate_ad_group_bid_modifiers(self) -> Callable[[ad_group_bid_modifier_service.MutateAdGroupBidModifiersRequest], Awaitable[ad_group_bid_modifier_service.MutateAdGroupBidModifiersResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
