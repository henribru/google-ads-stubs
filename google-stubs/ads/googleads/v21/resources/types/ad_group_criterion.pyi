from google.ads.googleads.v21.common.types.criteria import BrandListInfo
from google.ads.googleads.v21.common.types.criteria import ExtendedDemographicInfo
from google.ads.googleads.v21.common.types.criteria import VideoLineupInfo
from google.ads.googleads.v21.common.types.criteria import LifeEventInfo
from google.ads.googleads.v21.common.types.criteria import LanguageInfo
from google.ads.googleads.v21.common.types.criteria import LocationInfo
from google.ads.googleads.v21.common.types.criteria import AudienceInfo
from google.ads.googleads.v21.common.types.criteria import CombinedAudienceInfo
from google.ads.googleads.v21.common.types.criteria import CustomAudienceInfo
from google.ads.googleads.v21.common.types.criteria import CustomIntentInfo
from google.ads.googleads.v21.common.types.criteria import CustomAffinityInfo
from google.ads.googleads.v21.common.types.criteria import AppPaymentModelInfo
...
from google.ads.googleads.v21.common.types.criteria import TopicInfo
...
from google.ads.googleads.v21.common.types.criteria import ParentalStatusInfo
from google.ads.googleads.v21.common.types.criteria import IncomeRangeInfo
from google.ads.googleads.v21.common.types.criteria import GenderInfo
from google.ads.googleads.v21.common.types.criteria import AgeRangeInfo
from google.ads.googleads.v21.common.types.criteria import ListingGroupInfo
...
from google.ads.googleads.v21.enums.types.ad_group_criterion_primary_status_reason import AdGroupCriterionPrimaryStatusReasonEnum
from google.ads.googleads.v21.enums.types.ad_group_criterion_primary_status import AdGroupCriterionPrimaryStatusEnum
from collections.abc import MutableSequence
...
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from google.ads.googleads.v21.enums.types.ad_group_criterion_approval_status import AdGroupCriterionApprovalStatusEnum
from google.ads.googleads.v21.enums.types.criterion_system_serving_status import CriterionSystemServingStatusEnum
from google.ads.googleads.v21.enums.types.criterion_type import CriterionTypeEnum
from google.ads.googleads.v21.enums.types.ad_group_criterion_status import AdGroupCriterionStatusEnum
from google.ads.googleads.v21.enums.types.quality_score_bucket import QualityScoreBucketEnum
from google.ads.googleads.v21.enums.types.quality_score_bucket import QualityScoreBucketEnum
from google.ads.googleads.v21.enums.types.quality_score_bucket import QualityScoreBucketEnum
import proto
...
class AdGroupCriterion(proto.Message):
    class PositionEstimates(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, first_page_cpc_micros: int = ..., first_position_cpc_micros: int = ..., top_of_page_cpc_micros: int = ..., estimated_add_clicks_at_first_position_cpc: int = ..., estimated_add_cost_at_first_position_cpc: int = ...) -> None: ...
    ...
    class QualityInfo(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, quality_score: int = ..., creative_quality_score: QualityScoreBucketEnum.QualityScoreBucket = ..., post_click_quality_score: QualityScoreBucketEnum.QualityScoreBucket = ..., search_predicted_ctr: QualityScoreBucketEnum.QualityScoreBucket = ...) -> None: ...
        def __contains__(  # type: ignore[override]
