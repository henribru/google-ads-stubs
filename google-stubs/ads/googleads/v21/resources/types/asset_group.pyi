...
from google.ads.googleads.v21.enums.types.asset_group_primary_status_reason import AssetGroupPrimaryStatusReasonEnum
from google.ads.googleads.v21.enums.types.asset_group_primary_status import AssetGroupPrimaryStatusEnum
from google.ads.googleads.v21.enums.types.asset_group_status import AssetGroupStatusEnum
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from google.ads.googleads.v21.enums.types.ad_strength_action_item_type import AdStrengthActionItemTypeEnum
from google.ads.googleads.v21.enums.types.asset_coverage_video_aspect_ratio_requirement import AssetCoverageVideoAspectRatioRequirementEnum
...
class AdStrengthActionItem(proto.Message):
    class AddAssetDetails(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, asset_field_type: AssetFieldTypeEnum.AssetFieldType = ..., asset_count: int = ..., video_aspect_ratio_requirement: AssetCoverageVideoAspectRatioRequirementEnum.AssetCoverageVideoAspectRatioRequirement = ...) -> None: ...
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, action_item_type: AdStrengthActionItemTypeEnum.AdStrengthActionItemType = ..., add_asset_details: AdStrengthActionItem.AddAssetDetails = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class AssetCoverage(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, ad_strength_action_items: MutableSequence[AdStrengthActionItem] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
