...
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from google.ads.googleads.v21.enums.types.insights_knowledge_graph_entity_capabilities import InsightsKnowledgeGraphEntityCapabilitiesEnum
from collections.abc import MutableSequence
...
class YouTubeVideoAttributeMetadata(proto.Message):
    ...
    likes_count: int
    comments_count: int
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, thumbnail_url: str = ..., video_url: str = ..., views_count: int = ..., likes_count: int = ..., comments_count: int = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["thumbnail_url", "video_url", "views_count", "likes_count", "comments_count"]) -> bool: ...
