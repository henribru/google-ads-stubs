...
from google.ads.googleads.v21.enums.types.insights_knowledge_graph_entity_capabilities import (
...
class YouTubeVideoAttributeMetadata(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self,
        key: Literal[
            "thumbnail_url", "video_url", "views_count", "likes_count", "comments_count"
        ],
    ) -> bool: ...
