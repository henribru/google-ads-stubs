...
from google.ads.googleads.v21.enums.types.asset_offline_evaluation_error_reasons import AssetOfflineEvaluationErrorReasonsEnum
...
class AssetDisapproved(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, offline_evaluation_error_reasons: MutableSequence[AssetOfflineEvaluationErrorReasonsEnum.AssetOfflineEvaluationErrorReasons] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class AssetLinkPrimaryStatusDetails(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, reason: AssetLinkPrimaryStatusReasonEnum.AssetLinkPrimaryStatusReason = ..., status: AssetLinkPrimaryStatusEnum.AssetLinkPrimaryStatus = ..., asset_disapproved: AssetDisapproved = ...) -> None: ...
    def __contains__(  # type: ignore[override]
