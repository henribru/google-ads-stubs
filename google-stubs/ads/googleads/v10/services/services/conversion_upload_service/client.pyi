...
class ConversionUploadServiceClient(metaclass=ConversionUploadServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, ConversionUploadServiceTransport, None] = ...,
    ...
    def upload_click_conversions(
        ...
        *,
        customer_id: str = ...,
        conversions: Sequence[conversion_upload_service.ClickConversion] = ...,
    ...
    def upload_call_conversions(
        ...
        *,
        customer_id: str = ...,
        conversions: Sequence[conversion_upload_service.CallConversion] = ...,
        partial_failure: bool = ...,
        retry: Union[retries.Retry, gapic_v1.method._MethodDefault] = ...,
        timeout: float = ...,
        metadata: Sequence[Tuple[str, str]] = ...
