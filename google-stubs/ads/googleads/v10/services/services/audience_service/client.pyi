...
class AudienceServiceClient(metaclass=AudienceServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, AudienceServiceTransport, None] = ...,
        client_options: Optional[client_options_lib.ClientOptions] = ...,
        client_info: gapic_v1.client_info.ClientInfo = ...
    ) -> None: ...
    def mutate_audiences(
        self,
        request: Union[audience_service.MutateAudiencesRequest, dict] = ...,
        *,
        customer_id: str = ...,
        operations: Sequence[audience_service.AudienceOperation] = ...,
