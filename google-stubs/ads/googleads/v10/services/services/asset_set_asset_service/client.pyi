...
class AssetSetAssetServiceClient(metaclass=AssetSetAssetServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, AssetSetAssetServiceTransport, None] = ...,
        client_options: Optional[client_options_lib.ClientOptions] = ...,
        client_info: gapic_v1.client_info.ClientInfo = ...
    ) -> None: ...
    def mutate_asset_set_assets(
        self,
        request: Union[asset_set_asset_service.MutateAssetSetAssetsRequest, dict] = ...,
        *,
        customer_id: str = ...,
        operations: Sequence[asset_set_asset_service.AssetSetAssetOperation] = ...,
