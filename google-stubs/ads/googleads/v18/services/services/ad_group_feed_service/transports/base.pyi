...
class AdGroupFeedServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_ad_group_feeds(self) -> Callable[[ad_group_feed_service.MutateAdGroupFeedsRequest], ad_group_feed_service.MutateAdGroupFeedsResponse | Awaitable[ad_group_feed_service.MutateAdGroupFeedsResponse]]: ...
    @property
    def kind(self) -> str: ...
