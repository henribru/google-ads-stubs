...
class AdGroupFeedServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[AdGroupFeedServiceTransport]: ...
...
class AdGroupFeedServiceClient(metaclass=AdGroupFeedServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | AdGroupFeedServiceTransport | Callable[..., AdGroupFeedServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_ad_group_feeds(self, request: ad_group_feed_service.MutateAdGroupFeedsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[ad_group_feed_service.AdGroupFeedOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> ad_group_feed_service.MutateAdGroupFeedsResponse: ...
