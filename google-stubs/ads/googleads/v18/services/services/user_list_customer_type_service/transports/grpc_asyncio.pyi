...
class UserListCustomerTypeServiceGrpcAsyncIOTransport(UserListCustomerTypeServiceTransport):
    @classmethod
    ...
    @property
    def mutate_user_list_customer_types(self) -> Callable[[user_list_customer_type_service.MutateUserListCustomerTypesRequest], Awaitable[user_list_customer_type_service.MutateUserListCustomerTypesResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
