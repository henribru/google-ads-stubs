...
class KeywordThemeConstantServiceGrpcAsyncIOTransport(KeywordThemeConstantServiceTransport):
    @classmethod
    ...
    @property
    def suggest_keyword_theme_constants(self) -> Callable[[keyword_theme_constant_service.SuggestKeywordThemeConstantsRequest], Awaitable[keyword_theme_constant_service.SuggestKeywordThemeConstantsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
