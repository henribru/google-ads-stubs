...
class CampaignAssetServiceGrpcAsyncIOTransport(CampaignAssetServiceTransport):
    ...
    @property
    def mutate_campaign_assets(self) -> Callable[[campaign_asset_service.MutateCampaignAssetsRequest], Awaitable[campaign_asset_service.MutateCampaignAssetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
