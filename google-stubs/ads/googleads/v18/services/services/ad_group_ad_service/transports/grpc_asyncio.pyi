...
class AdGroupAdServiceGrpcAsyncIOTransport(AdGroupAdServiceTransport):
    ...
    @property
    def mutate_ad_group_ads(self) -> Callable[[ad_group_ad_service.MutateAdGroupAdsRequest], Awaitable[ad_group_ad_service.MutateAdGroupAdsResponse]]: ...
    @property
    def remove_automatically_created_assets(self) -> Callable[[ad_group_ad_service.RemoveAutomaticallyCreatedAssetsRequest], Awaitable[empty_pb2.Empty]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
