...
class CampaignBudgetServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[CampaignBudgetServiceTransport]: ...
...
class CampaignBudgetServiceClient(metaclass=CampaignBudgetServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CampaignBudgetServiceTransport | Callable[..., CampaignBudgetServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_campaign_budgets(self, request: campaign_budget_service.MutateCampaignBudgetsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[campaign_budget_service.CampaignBudgetOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> campaign_budget_service.MutateCampaignBudgetsResponse: ...
