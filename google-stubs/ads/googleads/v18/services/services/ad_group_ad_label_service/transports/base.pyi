...
class AdGroupAdLabelServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_ad_group_ad_labels(self) -> Callable[[ad_group_ad_label_service.MutateAdGroupAdLabelsRequest], ad_group_ad_label_service.MutateAdGroupAdLabelsResponse | Awaitable[ad_group_ad_label_service.MutateAdGroupAdLabelsResponse]]: ...
    @property
    def kind(self) -> str: ...
