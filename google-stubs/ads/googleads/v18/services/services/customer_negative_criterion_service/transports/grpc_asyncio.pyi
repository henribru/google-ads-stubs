...
class CustomerNegativeCriterionServiceGrpcAsyncIOTransport(CustomerNegativeCriterionServiceTransport):
    @classmethod
    ...
    @property
    def mutate_customer_negative_criteria(self) -> Callable[[customer_negative_criterion_service.MutateCustomerNegativeCriteriaRequest], Awaitable[customer_negative_criterion_service.MutateCustomerNegativeCriteriaResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
