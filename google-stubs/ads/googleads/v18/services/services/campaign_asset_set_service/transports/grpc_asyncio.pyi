...
class CampaignAssetSetServiceGrpcAsyncIOTransport(CampaignAssetSetServiceTransport):
    @classmethod
    ...
    @property
    def mutate_campaign_asset_sets(self) -> Callable[[campaign_asset_set_service.MutateCampaignAssetSetsRequest], Awaitable[campaign_asset_set_service.MutateCampaignAssetSetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
