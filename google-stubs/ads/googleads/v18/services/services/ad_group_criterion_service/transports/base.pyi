...
class AdGroupCriterionServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_ad_group_criteria(self) -> Callable[[ad_group_criterion_service.MutateAdGroupCriteriaRequest], ad_group_criterion_service.MutateAdGroupCriteriaResponse | Awaitable[ad_group_criterion_service.MutateAdGroupCriteriaResponse]]: ...
    @property
    def kind(self) -> str: ...
