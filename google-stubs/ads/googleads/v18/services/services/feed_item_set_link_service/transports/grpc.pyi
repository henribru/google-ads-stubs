...
class FeedItemSetLinkServiceGrpcTransport(FeedItemSetLinkServiceTransport):
    ...
    @property
    def mutate_feed_item_set_links(self) -> Callable[[feed_item_set_link_service.MutateFeedItemSetLinksRequest], feed_item_set_link_service.MutateFeedItemSetLinksResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
