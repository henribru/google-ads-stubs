...
class FeedItemSetLinkServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_feed_item_set_links(self) -> Callable[[feed_item_set_link_service.MutateFeedItemSetLinksRequest], feed_item_set_link_service.MutateFeedItemSetLinksResponse | Awaitable[feed_item_set_link_service.MutateFeedItemSetLinksResponse]]: ...
    @property
    def kind(self) -> str: ...
