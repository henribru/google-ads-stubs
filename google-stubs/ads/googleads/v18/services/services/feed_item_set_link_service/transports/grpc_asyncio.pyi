...
class FeedItemSetLinkServiceGrpcAsyncIOTransport(FeedItemSetLinkServiceTransport):
    @classmethod
    ...
    @property
    def mutate_feed_item_set_links(self) -> Callable[[feed_item_set_link_service.MutateFeedItemSetLinksRequest], Awaitable[feed_item_set_link_service.MutateFeedItemSetLinksResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
