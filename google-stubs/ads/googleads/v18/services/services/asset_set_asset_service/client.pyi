...
class AssetSetAssetServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[AssetSetAssetServiceTransport]: ...
...
class AssetSetAssetServiceClient(metaclass=AssetSetAssetServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | AssetSetAssetServiceTransport | Callable[..., AssetSetAssetServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_asset_set_assets(self, request: asset_set_asset_service.MutateAssetSetAssetsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[asset_set_asset_service.AssetSetAssetOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> asset_set_asset_service.MutateAssetSetAssetsResponse: ...
