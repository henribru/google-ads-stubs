...
class FeedItemServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_feed_items(self) -> Callable[[feed_item_service.MutateFeedItemsRequest], feed_item_service.MutateFeedItemsResponse | Awaitable[feed_item_service.MutateFeedItemsResponse]]: ...
    @property
    def kind(self) -> str: ...
