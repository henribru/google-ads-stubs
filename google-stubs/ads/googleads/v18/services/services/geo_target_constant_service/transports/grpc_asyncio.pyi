...
class GeoTargetConstantServiceGrpcAsyncIOTransport(GeoTargetConstantServiceTransport):
    @classmethod
    ...
    @property
    def suggest_geo_target_constants(self) -> Callable[[geo_target_constant_service.SuggestGeoTargetConstantsRequest], Awaitable[geo_target_constant_service.SuggestGeoTargetConstantsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
