...
class ContentCreatorInsightsServiceGrpcAsyncIOTransport(ContentCreatorInsightsServiceTransport):
    @classmethod
    ...
    @property
    def generate_creator_insights(self) -> Callable[[content_creator_insights_service.GenerateCreatorInsightsRequest], Awaitable[content_creator_insights_service.GenerateCreatorInsightsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
