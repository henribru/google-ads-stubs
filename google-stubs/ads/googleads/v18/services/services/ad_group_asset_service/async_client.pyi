...
class AdGroupAssetServiceAsyncClient:
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | AdGroupAssetServiceTransport | Callable[..., AdGroupAssetServiceTransport] | None = 'grpc_asyncio', client_options: ClientOptions | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    async def mutate_ad_group_assets(self, request: ad_group_asset_service.MutateAdGroupAssetsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[ad_group_asset_service.AdGroupAssetOperation] | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> ad_group_asset_service.MutateAdGroupAssetsResponse: ...
