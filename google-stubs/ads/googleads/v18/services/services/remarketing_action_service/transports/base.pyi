...
class RemarketingActionServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_remarketing_actions(self) -> Callable[[remarketing_action_service.MutateRemarketingActionsRequest], remarketing_action_service.MutateRemarketingActionsResponse | Awaitable[remarketing_action_service.MutateRemarketingActionsResponse]]: ...
    @property
    def kind(self) -> str: ...
