...
class RemarketingActionServiceGrpcTransport(RemarketingActionServiceTransport):
    ...
    @property
    def mutate_remarketing_actions(self) -> Callable[[remarketing_action_service.MutateRemarketingActionsRequest], remarketing_action_service.MutateRemarketingActionsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
