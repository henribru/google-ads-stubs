...
class CampaignSharedSetServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_campaign_shared_sets(self) -> Callable[[campaign_shared_set_service.MutateCampaignSharedSetsRequest], campaign_shared_set_service.MutateCampaignSharedSetsResponse | Awaitable[campaign_shared_set_service.MutateCampaignSharedSetsResponse]]: ...
    @property
    def kind(self) -> str: ...
