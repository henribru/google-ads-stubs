...
class AssetSetServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_asset_sets(self) -> Callable[[asset_set_service.MutateAssetSetsRequest], asset_set_service.MutateAssetSetsResponse | Awaitable[asset_set_service.MutateAssetSetsResponse]]: ...
    @property
    def kind(self) -> str: ...
