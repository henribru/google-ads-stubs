...
class CustomConversionGoalServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[CustomConversionGoalServiceTransport]: ...

class CustomConversionGoalServiceClient(metaclass=CustomConversionGoalServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CustomConversionGoalServiceTransport | Callable[..., CustomConversionGoalServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_custom_conversion_goals(self, request: custom_conversion_goal_service.MutateCustomConversionGoalsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[custom_conversion_goal_service.CustomConversionGoalOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> custom_conversion_goal_service.MutateCustomConversionGoalsResponse: ...
