...
class CampaignFeedServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[CampaignFeedServiceTransport]: ...
...
class CampaignFeedServiceClient(metaclass=CampaignFeedServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CampaignFeedServiceTransport | Callable[..., CampaignFeedServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_campaign_feeds(self, request: campaign_feed_service.MutateCampaignFeedsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[campaign_feed_service.CampaignFeedOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> campaign_feed_service.MutateCampaignFeedsResponse: ...
