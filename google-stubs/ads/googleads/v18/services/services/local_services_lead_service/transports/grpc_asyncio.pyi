...
class LocalServicesLeadServiceGrpcAsyncIOTransport(LocalServicesLeadServiceTransport):
    ...
    @property
    def append_lead_conversation(self) -> Callable[[local_services_lead_service.AppendLeadConversationRequest], Awaitable[local_services_lead_service.AppendLeadConversationResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
