...
class AdGroupAssetSetServiceGrpcTransport(AdGroupAssetSetServiceTransport):
    ...
    @property
    def mutate_ad_group_asset_sets(self) -> Callable[[ad_group_asset_set_service.MutateAdGroupAssetSetsRequest], ad_group_asset_set_service.MutateAdGroupAssetSetsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
