...
class FeedServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[FeedServiceTransport]: ...
...
class FeedServiceClient(metaclass=FeedServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | FeedServiceTransport | Callable[..., FeedServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_feeds(self, request: feed_service.MutateFeedsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[feed_service.FeedOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> feed_service.MutateFeedsResponse: ...
