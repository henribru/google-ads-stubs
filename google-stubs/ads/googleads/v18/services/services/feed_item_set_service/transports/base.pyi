...
class FeedItemSetServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_feed_item_sets(self) -> Callable[[feed_item_set_service.MutateFeedItemSetsRequest], feed_item_set_service.MutateFeedItemSetsResponse | Awaitable[feed_item_set_service.MutateFeedItemSetsResponse]]: ...
    @property
    def kind(self) -> str: ...
