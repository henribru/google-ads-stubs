...
class CampaignExtensionSettingServiceGrpcAsyncIOTransport(CampaignExtensionSettingServiceTransport):
    @classmethod
    ...
    @property
    def mutate_campaign_extension_settings(self) -> Callable[[campaign_extension_setting_service.MutateCampaignExtensionSettingsRequest], Awaitable[campaign_extension_setting_service.MutateCampaignExtensionSettingsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
