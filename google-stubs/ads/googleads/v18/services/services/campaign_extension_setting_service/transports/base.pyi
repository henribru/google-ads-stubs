...
class CampaignExtensionSettingServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_campaign_extension_settings(self) -> Callable[[campaign_extension_setting_service.MutateCampaignExtensionSettingsRequest], campaign_extension_setting_service.MutateCampaignExtensionSettingsResponse | Awaitable[campaign_extension_setting_service.MutateCampaignExtensionSettingsResponse]]: ...
    @property
    def kind(self) -> str: ...
