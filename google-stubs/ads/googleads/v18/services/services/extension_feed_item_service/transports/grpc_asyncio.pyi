...
class ExtensionFeedItemServiceGrpcAsyncIOTransport(ExtensionFeedItemServiceTransport):
    @classmethod
    ...
    @property
    def mutate_extension_feed_items(self) -> Callable[[extension_feed_item_service.MutateExtensionFeedItemsRequest], Awaitable[extension_feed_item_service.MutateExtensionFeedItemsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
