...
class ExtensionFeedItemServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_extension_feed_items(self) -> Callable[[extension_feed_item_service.MutateExtensionFeedItemsRequest], extension_feed_item_service.MutateExtensionFeedItemsResponse | Awaitable[extension_feed_item_service.MutateExtensionFeedItemsResponse]]: ...
    @property
    def kind(self) -> str: ...
