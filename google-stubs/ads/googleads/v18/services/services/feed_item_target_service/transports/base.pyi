...
class FeedItemTargetServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_feed_item_targets(self) -> Callable[[feed_item_target_service.MutateFeedItemTargetsRequest], feed_item_target_service.MutateFeedItemTargetsResponse | Awaitable[feed_item_target_service.MutateFeedItemTargetsResponse]]: ...
    @property
    def kind(self) -> str: ...
