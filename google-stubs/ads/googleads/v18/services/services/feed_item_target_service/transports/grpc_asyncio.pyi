...
class FeedItemTargetServiceGrpcAsyncIOTransport(FeedItemTargetServiceTransport):
    ...
    @property
    def mutate_feed_item_targets(self) -> Callable[[feed_item_target_service.MutateFeedItemTargetsRequest], Awaitable[feed_item_target_service.MutateFeedItemTargetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
