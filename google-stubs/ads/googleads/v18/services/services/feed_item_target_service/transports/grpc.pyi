...
class FeedItemTargetServiceGrpcTransport(FeedItemTargetServiceTransport):
    ...
    @property
    def mutate_feed_item_targets(self) -> Callable[[feed_item_target_service.MutateFeedItemTargetsRequest], feed_item_target_service.MutateFeedItemTargetsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
