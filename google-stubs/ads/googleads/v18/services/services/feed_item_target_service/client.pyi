...
class FeedItemTargetServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[FeedItemTargetServiceTransport]: ...
...
class FeedItemTargetServiceClient(metaclass=FeedItemTargetServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | FeedItemTargetServiceTransport | Callable[..., FeedItemTargetServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_feed_item_targets(self, request: feed_item_target_service.MutateFeedItemTargetsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[feed_item_target_service.FeedItemTargetOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> feed_item_target_service.MutateFeedItemTargetsResponse: ...
