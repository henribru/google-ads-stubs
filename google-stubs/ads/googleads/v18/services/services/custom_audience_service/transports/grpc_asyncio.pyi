...
class CustomAudienceServiceGrpcAsyncIOTransport(CustomAudienceServiceTransport):
    ...
    @property
    def mutate_custom_audiences(self) -> Callable[[custom_audience_service.MutateCustomAudiencesRequest], Awaitable[custom_audience_service.MutateCustomAudiencesResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
