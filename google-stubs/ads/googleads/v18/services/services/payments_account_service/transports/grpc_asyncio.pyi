...
class PaymentsAccountServiceGrpcAsyncIOTransport(PaymentsAccountServiceTransport):
    @classmethod
    ...
    @property
    def list_payments_accounts(self) -> Callable[[payments_account_service.ListPaymentsAccountsRequest], Awaitable[payments_account_service.ListPaymentsAccountsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
