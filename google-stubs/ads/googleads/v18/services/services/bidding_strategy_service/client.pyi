...
class BiddingStrategyServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[BiddingStrategyServiceTransport]: ...
...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | BiddingStrategyServiceTransport | Callable[..., BiddingStrategyServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_bidding_strategies(self, request: bidding_strategy_service.MutateBiddingStrategiesRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[bidding_strategy_service.BiddingStrategyOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> bidding_strategy_service.MutateBiddingStrategiesResponse: ...
