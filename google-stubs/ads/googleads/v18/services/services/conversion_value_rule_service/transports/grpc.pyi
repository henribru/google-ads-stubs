...
class ConversionValueRuleServiceGrpcTransport(ConversionValueRuleServiceTransport):
    ...
    @property
    def mutate_conversion_value_rules(self) -> Callable[[conversion_value_rule_service.MutateConversionValueRulesRequest], conversion_value_rule_service.MutateConversionValueRulesResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
