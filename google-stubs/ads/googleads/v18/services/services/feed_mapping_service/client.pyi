...
class FeedMappingServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[FeedMappingServiceTransport]: ...
...
class FeedMappingServiceClient(metaclass=FeedMappingServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | FeedMappingServiceTransport | Callable[..., FeedMappingServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_feed_mappings(self, request: feed_mapping_service.MutateFeedMappingsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[feed_mapping_service.FeedMappingOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> feed_mapping_service.MutateFeedMappingsResponse: ...
