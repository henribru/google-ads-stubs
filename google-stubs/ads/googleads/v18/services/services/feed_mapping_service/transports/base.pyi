...
class FeedMappingServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_feed_mappings(self) -> Callable[[feed_mapping_service.MutateFeedMappingsRequest], feed_mapping_service.MutateFeedMappingsResponse | Awaitable[feed_mapping_service.MutateFeedMappingsResponse]]: ...
    @property
    def kind(self) -> str: ...
