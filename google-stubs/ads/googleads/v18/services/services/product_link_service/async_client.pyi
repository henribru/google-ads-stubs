...
from google.ads.googleads.v18.resources.types import product_link as gagr_product_link
...
class ProductLinkServiceAsyncClient:
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | ProductLinkServiceTransport | Callable[..., ProductLinkServiceTransport] | None = 'grpc_asyncio', client_options: ClientOptions | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    async def create_product_link(self, request: product_link_service.CreateProductLinkRequest | dict | None = None, *, customer_id: str | None = None, product_link: gagr_product_link.ProductLink | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> product_link_service.CreateProductLinkResponse: ...
    async def remove_product_link(self, request: product_link_service.RemoveProductLinkRequest | dict | None = None, *, customer_id: str | None = None, resource_name: str | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> product_link_service.RemoveProductLinkResponse: ...
