...
class CustomerUserAccessInvitationServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[CustomerUserAccessInvitationServiceTransport]: ...
