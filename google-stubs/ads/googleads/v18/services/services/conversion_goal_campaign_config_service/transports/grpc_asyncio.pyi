...
from google.ads.googleads.v18.services.types import conversion_goal_campaign_config_service
...
class ConversionGoalCampaignConfigServiceGrpcAsyncIOTransport(ConversionGoalCampaignConfigServiceTransport):
    @classmethod
    ...
    @property
    def mutate_conversion_goal_campaign_configs(self) -> Callable[[conversion_goal_campaign_config_service.MutateConversionGoalCampaignConfigsRequest], Awaitable[conversion_goal_campaign_config_service.MutateConversionGoalCampaignConfigsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
