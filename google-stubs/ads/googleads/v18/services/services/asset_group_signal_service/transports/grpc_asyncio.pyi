...
class AssetGroupSignalServiceGrpcAsyncIOTransport(AssetGroupSignalServiceTransport):
    @classmethod
    ...
    @property
    def mutate_asset_group_signals(self) -> Callable[[asset_group_signal_service.MutateAssetGroupSignalsRequest], Awaitable[asset_group_signal_service.MutateAssetGroupSignalsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
