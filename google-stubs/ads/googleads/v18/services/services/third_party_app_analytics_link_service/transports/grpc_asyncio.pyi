...
class ThirdPartyAppAnalyticsLinkServiceGrpcAsyncIOTransport(ThirdPartyAppAnalyticsLinkServiceTransport):
    @classmethod
    ...
    @property
    def regenerate_shareable_link_id(self) -> Callable[[third_party_app_analytics_link_service.RegenerateShareableLinkIdRequest], Awaitable[third_party_app_analytics_link_service.RegenerateShareableLinkIdResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
