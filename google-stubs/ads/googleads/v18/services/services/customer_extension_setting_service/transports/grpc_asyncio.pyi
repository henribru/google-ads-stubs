...
class CustomerExtensionSettingServiceGrpcAsyncIOTransport(CustomerExtensionSettingServiceTransport):
    @classmethod
    ...
    @property
    def mutate_customer_extension_settings(self) -> Callable[[customer_extension_setting_service.MutateCustomerExtensionSettingsRequest], Awaitable[customer_extension_setting_service.MutateCustomerExtensionSettingsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
