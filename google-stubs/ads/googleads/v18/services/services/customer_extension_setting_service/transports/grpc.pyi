...
class CustomerExtensionSettingServiceGrpcTransport(CustomerExtensionSettingServiceTransport):
    ...
    @property
    def mutate_customer_extension_settings(self) -> Callable[[customer_extension_setting_service.MutateCustomerExtensionSettingsRequest], customer_extension_setting_service.MutateCustomerExtensionSettingsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
