...
class CampaignBidModifierServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[CampaignBidModifierServiceTransport]: ...
...
class CampaignBidModifierServiceClient(metaclass=CampaignBidModifierServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CampaignBidModifierServiceTransport | Callable[..., CampaignBidModifierServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_campaign_bid_modifiers(self, request: campaign_bid_modifier_service.MutateCampaignBidModifiersRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[campaign_bid_modifier_service.CampaignBidModifierOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> campaign_bid_modifier_service.MutateCampaignBidModifiersResponse: ...
