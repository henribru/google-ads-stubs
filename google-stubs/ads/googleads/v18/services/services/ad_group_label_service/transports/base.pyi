...
class AdGroupLabelServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_ad_group_labels(self) -> Callable[[ad_group_label_service.MutateAdGroupLabelsRequest], ad_group_label_service.MutateAdGroupLabelsResponse | Awaitable[ad_group_label_service.MutateAdGroupLabelsResponse]]: ...
    @property
    def kind(self) -> str: ...
