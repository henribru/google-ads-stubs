...
class AdGroupLabelServiceGrpcAsyncIOTransport(AdGroupLabelServiceTransport):
    ...
    @property
    def mutate_ad_group_labels(self) -> Callable[[ad_group_label_service.MutateAdGroupLabelsRequest], Awaitable[ad_group_label_service.MutateAdGroupLabelsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
