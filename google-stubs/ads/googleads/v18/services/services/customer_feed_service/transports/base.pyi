...
class CustomerFeedServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_customer_feeds(self) -> Callable[[customer_feed_service.MutateCustomerFeedsRequest], customer_feed_service.MutateCustomerFeedsResponse | Awaitable[customer_feed_service.MutateCustomerFeedsResponse]]: ...
    @property
    def kind(self) -> str: ...
