...
class CustomerFeedServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[CustomerFeedServiceTransport]: ...
...
class CustomerFeedServiceClient(metaclass=CustomerFeedServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CustomerFeedServiceTransport | Callable[..., CustomerFeedServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_customer_feeds(self, request: customer_feed_service.MutateCustomerFeedsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[customer_feed_service.CustomerFeedOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> customer_feed_service.MutateCustomerFeedsResponse: ...
