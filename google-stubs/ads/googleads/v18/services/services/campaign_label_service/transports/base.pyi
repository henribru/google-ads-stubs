...
class CampaignLabelServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_campaign_labels(self) -> Callable[[campaign_label_service.MutateCampaignLabelsRequest], campaign_label_service.MutateCampaignLabelsResponse | Awaitable[campaign_label_service.MutateCampaignLabelsResponse]]: ...
    @property
    def kind(self) -> str: ...
