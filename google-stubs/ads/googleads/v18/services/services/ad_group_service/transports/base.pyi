...
class AdGroupServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_ad_groups(self) -> Callable[[ad_group_service.MutateAdGroupsRequest], ad_group_service.MutateAdGroupsResponse | Awaitable[ad_group_service.MutateAdGroupsResponse]]: ...
    @property
    def kind(self) -> str: ...
