...
class AdGroupExtensionSettingServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[AdGroupExtensionSettingServiceTransport]: ...
...
class AdGroupExtensionSettingServiceClient(metaclass=AdGroupExtensionSettingServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | AdGroupExtensionSettingServiceTransport | Callable[..., AdGroupExtensionSettingServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_ad_group_extension_settings(self, request: ad_group_extension_setting_service.MutateAdGroupExtensionSettingsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[ad_group_extension_setting_service.AdGroupExtensionSettingOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> ad_group_extension_setting_service.MutateAdGroupExtensionSettingsResponse: ...
