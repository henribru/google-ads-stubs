...
class AdGroupExtensionSettingServiceGrpcAsyncIOTransport(AdGroupExtensionSettingServiceTransport):
    @classmethod
    ...
    @property
    def mutate_ad_group_extension_settings(self) -> Callable[[ad_group_extension_setting_service.MutateAdGroupExtensionSettingsRequest], Awaitable[ad_group_extension_setting_service.MutateAdGroupExtensionSettingsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
