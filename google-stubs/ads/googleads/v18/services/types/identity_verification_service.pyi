from google.ads.googleads.v18.enums.types.identity_verification_program import IdentityVerificationProgramEnum
from google.ads.googleads.v18.enums.types.identity_verification_program_status import IdentityVerificationProgramStatusEnum
from google.ads.googleads.v18.enums.types.identity_verification_program import IdentityVerificationProgramEnum
...
class GetIdentityVerificationResponse(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, identity_verification: MutableSequence[IdentityVerification] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class IdentityVerification(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, verification_program: IdentityVerificationProgramEnum.IdentityVerificationProgram = ..., identity_verification_requirement: IdentityVerificationRequirement = ..., verification_progress: IdentityVerificationProgress = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class IdentityVerificationProgress(proto.Message):
    ...
    action_url: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, program_status: IdentityVerificationProgramStatusEnum.IdentityVerificationProgramStatus = ..., invitation_link_expiration_time: str = ..., action_url: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class IdentityVerificationRequirement(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, verification_start_deadline_time: str = ..., verification_completion_deadline_time: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class StartIdentityVerificationRequest(proto.Message):
    customer_id: str
    verification_program: IdentityVerificationProgramEnum.IdentityVerificationProgram
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., verification_program: IdentityVerificationProgramEnum.IdentityVerificationProgram = ...) -> None: ...
    def __contains__(  # type: ignore[override]
