...
class CampaignBudgetMapping(proto.Message):
    ...
    campaign_budget: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., experiment_campaign: str = ..., campaign_budget: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["experiment_campaign", "campaign_budget"]) -> bool: ...
class EndExperimentRequest(proto.Message):
    experiment: str
    validate_only: bool
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., experiment: str = ..., validate_only: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ExperimentOperation(proto.Message):
    ...
    update: Experiment
    remove: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., update_mask: FieldMask = ..., create: Experiment = ..., update: Experiment = ..., remove: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class GraduateExperimentRequest(proto.Message):
    ...
    validate_only: bool
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., experiment: str = ..., campaign_budget_mappings: MutableSequence[CampaignBudgetMapping] = ..., validate_only: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ListExperimentAsyncErrorsRequest(proto.Message):
    ...
    page_token: str
    page_size: int
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., resource_name: str = ..., page_token: str = ..., page_size: int = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ListExperimentAsyncErrorsResponse(proto.Message):
    ...
    next_page_token: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., errors: MutableSequence[Status] = ..., next_page_token: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class MutateExperimentsRequest(proto.Message):
    ...
    validate_only: bool
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., operations: MutableSequence[ExperimentOperation] = ..., partial_failure: bool = ..., validate_only: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class MutateExperimentsResponse(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., partial_failure_error: Status = ..., results: MutableSequence[MutateExperimentResult] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["partial_failure_error", "results"]) -> bool: ...
class PromoteExperimentMetadata(proto.Message):
    experiment: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., experiment: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
