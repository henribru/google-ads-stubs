...
class CustomerUserAccessInvitationOperation(proto.Message):
    ...
    remove: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, create: CustomerUserAccessInvitation = ..., remove: str = ...) -> None: ...
...
class MutateCustomerUserAccessInvitationRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., operation: CustomerUserAccessInvitationOperation = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class MutateCustomerUserAccessInvitationResponse(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, result: MutateCustomerUserAccessInvitationResult = ...) -> None: ...
    def __contains__(  # type: ignore[override]
