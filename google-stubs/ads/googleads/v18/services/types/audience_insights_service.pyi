...
class AudienceInsightsAttribute(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, age_range: AgeRangeInfo = ..., gender: GenderInfo = ..., location: LocationInfo = ..., user_interest: UserInterestInfo = ..., entity: AudienceInsightsEntity = ..., category: AudienceInsightsCategory = ..., dynamic_lineup: AudienceInsightsDynamicLineup = ..., parental_status: ParentalStatusInfo = ..., income_range: IncomeRangeInfo = ..., youtube_channel: YouTubeChannelInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class AudienceInsightsAttributeMetadata(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, dimension: AudienceInsightsDimensionEnum.AudienceInsightsDimension = ..., attribute: AudienceInsightsAttribute = ..., display_name: str = ..., display_info: str = ..., potential_youtube_reach: int = ..., youtube_channel_metadata: YouTubeChannelAttributeMetadata = ..., dynamic_attribute_metadata: DynamicLineupAttributeMetadata = ..., location_attribute_metadata: LocationAttributeMetadata = ..., user_interest_attribute_metadata: UserInterestAttributeMetadata = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class GenerateAudienceCompositionInsightsRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., audience: InsightsAudience = ..., baseline_audience: InsightsAudience = ..., data_month: str = ..., dimensions: MutableSequence[AudienceInsightsDimensionEnum.AudienceInsightsDimension] = ..., customer_insights_group: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class GenerateInsightsFinderReportRequest(proto.Message):
    ...
    customer_insights_group: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., baseline_audience: BasicInsightsAudience = ..., specific_audience: BasicInsightsAudience = ..., customer_insights_group: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class GenerateSuggestedTargetingInsightsRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., customer_insights_group: str = ..., audience_definition: InsightsAudienceDefinition = ..., audience_description: InsightsAudienceDescription = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class GenerateTargetingSuggestionMetricsRequest(proto.Message):
    ...
    customer_insights_group: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., audiences: MutableSequence[BasicInsightsAudience] = ..., customer_insights_group: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
