...
class GenerateCreatorInsightsRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., customer_insights_group: str = ..., search_attributes: GenerateCreatorInsightsRequest.SearchAttributes = ..., search_channels: GenerateCreatorInsightsRequest.YouTubeChannels = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class YouTubeChannelInsights(proto.Message):
    ...
    channel_type: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., display_name: str = ..., youtube_channel: YouTubeChannelInfo = ..., channel_metrics: YouTubeMetrics = ..., channel_audience_demographics: MutableSequence[AudienceInsightsAttributeMetadata] = ..., channel_attributes: MutableSequence[AudienceInsightsAttributeMetadata] = ..., channel_type: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class YouTubeMetrics(proto.Message):
    ...
    views_count: int
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., subscriber_count: int = ..., views_count: int = ...) -> None: ...
    def __contains__(  # type: ignore[override]
