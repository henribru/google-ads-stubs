...
class CreateProductLinkInvitationRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., product_link_invitation: ProductLinkInvitation = ...) -> None: ...
...
class UpdateProductLinkInvitationRequest(proto.Message):
    ...
    resource_name: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., product_link_invitation_status: ProductLinkInvitationStatusEnum.ProductLinkInvitationStatus = ..., resource_name: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
