...
class KeywordPlanAdGroupKeywordOperation(proto.Message):
    ...
    remove: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., update_mask: FieldMask = ..., create: KeywordPlanAdGroupKeyword = ..., update: KeywordPlanAdGroupKeyword = ..., remove: str = ...) -> None: ...
...
class MutateKeywordPlanAdGroupKeywordsRequest(proto.Message):
    ...
    validate_only: bool
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., operations: MutableSequence[KeywordPlanAdGroupKeywordOperation] = ..., partial_failure: bool = ..., validate_only: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class MutateKeywordPlanAdGroupKeywordsResponse(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., partial_failure_error: Status = ..., results: MutableSequence[MutateKeywordPlanAdGroupKeywordResult] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
