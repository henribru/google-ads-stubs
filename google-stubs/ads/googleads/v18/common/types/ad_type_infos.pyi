...
class AppAdInfo(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., mandatory_ad_text: AdTextAsset = ..., headlines: MutableSequence[AdTextAsset] = ..., descriptions: MutableSequence[AdTextAsset] = ..., images: MutableSequence[AdImageAsset] = ..., youtube_videos: MutableSequence[AdVideoAsset] = ..., html5_media_bundles: MutableSequence[AdMediaBundleAsset] = ...) -> None: ...
...
class DemandGenMultiAssetAdInfo(proto.Message):
    ...
    call_to_action_text: str
    lead_form_only: bool
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., marketing_images: MutableSequence[AdImageAsset] = ..., square_marketing_images: MutableSequence[AdImageAsset] = ..., portrait_marketing_images: MutableSequence[AdImageAsset] = ..., logo_images: MutableSequence[AdImageAsset] = ..., headlines: MutableSequence[AdTextAsset] = ..., descriptions: MutableSequence[AdTextAsset] = ..., business_name: str = ..., call_to_action_text: str = ..., lead_form_only: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class VideoAdInfo(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., video: AdVideoAsset = ..., in_stream: VideoTrueViewInStreamAdInfo = ..., bumper: VideoBumperInStreamAdInfo = ..., out_stream: VideoOutstreamAdInfo = ..., non_skippable: VideoNonSkippableInStreamAdInfo = ..., in_feed: InFeedVideoAdInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
