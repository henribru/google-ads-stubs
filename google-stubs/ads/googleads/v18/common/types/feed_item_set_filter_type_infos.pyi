...
class BusinessNameFilter(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., business_name: str = ..., filter_type: FeedItemSetStringFilterTypeEnum.FeedItemSetStringFilterType = ...) -> None: ...
...
class DynamicAffiliateLocationSetFilter(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., chain_ids: MutableSequence[int] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["chain_ids"]) -> bool: ...
class DynamicLocationSetFilter(proto.Message):
    labels: MutableSequence[str]
    business_name_filter: BusinessNameFilter
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., labels: MutableSequence[str] = ..., business_name_filter: BusinessNameFilter = ...) -> None: ...
    def __contains__(  # type: ignore[override]
