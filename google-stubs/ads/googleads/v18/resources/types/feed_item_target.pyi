...
class FeedItemTarget(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., resource_name: str = ..., feed_item: str = ..., feed_item_target_type: FeedItemTargetTypeEnum.FeedItemTargetType = ..., feed_item_target_id: int = ..., status: FeedItemTargetStatusEnum.FeedItemTargetStatus = ..., campaign: str = ..., ad_group: str = ..., keyword: KeywordInfo = ..., geo_target_constant: str = ..., device: FeedItemTargetDeviceEnum.FeedItemTargetDevice = ..., ad_schedule: AdScheduleInfo = ...) -> None: ...
