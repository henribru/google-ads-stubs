...
from google.ads.googleads.v18.enums.types.local_services_participant_type import LocalServicesParticipantTypeEnum
from google.ads.googleads.v18.enums.types.local_services_conversation_type import LocalServicesLeadConversationTypeEnum
import proto
...
class LocalServicesLeadConversation(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, resource_name: str = ..., id: int = ..., conversation_channel: LocalServicesLeadConversationTypeEnum.ConversationType = ..., participant_type: LocalServicesParticipantTypeEnum.ParticipantType = ..., lead: str = ..., event_date_time: str = ..., phone_call_details: PhoneCallDetails = ..., message_details: MessageDetails = ...) -> None: ...
...
class MessageDetails(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, text: str = ..., attachment_urls: MutableSequence[str] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class PhoneCallDetails(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, call_duration_millis: int = ..., call_recording_url: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
