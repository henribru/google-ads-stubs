...
class FeedItemAttributeValue(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, feed_attribute_id: int = ..., integer_value: int = ..., boolean_value: bool = ..., string_value: str = ..., double_value: float = ..., price_value: Money = ..., integer_values: MutableSequence[int] = ..., boolean_values: MutableSequence[bool] = ..., string_values: MutableSequence[str] = ..., double_values: MutableSequence[float] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class FeedItemValidationError(proto.Message):
    ...
    extra_info: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, validation_error: FeedItemValidationErrorEnum.FeedItemValidationError = ..., description: str = ..., feed_attribute_ids: MutableSequence[int] = ..., extra_info: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
