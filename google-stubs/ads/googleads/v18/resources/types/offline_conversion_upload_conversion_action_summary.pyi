...
from google.ads.googleads.v18.resources.types.offline_conversion_upload_client_summary import OfflineConversionAlert
from collections.abc import MutableSequence
from google.ads.googleads.v18.resources.types.offline_conversion_upload_client_summary import OfflineConversionSummary
from collections.abc import MutableSequence
from google.ads.googleads.v18.resources.types.offline_conversion_upload_client_summary import OfflineConversionSummary
...
class OfflineConversionUploadConversionActionSummary(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., resource_name: str = ..., client: OfflineEventUploadClientEnum.OfflineEventUploadClient = ..., conversion_action_id: int = ..., conversion_action_name: str = ..., status: OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus = ..., total_event_count: int = ..., successful_event_count: int = ..., pending_event_count: int = ..., last_upload_date_time: str = ..., daily_summaries: MutableSequence[OfflineConversionSummary] = ..., job_summaries: MutableSequence[OfflineConversionSummary] = ..., alerts: MutableSequence[OfflineConversionAlert] = ...) -> None: ...
