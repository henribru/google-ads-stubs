...
from google.ads.googleads.v25.common.types.asset_policy import AdAssetPolicySummary
...
class AdVideoAssetInfo(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self,
        key: Literal[
            "ad_video_asset_inventory_preferences", "ad_video_asset_feature_control"
        ],
    ) -> bool: ...
...
class AdVideoAssetLinkFeatureControl(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["allow_youtube_comments"]
    ) -> bool: ...
