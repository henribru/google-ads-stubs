...
from google.ads.googleads.v25.enums.types.youtube_video_property import (
...
class KnowledgeGraphAttributeMetadata(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["entity_capabilities", "related_categories"]
    ) -> bool: ...
...
class UserListAttributeMetadata(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["user_list_type"]
    ) -> bool: ...
    ...
    def __init__(
        ...
        *,
        ...
        video_properties: MutableSequence[
            YouTubeVideoPropertyEnum.YouTubeVideoProperty
        ] = ...,
        publish_date: str = ...,
        channel_id: str = ...,
        channel_name: str = ...,
