...
from google.ads.googleads.v25.common.types.campaign_reservation_quote import (
    CampaignReservationQuote,
)
from google.ads.googleads.v25.common.types.policy import (
    PolicyTopicEntry,
    PolicyViolationKey,
)
from google.ads.googleads.v25.common.types.value import Value
from google.ads.googleads.v25.enums.types.customer_lifecycle_optimization_goal_sub_type import (
    CustomerLifecycleOptimizationGoalSubTypeEnum,
)
from google.ads.googleads.v25.enums.types.resource_limit_type import (
    ResourceLimitTypeEnum,
)
from google.ads.googleads.v25.errors.types.access_invitation_error import (
    AccessInvitationErrorEnum,
)
from google.ads.googleads.v25.errors.types.account_budget_proposal_error import (
    AccountBudgetProposalErrorEnum,
)
from google.ads.googleads.v25.errors.types.account_link_error import (
    AccountLinkErrorEnum,
)
from google.ads.googleads.v25.errors.types.action_error import ActionErrorEnum
from google.ads.googleads.v25.errors.types.ad_customizer_error import (
    AdCustomizerErrorEnum,
)
from google.ads.googleads.v25.errors.types.ad_error import AdErrorEnum
from google.ads.googleads.v25.errors.types.ad_group_ad_error import AdGroupAdErrorEnum
from google.ads.googleads.v25.errors.types.ad_group_bid_modifier_error import (
    AdGroupBidModifierErrorEnum,
)
from google.ads.googleads.v25.errors.types.ad_group_criterion_customizer_error import (
    AdGroupCriterionCustomizerErrorEnum,
)
from google.ads.googleads.v25.errors.types.ad_group_criterion_error import (
    AdGroupCriterionErrorEnum,
)
from google.ads.googleads.v25.errors.types.ad_group_customizer_error import (
    AdGroupCustomizerErrorEnum,
)
from google.ads.googleads.v25.errors.types.ad_group_error import AdGroupErrorEnum
from google.ads.googleads.v25.errors.types.ad_group_feed_error import (
    AdGroupFeedErrorEnum,
)
from google.ads.googleads.v25.errors.types.ad_parameter_error import (
    AdParameterErrorEnum,
)
from google.ads.googleads.v25.errors.types.ad_sharing_error import AdSharingErrorEnum
from google.ads.googleads.v25.errors.types.adx_error import AdxErrorEnum
from google.ads.googleads.v25.errors.types.asset_error import AssetErrorEnum
from google.ads.googleads.v25.errors.types.asset_generation_error import (
    AssetGenerationErrorEnum,
)
from google.ads.googleads.v25.errors.types.asset_group_asset_error import (
    AssetGroupAssetErrorEnum,
)
from google.ads.googleads.v25.errors.types.asset_group_error import AssetGroupErrorEnum
from google.ads.googleads.v25.errors.types.asset_group_listing_group_filter_error import (
    AssetGroupListingGroupFilterErrorEnum,
)
from google.ads.googleads.v25.errors.types.asset_group_signal_error import (
    AssetGroupSignalErrorEnum,
)
from google.ads.googleads.v25.errors.types.asset_link_error import AssetLinkErrorEnum
from google.ads.googleads.v25.errors.types.asset_set_asset_error import (
    AssetSetAssetErrorEnum,
)
from google.ads.googleads.v25.errors.types.asset_set_error import AssetSetErrorEnum
from google.ads.googleads.v25.errors.types.asset_set_link_error import (
    AssetSetLinkErrorEnum,
)
from google.ads.googleads.v25.errors.types.audience_error import AudienceErrorEnum
from google.ads.googleads.v25.errors.types.audience_insights_error import (
    AudienceInsightsErrorEnum,
)
from google.ads.googleads.v25.errors.types.authentication_error import (
    AuthenticationErrorEnum,
)
from google.ads.googleads.v25.errors.types.authorization_error import (
    AuthorizationErrorEnum,
)
from google.ads.googleads.v25.errors.types.automatically_created_asset_removal_error import (
    AutomaticallyCreatedAssetRemovalErrorEnum,
)
from google.ads.googleads.v25.errors.types.batch_job_error import BatchJobErrorEnum
from google.ads.googleads.v25.errors.types.benchmarks_error import BenchmarksErrorEnum
from google.ads.googleads.v25.errors.types.bidding_error import BiddingErrorEnum
from google.ads.googleads.v25.errors.types.bidding_strategy_error import (
    BiddingStrategyErrorEnum,
)
from google.ads.googleads.v25.errors.types.billing_setup_error import (
    BillingSetupErrorEnum,
)
from google.ads.googleads.v25.errors.types.brand_guidelines_migration_error import (
    BrandGuidelinesMigrationErrorEnum,
)
from google.ads.googleads.v25.errors.types.campaign_budget_error import (
    CampaignBudgetErrorEnum,
)
from google.ads.googleads.v25.errors.types.campaign_conversion_goal_error import (
    CampaignConversionGoalErrorEnum,
)
from google.ads.googleads.v25.errors.types.campaign_criterion_error import (
    CampaignCriterionErrorEnum,
)
from google.ads.googleads.v25.errors.types.campaign_customizer_error import (
    CampaignCustomizerErrorEnum,
)
from google.ads.googleads.v25.errors.types.campaign_draft_error import (
    CampaignDraftErrorEnum,
)
from google.ads.googleads.v25.errors.types.campaign_error import CampaignErrorEnum
from google.ads.googleads.v25.errors.types.campaign_experiment_error import (
    CampaignExperimentErrorEnum,
)
from google.ads.googleads.v25.errors.types.campaign_feed_error import (
    CampaignFeedErrorEnum,
)
from google.ads.googleads.v25.errors.types.campaign_goal_config_error import (
    CampaignGoalConfigErrorEnum,
)
from google.ads.googleads.v25.errors.types.campaign_shared_set_error import (
    CampaignSharedSetErrorEnum,
)
from google.ads.googleads.v25.errors.types.change_event_error import (
    ChangeEventErrorEnum,
)
from google.ads.googleads.v25.errors.types.change_status_error import (
    ChangeStatusErrorEnum,
)
from google.ads.googleads.v25.errors.types.click_view_error import ClickViewErrorEnum
from google.ads.googleads.v25.errors.types.collection_size_error import (
    CollectionSizeErrorEnum,
)
from google.ads.googleads.v25.errors.types.content_creator_insights_error import (
    ContentCreatorInsightsErrorEnum,
)
from google.ads.googleads.v25.errors.types.context_error import ContextErrorEnum
from google.ads.googleads.v25.errors.types.conversion_action_error import (
    ConversionActionErrorEnum,
)
from google.ads.googleads.v25.errors.types.conversion_adjustment_upload_error import (
    ConversionAdjustmentUploadErrorEnum,
)
from google.ads.googleads.v25.errors.types.conversion_custom_variable_error import (
    ConversionCustomVariableErrorEnum,
)
from google.ads.googleads.v25.errors.types.conversion_goal_campaign_config_error import (
    ConversionGoalCampaignConfigErrorEnum,
)
from google.ads.googleads.v25.errors.types.conversion_upload_error import (
    ConversionUploadErrorEnum,
)
from google.ads.googleads.v25.errors.types.conversion_value_rule_error import (
    ConversionValueRuleErrorEnum,
)
from google.ads.googleads.v25.errors.types.conversion_value_rule_set_error import (
    ConversionValueRuleSetErrorEnum,
)
from google.ads.googleads.v25.errors.types.country_code_error import (
    CountryCodeErrorEnum,
)
from google.ads.googleads.v25.errors.types.criterion_error import CriterionErrorEnum
from google.ads.googleads.v25.errors.types.currency_code_error import (
    CurrencyCodeErrorEnum,
)
from google.ads.googleads.v25.errors.types.currency_error import CurrencyErrorEnum
from google.ads.googleads.v25.errors.types.custom_audience_error import (
    CustomAudienceErrorEnum,
)
from google.ads.googleads.v25.errors.types.custom_conversion_goal_error import (
    CustomConversionGoalErrorEnum,
)
from google.ads.googleads.v25.errors.types.custom_interest_error import (
    CustomInterestErrorEnum,
)
from google.ads.googleads.v25.errors.types.customer_client_link_error import (
    CustomerClientLinkErrorEnum,
)
from google.ads.googleads.v25.errors.types.customer_customizer_error import (
    CustomerCustomizerErrorEnum,
)
from google.ads.googleads.v25.errors.types.customer_error import CustomerErrorEnum
from google.ads.googleads.v25.errors.types.customer_feed_error import (
    CustomerFeedErrorEnum,
)
from google.ads.googleads.v25.errors.types.customer_manager_link_error import (
    CustomerManagerLinkErrorEnum,
)
from google.ads.googleads.v25.errors.types.customer_sk_ad_network_conversion_value_schema_error import (
    CustomerSkAdNetworkConversionValueSchemaErrorEnum,
)
from google.ads.googleads.v25.errors.types.customer_user_access_error import (
    CustomerUserAccessErrorEnum,
)
from google.ads.googleads.v25.errors.types.customizer_attribute_error import (
    CustomizerAttributeErrorEnum,
)
from google.ads.googleads.v25.errors.types.data_link_error import DataLinkErrorEnum
from google.ads.googleads.v25.errors.types.database_error import DatabaseErrorEnum
from google.ads.googleads.v25.errors.types.date_error import DateErrorEnum
from google.ads.googleads.v25.errors.types.date_range_error import DateRangeErrorEnum
from google.ads.googleads.v25.errors.types.distinct_error import DistinctErrorEnum
from google.ads.googleads.v25.errors.types.enum_error import EnumErrorEnum
from google.ads.googleads.v25.errors.types.experiment_arm_error import (
    ExperimentArmErrorEnum,
)
from google.ads.googleads.v25.errors.types.experiment_error import ExperimentErrorEnum
from google.ads.googleads.v25.errors.types.extension_feed_item_error import (
    ExtensionFeedItemErrorEnum,
)
from google.ads.googleads.v25.errors.types.extension_setting_error import (
    ExtensionSettingErrorEnum,
)
from google.ads.googleads.v25.errors.types.feed_attribute_reference_error import (
    FeedAttributeReferenceErrorEnum,
)
from google.ads.googleads.v25.errors.types.feed_error import FeedErrorEnum
from google.ads.googleads.v25.errors.types.feed_item_error import FeedItemErrorEnum
from google.ads.googleads.v25.errors.types.feed_item_set_error import (
    FeedItemSetErrorEnum,
)
from google.ads.googleads.v25.errors.types.feed_item_set_link_error import (
    FeedItemSetLinkErrorEnum,
)
from google.ads.googleads.v25.errors.types.feed_item_target_error import (
    FeedItemTargetErrorEnum,
)
from google.ads.googleads.v25.errors.types.feed_item_validation_error import (
    FeedItemValidationErrorEnum,
)
from google.ads.googleads.v25.errors.types.feed_mapping_error import (
    FeedMappingErrorEnum,
)
from google.ads.googleads.v25.errors.types.field_error import FieldErrorEnum
from google.ads.googleads.v25.errors.types.field_mask_error import FieldMaskErrorEnum
from google.ads.googleads.v25.errors.types.final_url_expansion_asset_view_error import (
    FinalUrlExpansionAssetViewErrorEnum,
)
from google.ads.googleads.v25.errors.types.function_error import FunctionErrorEnum
from google.ads.googleads.v25.errors.types.function_parsing_error import (
    FunctionParsingErrorEnum,
)
from google.ads.googleads.v25.errors.types.geo_target_constant_suggestion_error import (
    GeoTargetConstantSuggestionErrorEnum,
)
from google.ads.googleads.v25.errors.types.goal_error import GoalErrorEnum
from google.ads.googleads.v25.errors.types.header_error import HeaderErrorEnum
from google.ads.googleads.v25.errors.types.id_error import IdErrorEnum
from google.ads.googleads.v25.errors.types.identity_verification_error import (
    IdentityVerificationErrorEnum,
)
from google.ads.googleads.v25.errors.types.image_error import ImageErrorEnum
from google.ads.googleads.v25.errors.types.incentive_error import IncentiveErrorEnum
from google.ads.googleads.v25.errors.types.internal_error import InternalErrorEnum
from google.ads.googleads.v25.errors.types.invoice_error import InvoiceErrorEnum
from google.ads.googleads.v25.errors.types.keyword_plan_ad_group_error import (
    KeywordPlanAdGroupErrorEnum,
)
from google.ads.googleads.v25.errors.types.keyword_plan_ad_group_keyword_error import (
    KeywordPlanAdGroupKeywordErrorEnum,
)
from google.ads.googleads.v25.errors.types.keyword_plan_campaign_error import (
    KeywordPlanCampaignErrorEnum,
)
from google.ads.googleads.v25.errors.types.keyword_plan_campaign_keyword_error import (
    KeywordPlanCampaignKeywordErrorEnum,
)
from google.ads.googleads.v25.errors.types.keyword_plan_error import (
    KeywordPlanErrorEnum,
)
from google.ads.googleads.v25.errors.types.keyword_plan_idea_error import (
    KeywordPlanIdeaErrorEnum,
)
from google.ads.googleads.v25.errors.types.label_error import LabelErrorEnum
from google.ads.googleads.v25.errors.types.language_code_error import (
    LanguageCodeErrorEnum,
)
from google.ads.googleads.v25.errors.types.list_operation_error import (
    ListOperationErrorEnum,
)
from google.ads.googleads.v25.errors.types.manager_link_error import (
    ManagerLinkErrorEnum,
)
from google.ads.googleads.v25.errors.types.media_bundle_error import (
    MediaBundleErrorEnum,
)
from google.ads.googleads.v25.errors.types.media_file_error import MediaFileErrorEnum
from google.ads.googleads.v25.errors.types.media_upload_error import (
    MediaUploadErrorEnum,
)
from google.ads.googleads.v25.errors.types.merchant_center_error import (
    MerchantCenterErrorEnum,
)
from google.ads.googleads.v25.errors.types.multi_party_auth_review_error import (
    MultiPartyAuthReviewErrorEnum,
)
from google.ads.googleads.v25.errors.types.multiplier_error import MultiplierErrorEnum
from google.ads.googleads.v25.errors.types.mutate_error import MutateErrorEnum
from google.ads.googleads.v25.errors.types.new_resource_creation_error import (
    NewResourceCreationErrorEnum,
)
from google.ads.googleads.v25.errors.types.not_allowlisted_error import (
    NotAllowlistedErrorEnum,
)
from google.ads.googleads.v25.errors.types.not_empty_error import NotEmptyErrorEnum
from google.ads.googleads.v25.errors.types.null_error import NullErrorEnum
from google.ads.googleads.v25.errors.types.offline_user_data_job_error import (
    OfflineUserDataJobErrorEnum,
)
from google.ads.googleads.v25.errors.types.operation_access_denied_error import (
    OperationAccessDeniedErrorEnum,
)
from google.ads.googleads.v25.errors.types.operator_error import OperatorErrorEnum
from google.ads.googleads.v25.errors.types.partial_failure_error import (
    PartialFailureErrorEnum,
)
from google.ads.googleads.v25.errors.types.payments_account_error import (
    PaymentsAccountErrorEnum,
)
from google.ads.googleads.v25.errors.types.policy_finding_error import (
    PolicyFindingErrorEnum,
)
from google.ads.googleads.v25.errors.types.policy_validation_parameter_error import (
...
from google.ads.googleads.v25.errors.types.product_link_error import (
    ProductLinkErrorEnum,
)
from google.ads.googleads.v25.errors.types.product_link_invitation_error import (
...
from google.ads.googleads.v25.errors.types.range_error import RangeErrorEnum
from google.ads.googleads.v25.errors.types.reach_plan_error import ReachPlanErrorEnum
from google.ads.googleads.v25.errors.types.recommendation_error import (
    RecommendationErrorEnum,
)
from google.ads.googleads.v25.errors.types.recommendation_subscription_error import (
    RecommendationSubscriptionErrorEnum,
)
from google.ads.googleads.v25.errors.types.region_code_error import RegionCodeErrorEnum
from google.ads.googleads.v25.errors.types.request_error import RequestErrorEnum
from google.ads.googleads.v25.errors.types.resource_access_denied_error import (
    ResourceAccessDeniedErrorEnum,
)
from google.ads.googleads.v25.errors.types.resource_count_limit_exceeded_error import (
    ResourceCountLimitExceededErrorEnum,
)
from google.ads.googleads.v25.errors.types.search_term_insight_error import (
    SearchTermInsightErrorEnum,
)
from google.ads.googleads.v25.errors.types.setting_error import SettingErrorEnum
from google.ads.googleads.v25.errors.types.shareable_preview_error import (
    ShareablePreviewErrorEnum,
)
from google.ads.googleads.v25.errors.types.shared_criterion_error import (
    SharedCriterionErrorEnum,
)
from google.ads.googleads.v25.errors.types.shared_set_error import SharedSetErrorEnum
from google.ads.googleads.v25.errors.types.shopping_product_error import (
    ShoppingProductErrorEnum,
)
from google.ads.googleads.v25.errors.types.size_limit_error import SizeLimitErrorEnum
from google.ads.googleads.v25.errors.types.smart_campaign_error import (
    SmartCampaignErrorEnum,
)
from google.ads.googleads.v25.errors.types.string_format_error import (
    StringFormatErrorEnum,
)
from google.ads.googleads.v25.errors.types.string_length_error import (
    StringLengthErrorEnum,
)
from google.ads.googleads.v25.errors.types.third_party_app_analytics_link_error import (
    ThirdPartyAppAnalyticsLinkErrorEnum,
)
from google.ads.googleads.v25.errors.types.time_zone_error import TimeZoneErrorEnum
from google.ads.googleads.v25.errors.types.url_field_error import UrlFieldErrorEnum
from google.ads.googleads.v25.errors.types.user_data_error import UserDataErrorEnum
from google.ads.googleads.v25.errors.types.user_list_customer_type_error import (
    UserListCustomerTypeErrorEnum,
)
from google.ads.googleads.v25.errors.types.user_list_error import UserListErrorEnum
from google.ads.googleads.v25.errors.types.video_campaign_error import (
    VideoCampaignErrorEnum,
)
from google.ads.googleads.v25.errors.types.video_reservation_error import (
    VideoReservationErrorEnum,
)
from google.ads.googleads.v25.errors.types.youtube_video_registration_error import (
...
class ErrorCode(proto.Message):
    ...
    automatically_created_asset_removal_error: (
        AutomaticallyCreatedAssetRemovalErrorEnum.AutomaticallyCreatedAssetRemovalError
    )
...
class ErrorDetails(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        ...
        key: Literal[
            ...
            "incompatible_clo_goal_error_details",
        ],
    ) -> bool: ...
...
class IncompatibleCloGoalsErrorDetails(proto.Message):
    clo_goal_sub_type1: CustomerLifecycleOptimizationGoalSubTypeEnum.CustomerLifecycleOptimizationGoalSubType
    clo_goal_sub_type2: CustomerLifecycleOptimizationGoalSubTypeEnum.CustomerLifecycleOptimizationGoalSubType
    def __init__(
        self: _M,
        mapping: _M | Mapping | google.protobuf.message.Message | None = None,
        *,
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["clo_goal_sub_type1", "clo_goal_sub_type2"]
    ) -> bool: ...
