...
from google.ads.googleads.v25.enums.types.audience_insights_dimension import (
    AudienceInsightsDimensionEnum,
)
from google.ads.googleads.v25.enums.types.audience_insights_marketing_objective import (
    AudienceInsightsMarketingObjectiveEnum,
)
from google.ads.googleads.v25.enums.types.insights_knowledge_graph_entity_capabilities import (
...
class GenerateAudienceDefinitionResponse(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["high_relevance_attributes", "medium_relevance_attributes"]
    ) -> bool: ...
...
class KnowledgeGraphEntitySearchOptions(proto.Message):
    class SearchFilter(proto.Message):
        ...
        def __contains__(  # type: ignore[override]
            self, key: Literal["entity_capability_filters"]
        ) -> bool: ...

    get_all_creator_attributes: bool
    search_filter: KnowledgeGraphEntitySearchOptions.SearchFilter
    def __init__(
        self: _M,
        mapping: _M | Mapping | google.protobuf.message.Message | None = None,
        *,
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["get_all_creator_attributes", "search_filter"]
    ) -> bool: ...
...
class ListAudienceInsightsAttributesRequest(proto.Message):
    ...
    knowledge_graph_entity_search_options: KnowledgeGraphEntitySearchOptions
    def __init__(
        self: _M,
        mapping: _M | Mapping | google.protobuf.message.Message | None = None,
        *,
...
class ListInsightsEligibleDatesRequest(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["insights_application_info"]
    ) -> bool: ...
