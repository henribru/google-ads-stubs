...
from google.ads.googleads.v25.enums.types.incentive_offer_type import (
    IncentiveOfferTypeEnum,
)
from google.ads.googleads.v25.enums.types.incentive_type import IncentiveTypeEnum
...
class ApplyIncentiveRequest(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["selected_incentive_id", "customer_id", "country_code"]
    ) -> bool: ...
...
class ApplyIncentiveResponse(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["coupon_code", "creation_time"]
    ) -> bool: ...
...
class CyoIncentives(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["low_offer", "medium_offer", "high_offer"]
    ) -> bool: ...
...
class FetchIncentiveRequest(proto.Message):
    ...
    country_code: str
    email: str
    incentive_type: IncentiveTypeEnum.IncentiveType
    def __init__(
        self: _M,
        mapping: _M | Mapping | google.protobuf.message.Message | None = None,
        *,
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["language_code", "country_code", "email", "incentive_type"]
    ) -> bool: ...
...
class FetchIncentiveResponse(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["incentive_offer"]
    ) -> bool: ...
...
class Incentive(proto.Message):
    class Requirement(proto.Message):
        class Spend(proto.Message):
            ...
            def __contains__(  # type: ignore[override]
                self, key: Literal["award_amount", "required_amount"]
            ) -> bool: ...
...
class IncentiveOffer(proto.Message):
    ...
    offer_type: IncentiveOfferTypeEnum.OfferType
    ...
    def __contains__(  # type: ignore[override]
        self,
        key: Literal[
            "consolidated_terms_and_conditions_url", "offer_type", "cyo_incentives"
        ],
    ) -> bool: ...
