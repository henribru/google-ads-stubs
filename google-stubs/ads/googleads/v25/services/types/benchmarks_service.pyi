...
from google.ads.googleads.v25.common.types.criteria import LocationInfo
from google.ads.googleads.v25.common.types.dates import DateRange
from google.ads.googleads.v25.enums.types.benchmarks_marketing_objective import (
    BenchmarksMarketingObjectiveEnum,
)
from google.ads.googleads.v25.enums.types.benchmarks_source_type import (
    BenchmarksSourceTypeEnum,
)
from google.ads.googleads.v25.enums.types.benchmarks_time_granularity import (
...
class BenchmarksSource(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["industry_vertical_id", "all_advertisers"]
    ) -> bool: ...
...
class BenchmarksSourceMetadata(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self,
        key: Literal[
            "benchmarks_source_type", "industry_vertical_info", "category_info"
        ],
    ) -> bool: ...
...
class CategoryInfo(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["category_name", "category_id", "category_path"]
    ) -> bool: ...
...
class CustomerMetrics(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["average_rate_metrics", "share_metrics", "aggregate_metrics"]
    ) -> bool: ...
...
class ShareMetrics(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["share_of_voice", "share_of_spend"]
    ) -> bool: ...
