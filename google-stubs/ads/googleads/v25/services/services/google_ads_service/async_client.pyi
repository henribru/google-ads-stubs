...
class GoogleAdsServiceAsyncClient:
    ...
    ai_max_search_term_ad_combination_view_path: Incomplete
    parse_ai_max_search_term_ad_combination_view_path: Incomplete
    ...
    campaign_goal_config_path: Incomplete
    parse_campaign_goal_config_path: Incomplete
    ...
    campaign_search_term_view_path: Incomplete
    parse_campaign_search_term_view_path: Incomplete
    ...
    cart_data_sales_view_path: Incomplete
    parse_cart_data_sales_view_path: Incomplete
    ...
    detail_content_suitability_placement_view_path: Incomplete
    parse_detail_content_suitability_placement_view_path: Incomplete
    ...
    final_url_expansion_asset_view_path: Incomplete
    parse_final_url_expansion_asset_view_path: Incomplete
    ...
    goal_path: Incomplete
    parse_goal_path: Incomplete
    group_content_suitability_placement_view_path: Incomplete
    parse_group_content_suitability_placement_view_path: Incomplete
    ...
    lift_measurement_age_range_path: Incomplete
    parse_lift_measurement_age_range_path: Incomplete
    lift_measurement_campaign_path: Incomplete
    parse_lift_measurement_campaign_path: Incomplete
    lift_measurement_config_path: Incomplete
    parse_lift_measurement_config_path: Incomplete
    lift_measurement_device_path: Incomplete
    parse_lift_measurement_device_path: Incomplete
    lift_measurement_flight_path: Incomplete
    parse_lift_measurement_flight_path: Incomplete
    lift_measurement_gender_path: Incomplete
    parse_lift_measurement_gender_path: Incomplete
    lift_measurement_video_path: Incomplete
    parse_lift_measurement_video_path: Incomplete
    ...
    location_interest_view_path: Incomplete
    parse_location_interest_view_path: Incomplete
    ...
    matched_location_interest_view_path: Incomplete
    parse_matched_location_interest_view_path: Incomplete
    ...
    targeting_expansion_view_path: Incomplete
    parse_targeting_expansion_view_path: Incomplete
