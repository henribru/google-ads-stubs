...
from google.ads.googleads.v25.enums.types.asset_coverage_video_aspect_ratio_requirement import (
...
from google.ads.googleads.v25.enums.types.asset_group_primary_status import (
    AssetGroupPrimaryStatusEnum,
)
from google.ads.googleads.v25.enums.types.asset_group_primary_status_reason import (
    AssetGroupPrimaryStatusReasonEnum,
)
from google.ads.googleads.v25.enums.types.asset_group_status import AssetGroupStatusEnum
...
class AssetGroup(proto.Message):
    ...
    google_local_services_info: GoogleLocalServicesInfo
    def __init__(
        self: _M,
        mapping: _M | Mapping | google.protobuf.message.Message | None = None,
        *,
    ...
    def __contains__(  # type: ignore[override]
        ...
        key: Literal[
            ...
            "ad_strength",
            "asset_coverage",
            "google_local_services_info",
        ],
    ) -> bool: ...

class GoogleLocalServicesInfo(proto.Message):
    category_id: str
    callouts: MutableSequence[LocalServicesCallout]
    def __init__(
        self: _M,
        mapping: _M | Mapping | google.protobuf.message.Message | None = None,
        *,
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["category_id", "callouts"]
    ) -> bool: ...
