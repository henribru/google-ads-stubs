...
from google.ads.googleads.v25.common.types.bidding import (
    Commission,
    FixedCpm,
    ManualCpa,
    ManualCpc,
...
from google.ads.googleads.v25.common.types.custom_parameter import CustomParameter
from google.ads.googleads.v25.common.types.frequency_cap import FrequencyCapEntry
from google.ads.googleads.v25.common.types.local_services import (
    LocalServicesPhoneNumber,
)
from google.ads.googleads.v25.common.types.real_time_bidding_setting import (
    RealTimeBiddingSetting,
)
from google.ads.googleads.v25.common.types.targeting_setting import TargetingSetting
from google.ads.googleads.v25.common.types.third_party_integration_partners import (
    CampaignThirdPartyIntegrationPartners,
)
from google.ads.googleads.v25.enums.types.ad_group_type import AdGroupTypeEnum
from google.ads.googleads.v25.enums.types.ad_serving_optimization_status import (
    AdServingOptimizationStatusEnum,
)
from google.ads.googleads.v25.enums.types.advertising_channel_sub_type import (
    AdvertisingChannelSubTypeEnum,
)
from google.ads.googleads.v25.enums.types.advertising_channel_type import (
    AdvertisingChannelTypeEnum,
)
from google.ads.googleads.v25.enums.types.app_campaign_app_store import (
    AppCampaignAppStoreEnum,
)
from google.ads.googleads.v25.enums.types.app_campaign_bidding_strategy_goal_type import (
...
from google.ads.googleads.v25.enums.types.asset_set_type import AssetSetTypeEnum
...
from google.ads.googleads.v25.enums.types.booking_status import BookingStatusEnum
from google.ads.googleads.v25.enums.types.campaign_experiment_type import (
    CampaignExperimentTypeEnum,
)
from google.ads.googleads.v25.enums.types.campaign_keyword_match_type import (
    CampaignKeywordMatchTypeEnum,
)
from google.ads.googleads.v25.enums.types.campaign_primary_status import (
...
from google.ads.googleads.v25.enums.types.campaign_serving_status import (
    CampaignServingStatusEnum,
)
from google.ads.googleads.v25.enums.types.campaign_status import CampaignStatusEnum
from google.ads.googleads.v25.enums.types.eu_political_advertising_status import (
    EuPoliticalAdvertisingStatusEnum,
)
from google.ads.googleads.v25.enums.types.listing_type import ListingTypeEnum
from google.ads.googleads.v25.enums.types.location_source_type import (
    LocationSourceTypeEnum,
)
from google.ads.googleads.v25.enums.types.messaging_restriction_type import (
    MessagingRestrictionTypeEnum,
)
from google.ads.googleads.v25.enums.types.negative_geo_target_type import (
    NegativeGeoTargetTypeEnum,
)
from google.ads.googleads.v25.enums.types.non_skippable_max_duration import (
    NonSkippableMaxDurationEnum,
)
from google.ads.googleads.v25.enums.types.non_skippable_min_duration import (
    NonSkippableMinDurationEnum,
)
from google.ads.googleads.v25.enums.types.optimization_goal_type import (
    OptimizationGoalTypeEnum,
)
from google.ads.googleads.v25.enums.types.payment_mode import PaymentModeEnum
from google.ads.googleads.v25.enums.types.performance_max_upgrade_status import (
    PerformanceMaxUpgradeStatusEnum,
)
from google.ads.googleads.v25.enums.types.positive_geo_target_type import (
    PositiveGeoTargetTypeEnum,
)
from google.ads.googleads.v25.enums.types.vanity_pharma_display_url_mode import (
    VanityPharmaDisplayUrlModeEnum,
)
from google.ads.googleads.v25.enums.types.vanity_pharma_text import VanityPharmaTextEnum
from google.ads.googleads.v25.enums.types.video_ad_format_restriction import (
    VideoAdFormatRestrictionEnum,
)
from google.ads.googleads.v25.enums.types.video_ad_sequence_interaction_type import (
    VideoAdSequenceInteractionTypeEnum,
)
from google.ads.googleads.v25.enums.types.video_ad_sequence_minimum_duration import (
...
class Campaign(proto.Message):
    class AiMaxSetting(proto.Message):
        ...
        def __contains__(  # type: ignore[override]
            self, key: Literal["enable_ai_max", "bundling_required"]
        ) -> bool: ...
    ...
    class LocalServicesPmaxCampaignSettings(proto.Message):
        ...
        founding_year: int
        country_code: str
        phone_numbers: MutableSequence[LocalServicesPhoneNumber]
        def __init__(
            self: _M,
            mapping: _M | Mapping | google.protobuf.message.Message | None = None,
            *,
    ...
    class PmaxCampaignSettings(proto.Message):
        ...
        def __init__(
            ...
            *,
            ignore_unknown_fields: bool = False,
            brand_targeting_overrides: Campaign.PmaxCampaignSettings.BrandTargetingOverrides = ...,
            local_services_pmax_campaign_settings: Campaign.LocalServicesPmaxCampaignSettings = ...,
            local_services_enabled: bool = ...,
        ) -> None: ...
        def __contains__(  # type: ignore[override]
            self,
    ...
    class ShoppingSetting(proto.Message):
        ...
        def __contains__(  # type: ignore[override]
            ...
            key: Literal[
                ...
                "ignore_brand_exclusion_in_shopping_ads",
            ],
        ) -> bool: ...
    ...
    class VideoCampaignSettings(proto.Message):
        ...
        class VideoAdSequence(proto.Message):
            ...
            minimum_duration: (
                VideoAdSequenceMinimumDurationEnum.VideoAdSequenceMinimumDuration
            )
            def __init__(
                self: _M,
                mapping: _M | Mapping | google.protobuf.message.Message | None = None,
            ...
            def __contains__(  # type: ignore[override]
                self, key: Literal["steps", "minimum_duration"]
            ) -> bool: ...
        ...
        class VideoAdSequenceStep(proto.Message):
            ...
            previous_step_interaction_type: (
                VideoAdSequenceInteractionTypeEnum.VideoAdSequenceInteractionType
            )
            def __init__(
                self: _M,
                mapping: _M | Mapping | google.protobuf.message.Message | None = None,
