...
from google.ads.googleads.v25.common.types.effective_automatic_goal import (
    EffectiveAutomaticGoal,
)
from google.ads.googleads.v25.enums.types.ad_strength import AdStrengthEnum
from google.ads.googleads.v25.enums.types.app_bidding_goal import AppBiddingGoalEnum
...
from google.ads.googleads.v25.enums.types.shopping_add_products_to_campaign_recommendation_enum import (
    ShoppingAddProductsToCampaignRecommendationEnum,
)
from google.ads.googleads.v25.enums.types.target_cpa_opt_in_recommendation_goal import (
...
class Recommendation(proto.Message):
    ...
    class CampaignSpecificAppGoalRecommendation(proto.Message):
        ...
        current_auto_goals: MutableSequence[EffectiveAutomaticGoal]
        current_custom_goal: str
        suggested_conversion_goals: MutableSequence[
            ConversionActionCategoryEnum.ConversionActionCategory
        ]
        current_conversion_goals: MutableSequence[EffectiveAutomaticGoal]
        ...
        def __contains__(  # type: ignore[override]
            self,
            key: Literal[
                "campaign_cost_micros_last_fifteen_days",
                "campaign_conversions_last_fifteen_days",
                "campaign_conversion_value_last_fifteen_days",
                "projected_conversions_last_fifteen_days",
                "projected_conversion_value_last_fifteen_days",
                "app_conversion_goals",
                "current_auto_goals",
                "current_custom_goal",
                "suggested_conversion_goals",
                "current_conversion_goals",
                "current_custom_conversion_goal",
            ],
        ) -> bool: ...
    ...
    campaign_specific_app_goal_recommendation: (
        Recommendation.CampaignSpecificAppGoalRecommendation
    )
    def __init__(
        self: _M,
        mapping: _M | Mapping | google.protobuf.message.Message | None = None,
        *,
        ...
        campaign_specific_app_goal_recommendation: Recommendation.CampaignSpecificAppGoalRecommendation = ...,
    ) -> None: ...
    def __contains__(  # type: ignore[override]
        self,
        key: Literal[
