...
from google.ads.googleads.v16.common.types.frequency_cap import FrequencyCapEntry
...
from google.ads.googleads.v16.enums.types.listing_type import ListingTypeEnum
...
from google.ads.googleads.v16.enums.types.payment_mode import PaymentModeEnum
...
from google.ads.googleads.v16.enums.types.vanity_pharma_text import VanityPharmaTextEnum
...
class Campaign(proto.Message):
    ...
    class ShoppingSetting(proto.Message):
        ...
        def __contains__(self, key: Literal["merchant_id", "feed_label", "campaign_priority", "enable_local", "use_vehicle_inventory", "advertising_partner_ids", "disable_product_feed"]) -> bool: ...  # type: ignore[override]
