...
class AdGroupCriterionLabelServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_ad_group_criterion_labels(self) -> Callable[[ad_group_criterion_label_service.MutateAdGroupCriterionLabelsRequest], ad_group_criterion_label_service.MutateAdGroupCriterionLabelsResponse | Awaitable[ad_group_criterion_label_service.MutateAdGroupCriterionLabelsResponse]]: ...
    @property
    def kind(self) -> str: ...
