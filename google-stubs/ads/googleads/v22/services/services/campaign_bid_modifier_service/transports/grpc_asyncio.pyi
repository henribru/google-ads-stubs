...
from google.ads.googleads.v22.services.types import campaign_bid_modifier_service
...
class CampaignBidModifierServiceGrpcAsyncIOTransport(CampaignBidModifierServiceTransport):
    @classmethod
    ...
    @property
    def mutate_campaign_bid_modifiers(self) -> Callable[[campaign_bid_modifier_service.MutateCampaignBidModifiersRequest], Awaitable[campaign_bid_modifier_service.MutateCampaignBidModifiersResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
