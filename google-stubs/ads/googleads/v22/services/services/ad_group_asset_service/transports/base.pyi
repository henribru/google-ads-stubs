...
class AdGroupAssetServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_ad_group_assets(self) -> Callable[[ad_group_asset_service.MutateAdGroupAssetsRequest], ad_group_asset_service.MutateAdGroupAssetsResponse | Awaitable[ad_group_asset_service.MutateAdGroupAssetsResponse]]: ...
    @property
    def kind(self) -> str: ...
