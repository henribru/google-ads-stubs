...
from google.ads.googleads.v22.services.types import travel_asset_suggestion_service
...
class TravelAssetSuggestionServiceGrpcAsyncIOTransport(TravelAssetSuggestionServiceTransport):
    @classmethod
    ...
    @property
    def suggest_travel_assets(self) -> Callable[[travel_asset_suggestion_service.SuggestTravelAssetsRequest], Awaitable[travel_asset_suggestion_service.SuggestTravelAssetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
