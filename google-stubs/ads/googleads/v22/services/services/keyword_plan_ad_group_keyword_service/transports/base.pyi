...
class KeywordPlanAdGroupKeywordServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_keyword_plan_ad_group_keywords(self) -> Callable[[keyword_plan_ad_group_keyword_service.MutateKeywordPlanAdGroupKeywordsRequest], keyword_plan_ad_group_keyword_service.MutateKeywordPlanAdGroupKeywordsResponse | Awaitable[keyword_plan_ad_group_keyword_service.MutateKeywordPlanAdGroupKeywordsResponse]]: ...
    @property
    def kind(self) -> str: ...
