...
class RecommendationSubscriptionServiceGrpcTransport(RecommendationSubscriptionServiceTransport):
    ...
    @property
    def mutate_recommendation_subscription(self) -> Callable[[recommendation_subscription_service.MutateRecommendationSubscriptionRequest], recommendation_subscription_service.MutateRecommendationSubscriptionResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
