...
class AssetGroupSignalServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_asset_group_signals(self) -> Callable[[asset_group_signal_service.MutateAssetGroupSignalsRequest], asset_group_signal_service.MutateAssetGroupSignalsResponse | Awaitable[asset_group_signal_service.MutateAssetGroupSignalsResponse]]: ...
    @property
    def kind(self) -> str: ...
