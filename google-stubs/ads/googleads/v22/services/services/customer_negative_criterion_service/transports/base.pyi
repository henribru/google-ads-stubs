...
class CustomerNegativeCriterionServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_customer_negative_criteria(self) -> Callable[[customer_negative_criterion_service.MutateCustomerNegativeCriteriaRequest], customer_negative_criterion_service.MutateCustomerNegativeCriteriaResponse | Awaitable[customer_negative_criterion_service.MutateCustomerNegativeCriteriaResponse]]: ...
    @property
    def kind(self) -> str: ...
