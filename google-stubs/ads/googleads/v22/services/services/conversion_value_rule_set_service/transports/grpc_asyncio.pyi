...
from google.ads.googleads.v22.services.types import conversion_value_rule_set_service
...
class ConversionValueRuleSetServiceGrpcAsyncIOTransport(ConversionValueRuleSetServiceTransport):
    @classmethod
    ...
    @property
    def mutate_conversion_value_rule_sets(self) -> Callable[[conversion_value_rule_set_service.MutateConversionValueRuleSetsRequest], Awaitable[conversion_value_rule_set_service.MutateConversionValueRuleSetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
