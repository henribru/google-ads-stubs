...
class CampaignGoalConfigServiceGrpcAsyncIOTransport(CampaignGoalConfigServiceTransport):
    @classmethod
    ...
    @property
    def mutate_campaign_goal_configs(self) -> Callable[[campaign_goal_config_service.MutateCampaignGoalConfigsRequest], Awaitable[campaign_goal_config_service.MutateCampaignGoalConfigsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
