...
class AccountLinkServiceGrpcAsyncIOTransport(AccountLinkServiceTransport):
    ...
    @property
    def create_account_link(self) -> Callable[[account_link_service.CreateAccountLinkRequest], Awaitable[account_link_service.CreateAccountLinkResponse]]: ...
    @property
    def mutate_account_link(self) -> Callable[[account_link_service.MutateAccountLinkRequest], Awaitable[account_link_service.MutateAccountLinkResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
