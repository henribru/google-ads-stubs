...
class CustomerUserAccessInvitationServiceGrpcTransport(CustomerUserAccessInvitationServiceTransport):
    ...
    @property
    def mutate_customer_user_access_invitation(self) -> Callable[[customer_user_access_invitation_service.MutateCustomerUserAccessInvitationRequest], customer_user_access_invitation_service.MutateCustomerUserAccessInvitationResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
