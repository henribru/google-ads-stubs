...
class AssetGenerationServiceGrpcAsyncIOTransport(AssetGenerationServiceTransport):
    ...
    @property
    def generate_text(self) -> Callable[[asset_generation_service.GenerateTextRequest], Awaitable[asset_generation_service.GenerateTextResponse]]: ...
    @property
    def generate_images(self) -> Callable[[asset_generation_service.GenerateImagesRequest], Awaitable[asset_generation_service.GenerateImagesResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
