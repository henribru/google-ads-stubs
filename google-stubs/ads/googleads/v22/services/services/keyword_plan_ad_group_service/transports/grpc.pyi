...
class KeywordPlanAdGroupServiceGrpcTransport(KeywordPlanAdGroupServiceTransport):
    ...
    @property
    def mutate_keyword_plan_ad_groups(self) -> Callable[[keyword_plan_ad_group_service.MutateKeywordPlanAdGroupsRequest], keyword_plan_ad_group_service.MutateKeywordPlanAdGroupsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
