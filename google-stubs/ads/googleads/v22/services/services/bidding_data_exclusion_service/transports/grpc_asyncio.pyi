...
class BiddingDataExclusionServiceGrpcAsyncIOTransport(BiddingDataExclusionServiceTransport):
    @classmethod
    ...
    @property
    def mutate_bidding_data_exclusions(self) -> Callable[[bidding_data_exclusion_service.MutateBiddingDataExclusionsRequest], Awaitable[bidding_data_exclusion_service.MutateBiddingDataExclusionsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
