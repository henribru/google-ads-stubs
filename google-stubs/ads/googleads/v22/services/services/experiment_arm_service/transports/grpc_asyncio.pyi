...
class ExperimentArmServiceGrpcAsyncIOTransport(ExperimentArmServiceTransport):
    ...
    @property
    def mutate_experiment_arms(self) -> Callable[[experiment_arm_service.MutateExperimentArmsRequest], Awaitable[experiment_arm_service.MutateExperimentArmsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
