...
class CampaignBudgetServiceGrpcAsyncIOTransport(CampaignBudgetServiceTransport):
    ...
    @property
    def mutate_campaign_budgets(self) -> Callable[[campaign_budget_service.MutateCampaignBudgetsRequest], Awaitable[campaign_budget_service.MutateCampaignBudgetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
