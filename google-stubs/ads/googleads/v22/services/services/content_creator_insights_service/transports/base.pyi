...
class ContentCreatorInsightsServiceTransport(abc.ABC):
    ...
    @property
    def generate_trending_insights(self) -> Callable[[content_creator_insights_service.GenerateTrendingInsightsRequest], content_creator_insights_service.GenerateTrendingInsightsResponse | Awaitable[content_creator_insights_service.GenerateTrendingInsightsResponse]]: ...
    @property
    def kind(self) -> str: ...
