...
class ContentCreatorInsightsServiceGrpcTransport(ContentCreatorInsightsServiceTransport):
    ...
    @property
    def generate_creator_insights(self) -> Callable[[content_creator_insights_service.GenerateCreatorInsightsRequest], content_creator_insights_service.GenerateCreatorInsightsResponse]: ...
    @property
    def generate_trending_insights(self) -> Callable[[content_creator_insights_service.GenerateTrendingInsightsRequest], content_creator_insights_service.GenerateTrendingInsightsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
