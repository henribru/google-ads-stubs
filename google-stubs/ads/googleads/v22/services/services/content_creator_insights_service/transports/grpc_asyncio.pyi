...
class ContentCreatorInsightsServiceGrpcAsyncIOTransport(ContentCreatorInsightsServiceTransport):
    ...
    @property
    def generate_trending_insights(self) -> Callable[[content_creator_insights_service.GenerateTrendingInsightsRequest], Awaitable[content_creator_insights_service.GenerateTrendingInsightsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
