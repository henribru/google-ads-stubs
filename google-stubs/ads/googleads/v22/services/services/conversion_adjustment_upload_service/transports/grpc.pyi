...
class ConversionAdjustmentUploadServiceGrpcTransport(ConversionAdjustmentUploadServiceTransport):
    ...
    @property
    def upload_conversion_adjustments(self) -> Callable[[conversion_adjustment_upload_service.UploadConversionAdjustmentsRequest], conversion_adjustment_upload_service.UploadConversionAdjustmentsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
