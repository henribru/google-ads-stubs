...
class AutomaticallyCreatedAssetRemovalServiceGrpcTransport(AutomaticallyCreatedAssetRemovalServiceTransport):
    ...
    @property
    def remove_campaign_automatically_created_asset(self) -> Callable[[automatically_created_asset_removal_service.RemoveCampaignAutomaticallyCreatedAssetRequest], automatically_created_asset_removal_service.RemoveCampaignAutomaticallyCreatedAssetResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
