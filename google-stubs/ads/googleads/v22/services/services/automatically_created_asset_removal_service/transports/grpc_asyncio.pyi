...
from google.ads.googleads.v22.services.types import automatically_created_asset_removal_service
...
class AutomaticallyCreatedAssetRemovalServiceGrpcAsyncIOTransport(AutomaticallyCreatedAssetRemovalServiceTransport):
    @classmethod
    ...
    @property
    def remove_campaign_automatically_created_asset(self) -> Callable[[automatically_created_asset_removal_service.RemoveCampaignAutomaticallyCreatedAssetRequest], Awaitable[automatically_created_asset_removal_service.RemoveCampaignAutomaticallyCreatedAssetResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
