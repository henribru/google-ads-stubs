...
class UserListServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_user_lists(self) -> Callable[[user_list_service.MutateUserListsRequest], user_list_service.MutateUserListsResponse | Awaitable[user_list_service.MutateUserListsResponse]]: ...
    @property
    def kind(self) -> str: ...
