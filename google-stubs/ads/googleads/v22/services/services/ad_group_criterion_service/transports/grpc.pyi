...
class AdGroupCriterionServiceGrpcTransport(AdGroupCriterionServiceTransport):
    ...
    @property
    def mutate_ad_group_criteria(self) -> Callable[[ad_group_criterion_service.MutateAdGroupCriteriaRequest], ad_group_criterion_service.MutateAdGroupCriteriaResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
