...
class AccountBudgetProposalServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_account_budget_proposal(self) -> Callable[[account_budget_proposal_service.MutateAccountBudgetProposalRequest], account_budget_proposal_service.MutateAccountBudgetProposalResponse | Awaitable[account_budget_proposal_service.MutateAccountBudgetProposalResponse]]: ...
    @property
    def kind(self) -> str: ...
