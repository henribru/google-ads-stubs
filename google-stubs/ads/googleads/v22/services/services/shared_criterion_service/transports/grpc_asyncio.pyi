...
class SharedCriterionServiceGrpcAsyncIOTransport(SharedCriterionServiceTransport):
    @classmethod
    ...
    @property
    def mutate_shared_criteria(self) -> Callable[[shared_criterion_service.MutateSharedCriteriaRequest], Awaitable[shared_criterion_service.MutateSharedCriteriaResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
