...
class CampaignGroupServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_campaign_groups(self) -> Callable[[campaign_group_service.MutateCampaignGroupsRequest], campaign_group_service.MutateCampaignGroupsResponse | Awaitable[campaign_group_service.MutateCampaignGroupsResponse]]: ...
    @property
    def kind(self) -> str: ...
