...
class CustomerConversionGoalServiceGrpcAsyncIOTransport(CustomerConversionGoalServiceTransport):
    @classmethod
    ...
    @property
    def mutate_customer_conversion_goals(self) -> Callable[[customer_conversion_goal_service.MutateCustomerConversionGoalsRequest], Awaitable[customer_conversion_goal_service.MutateCustomerConversionGoalsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
