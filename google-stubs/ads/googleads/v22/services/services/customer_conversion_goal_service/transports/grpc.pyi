...
class CustomerConversionGoalServiceGrpcTransport(CustomerConversionGoalServiceTransport):
    ...
    @property
    def mutate_customer_conversion_goals(self) -> Callable[[customer_conversion_goal_service.MutateCustomerConversionGoalsRequest], customer_conversion_goal_service.MutateCustomerConversionGoalsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
