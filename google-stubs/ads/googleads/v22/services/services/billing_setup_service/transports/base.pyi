...
class BillingSetupServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_billing_setup(self) -> Callable[[billing_setup_service.MutateBillingSetupRequest], billing_setup_service.MutateBillingSetupResponse | Awaitable[billing_setup_service.MutateBillingSetupResponse]]: ...
    @property
    def kind(self) -> str: ...
