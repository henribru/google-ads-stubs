...
from google.ads.googleads.v22.enums.types.local_services_lead_credit_issuance_decision import (
    LocalServicesLeadCreditIssuanceDecisionEnum,
)
from google.ads.googleads.v22.enums.types.local_services_lead_survey_answer import (
    LocalServicesLeadSurveyAnswerEnum,
)
from google.ads.googleads.v22.enums.types.local_services_lead_survey_dissatisfied_reason import (
    LocalServicesLeadSurveyDissatisfiedReasonEnum,
)
from google.ads.googleads.v22.enums.types.local_services_lead_survey_satisfied_reason import (
...
class ProvideLeadFeedbackRequest(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self,
        key: Literal[
            "resource_name", "survey_answer", "survey_satisfied", "survey_dissatisfied"
        ],
    ) -> bool: ...

class ProvideLeadFeedbackResponse(proto.Message):
    credit_issuance_decision: (
        LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision
    )
    def __init__(
        self: _M,
        mapping: _M | Mapping | google.protobuf.message.Message | None = None,
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["credit_issuance_decision"]
    ) -> bool: ...

class SurveyDissatisfied(proto.Message):
    survey_dissatisfied_reason: (
        LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason
    )
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["survey_dissatisfied_reason", "other_reason_comment"]
    ) -> bool: ...

class SurveySatisfied(proto.Message):
    survey_satisfied_reason: (
        LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason
    )
    other_reason_comment: str
    def __init__(
        self: _M,
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["survey_satisfied_reason", "other_reason_comment"]
    ) -> bool: ...
