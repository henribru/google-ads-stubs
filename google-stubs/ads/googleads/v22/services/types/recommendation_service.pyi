...
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from google.ads.googleads.v22.enums.types.conversion_tracking_status_enum import ConversionTrackingStatusEnum
...
from collections.abc import MutableSequence
from google.ads.googleads.v22.common.types.extensions import SitelinkFeedItem
from google.ads.googleads.v22.resources.types.ad import Ad
from google.ads.googleads.v22.resources.types.ad import Ad
from google.ads.googleads.v22.resources.types.ad import Ad
from google.ads.googleads.v22.enums.types.keyword_match_type import KeywordMatchTypeEnum
from collections.abc import MutableSequence
from google.ads.googleads.v22.common.types.extensions import CalloutFeedItem
from collections.abc import MutableSequence
from google.ads.googleads.v22.common.types.extensions import CallFeedItem
from collections.abc import MutableSequence
from collections.abc import MutableSequence
...
class ApplyRecommendationOperation(proto.Message):
    class AdAssetApplyParameters(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, new_assets: MutableSequence[Asset] = ..., existing_assets: MutableSequence[str] = ..., scope: ApplyRecommendationOperation.AdAssetApplyParameters.ApplyScope = ...) -> None: ...
    ...
    class CallAssetParameters(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, ad_asset_apply_parameters: ApplyRecommendationOperation.AdAssetApplyParameters = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class CallExtensionParameters(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, call_extensions: MutableSequence[CallFeedItem] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class CalloutExtensionParameters(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, callout_extensions: MutableSequence[CalloutFeedItem] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["callout_extensions"]) -> bool: ...
    class CampaignBudgetParameters(proto.Message):
        new_budget_amount_micros: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, new_budget_amount_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ForecastingSetTargetCpaParameters(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, target_cpa_micros: int = ..., campaign_budget_amount_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ForecastingSetTargetRoasParameters(proto.Message):
        target_roas: float
        campaign_budget_amount_micros: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, target_roas: float = ..., campaign_budget_amount_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class KeywordParameters(proto.Message):
        ...
        cpc_bid_micros: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, ad_group: str = ..., match_type: KeywordMatchTypeEnum.KeywordMatchType = ..., cpc_bid_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class LeadFormAssetParameters(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, ad_asset_apply_parameters: ApplyRecommendationOperation.AdAssetApplyParameters = ..., set_submit_lead_form_asset_campaign_goal: bool = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class LowerTargetRoasParameters(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, target_roas_multiplier: float = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["target_roas_multiplier"]) -> bool: ...
    class MoveUnusedBudgetParameters(proto.Message):
        budget_micros_to_move: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, budget_micros_to_move: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["budget_micros_to_move"]) -> bool: ...
    class RaiseTargetCpaBidTooLowParameters(proto.Message):
        target_multiplier: float
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, target_multiplier: float = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["target_multiplier"]) -> bool: ...
    class RaiseTargetCpaParameters(proto.Message):
        target_cpa_multiplier: float
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, target_cpa_multiplier: float = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["target_cpa_multiplier"]) -> bool: ...
    class ResponsiveSearchAdAssetParameters(proto.Message):
        updated_ad: Ad
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, updated_ad: Ad = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class SitelinkExtensionParameters(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, sitelink_extensions: MutableSequence[SitelinkFeedItem] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class TargetCpaOptInParameters(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, target_cpa_micros: int = ..., new_campaign_budget_amount_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["target_cpa_micros", "new_campaign_budget_amount_micros"]) -> bool: ...
    class TargetRoasOptInParameters(proto.Message):
        target_roas: float
        new_campaign_budget_amount_micros: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, target_roas: float = ..., new_campaign_budget_amount_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
...
class ApplyRecommendationRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., operations: MutableSequence[ApplyRecommendationOperation] = ..., partial_failure: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ApplyRecommendationResponse(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, results: MutableSequence[ApplyRecommendationResult] = ..., partial_failure_error: Status = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class DismissRecommendationRequest(proto.Message):
    ...
    partial_failure: bool
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., operations: MutableSequence[DismissRecommendationRequest.DismissRecommendationOperation] = ..., partial_failure: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["customer_id", "operations", "partial_failure"]) -> bool: ...
class DismissRecommendationResponse(proto.Message):
    ...
    partial_failure_error: Status
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, results: MutableSequence[DismissRecommendationResponse.DismissRecommendationResult] = ..., partial_failure_error: Status = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["results", "partial_failure_error"]) -> bool: ...
class GenerateRecommendationsRequest(proto.Message):
    class AdGroupInfo(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, ad_group_type: AdGroupTypeEnum.AdGroupType = ..., keywords: MutableSequence[KeywordInfo] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class AssetGroupInfo(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, final_url: str = ..., headline: MutableSequence[str] = ..., description: MutableSequence[str] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class BiddingInfo(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, bidding_strategy_type: BiddingStrategyTypeEnum.BiddingStrategyType = ..., target_cpa_micros: int = ..., target_roas: float = ..., target_impression_share_info: GenerateRecommendationsRequest.TargetImpressionShareInfo = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class BudgetInfo(proto.Message):
        current_budget: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, current_budget: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["current_budget"]) -> bool: ...
    class SeedInfo(proto.Message):
        url_seed: str
        keyword_seeds: MutableSequence[str]
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, url_seed: str = ..., keyword_seeds: MutableSequence[str] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class TargetImpressionShareInfo(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, location: TargetImpressionShareLocationEnum.TargetImpressionShareLocation = ..., target_impression_share_micros: int = ..., max_cpc_bid_ceiling: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
