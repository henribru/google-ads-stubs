from google.ads.googleads.v22.common.types.offline_user_data import UserData
from google.ads.googleads.v22.common.types.offline_user_data import UserData
...
class AddOfflineUserDataJobOperationsRequest(proto.Message):
    ...
    validate_only: bool
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, resource_name: str = ..., enable_partial_failure: bool = ..., enable_warnings: bool = ..., operations: MutableSequence[OfflineUserDataJobOperation] = ..., validate_only: bool = ...) -> None: ...
...
class AddOfflineUserDataJobOperationsResponse(proto.Message):
    ...
    warning: Status
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, partial_failure_error: Status = ..., warning: Status = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class CreateOfflineUserDataJobRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., job: OfflineUserDataJob = ..., validate_only: bool = ..., enable_match_rate_range_preview: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class OfflineUserDataJobOperation(proto.Message):
    ...
    remove: UserData
    remove_all: bool
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, create: UserData = ..., remove: UserData = ..., remove_all: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
