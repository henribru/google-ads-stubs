...
from collections.abc import MutableSequence
from google.ads.googleads.v22.common.types.audience_insights_attribute import AudienceInsightsAttributeMetadata
from google.ads.googleads.v22.enums.types.insights_trend import InsightsTrendEnum
from google.ads.googleads.v22.common.types.audience_insights_attribute import AudienceInsightsAttributeMetadata
from collections.abc import MutableSequence
from google.ads.googleads.v22.common.types.audience_insights_attribute import AudienceInsightsEntity
from collections.abc import MutableSequence
...
class TrendInsightMetrics(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, views_count: int = ..., audience_share: float = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["views_count", "audience_share"]) -> bool: ...
class YouTubeChannelInsights(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["display_name", "youtube_channel", "channel_url", "channel_description", "handle", "thumbnail_url", "publish_date", "country_location", "channel_metrics", "channel_audience_attributes", "channel_attributes", "top_videos", "channel_type"]) -> bool: ...
