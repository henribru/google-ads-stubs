from google.ads.googleads.v22.common.types.asset_policy import AdAssetPolicySummary
...
class AdVideoAssetInfo(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, ad_video_asset_inventory_preferences: AdVideoAssetInventoryPreferences = ...) -> None: ...
    def __contains__(  # type: ignore[override]
