...
class AssetFieldTypeView(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, resource_name: str = ..., field_type: AssetFieldTypeEnum.AssetFieldType = ...) -> None: ...
