...
from google.ads.googleads.v22.enums.types.served_asset_field_type import ServedAssetFieldTypeEnum
from google.ads.googleads.v22.enums.types.asset_performance_label import AssetPerformanceLabelEnum
...
class AdGroupAdAssetView(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, resource_name: str = ..., ad_group_ad: str = ..., asset: str = ..., field_type: AssetFieldTypeEnum.AssetFieldType = ..., enabled: bool = ..., policy_summary: AdGroupAdAssetPolicySummary = ..., performance_label: AssetPerformanceLabelEnum.AssetPerformanceLabel = ..., pinned_field: ServedAssetFieldTypeEnum.ServedAssetFieldType = ..., source: AssetSourceEnum.AssetSource = ...) -> None: ...
    def __contains__(  # type: ignore[override]
    self, key: Literal["resource_name", "ad_group_ad", "asset", "field_type", "enabled", "policy_summary", "performance_label", "pinned_field", "source"]) -> bool: ...
