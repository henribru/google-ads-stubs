...
from collections.abc import MutableSequence
from google.ads.googleads.v22.enums.types.target_cpa_opt_in_recommendation_goal import TargetCpaOptInRecommendationGoalEnum
from collections.abc import MutableSequence
from google.ads.googleads.v22.resources.types.asset import Asset
from collections.abc import MutableSequence
from google.ads.googleads.v22.resources.types.asset import Asset
from google.ads.googleads.v22.enums.types.shopping_add_products_to_campaign_recommendation_enum import ShoppingAddProductsToCampaignRecommendationEnum
from google.ads.googleads.v22.resources.types.ad import Ad
from google.ads.googleads.v22.resources.types.ad import Ad
from google.ads.googleads.v22.resources.types.ad import Ad
from google.ads.googleads.v22.resources.types.ad import Ad
from google.ads.googleads.v22.resources.types.ad import Ad
from collections.abc import MutableSequence
from google.ads.googleads.v22.enums.types.app_bidding_goal import AppBiddingGoalEnum
from collections.abc import MutableSequence
from google.ads.googleads.v22.common.types.criteria import KeywordInfo
from google.ads.googleads.v22.enums.types.keyword_match_type import KeywordMatchTypeEnum
from google.ads.googleads.v22.common.types.criteria import KeywordInfo
...
class Recommendation(proto.Message):
    class AccountInfo(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: int = ..., descriptive_name: str = ...) -> None: ...
    ...
    class CalloutAssetRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, recommended_campaign_callout_assets: MutableSequence[Asset] = ..., recommended_customer_callout_assets: MutableSequence[Asset] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class CampaignBudget(proto.Message):
        ...
        new_start_date: str
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, current_amount_micros: int = ..., recommended_new_amount_micros: int = ..., new_start_date: str = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class CampaignBudgetRecommendation(proto.Message):
        class CampaignBudgetRecommendationOption(proto.Message):
            ...
            def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, budget_amount_micros: int = ..., impact: Recommendation.RecommendationImpact = ...) -> None: ...
            def __contains__(  # type: ignore[override]
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, current_budget_amount_micros: int = ..., recommended_budget_amount_micros: int = ..., budget_options: MutableSequence[Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class CustomAudienceOptInRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, keywords: MutableSequence[KeywordInfo] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ForecastingSetTargetCpaRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, recommended_target_cpa_micros: int = ..., campaign_budget: Recommendation.CampaignBudget = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ForecastingSetTargetRoasRecommendation(proto.Message):
        ...
        campaign_budget: Recommendation.CampaignBudget
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, recommended_target_roas: float = ..., campaign_budget: Recommendation.CampaignBudget = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ImproveDemandGenAdStrengthRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, ad: str = ..., ad_strength: AdStrengthEnum.AdStrength = ..., demand_gen_asset_action_items: MutableSequence[str] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ImprovePerformanceMaxAdStrengthRecommendation(proto.Message):
        asset_group: str
        ad_strength: AdStrengthEnum.AdStrength
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, asset_group: str = ..., ad_strength: AdStrengthEnum.AdStrength = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class KeywordMatchTypeRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, keyword: KeywordInfo = ..., recommended_match_type: KeywordMatchTypeEnum.KeywordMatchType = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class KeywordRecommendation(proto.Message):
        class SearchTerm(proto.Message):
            ...
            def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, text: str = ..., estimated_weekly_search_count: int = ...) -> None: ...
            def __contains__(  # type: ignore[override]
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, keyword: KeywordInfo = ..., search_terms: MutableSequence[Recommendation.KeywordRecommendation.SearchTerm] = ..., recommended_cpc_bid_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class LowerTargetRoasRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, target_adjustment: Recommendation.TargetAdjustmentInfo = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["target_adjustment"]) -> bool: ...
    class MaximizeClicksOptInRecommendation(proto.Message):
        recommended_budget_amount_micros: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, recommended_budget_amount_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class MerchantInfo(proto.Message):
        ...
        name: str
        multi_client: bool
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, id: int = ..., name: str = ..., multi_client: bool = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class MigrateDynamicSearchAdsCampaignToPerformanceMaxRecommendation(proto.Message):
        apply_link: str
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, apply_link: str = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class MoveUnusedBudgetRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, excess_campaign_budget: str = ..., budget_recommendation: Recommendation.CampaignBudgetRecommendation = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class RaiseTargetCpaBidTooLowRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, recommended_target_multiplier: float = ..., average_target_cpa_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class RaiseTargetCpaRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, target_adjustment: Recommendation.TargetAdjustmentInfo = ..., app_bidding_goal: AppBiddingGoalEnum.AppBiddingGoal = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class RecommendationImpact(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, base_metrics: Recommendation.RecommendationMetrics = ..., potential_metrics: Recommendation.RecommendationMetrics = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class RecommendationMetrics(proto.Message):
        ...
        video_views: float
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, impressions: float = ..., clicks: float = ..., cost_micros: int = ..., conversions: float = ..., conversions_value: float = ..., video_views: float = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class RefreshCustomerMatchListRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, user_list_id: int = ..., user_list_name: str = ..., days_since_last_refresh: int = ..., top_spending_account: MutableSequence[Recommendation.AccountInfo] = ..., targeting_accounts_count: int = ..., owner_account: Recommendation.AccountInfo = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ResponsiveSearchAdAssetRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, current_ad: Ad = ..., recommended_assets: Ad = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["current_ad", "recommended_assets"]) -> bool: ...
    class ResponsiveSearchAdImproveAdStrengthRecommendation(proto.Message):
        current_ad: Ad
        recommended_ad: Ad
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, current_ad: Ad = ..., recommended_ad: Ad = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["current_ad", "recommended_ad"]) -> bool: ...
    class ResponsiveSearchAdRecommendation(proto.Message):
        ad: Ad
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, ad: Ad = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ShoppingAddProductsToCampaignRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, merchant: Recommendation.MerchantInfo = ..., feed_label: str = ..., reason: ShoppingAddProductsToCampaignRecommendationEnum.Reason = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ShoppingFixDisapprovedProductsRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, merchant: Recommendation.MerchantInfo = ..., feed_label: str = ..., products_count: int = ..., disapproved_products_count: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ShoppingMerchantCenterAccountSuspensionRecommendation(proto.Message):
        merchant: Recommendation.MerchantInfo
        feed_label: str
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, merchant: Recommendation.MerchantInfo = ..., feed_label: str = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ShoppingOfferAttributeRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, merchant: Recommendation.MerchantInfo = ..., feed_label: str = ..., offers_count: int = ..., demoted_offers_count: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ShoppingTargetAllOffersRecommendation(proto.Message):
        ...
        feed_label: str
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, merchant: Recommendation.MerchantInfo = ..., untargeted_offers_count: int = ..., feed_label: str = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class SitelinkAssetRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, recommended_campaign_sitelink_assets: MutableSequence[Asset] = ..., recommended_customer_sitelink_assets: MutableSequence[Asset] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class TargetAdjustmentInfo(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, shared_set: str = ..., recommended_target_multiplier: float = ..., current_average_target_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class TargetCpaOptInRecommendation(proto.Message):
        class TargetCpaOptInRecommendationOption(proto.Message):
            ...
            impact: Recommendation.RecommendationImpact
            def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, goal: TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal = ..., target_cpa_micros: int = ..., required_campaign_budget_amount_micros: int = ..., impact: Recommendation.RecommendationImpact = ...) -> None: ...
            def __contains__(  # type: ignore[override]
        ...
        recommended_target_cpa_micros: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, options: MutableSequence[Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption] = ..., recommended_target_cpa_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
        self, key: Literal["options", "recommended_target_cpa_micros"]) -> bool: ...
    class TargetRoasOptInRecommendation(proto.Message):
        recommended_target_roas: float
        required_campaign_budget_amount_micros: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, recommended_target_roas: float = ..., required_campaign_budget_amount_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class TextAdRecommendation(proto.Message):
        ...
        creation_date: str
        auto_apply_date: str
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, ad: Ad = ..., creation_date: str = ..., auto_apply_date: str = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class UpgradeSmartShoppingCampaignToPerformanceMaxRecommendation(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, merchant_id: int = ..., sales_country_code: str = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class UseBroadMatchKeywordRecommendation(proto.Message):
        ...
        required_campaign_budget_amount_micros: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, keyword: MutableSequence[KeywordInfo] = ..., suggested_keywords_count: int = ..., campaign_keywords_count: int = ..., campaign_uses_shared_budget: bool = ..., required_campaign_budget_amount_micros: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
