...
class GoogleAdsRow(proto.Message):
    ...
    asset_group_product_group_view: Any
    asset_group: Any
    asset_set_asset: Any
    asset_set: Any
    batch_job: Any
...
class MutateOperation(proto.Message):
    ...
    ad_group_criterion_customizer_operation: Any
    ad_group_criterion_label_operation: Any
    ad_group_criterion_operation: Any
    ad_group_customizer_operation: Any
    ...
    asset_operation: Any
    asset_group_asset_operation: Any
    asset_group_listing_group_filter_operation: Any
    asset_group_operation: Any
    asset_set_asset_operation: Any
    asset_set_operation: Any
    ...
    campaign_asset_set_operation: Any
    campaign_bid_modifier_operation: Any
    campaign_budget_operation: Any
    campaign_conversion_goal_operation: Any
    campaign_criterion_operation: Any
    campaign_customizer_operation: Any
    ...
    conversion_goal_campaign_config_operation: Any
    conversion_value_rule_operation: Any
    conversion_value_rule_set_operation: Any
    custom_conversion_goal_operation: Any
    customer_asset_operation: Any
    customer_conversion_goal_operation: Any
    customizer_customizer_operation: Any
    ...
    customizer_attribute_operation: Any
...
class MutateOperationResponse(proto.Message):
    ...
    ad_group_criterion_customizer_result: Any
    ad_group_criterion_label_result: Any
    ad_group_criterion_result: Any
    ad_group_customizer_result: Any
    ...
    ad_result: Any
    asset_result: Any
    asset_group_asset_result: Any
    asset_group_listing_group_filter_result: Any
    asset_group_result: Any
    asset_set_asset_result: Any
    asset_set_result: Any
    ...
    campaign_asset_set_result: Any
    campaign_bid_modifier_result: Any
    campaign_budget_result: Any
    campaign_conversion_goal_result: Any
    campaign_criterion_result: Any
    campaign_customizer_result: Any
    ...
    conversion_goal_campaign_config_result: Any
    conversion_value_rule_result: Any
    conversion_value_rule_set_result: Any
    custom_conversion_goal_result: Any
    customer_asset_result: Any
    customer_conversion_goal_result: Any
    customer_customizer_result: Any
    ...
    customer_result: Any
    customizer_attribute_result: Any
