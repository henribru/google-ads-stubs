...
class AdParameterServiceClient(metaclass=AdParameterServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, AdParameterServiceTransport, None] = ...,
        client_options: Optional[client_options_lib.ClientOptions] = ...,
        client_info: gapic_v1.client_info.ClientInfo = ...
    ) -> None: ...
    def get_ad_parameter(
        self,
        request: Union[ad_parameter_service.GetAdParameterRequest, dict] = ...,
        *,
        resource_name: str = ...,
    ...
    def mutate_ad_parameters(
        self,
        request: Union[ad_parameter_service.MutateAdParametersRequest, dict] = ...,
        *,
        customer_id: str = ...,
        operations: Sequence[ad_parameter_service.AdParameterOperation] = ...,
        retry: Union[retries.Retry, gapic_v1.method._MethodDefault] = ...,
        timeout: float = ...,
        metadata: Sequence[Tuple[str, str]] = ...
