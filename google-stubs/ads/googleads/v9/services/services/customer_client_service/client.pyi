...
from .transports.base import CustomerClientServiceTransport
...
class CustomerClientServiceClient(metaclass=CustomerClientServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, CustomerClientServiceTransport, None] = ...,
        client_options: Optional[client_options_lib.ClientOptions] = ...,
        client_info: gapic_v1.client_info.ClientInfo = ...
    ) -> None: ...
    def get_customer_client(
        self,
        request: Union[customer_client_service.GetCustomerClientRequest, dict] = ...,
        *,
        resource_name: str = ...,
