...
class AssetGroupAssetServiceClient(metaclass=AssetGroupAssetServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, AssetGroupAssetServiceTransport, None] = ...,
        client_options: Optional[client_options_lib.ClientOptions] = ...,
        client_info: gapic_v1.client_info.ClientInfo = ...
    ) -> None: ...
    def get_asset_group_asset(
        self,
        request: Union[asset_group_asset_service.GetAssetGroupAssetRequest, dict] = ...,
        *,
        resource_name: str = ...,
    ...
    def mutate_asset_group_assets(
        ...
        *,
        customer_id: str = ...,
        operations: Sequence[asset_group_asset_service.AssetGroupAssetOperation] = ...,
        retry: Union[retries.Retry, gapic_v1.method._MethodDefault] = ...,
        timeout: float = ...,
        metadata: Sequence[Tuple[str, str]] = ...
