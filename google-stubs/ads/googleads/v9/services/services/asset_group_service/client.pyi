...
class AssetGroupServiceClient(metaclass=AssetGroupServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, AssetGroupServiceTransport, None] = ...,
        client_options: Optional[client_options_lib.ClientOptions] = ...,
        client_info: gapic_v1.client_info.ClientInfo = ...
    ) -> None: ...
    def get_asset_group(
        self,
        request: Union[asset_group_service.GetAssetGroupRequest, dict] = ...,
        *,
        resource_name: str = ...,
    ...
    def mutate_asset_groups(
        self,
        request: Union[asset_group_service.MutateAssetGroupsRequest, dict] = ...,
        *,
        customer_id: str = ...,
        operations: Sequence[asset_group_service.AssetGroupOperation] = ...,
        retry: Union[retries.Retry, gapic_v1.method._MethodDefault] = ...,
        timeout: float = ...,
        metadata: Sequence[Tuple[str, str]] = ...
