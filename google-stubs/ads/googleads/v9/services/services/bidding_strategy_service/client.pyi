...
class BiddingStrategyServiceClient(metaclass=BiddingStrategyServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, BiddingStrategyServiceTransport, None] = ...,
        client_options: Optional[client_options_lib.ClientOptions] = ...,
        client_info: gapic_v1.client_info.ClientInfo = ...
    ) -> None: ...
    def get_bidding_strategy(
        self,
        request: Union[bidding_strategy_service.GetBiddingStrategyRequest, dict] = ...,
        *,
        resource_name: str = ...,
    ...
    def mutate_bidding_strategies(
        ...
        *,
        customer_id: str = ...,
        operations: Sequence[bidding_strategy_service.BiddingStrategyOperation] = ...,
        retry: Union[retries.Retry, gapic_v1.method._MethodDefault] = ...,
        timeout: float = ...,
        metadata: Sequence[Tuple[str, str]] = ...
