...
class CustomerLabelServiceClient(metaclass=CustomerLabelServiceClientMeta):
    ...
    def __init__(
        ...
        *,
        ...
        transport: Union[str, CustomerLabelServiceTransport, None] = ...,
        client_options: Optional[client_options_lib.ClientOptions] = ...,
        client_info: gapic_v1.client_info.ClientInfo = ...
    ) -> None: ...
    def get_customer_label(
        self,
        request: Union[customer_label_service.GetCustomerLabelRequest, dict] = ...,
        *,
        resource_name: str = ...,
    ...
    def mutate_customer_labels(
        self,
        request: Union[customer_label_service.MutateCustomerLabelsRequest, dict] = ...,
        *,
        customer_id: str = ...,
        operations: Sequence[customer_label_service.CustomerLabelOperation] = ...,
        retry: Union[retries.Retry, gapic_v1.method._MethodDefault] = ...,
        timeout: float = ...,
        metadata: Sequence[Tuple[str, str]] = ...
