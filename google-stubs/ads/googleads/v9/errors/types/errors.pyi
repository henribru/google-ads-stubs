...
from google.ads.googleads.v9.common.types import policy as policy, value as value
...
class ErrorCode(proto.Message):
    ...
    ad_group_criterion_customizer_error: Any
    ad_group_criterion_error: Any
    ad_group_customizer_error: Any
    ad_customizer_error: Any
    ad_group_ad_error: Any
    ad_sharing_error: Any
    adx_error: Any
    asset_error: Any
    asset_group_asset_error: Any
    asset_group_listing_group_filter_error: Any
    asset_group_error: Any
    asset_set_asset_error: Any
    asset_set_link_error: Any
    asset_set_error: Any
    bidding_error: Any
    campaign_criterion_error: Any
    campaign_customizer_error: Any
    collection_size_error: Any
    country_code_error: Any
    criterion_error: Any
    custom_conversion_goal_error: Any
    customer_customizer_error: Any
    customer_error: Any
    customizer_attribute_error: Any
    date_error: Any
