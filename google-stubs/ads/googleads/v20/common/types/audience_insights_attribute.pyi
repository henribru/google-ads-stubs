...
class AudienceInsightsAttribute(proto.Message):
    ...
    device: DeviceInfo
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., age_range: AgeRangeInfo = ..., gender: GenderInfo = ..., location: LocationInfo = ..., user_interest: UserInterestInfo = ..., entity: AudienceInsightsEntity = ..., category: AudienceInsightsCategory = ..., lineup: AudienceInsightsLineup = ..., parental_status: ParentalStatusInfo = ..., income_range: IncomeRangeInfo = ..., youtube_channel: YouTubeChannelInfo = ..., youtube_video: YouTubeVideoInfo = ..., device: DeviceInfo = ...) -> None: ...
...
class AudienceInsightsAttributeMetadata(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., dimension: AudienceInsightsDimensionEnum.AudienceInsightsDimension = ..., attribute: AudienceInsightsAttribute = ..., display_name: str = ..., display_info: str = ..., potential_youtube_reach: int = ..., subscriber_share: float = ..., viewer_share: float = ..., youtube_channel_metadata: YouTubeChannelAttributeMetadata = ..., youtube_video_metadata: YouTubeVideoAttributeMetadata = ..., lineup_attribute_metadata: LineupAttributeMetadata = ..., location_attribute_metadata: LocationAttributeMetadata = ..., user_interest_attribute_metadata: UserInterestAttributeMetadata = ..., knowledge_graph_attribute_metadata: KnowledgeGraphAttributeMetadata = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class AudienceInsightsLineup(proto.Message):
    lineup_id: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., lineup_id: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class KnowledgeGraphAttributeMetadata(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., entity_capabilities: MutableSequence[InsightsKnowledgeGraphEntityCapabilitiesEnum.InsightsKnowledgeGraphEntityCapabilities] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class LineupAttributeMetadata(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., inventory_country: LocationInfo = ..., median_monthly_inventory: int = ..., channel_count_lower_bound: int = ..., channel_count_upper_bound: int = ..., sample_channels: MutableSequence[LineupAttributeMetadata.SampleChannel] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class YouTubeVideoAttributeMetadata(proto.Message):
    thumbnail_url: str
    video_url: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., thumbnail_url: str = ..., video_url: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
