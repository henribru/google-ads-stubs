...
from google.ads.googleads.v20.enums.types.insights_knowledge_graph_entity_capabilities import (
...
class KnowledgeGraphAttributeMetadata(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["entity_capabilities"]
    ) -> bool: ...
...
class YouTubeVideoAttributeMetadata(proto.Message):
    ...
    def __contains__(  # type: ignore[override]
        self, key: Literal["thumbnail_url", "video_url"]
    ) -> bool: ...
