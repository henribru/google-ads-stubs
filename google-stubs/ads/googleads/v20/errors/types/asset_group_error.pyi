...
class AssetGroupErrorEnum(proto.Message):
    class AssetGroupError(proto.Enum):
        ...
        PATH1_REQUIRED_WHEN_PATH2_IS_SET: int
        SHORT_DESCRIPTION_REQUIRED: int
        FINAL_URL_REQUIRED: int
        FINAL_URL_CONTAINS_INVALID_DOMAIN_NAME: int
        AD_CUSTOMIZER_NOT_SUPPORTED: int
        CANNOT_MUTATE_ASSET_GROUP_FOR_REMOVED_CAMPAIGN: int
