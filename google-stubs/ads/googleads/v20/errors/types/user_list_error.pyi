...
class UserListErrorEnum(proto.Message):
    class UserListError(proto.Enum):
        ...
        APP_ID_NOT_ALLOWED: int
        CANNOT_MUTATE_SYSTEM_LIST: int
        MOBILE_APP_IS_SENSITIVE: int
        SEED_LIST_DOES_NOT_EXIST: int
        INVALID_SEED_LIST_ACCESS_REASON: int
        INVALID_SEED_LIST_TYPE: int
