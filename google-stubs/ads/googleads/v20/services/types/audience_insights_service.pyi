...
from google.ads.googleads.v20.enums.types.audience_insights_marketing_objective import AudienceInsightsMarketingObjectiveEnum
from collections.abc import MutableSequence
from google.ads.googleads.v20.common.types.criteria import LocationInfo
from collections.abc import MutableSequence
...
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from google.ads.googleads.v20.common.types.audience_insights_attribute import AudienceInsightsLineup
from collections.abc import MutableSequence
...
from google.ads.googleads.v20.enums.types.audience_insights_dimension import AudienceInsightsDimensionEnum
from collections.abc import MutableSequence
from google.ads.googleads.v20.common.types.audience_insights_attribute import AudienceInsightsTopic
from collections.abc import MutableSequence
...
class GenerateAudienceCompositionInsightsRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., audience: InsightsAudience = ..., baseline_audience: InsightsAudience = ..., data_month: str = ..., dimensions: MutableSequence[AudienceInsightsDimensionEnum.AudienceInsightsDimension] = ..., customer_insights_group: str = ..., insights_application_info: AdditionalApplicationInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class GenerateInsightsFinderReportRequest(proto.Message):
    ...
    customer_insights_group: str
    insights_application_info: AdditionalApplicationInfo
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., baseline_audience: BasicInsightsAudience = ..., specific_audience: BasicInsightsAudience = ..., customer_insights_group: str = ..., insights_application_info: AdditionalApplicationInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class GenerateSuggestedTargetingInsightsRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., customer_insights_group: str = ..., insights_application_info: AdditionalApplicationInfo = ..., audience_definition: InsightsAudienceDefinition = ..., audience_description: InsightsAudienceDescription = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class GenerateTargetingSuggestionMetricsRequest(proto.Message):
    ...
    customer_insights_group: str
    insights_application_info: AdditionalApplicationInfo
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., audiences: MutableSequence[BasicInsightsAudience] = ..., customer_insights_group: str = ..., insights_application_info: AdditionalApplicationInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ListInsightsEligibleDatesRequest(proto.Message):
    insights_application_info: AdditionalApplicationInfo
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., insights_application_info: AdditionalApplicationInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
