...
class GenerateTargetingSuggestionMetricsRequest(proto.Message):
    ...
    customer_insights_group: str
    insights_application_info: AdditionalApplicationInfo
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = None, *, ignore_unknown_fields: bool = False, customer_id: str = ..., audiences: MutableSequence[BasicInsightsAudience] = ..., customer_insights_group: str = ..., insights_application_info: AdditionalApplicationInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
