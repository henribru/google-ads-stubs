...
from google.ads.googleads.v20.common.types import additional_application_info, criteria, dates
from google.ads.googleads.v20.enums.types import frequency_cap_time_unit, reach_plan_age_range, reach_plan_conversion_rate_model, reach_plan_network, reach_plan_plannable_user_list_status, reach_plan_surface, target_frequency_time_unit, user_list_type as gage_user_list_type
...
class GenerateConversionRatesRequest(proto.Message):
    ...
    reach_application_info: additional_application_info.AdditionalApplicationInfo
...
class PlannableUserList(proto.Message):
    user_list_info: criteria.UserListInfo
    display_name: str
...
class AudienceTargeting(proto.Message):
    ...
    user_lists: MutableSequence[criteria.UserListInfo]
