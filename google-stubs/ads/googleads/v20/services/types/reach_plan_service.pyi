...
class AudienceTargeting(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., user_interest: MutableSequence[UserInterestInfo] = ..., user_lists: MutableSequence[UserListInfo] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ConversionRateSuggestion(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., conversion_rate_model: ReachPlanConversionRateModelEnum.ReachPlanConversionRateModel = ..., plannable_product_code: str = ..., conversion_rate: float = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class GenerateConversionRatesRequest(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., customer_reach_group: str = ..., reach_application_info: AdditionalApplicationInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class GenerateConversionRatesResponse(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., conversion_rate_suggestions: MutableSequence[ConversionRateSuggestion] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ListPlannableLocationsRequest(proto.Message):
    reach_application_info: AdditionalApplicationInfo
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., reach_application_info: AdditionalApplicationInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ListPlannableProductsRequest(proto.Message):
    ...
    reach_application_info: AdditionalApplicationInfo
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., plannable_location_id: str = ..., reach_application_info: AdditionalApplicationInfo = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ListPlannableUserListsRequest(proto.Message):
    customer_id: str
    customer_reach_group: str
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., customer_reach_group: str = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ListPlannableUserListsResponse(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., plannable_user_lists: MutableSequence[PlannableUserList] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class PlannableUserList(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., user_list_info: UserListInfo = ..., display_name: str = ..., user_list_type: UserListTypeEnum.UserListType = ..., plannable_status: ReachPlanPlannableUserListStatusEnum.ReachPlanPlannableUserListStatus = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class PlannedProduct(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., plannable_product_code: str = ..., budget_micros: int = ..., conversion_rate: float = ..., advanced_product_targeting: AdvancedProductTargeting = ...) -> None: ...
    def __contains__(  # type: ignore[override]
