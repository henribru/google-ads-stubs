...
class CampaignLifecycleGoalOperation(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., update_mask: FieldMask = ..., create: CampaignLifecycleGoal = ..., update: CampaignLifecycleGoal = ...) -> None: ...
...
class ConfigureCampaignLifecycleGoalsRequest(proto.Message):
    ...
    validate_only: bool
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., customer_id: str = ..., operation: CampaignLifecycleGoalOperation = ..., validate_only: bool = ...) -> None: ...
    def __contains__(  # type: ignore[override]
...
class ConfigureCampaignLifecycleGoalsResponse(proto.Message):
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., result: ConfigureCampaignLifecycleGoalsResult = ...) -> None: ...
    def __contains__(  # type: ignore[override]
