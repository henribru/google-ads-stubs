...
class AdGroupCriterionServiceGrpcAsyncIOTransport(AdGroupCriterionServiceTransport):
    @classmethod
    ...
    @property
    def mutate_ad_group_criteria(self) -> Callable[[ad_group_criterion_service.MutateAdGroupCriteriaRequest], Awaitable[ad_group_criterion_service.MutateAdGroupCriteriaResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
