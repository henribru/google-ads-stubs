...
class GoogleAdsFieldServiceGrpcAsyncIOTransport(GoogleAdsFieldServiceTransport):
    ...
    @property
    def get_google_ads_field(self) -> Callable[[google_ads_field_service.GetGoogleAdsFieldRequest], Awaitable[google_ads_field.GoogleAdsField]]: ...
    @property
    def search_google_ads_fields(self) -> Callable[[google_ads_field_service.SearchGoogleAdsFieldsRequest], Awaitable[google_ads_field_service.SearchGoogleAdsFieldsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
