...
class ConversionValueRuleSetServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_conversion_value_rule_sets(self) -> Callable[[conversion_value_rule_set_service.MutateConversionValueRuleSetsRequest], conversion_value_rule_set_service.MutateConversionValueRuleSetsResponse | Awaitable[conversion_value_rule_set_service.MutateConversionValueRuleSetsResponse]]: ...
    @property
    def kind(self) -> str: ...
