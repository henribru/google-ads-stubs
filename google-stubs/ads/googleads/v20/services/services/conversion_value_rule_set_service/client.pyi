...
class ConversionValueRuleSetServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[ConversionValueRuleSetServiceTransport]: ...
...
class ConversionValueRuleSetServiceClient(metaclass=ConversionValueRuleSetServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | ConversionValueRuleSetServiceTransport | Callable[..., ConversionValueRuleSetServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_conversion_value_rule_sets(self, request: conversion_value_rule_set_service.MutateConversionValueRuleSetsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[conversion_value_rule_set_service.ConversionValueRuleSetOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> conversion_value_rule_set_service.MutateConversionValueRuleSetsResponse: ...
