...
class ConversionActionServiceGrpcAsyncIOTransport(ConversionActionServiceTransport):
    @classmethod
    ...
    @property
    def mutate_conversion_actions(self) -> Callable[[conversion_action_service.MutateConversionActionsRequest], Awaitable[conversion_action_service.MutateConversionActionsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
