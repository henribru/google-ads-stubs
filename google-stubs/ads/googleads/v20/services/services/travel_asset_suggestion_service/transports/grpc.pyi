...
class TravelAssetSuggestionServiceGrpcTransport(TravelAssetSuggestionServiceTransport):
    ...
    @property
    def suggest_travel_assets(self) -> Callable[[travel_asset_suggestion_service.SuggestTravelAssetsRequest], travel_asset_suggestion_service.SuggestTravelAssetsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
