...
class CustomAudienceServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_custom_audiences(self) -> Callable[[custom_audience_service.MutateCustomAudiencesRequest], custom_audience_service.MutateCustomAudiencesResponse | Awaitable[custom_audience_service.MutateCustomAudiencesResponse]]: ...
    @property
    def kind(self) -> str: ...
