...
class UserListCustomerTypeServiceGrpcTransport(UserListCustomerTypeServiceTransport):
    ...
    @property
    def mutate_user_list_customer_types(self) -> Callable[[user_list_customer_type_service.MutateUserListCustomerTypesRequest], user_list_customer_type_service.MutateUserListCustomerTypesResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
