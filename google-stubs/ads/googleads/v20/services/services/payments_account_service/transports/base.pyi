...
class PaymentsAccountServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def list_payments_accounts(self) -> Callable[[payments_account_service.ListPaymentsAccountsRequest], payments_account_service.ListPaymentsAccountsResponse | Awaitable[payments_account_service.ListPaymentsAccountsResponse]]: ...
    @property
    def kind(self) -> str: ...
