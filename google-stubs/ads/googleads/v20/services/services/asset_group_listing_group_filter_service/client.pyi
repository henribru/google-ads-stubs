...
class AssetGroupListingGroupFilterServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> type[AssetGroupListingGroupFilterServiceTransport]: ...
