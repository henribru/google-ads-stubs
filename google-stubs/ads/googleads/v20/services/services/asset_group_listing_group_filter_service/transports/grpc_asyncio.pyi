...
from google.ads.googleads.v20.services.types import asset_group_listing_group_filter_service
...
class AssetGroupListingGroupFilterServiceGrpcAsyncIOTransport(AssetGroupListingGroupFilterServiceTransport):
    @classmethod
    ...
    @property
    def mutate_asset_group_listing_group_filters(self) -> Callable[[asset_group_listing_group_filter_service.MutateAssetGroupListingGroupFiltersRequest], Awaitable[asset_group_listing_group_filter_service.MutateAssetGroupListingGroupFiltersResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
