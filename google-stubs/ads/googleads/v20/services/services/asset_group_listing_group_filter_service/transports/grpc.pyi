...
class AssetGroupListingGroupFilterServiceGrpcTransport(AssetGroupListingGroupFilterServiceTransport):
    ...
    @property
    def mutate_asset_group_listing_group_filters(self) -> Callable[[asset_group_listing_group_filter_service.MutateAssetGroupListingGroupFiltersRequest], asset_group_listing_group_filter_service.MutateAssetGroupListingGroupFiltersResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
