...
class CustomConversionGoalServiceGrpcTransport(CustomConversionGoalServiceTransport):
    ...
    @property
    def mutate_custom_conversion_goals(self) -> Callable[[custom_conversion_goal_service.MutateCustomConversionGoalsRequest], custom_conversion_goal_service.MutateCustomConversionGoalsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
