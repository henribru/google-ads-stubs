...
class AdGroupAssetSetServiceGrpcAsyncIOTransport(AdGroupAssetSetServiceTransport):
    ...
    @property
    def mutate_ad_group_asset_sets(self) -> Callable[[ad_group_asset_set_service.MutateAdGroupAssetSetsRequest], Awaitable[ad_group_asset_set_service.MutateAdGroupAssetSetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
