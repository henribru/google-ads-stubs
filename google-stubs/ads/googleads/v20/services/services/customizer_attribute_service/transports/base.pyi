...
class CustomizerAttributeServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_customizer_attributes(self) -> Callable[[customizer_attribute_service.MutateCustomizerAttributesRequest], customizer_attribute_service.MutateCustomizerAttributesResponse | Awaitable[customizer_attribute_service.MutateCustomizerAttributesResponse]]: ...
    @property
    def kind(self) -> str: ...
