...
class CampaignAssetServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[CampaignAssetServiceTransport]: ...
...
class CampaignAssetServiceClient(metaclass=CampaignAssetServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CampaignAssetServiceTransport | Callable[..., CampaignAssetServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_campaign_assets(self, request: campaign_asset_service.MutateCampaignAssetsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[campaign_asset_service.CampaignAssetOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> campaign_asset_service.MutateCampaignAssetsResponse: ...
