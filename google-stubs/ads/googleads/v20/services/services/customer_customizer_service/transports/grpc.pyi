...
class CustomerCustomizerServiceGrpcTransport(CustomerCustomizerServiceTransport):
    ...
    @property
    def mutate_customer_customizers(self) -> Callable[[customer_customizer_service.MutateCustomerCustomizersRequest], customer_customizer_service.MutateCustomerCustomizersResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
