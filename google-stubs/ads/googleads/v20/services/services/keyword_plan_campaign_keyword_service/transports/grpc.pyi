...
class KeywordPlanCampaignKeywordServiceGrpcTransport(KeywordPlanCampaignKeywordServiceTransport):
    ...
    @property
    def mutate_keyword_plan_campaign_keywords(self) -> Callable[[keyword_plan_campaign_keyword_service.MutateKeywordPlanCampaignKeywordsRequest], keyword_plan_campaign_keyword_service.MutateKeywordPlanCampaignKeywordsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
