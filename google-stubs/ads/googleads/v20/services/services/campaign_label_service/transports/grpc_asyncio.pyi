...
class CampaignLabelServiceGrpcAsyncIOTransport(CampaignLabelServiceTransport):
    ...
    @property
    def mutate_campaign_labels(self) -> Callable[[campaign_label_service.MutateCampaignLabelsRequest], Awaitable[campaign_label_service.MutateCampaignLabelsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
