...
class CampaignDraftServiceGrpcAsyncIOTransport(CampaignDraftServiceTransport):
    ...
    @property
    def mutate_campaign_drafts(self) -> Callable[[campaign_draft_service.MutateCampaignDraftsRequest], Awaitable[campaign_draft_service.MutateCampaignDraftsResponse]]: ...
    @property
    def promote_campaign_draft(self) -> Callable[[campaign_draft_service.PromoteCampaignDraftRequest], Awaitable[operations_pb2.Operation]]: ...
    @property
    def list_campaign_draft_async_errors(self) -> Callable[[campaign_draft_service.ListCampaignDraftAsyncErrorsRequest], Awaitable[campaign_draft_service.ListCampaignDraftAsyncErrorsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
