...
class OfflineUserDataJobServiceGrpcTransport(OfflineUserDataJobServiceTransport):
    ...
    @property
    def create_offline_user_data_job(self) -> Callable[[offline_user_data_job_service.CreateOfflineUserDataJobRequest], offline_user_data_job_service.CreateOfflineUserDataJobResponse]: ...
    @property
    def add_offline_user_data_job_operations(self) -> Callable[[offline_user_data_job_service.AddOfflineUserDataJobOperationsRequest], offline_user_data_job_service.AddOfflineUserDataJobOperationsResponse]: ...
    @property
    def run_offline_user_data_job(self) -> Callable[[offline_user_data_job_service.RunOfflineUserDataJobRequest], operations_pb2.Operation]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
