...
from google.ads.googleads.v20.services.types import campaign_conversion_goal_service
...
class CampaignConversionGoalServiceGrpcAsyncIOTransport(CampaignConversionGoalServiceTransport):
    @classmethod
    ...
    @property
    def mutate_campaign_conversion_goals(self) -> Callable[[campaign_conversion_goal_service.MutateCampaignConversionGoalsRequest], Awaitable[campaign_conversion_goal_service.MutateCampaignConversionGoalsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
