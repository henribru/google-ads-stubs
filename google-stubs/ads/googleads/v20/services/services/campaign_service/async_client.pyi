...
class CampaignServiceAsyncClient:
    ...
    async def enable_p_max_brand_guidelines(self, request: campaign_service.EnablePMaxBrandGuidelinesRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[campaign_service.EnableOperation] | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> campaign_service.EnablePMaxBrandGuidelinesResponse: ...
