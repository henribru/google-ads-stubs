...
class CampaignServiceGrpcTransport(CampaignServiceTransport):
    ...
    @property
    def mutate_campaigns(self) -> Callable[[campaign_service.MutateCampaignsRequest], campaign_service.MutateCampaignsResponse]: ...
    @property
    def enable_p_max_brand_guidelines(self) -> Callable[[campaign_service.EnablePMaxBrandGuidelinesRequest], campaign_service.EnablePMaxBrandGuidelinesResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
