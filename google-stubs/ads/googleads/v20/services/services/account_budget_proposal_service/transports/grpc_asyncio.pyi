...
from google.ads.googleads.v20.services.types import account_budget_proposal_service
...
class AccountBudgetProposalServiceGrpcAsyncIOTransport(AccountBudgetProposalServiceTransport):
    @classmethod
    ...
    @property
    def mutate_account_budget_proposal(self) -> Callable[[account_budget_proposal_service.MutateAccountBudgetProposalRequest], Awaitable[account_budget_proposal_service.MutateAccountBudgetProposalResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
