...
class AudienceServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_audiences(self) -> Callable[[audience_service.MutateAudiencesRequest], audience_service.MutateAudiencesResponse | Awaitable[audience_service.MutateAudiencesResponse]]: ...
    @property
    def kind(self) -> str: ...
