...
class AudienceServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> type[AudienceServiceTransport]: ...
...
class AudienceServiceClient(metaclass=AudienceServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | AudienceServiceTransport | Callable[..., AudienceServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_audiences(self, request: audience_service.MutateAudiencesRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[audience_service.AudienceOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> audience_service.MutateAudiencesResponse: ...
