...
class GeoTargetConstantServiceGrpcTransport(GeoTargetConstantServiceTransport):
    ...
    @property
    def suggest_geo_target_constants(self) -> Callable[[geo_target_constant_service.SuggestGeoTargetConstantsRequest], geo_target_constant_service.SuggestGeoTargetConstantsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
