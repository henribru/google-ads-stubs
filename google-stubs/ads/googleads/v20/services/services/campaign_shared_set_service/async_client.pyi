...
class CampaignSharedSetServiceAsyncClient:
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | CampaignSharedSetServiceTransport | Callable[..., CampaignSharedSetServiceTransport] | None = 'grpc_asyncio', client_options: ClientOptions | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    async def mutate_campaign_shared_sets(self, request: campaign_shared_set_service.MutateCampaignSharedSetsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[campaign_shared_set_service.CampaignSharedSetOperation] | None = None, retry: retries.AsyncRetry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[tuple[str, str | bytes]] = ()) -> campaign_shared_set_service.MutateCampaignSharedSetsResponse: ...
