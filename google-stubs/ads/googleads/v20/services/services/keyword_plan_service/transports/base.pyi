...
class KeywordPlanServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_keyword_plans(self) -> Callable[[keyword_plan_service.MutateKeywordPlansRequest], keyword_plan_service.MutateKeywordPlansResponse | Awaitable[keyword_plan_service.MutateKeywordPlansResponse]]: ...
    @property
    def kind(self) -> str: ...
