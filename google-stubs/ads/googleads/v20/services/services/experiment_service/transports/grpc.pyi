...
class ExperimentServiceGrpcTransport(ExperimentServiceTransport):
    ...
    @property
    def mutate_experiments(self) -> Callable[[experiment_service.MutateExperimentsRequest], experiment_service.MutateExperimentsResponse]: ...
    @property
    def end_experiment(self) -> Callable[[experiment_service.EndExperimentRequest], empty_pb2.Empty]: ...
    @property
    def list_experiment_async_errors(self) -> Callable[[experiment_service.ListExperimentAsyncErrorsRequest], experiment_service.ListExperimentAsyncErrorsResponse]: ...
    @property
    def graduate_experiment(self) -> Callable[[experiment_service.GraduateExperimentRequest], empty_pb2.Empty]: ...
    @property
    def schedule_experiment(self) -> Callable[[experiment_service.ScheduleExperimentRequest], operations_pb2.Operation]: ...
    @property
    def promote_experiment(self) -> Callable[[experiment_service.PromoteExperimentRequest], operations_pb2.Operation]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
