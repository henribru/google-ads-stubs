...
class LocalServicesLeadServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def append_lead_conversation(self) -> Callable[[local_services_lead_service.AppendLeadConversationRequest], local_services_lead_service.AppendLeadConversationResponse | Awaitable[local_services_lead_service.AppendLeadConversationResponse]]: ...
    @property
    def provide_lead_feedback(self) -> Callable[[local_services_lead_service.ProvideLeadFeedbackRequest], local_services_lead_service.ProvideLeadFeedbackResponse | Awaitable[local_services_lead_service.ProvideLeadFeedbackResponse]]: ...
    @property
    def kind(self) -> str: ...
