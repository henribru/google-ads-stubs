...
class CustomerUserAccessInvitationServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_customer_user_access_invitation(self) -> Callable[[customer_user_access_invitation_service.MutateCustomerUserAccessInvitationRequest], customer_user_access_invitation_service.MutateCustomerUserAccessInvitationResponse | Awaitable[customer_user_access_invitation_service.MutateCustomerUserAccessInvitationResponse]]: ...
    @property
    def kind(self) -> str: ...
