...
class AdGroupServiceClientMeta(type):
    def get_transport_class(cls, label: str | None = None) -> Type[AdGroupServiceTransport]: ...
...
class AdGroupServiceClient(metaclass=AdGroupServiceClientMeta):
    ...
    def __init__(self, *, credentials: ga_credentials.Credentials | None = None, transport: str | AdGroupServiceTransport | Callable[..., AdGroupServiceTransport] | None = None, client_options: client_options_lib.ClientOptions | dict | None = None, client_info: gapic_v1.client_info.ClientInfo = ...) -> None: ...
    def mutate_ad_groups(self, request: ad_group_service.MutateAdGroupsRequest | dict | None = None, *, customer_id: str | None = None, operations: MutableSequence[ad_group_service.AdGroupOperation] | None = None, retry: retries.Retry | gapic_v1.method._MethodDefault = ..., timeout: float | object = ..., metadata: Sequence[Tuple[str, str | bytes]] = ()) -> ad_group_service.MutateAdGroupsResponse: ...
