...
class CustomerAssetSetServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_customer_asset_sets(self) -> Callable[[customer_asset_set_service.MutateCustomerAssetSetsRequest], customer_asset_set_service.MutateCustomerAssetSetsResponse | Awaitable[customer_asset_set_service.MutateCustomerAssetSetsResponse]]: ...
    @property
    def kind(self) -> str: ...
