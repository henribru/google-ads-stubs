...
class CustomerAssetServiceGrpcAsyncIOTransport(CustomerAssetServiceTransport):
    ...
    @property
    def mutate_customer_assets(self) -> Callable[[customer_asset_service.MutateCustomerAssetsRequest], Awaitable[customer_asset_service.MutateCustomerAssetsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
