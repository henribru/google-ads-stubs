...
class AdGroupCustomizerServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_ad_group_customizers(self) -> Callable[[ad_group_customizer_service.MutateAdGroupCustomizersRequest], ad_group_customizer_service.MutateAdGroupCustomizersResponse | Awaitable[ad_group_customizer_service.MutateAdGroupCustomizersResponse]]: ...
    @property
    def kind(self) -> str: ...
