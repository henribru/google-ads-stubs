...
class AdGroupCustomizerServiceGrpcAsyncIOTransport(AdGroupCustomizerServiceTransport):
    @classmethod
    ...
    @property
    def mutate_ad_group_customizers(self) -> Callable[[ad_group_customizer_service.MutateAdGroupCustomizersRequest], Awaitable[ad_group_customizer_service.MutateAdGroupCustomizersResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
