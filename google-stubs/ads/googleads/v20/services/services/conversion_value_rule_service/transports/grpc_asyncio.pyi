...
class ConversionValueRuleServiceGrpcAsyncIOTransport(ConversionValueRuleServiceTransport):
    @classmethod
    ...
    @property
    def mutate_conversion_value_rules(self) -> Callable[[conversion_value_rule_service.MutateConversionValueRulesRequest], Awaitable[conversion_value_rule_service.MutateConversionValueRulesResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
