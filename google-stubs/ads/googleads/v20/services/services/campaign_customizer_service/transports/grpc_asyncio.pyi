...
class CampaignCustomizerServiceGrpcAsyncIOTransport(CampaignCustomizerServiceTransport):
    @classmethod
    ...
    @property
    def mutate_campaign_customizers(self) -> Callable[[campaign_customizer_service.MutateCampaignCustomizersRequest], Awaitable[campaign_customizer_service.MutateCampaignCustomizersResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
