...
class CustomerLabelServiceTransport(abc.ABC):
    ...
    def close(self) -> None: ...
    @property
    def mutate_customer_labels(self) -> Callable[[customer_label_service.MutateCustomerLabelsRequest], customer_label_service.MutateCustomerLabelsResponse | Awaitable[customer_label_service.MutateCustomerLabelsResponse]]: ...
    @property
    def kind(self) -> str: ...
