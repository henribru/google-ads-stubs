...
class ShareablePreviewServiceGrpcAsyncIOTransport(ShareablePreviewServiceTransport):
    @classmethod
    ...
    @property
    def generate_shareable_previews(self) -> Callable[[shareable_preview_service.GenerateShareablePreviewsRequest], Awaitable[shareable_preview_service.GenerateShareablePreviewsResponse]]: ...
    def close(self): ...
    @property
    def kind(self) -> str: ...
