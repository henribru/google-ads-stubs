...
class ShareablePreviewServiceGrpcTransport(ShareablePreviewServiceTransport):
    ...
    @property
    def generate_shareable_previews(self) -> Callable[[shareable_preview_service.GenerateShareablePreviewsRequest], shareable_preview_service.GenerateShareablePreviewsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
