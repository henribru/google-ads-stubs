...
class BatchJobServiceGrpcTransport(BatchJobServiceTransport):
    ...
    @property
    def mutate_batch_job(self) -> Callable[[batch_job_service.MutateBatchJobRequest], batch_job_service.MutateBatchJobResponse]: ...
    @property
    def list_batch_job_results(self) -> Callable[[batch_job_service.ListBatchJobResultsRequest], batch_job_service.ListBatchJobResultsResponse]: ...
    @property
    def run_batch_job(self) -> Callable[[batch_job_service.RunBatchJobRequest], operations_pb2.Operation]: ...
    @property
    def add_batch_job_operations(self) -> Callable[[batch_job_service.AddBatchJobOperationsRequest], batch_job_service.AddBatchJobOperationsResponse]: ...
    def close(self) -> None: ...
    @property
    def kind(self) -> str: ...
