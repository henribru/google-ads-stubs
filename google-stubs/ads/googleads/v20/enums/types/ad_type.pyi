...
class AdTypeEnum(proto.Message):
    class AdType(proto.Enum):
        ...
        IN_FEED_VIDEO_AD: int
        DEMAND_GEN_MULTI_ASSET_AD: int
        DEMAND_GEN_CAROUSEL_AD: int
        TRAVEL_AD: int
        DEMAND_GEN_VIDEO_RESPONSIVE_AD: int
        DEMAND_GEN_PRODUCT_AD: int
        YOUTUBE_AUDIO_AD: int
