...
from google.ads.googleads.v20.enums.types.product_category_state import ProductCategoryStateEnum
from google.ads.googleads.v20.enums.types.product_category_level import ProductCategoryLevelEnum
import proto
...
class ProductCategoryConstant(proto.Message):
    class ProductCategoryLocalization(proto.Message):
        ...
        language_code: str
        value: str
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., region_code: str = ..., language_code: str = ..., value: str = ...) -> None: ...
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., resource_name: str = ..., category_id: int = ..., product_category_constant_parent: str = ..., level: ProductCategoryLevelEnum.ProductCategoryLevel = ..., state: ProductCategoryStateEnum.ProductCategoryState = ..., localizations: MutableSequence[ProductCategoryConstant.ProductCategoryLocalization] = ...) -> None: ...
    def __contains__(  # type: ignore[override]
