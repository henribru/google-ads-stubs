from google.ads.googleads.v20.enums.types.conversion_value_rule_status import ConversionValueRuleStatusEnum
from google.ads.googleads.v20.enums.types.value_rule_geo_location_match_type import ValueRuleGeoLocationMatchTypeEnum
from collections.abc import MutableSequence
from google.ads.googleads.v20.enums.types.value_rule_geo_location_match_type import ValueRuleGeoLocationMatchTypeEnum
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from google.ads.googleads.v20.enums.types.value_rule_device_type import ValueRuleDeviceTypeEnum
from collections.abc import MutableSequence
from collections.abc import MutableSequence
from google.ads.googleads.v20.enums.types.value_rule_operation import ValueRuleOperationEnum
import proto
...
class ConversionValueRule(proto.Message):
    class ValueRuleAction(proto.Message):
        ...
        value: float
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., operation: ValueRuleOperationEnum.ValueRuleOperation = ..., value: float = ...) -> None: ...
    ...
    class ValueRuleAudienceCondition(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., user_lists: MutableSequence[str] = ..., user_interests: MutableSequence[str] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ValueRuleDeviceCondition(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., device_types: MutableSequence[ValueRuleDeviceTypeEnum.ValueRuleDeviceType] = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ValueRuleGeoLocationCondition(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., excluded_geo_target_constants: MutableSequence[str] = ..., excluded_geo_match_type: ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType = ..., geo_target_constants: MutableSequence[str] = ..., geo_match_type: ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ValueRuleItineraryAdvanceBookingWindow(proto.Message):
        min_days: int
        max_days: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., min_days: int = ..., max_days: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ValueRuleItineraryCondition(proto.Message):
        ...
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., advance_booking_window: ConversionValueRule.ValueRuleItineraryAdvanceBookingWindow = ..., travel_length: ConversionValueRule.ValueRuleItineraryTravelLength = ..., travel_start_day: ConversionValueRule.ValueRuleItineraryTravelStartDay = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ValueRuleItineraryTravelLength(proto.Message):
        min_nights: int
        max_nights: int
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., min_nights: int = ..., max_nights: int = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    class ValueRuleItineraryTravelStartDay(proto.Message):
        ...
        saturday: bool
        sunday: bool
        def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., monday: bool = ..., tuesday: bool = ..., wednesday: bool = ..., thursday: bool = ..., friday: bool = ..., saturday: bool = ..., sunday: bool = ...) -> None: ...
        def __contains__(  # type: ignore[override]
    ...
    def __init__(self: _M, mapping: _M | Mapping | google.protobuf.message.Message | None = ..., *, ignore_unknown_fields: bool = ..., resource_name: str = ..., id: int = ..., action: ConversionValueRule.ValueRuleAction = ..., geo_location_condition: ConversionValueRule.ValueRuleGeoLocationCondition = ..., device_condition: ConversionValueRule.ValueRuleDeviceCondition = ..., audience_condition: ConversionValueRule.ValueRuleAudienceCondition = ..., itinerary_condition: ConversionValueRule.ValueRuleItineraryCondition = ..., owner_customer: str = ..., status: ConversionValueRuleStatusEnum.ConversionValueRuleStatus = ...) -> None: ...
    def __contains__(  # type: ignore[override]
