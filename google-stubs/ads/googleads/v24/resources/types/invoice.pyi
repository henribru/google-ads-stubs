...
from google.ads.googleads.v24.enums.types.invoice_type import InvoiceTypeEnum
from google.ads.googleads.v24.enums.types.month_of_year import MonthOfYearEnum
from google.ads.googleads.v24.enums.types.regulatory_fee_type import (
    RegulatoryFeeTypeEnum,
)
from google.ads.googleads.v24.enums.types.unit_of_measure import UnitOfMeasureEnum
...
class Invoice(proto.Message):
    ...
    class AdjustmentSummary(proto.Message):
        ...
        def __contains__(  # type: ignore[override]
            self, key: Literal["adjustment_description", "amount_micros"]
        ) -> bool: ...
    ...
    class CampaignSummary(proto.Message):
        ...
        def __contains__(  # type: ignore[override]
            self,
            key: Literal[
                "campaign_description", "quantity", "unit_of_measure", "amount_micros"
            ],
        ) -> bool: ...
    ...
    class RegulatoryCostSummary(proto.Message):
        ...
        def __contains__(  # type: ignore[override]
            self, key: Literal["regulatory_fee_type", "amount_micros"]
        ) -> bool: ...
