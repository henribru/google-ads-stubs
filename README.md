...
It's currently compatible with v28.0.0 of this library (v21.0 of the API). It allows you to type check usage of the library with e.g. [mypy](http://mypy-lang.org/) and will also improve autocomplete in many editors.
...
# With this:
from google.ads.googleads.v21.services import CampaignOperation
...
# With this:
from google.ads.googleads.v21.resources import Ad
from google.ads.googleads.v21.enums import AdGroupAdStatusEnum, AdTypeEnum
AdGroupAd(
